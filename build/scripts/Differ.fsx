...
module Differ = 
    ...
    let private downloadNugetPackages nuget =
        ...
        let packageVersionPath dir packageVersion =
                ...
                | _ -> 
                    // TODO: resolve the dependency compatible framework version for the target framework.
                    // May want to remove this for dependencies as they are not required for JustAssembly,
                    // but are for BitDiffer, which was originally used.
                    traceFAKE "Nuget package %s, version %s, does not contain framework version %s in %s" 
                        nuget.Package 
                        packageVersion 
