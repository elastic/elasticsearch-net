...
module Projects = 
    ...
    type DotNetProject = 
        ...
        member this.VersionedMergeDependencies =
            ...
            | Project NestUpgradeHelper -> [Project NestJsonNetSerializer; Project Project.Nest; Project Project.ElasticsearchNet ]
        ...
        member this.Name =
            ...
            | Project NestUpgradeHelper -> "Nest.7xUpgradeHelper"
