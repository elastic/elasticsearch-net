...
[source,csharp,method="usingtypes"]
----
...
[source,csharp,method="usingconcretetypeselector"]
----
var result = this._client.Search<ISearchResult>(s => s
...
[source,csharp,method="usingcovarianttypesonscroll"]
----
...
[source,csharp,method="usingconcretetypeselectoronscroll"]
----
