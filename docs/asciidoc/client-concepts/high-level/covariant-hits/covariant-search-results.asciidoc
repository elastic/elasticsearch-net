...
[source,csharp,method-name="usingtypes"]
----
...
[source,csharp,method-name="usingconcretetypeselector"]
----
var result = this._client.Search<ISearchResult>(s => s
...
[source,csharp,method-name="usingcovarianttypesonscroll"]
----
...
[source,csharp,method-name="usingconcretetypeselectoronscroll"]
----
