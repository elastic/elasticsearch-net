...
[source,csharp,method="staticpoolwithstandsconcurrentreadandwrites"]
----
...
[source,csharp,method="sniffingpoolwithstandsconcurrentreadandwrites"]
----
var uris = Enumerable.Range(9200, NumberOfNodes).Select(p => new Uri("http://localhost:" + p));
...
[source,csharp,method="assertcreateview"]
----
