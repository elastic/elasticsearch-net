...
[source,csharp,method="eachviewseesnextbutskipsthedeadnode"]
----
...
[source,csharp,method="eachviewskipsaheadwithone"]
----
var seeds = Enumerable.Range(9200, NumberOfNodes).Select(p => new Node(new Uri("http://localhost:" + p))).ToList();
var pool = new StaticConnectionPool(seeds, randomize: false);
var node = pool.CreateView().First();
...
[source,csharp,method="viewseesresurrectednodes"]
----
...
[source,csharp,method="fallsoverdeadnodes"]
----
