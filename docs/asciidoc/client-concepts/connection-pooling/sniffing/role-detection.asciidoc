...
[source,csharp,method="detectsdatanodes"]
----
...
[source,csharp,method="detectsfqdn"]
----
var audit = new Auditor(() => Framework.Cluster
	.Nodes(10)
...
[source,csharp,method="sniffandreturnnode"]
----
...
[source,csharp,method="sniffandreturnnodeasync"]
----
var pipeline = CreatePipeline();
...
[source,csharp,method="assertsniffresponse"]
----
...
[source,csharp,method="detectsmasternodes"]
----
var audit = new Auditor(() => Framework.Cluster
	.Nodes(10)
	.Sniff(s => s.Fails(Always))
