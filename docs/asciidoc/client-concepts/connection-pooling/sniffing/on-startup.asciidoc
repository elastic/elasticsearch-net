...
[source,csharp,method-name="asniffonstartuphappensonce"]
----
...
[source,csharp,method-name="sniffonstartuptakesnewclusterstate"]
----
var audit = new Auditor(() => Framework.Cluster
	.Nodes(10)
	.Sniff(s => s.Fails(Always))
...
[source,csharp,method-name="snifftriesallnodes"]
----
var audit = new Auditor(() => Framework.Cluster
	.Nodes(10)
	.Sniff(s => s.Fails(Always))
...
[source,csharp,method-name="sniffprefersmasternodes"]
----
var audit = new Auditor(() => Framework.Cluster
	.Nodes(new[] {
...
[source,csharp,method-name="sniffprefersmasternodesbutstillfailsover"]
----
var audit = new Auditor(() => Framework.Cluster
	.Nodes(new[] {
...
[source,csharp,method-name="asniffonstartuphappens"]
----
var audit = new Auditor(() => Framework.Cluster
	.Nodes(10)
	.Sniff(s => s.Fails(Always))
