...
[source,csharp,method="unexpectedexceptionsbubbleout"]
----
...
[source,csharp,method="willfailoverknowconnectionexceptionbutnotunexpected"]
----
var audit = new Auditor(() => Framework.Cluster
	.Nodes(10)
#if DOTNETCORE
...
[source,csharp,method="pingunexceptedexceptiondoesfailover"]
----
var audit = new Auditor(() => Framework.Cluster
	.Nodes(10)
