...
[source,csharp,method-name="exceptionfallsovertonextnode"]
----
...
[source,csharp,method-name="http502fallsover"]
----
var audit = new Auditor(() => Framework.Cluster
	.Nodes(10)
...
[source,csharp,method-name="http503fallsover"]
----
var audit = new Auditor(() => Framework.Cluster
	.Nodes(10)
...
[source,csharp,method-name="httpteapotdoesnotfallover"]
----
var audit = new Auditor(() => Framework.Cluster
	.Nodes(10)
