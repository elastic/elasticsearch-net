...
[source,csharp,method="pingfailsfallsovertohealthynodewithoutping"]
----
...
[source,csharp,method="pingfailsfallsovermultipletimestohealthynode"]
----
var audit = new Auditor(() => Framework.Cluster
	.Nodes(4)
...
[source,csharp,method="allnodesarepingedonlyonfirstuseprovidedtheyarehealthy"]
----
var audit = new Auditor(() => Framework.Cluster
	.Nodes(4)
	.Ping(p => p.SucceedAlways())
