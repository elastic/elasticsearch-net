...
[source,csharp,method-name="pingfailsfallsovertohealthynodewithoutping"]
----
...
[source,csharp,method-name="pingfailsfallsovermultipletimestohealthynode"]
----
var audit = new Auditor(() => Framework.Cluster
	.Nodes(4)
...
[source,csharp,method-name="allnodesarepingedonlyonfirstuseprovidedtheyarehealthy"]
----
var audit = new Auditor(() => Framework.Cluster
	.Nodes(4)
	.Ping(p => p.SucceedAlways())
