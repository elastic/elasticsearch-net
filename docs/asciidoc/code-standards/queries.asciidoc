...
[source,csharp,method-name="staticqueryexposesall"]
----
...
[source,csharp,method-name="fluentdescriptorexposesall"]
----
...
[source,csharp,method-name="visitorvisitsall"]
----
...
[source,csharp,method-name="interfacepropertiesmustbemarkedexplicitly"]
----
