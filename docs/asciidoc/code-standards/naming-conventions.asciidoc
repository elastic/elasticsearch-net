...
[source,csharp,method="abstractclassnamesendwithbase"]
----
var exceptions = new[]
{
	typeof(DateMath)
...
[source,csharp,method="classnamecontainsbaseshouldbeabstract"]
----
...
[source,csharp,method="requestclassnamesendwithrequest"]
----
...
[source,csharp,method="responseclassnamesendwithresponse"]
----
var types = typeof(IRequest).Assembly().GetTypes();
...
[source,csharp,method="paritybetweenrequestsandresponses"]
----
