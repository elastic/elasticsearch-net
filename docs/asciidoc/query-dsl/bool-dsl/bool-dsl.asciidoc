...
[source,csharp,method="verboseway"]
----
...
[source,csharp,method="usingoperator"]
----
var searchResults = this.Client.Search<Project>(s => s
...
[source,csharp,method="joinsmustwithmustnot"]
----
Assert(
...
[source,csharp,method="assertdoesnotjoinontolockedbool"]
----
