...
IMPORTANT NOTE
==============
This file has been generated from https://github.com/elastic/elasticsearch-net/tree/master/src/Tests/query-dsl-usage.asciidoc. 
...
include::query-dsl/compound/full-text/common-terms/common-terms-usage.asciidoc[]

include::query-dsl/compound/full-text/match/match-phrase-prefix-usage.asciidoc[]

include::query-dsl/compound/full-text/match/match-phrase-usage.asciidoc[]

include::query-dsl/compound/full-text/match/match-usage.asciidoc[]

include::query-dsl/compound/full-text/match-phrase/match-phrase-usage.asciidoc[]

include::query-dsl/compound/full-text/match-phrase-prefix/match-phrase-prefix-usage.asciidoc[]

include::query-dsl/compound/full-text/multi-match/multi-match-usage.asciidoc[]

include::query-dsl/compound/full-text/query-string/query-string-usage.asciidoc[]

include::query-dsl/compound/full-text/simple-query-string/simple-query-string-usage.asciidoc[]
