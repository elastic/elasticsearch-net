...
IMPORTANT NOTE
==============
This file has been generated from https://github.com/elastic/elasticsearch-net/tree/6.x/src/Tests/QueryDsl/Specialized/Percolate/PercolateQueryUsageTests.cs. 
