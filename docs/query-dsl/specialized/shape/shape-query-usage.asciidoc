...
IMPORTANT NOTE
==============
This file has been generated from https://github.com/elastic/elasticsearch-net/tree/feature/7.x/shape-queries/src/Tests/Tests/QueryDsl/Specialized/Shape/ShapeQueryUsageTests.cs. 
