...
include::query-dsl/geo/shape/geo-shape-query-usage.asciidoc[]
...
* <<distance-feature-time-query-usage,Distance Feature Time Query Usage>>
...
include::query-dsl/specialized/distance-feature/distance-feature-time-query-usage.asciidoc[]
