...
{
	//public abstract class XPackAggregationUsageTestBase
	//	: ApiIntegrationTestBase<XPackCluster, ISearchResponse<Project>, ISearchRequest, SearchDescriptor<Project>, SearchRequest<Project>>
	//{
	//	protected XPackAggregationUsageTestBase(XPackCluster cluster, EndpointUsage usage) : base(cluster, usage) { }
	...
	//public abstract class AggregationUsageTestBase<ReadOnlyCluster> : AggregationUsageTestBase<ReadOnlyCluster>
	//{
	//	protected AggregationUsageTestBase<ReadOnlyCluster>(ReadOnlyCluster cluster, EndpointUsage usage) : base(cluster, usage) { }
	//}
