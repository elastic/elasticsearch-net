...
#pragma warning restore format
        ...
        client = new ElasticsearchClient(new ElasticsearchClientSettings(new InMemoryTransportClient(responseBytes, 201)));
...
#pragma warning restore format
    ...
    public async Task GettingADocument()
    {
        ...
        var client = new ElasticsearchClient(new ElasticsearchClientSettings(new InMemoryTransportClient(responseBytes, 200)));
...
#pragma warning restore format
    ...
    public async Task SearchingForDocumentsFluent()
    {
        ...
        var client = new ElasticsearchClient(new ElasticsearchClientSettings(new InMemoryTransportClient(responseBytes, 200)).EnableDebugMode());
