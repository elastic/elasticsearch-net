...
namespace Tests.Cluster.ClusterReroute
{
	public class ClusterRerouteApiTests
		: ApiIntegrationTestBase<IntrusiveOperationCluster, ClusterRerouteResponse, IClusterRerouteRequest, ClusterRerouteRequestDescriptor,
			ClusterRerouteRequest>
	{
		...
		protected override void IntegrationSetup(IElasticClient client, CallUniqueValues values)
		{
			...
			{
				//var createIndex = client.IndexManagement.Create(index, i => i
		...
		protected override Func<ClusterRerouteRequestDescriptor, IClusterRerouteRequest> Fluent => c => c;
		...
		protected override string ExpectedUrlPathAndQuery => "/_cluster/reroute";
