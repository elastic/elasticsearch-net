...
namespace Tests.Cluster.ClusterReroute
{
	public class ClusterRerouteApiTests
		: ApiIntegrationTestBase<IntrusiveOperationCluster, ClusterRerouteResponse, ClusterRerouteRequestDescriptor,
			ClusterRerouteRequest>
	{
		...
		//protected override Action<ClusterRerouteRequestDescriptor> Fluent => c => c;
