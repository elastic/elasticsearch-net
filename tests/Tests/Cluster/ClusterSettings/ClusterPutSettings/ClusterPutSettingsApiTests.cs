...
public class ClusterPutSettingsApiTests
	: ApiIntegrationTestBase<IntrusiveOperationCluster, ClusterPutSettingsResponse, IClusterPutSettingsRequest, ClusterPutSettingsRequestDescriptor,
		ClusterPutSettingsRequest>
{
	...
	protected override Func<ClusterPutSettingsRequestDescriptor, IClusterPutSettingsRequest> Fluent => c => c
		.Transient(s => s.Add("indices.recovery.max_bytes_per_sec", "41mb"));

	protected override HttpMethod HttpMethod => HttpMethod.PUT;

	protected override ClusterPutSettingsRequest Initializer => new()
	{
