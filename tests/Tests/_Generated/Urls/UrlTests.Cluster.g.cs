...
namespace Tests.Urls.Cluster
{
    ...
    public class ClusterPostVotingConfigExclusionsUrlTests : UrlTestsBase
    {
        ...
        public override async Task Urls()
        {
            await UrlTester.POST("/_cluster/voting_config_exclusions").Request(c => c.Cluster.PutVotingConfigExclusions(new ClusterPutVotingConfigExclusionsRequest())).RequestAsync(c => c.Cluster.PutVotingConfigExclusionsAsync(new ClusterPutVotingConfigExclusionsRequest()));
        }
    }
    ...
    public class ClusterRemoteInfoUrlTests : UrlTestsBase
    {
        ...
        public override async Task Urls()
        {
            await UrlTester.GET("/_remote/info").Request(c => c.Cluster.RemoteInfo(new ClusterRemoteInfoRequest())).RequestAsync(c => c.Cluster.RemoteInfoAsync(new ClusterRemoteInfoRequest()));
        }
    }
