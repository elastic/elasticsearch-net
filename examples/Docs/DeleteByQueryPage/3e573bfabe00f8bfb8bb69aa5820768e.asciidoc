...
IMPORTANT NOTE
==============
This file is generated from method Line449 in https://github.com/elastic/elasticsearch-net/tree/master/src/Examples/Examples/Docs/DeleteByQueryPage.cs#L237-L283.
