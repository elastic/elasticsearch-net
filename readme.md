...
Always use the latest minor version of the client within that major version, so in this instance version `6.8`. The reason being is that `6.8` will contain many bug fixes not present in the `6.0` version of the client.
