...
public static class ReasoningSummaryCodeFormatter
{
	public static void FormatCode(Elastic.Clients.Elasticsearch.Inference.ReasoningSummary instance, RequestConverter.CodeWriter writer)
	{
		switch (instance)
		{
