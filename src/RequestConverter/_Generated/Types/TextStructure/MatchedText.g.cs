...
public partial class MatchedText : RequestConverter.ICodeFormattable
{
	...
	{
		var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.TextStructure.MatchedText", false);
		if (Fields is not null)
		{
			...
			writer.Write(", ");
			writer.WriteTypeRef("System.Collections.Generic.IReadOnlyCollection<Elastic.Clients.Elasticsearch.TextStructure.MatchedField>");
			writer.Write(">()");
