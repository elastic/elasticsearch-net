...
public partial class NetworkDirectionProcessor : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		if (instance.InternalNetworks is not null)
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("InternalNetworks = ");
			sb.Append("[");
			RequestConverter.CodeFormatter.FormatCode(instance.InternalNetworks, (item, sb) => { sb.Append("\""); sb.Append(item); sb.Append("\""); }, sb);
			sb.Append("]");
		}

		if (instance.InternalNetworksField is not null)
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("InternalNetworksField = ");
			instance.InternalNetworksField.FormatCode(sb);
		}
