...
public partial class ForeachProcessor : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		if (writer.EffectiveSyntaxMode == RequestConverter.SyntaxMode.Descriptor)
		{
			...
			{
				writer.WriteFluentDescriptorCall("Processor", (w) => { Processor.FormatCode(w); }, (w) => { Processor.FormatCode(w); });
			}
		...
		{
			var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Ingest.ForeachProcessor", false);
			if (Description is not null)
			{
			...
			{
				initializer.Property("Processor");
				Processor.FormatCode(writer);
			}
