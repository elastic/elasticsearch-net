...
public partial class SplitProcessor : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		if (writer.EffectiveSyntaxMode == RequestConverter.SyntaxMode.Descriptor)
		{
			...
			if (PreserveTrailing is not null)
			{
				writer.WriteFluentCall("PreserveTrailing", (w) => { w.WriteValue(PreserveTrailing.Value); });
			}
		...
		{
			var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Ingest.SplitProcessor", false);
			if (Description is not null)
			{
			...
			if (PreserveTrailing is not null)
			{
				initializer.Property("PreserveTrailing");
				writer.WriteValue(PreserveTrailing.Value);
			}
