...
public partial class UserAgentProcessor : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		if (writer.EffectiveSyntaxMode == RequestConverter.SyntaxMode.Descriptor)
		{
			...
			{
				writer.WriteFluentCall("ExtractDeviceType", (w) => { using var _oi = w.ForceObjectInitializer(); w.WriteValue(ExtractDeviceType.Value); });
			}
			...
			{
				writer.WriteFluentCall("RegexFile", (w) => { using var _oi = w.ForceObjectInitializer(); w.WriteString(RegexFile); });
			}
