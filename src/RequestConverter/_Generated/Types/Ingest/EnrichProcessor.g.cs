...
public partial class EnrichProcessor : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		if (instance.MaxMatches is not null)
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("MaxMatches = ");
			sb.Append(instance.MaxMatches.Value);
		}
		...
		if (instance.Override is not null)
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("Override = ");
			sb.Append(instance.Override.Value ? "true" : "false");
		}

		{
			...
			sb.Append("\"");
			sb.Append(instance.PolicyName);
			sb.Append("\"");
		}

		if (instance.ShapeRelation is not null)
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("ShapeRelation = ");
			Elastic.Clients.Elasticsearch.GeoShapeRelationCodeFormatter.FormatCode(instance.ShapeRelation.Value, sb);
		}
