...
public partial class ConvertProcessor : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		if (writer.EffectiveSyntaxMode == RequestConverter.SyntaxMode.Descriptor)
		{
			...
			{
				writer.WriteFluentCall("Type", (w) => { Elastic.Clients.Elasticsearch.Ingest.ConvertTypeCodeFormatter.FormatCode(Type, w); });
			}
		}
		else
		{
			var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Ingest.ConvertProcessor", false);
			if (Description is not null)
			{
...

			{
				...
				Elastic.Clients.Elasticsearch.Ingest.ConvertTypeCodeFormatter.FormatCode(Type, writer);
			}
