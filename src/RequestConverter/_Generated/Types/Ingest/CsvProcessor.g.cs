...
public partial class CsvProcessor : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		if (instance.EmptyValue is not null)
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("EmptyValue = ");
			RequestConverter.CodeFormatter.FormatCode(instance.EmptyValue, sb);
		}
...

		{
			...
			instance.TargetFields.FormatCode(sb);
		}
		...
		if (instance.Trim is not null)
		{
			...
			hasProps = true;
			sb.Append("Trim = ");
			sb.Append(instance.Trim.Value ? "true" : "false");
		}
