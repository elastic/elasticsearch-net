...
public partial class PipelineProcessor : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		if (writer.EffectiveSyntaxMode == RequestConverter.SyntaxMode.Descriptor)
		{
			...
			{
				writer.WriteFluentCall("IgnoreMissingPipeline", (w) => { w.WriteValue(IgnoreMissingPipeline.Value); });
			}
		...
		{
			var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Ingest.PipelineProcessor", false);
			if (Description is not null)
			{
