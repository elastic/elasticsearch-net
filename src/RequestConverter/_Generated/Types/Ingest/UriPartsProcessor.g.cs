...
public partial class UriPartsProcessor : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		if (instance.KeepOriginal is not null)
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("KeepOriginal = ");
			sb.Append(instance.KeepOriginal.Value ? "true" : "false");
		}
		...
		if (instance.RemoveIfSuccessful is not null)
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("RemoveIfSuccessful = ");
			sb.Append(instance.RemoveIfSuccessful.Value ? "true" : "false");
		}
