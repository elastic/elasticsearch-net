...
public partial class FingerprintProcessor : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		if (instance.Method is not null)
		{
			...
			hasProps = true;
			sb.Append("Method = ");
			Elastic.Clients.Elasticsearch.Ingest.FingerprintDigestCodeFormatter.FormatCode(instance.Method.Value, sb);
		}
		...
		if (instance.Salt is not null)
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("Salt = ");
			sb.Append("\"");
			sb.Append(instance.Salt);
			sb.Append("\"");
		}
