...
public partial class FingerprintProcessor : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		if (writer.EffectiveSyntaxMode == RequestConverter.SyntaxMode.Descriptor)
		{
			...
			{
				writer.WriteFluentCall("Method", (w) => { Elastic.Clients.Elasticsearch.Ingest.FingerprintDigestCodeFormatter.FormatCode(Method.Value, w); });
			}
			...
			if (Salt is not null)
			{
				writer.WriteFluentCall("Salt", (w) => { w.WriteString(Salt); });
			}
