...
public partial class CircleProcessor : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		if (writer.EffectiveSyntaxMode == RequestConverter.SyntaxMode.Descriptor)
		{
			...
			{
				writer.WriteFluentCall("ErrorDistance", (w) => { w.WriteValue(ErrorDistance); w.Write("d"); });
			}
			...
			{
				writer.WriteFluentCall("ShapeType", (w) => { Elastic.Clients.Elasticsearch.Ingest.ShapeTypeCodeFormatter.FormatCode(ShapeType, w); });
			}
