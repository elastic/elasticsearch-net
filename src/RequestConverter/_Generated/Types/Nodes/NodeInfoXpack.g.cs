...
public partial class NodeInfoXpack : RequestConverter.ICodeFormattable
{
	...
	{
		var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Nodes.NodeInfoXpack", false);
		...
		if (Notification is not null)
		{
			...
			writer.Write(">()");
			writer.WriteBlockList(Notification, (w, kvp) => { w.Write("{ "); w.WriteString(kvp.Key); w.Write(", "); w.WriteObjectValue(kvp.Value); w.Write(" }"); });
		}
