	...
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		...
		else
		{
...

			{
				...
				writer.Write(", ");
				writer.WriteTypeRef("Elastic.Clients.Elasticsearch.Core.Search.HighlightField");
				writer.Write(">()");
				writer.WriteBlockList(Fields, (w, kvp) => { w.Write("{ "); kvp.Key.FormatCode(w); w.Write(", "); kvp.Value.FormatCode(w); w.Write(" }"); });
			}
