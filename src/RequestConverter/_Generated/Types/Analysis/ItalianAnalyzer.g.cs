...
public partial class ItalianAnalyzer : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		...
		{
			var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Analysis.ItalianAnalyzer", true);
			if (StemExclusion is not null)
			{
