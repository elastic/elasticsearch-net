...
public partial class NestedProperty : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		if (writer.EffectiveSyntaxMode == RequestConverter.SyntaxMode.Descriptor)
		{
			...
			{
				writer.WriteFluentCall("IncludeInParent", (w) => { w.WriteValue(IncludeInParent.Value); });
			}

			if (IncludeInRoot is not null)
			{
				writer.WriteFluentCall("IncludeInRoot", (w) => { w.WriteValue(IncludeInRoot.Value); });
			}
		...
		{
			var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Mapping.NestedProperty", true);
			if (CopyTo is not null)
			{
