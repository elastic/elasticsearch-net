...
public partial class NestedProperty : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		if (instance.IncludeInParent is not null)
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("IncludeInParent = ");
			sb.Append(instance.IncludeInParent.Value ? "true" : "false");
		}

		if (instance.IncludeInRoot is not null)
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("IncludeInRoot = ");
			sb.Append(instance.IncludeInRoot.Value ? "true" : "false");
		}
