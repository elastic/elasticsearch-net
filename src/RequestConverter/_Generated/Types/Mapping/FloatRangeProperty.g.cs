...
public partial class FloatRangeProperty : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		...
		{
			var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Mapping.FloatRangeProperty", true);
			if (Boost is not null)
			{
