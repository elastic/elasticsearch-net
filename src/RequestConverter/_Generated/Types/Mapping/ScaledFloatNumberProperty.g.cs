...
public partial class ScaledFloatNumberProperty : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		if (writer.EffectiveSyntaxMode == RequestConverter.SyntaxMode.Descriptor)
		{
			...
			{
				writer.WriteFluentCall("NullValue", (w) => { using var _oi = w.ForceObjectInitializer(); w.WriteValue(NullValue.Value); w.Write("d"); });
			}
			...
			{
				writer.WriteFluentCall("ScalingFactor", (w) => { using var _oi = w.ForceObjectInitializer(); w.WriteValue(ScalingFactor.Value); w.Write("d"); });
			}
		...
		{
			var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Mapping.ScaledFloatNumberProperty", true);
			if (Boost is not null)
			{
			...
			if (ScalingFactor is not null)
			{
				...
				writer.WriteValue(ScalingFactor.Value);
				writer.Write("d");
			}
