...
public partial class ExponentialHistogramProperty : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		...
		{
			var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Mapping.ExponentialHistogramProperty", true);
			if (Dynamic is not null)
			{
