...
public partial class QueryStringQuery : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		if (writer.EffectiveSyntaxMode == RequestConverter.SyntaxMode.Descriptor)
		{
			...
			{
				writer.WriteFluentCall("AllowLeadingWildcard", (w) => { w.WriteValue(AllowLeadingWildcard.Value); });
			}
			...
			{
				writer.WriteFluentCall("DefaultField", (w) => { DefaultField.FormatCode(w); }, false);
			}
			...
			{
				writer.WriteFluentCall("Escape", (w) => { w.WriteValue(Escape.Value); });
			}
			...
			{
				writer.WriteFluentCall("PhraseSlop", (w) => { w.WriteValue(PhraseSlop.Value); w.Write("d"); });
			}
			...
			{
				writer.WriteFluentCall("QuoteAnalyzer", (w) => { w.WriteString(QuoteAnalyzer); });
			}
			...
			{
				writer.WriteFluentCall("TieBreaker", (w) => { w.WriteValue(TieBreaker.Value); w.Write("d"); });
			}
			...
			if (Type is not null)
			{
				writer.WriteFluentCall("Type", (w) => { Elastic.Clients.Elasticsearch.QueryDsl.TextQueryTypeCodeFormatter.FormatCode(Type.Value, w); });
			}
		}
		else
		{
