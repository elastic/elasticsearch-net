...
public partial class ClusterStatistics : RequestConverter.ICodeFormattable
{
	...
	{
		var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.ClusterStatistics", false);
		if (Details is not null)
		{
			...
			writer.Write(", ");
			writer.WriteTypeRef("Elastic.Clients.Elasticsearch.ClusterDetails");
			writer.Write(">()");
