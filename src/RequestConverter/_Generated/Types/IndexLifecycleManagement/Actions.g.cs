...
public partial class Actions : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		if (writer.EffectiveSyntaxMode == RequestConverter.SyntaxMode.Descriptor)
		{
			...
			{
				writer.WriteFluentDescriptorCall("Downsample", (w) => { Downsample.FormatCode(w); }, (w) => { Downsample.FormatCode(w); });
			}

			if (Forcemerge is not null)
			{
				writer.WriteFluentDescriptorCall("Forcemerge", (w) => { Forcemerge.FormatCode(w); }, (w) => { Forcemerge.FormatCode(w); });
			}
...
#pragma warning restore CS0618
			...
			{
				writer.WriteFluentDescriptorCall("SearchableSnapshot", (w) => { SearchableSnapshot.FormatCode(w); }, (w) => { SearchableSnapshot.FormatCode(w); });
			}
			...
			{
				writer.WriteFluentDescriptorCall("WaitForSnapshot", (w) => { WaitForSnapshot.FormatCode(w); }, (w) => { WaitForSnapshot.FormatCode(w); });
			}
		}
		else
		{
