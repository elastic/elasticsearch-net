...
public partial class IndicesStats : RequestConverter.ICodeFormattable
{
	...
	{
		var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.IndexManagement.IndicesStats", false);
		...
		if (Shards is not null)
		{
			...
			writer.Write(", ");
			writer.WriteTypeRef("System.Collections.Generic.IReadOnlyCollection<Elastic.Clients.Elasticsearch.IndexManagement.ShardStats>");
			writer.Write(">()");
