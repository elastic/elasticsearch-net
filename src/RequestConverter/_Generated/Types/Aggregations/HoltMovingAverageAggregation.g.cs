...
public partial class HoltMovingAverageAggregation : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		...
		{
			var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Aggregations.HoltMovingAverageAggregation", true);
			if (BucketsPath is not null)
			{
