...
public partial class LinearMovingAverageAggregation : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		...
		{
			var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Aggregations.LinearMovingAverageAggregation", true);
			if (BucketsPath is not null)
			{
