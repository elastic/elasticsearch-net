...
public partial class CompositeAggregate : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		sb.Append("new()");
		var hasProps = false;
		if (instance.AfterKey is not null)
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("AfterKey = ");
			sb.Append("new()");
			RequestConverter.CodeFormatter.FormatCode(instance.AfterKey, (k, sb) => { sb.Append("\""); sb.Append(k); sb.Append("\""); }, (v, sb) => { v.FormatCode(sb); }, sb);
		}
