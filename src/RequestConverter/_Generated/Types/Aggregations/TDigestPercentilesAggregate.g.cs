...
public partial class TDigestPercentilesAggregate : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Aggregations.TDigestPercentilesAggregate", true);
		if (Meta is not null)
		{
