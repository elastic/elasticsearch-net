...
public partial class HdrPercentileRanksAggregate : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Aggregations.HdrPercentileRanksAggregate", true);
		if (Meta is not null)
		{
