...
public partial class MedianAbsoluteDeviationAggregate : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Aggregations.MedianAbsoluteDeviationAggregate", true);
		if (Meta is not null)
		{
