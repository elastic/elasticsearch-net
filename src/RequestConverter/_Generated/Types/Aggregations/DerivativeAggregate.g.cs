...
public partial class DerivativeAggregate : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		if (instance.NormalizedValue is not null)
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("NormalizedValue = ");
			sb.Append(instance.NormalizedValue.Value);
			sb.Append("d");
		}

		if (instance.NormalizedValueAsString is not null)
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("NormalizedValueAsString = ");
			sb.Append("\"");
			sb.Append(instance.NormalizedValueAsString);
			sb.Append("\"");
		}
