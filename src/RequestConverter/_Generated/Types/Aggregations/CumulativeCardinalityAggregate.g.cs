...
public partial class CumulativeCardinalityAggregate : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Aggregations.CumulativeCardinalityAggregate", true);
		if (Meta is not null)
		{
