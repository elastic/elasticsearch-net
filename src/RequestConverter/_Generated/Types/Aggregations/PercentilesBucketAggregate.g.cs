...
public partial class PercentilesBucketAggregate : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Aggregations.PercentilesBucketAggregate", true);
		if (Meta is not null)
		{
