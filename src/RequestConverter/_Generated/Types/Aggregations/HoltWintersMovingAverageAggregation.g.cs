...
public partial class HoltWintersMovingAverageAggregation : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		...
		{
			var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Aggregations.HoltWintersMovingAverageAggregation", true);
			if (BucketsPath is not null)
			{
