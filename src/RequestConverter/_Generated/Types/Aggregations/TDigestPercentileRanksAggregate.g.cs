...
public partial class TDigestPercentileRanksAggregate : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Aggregations.TDigestPercentileRanksAggregate", true);
		if (Meta is not null)
		{
