...
public partial class SimpleMovingAverageAggregation : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		...
		{
			var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Aggregations.SimpleMovingAverageAggregation", true);
			if (BucketsPath is not null)
			{
