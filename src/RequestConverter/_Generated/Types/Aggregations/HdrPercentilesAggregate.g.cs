...
public partial class HdrPercentilesAggregate : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Aggregations.HdrPercentilesAggregate", true);
		if (Meta is not null)
		{
