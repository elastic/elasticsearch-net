...
public partial class MaxAggregate : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Aggregations.MaxAggregate", true);
		if (Meta is not null)
		{
