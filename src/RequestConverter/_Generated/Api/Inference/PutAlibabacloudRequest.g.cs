...
public partial class PutAlibabacloudRequest : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		var hasProps = false;
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("AlibabacloudInferenceId = ");
			instance.AlibabacloudInferenceId.FormatCode(sb);
		}

		{
			...
			hasProps = true;
			sb.Append("TaskType = ");
			Elastic.Clients.Elasticsearch.Inference.AlibabaCloudTaskTypeCodeFormatter.FormatCode(instance.TaskType, sb);
		}
