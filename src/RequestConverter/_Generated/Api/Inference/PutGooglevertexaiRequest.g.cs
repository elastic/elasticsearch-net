...
public partial class PutGooglevertexaiRequest : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		var hasProps = false;
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("GooglevertexaiInferenceId = ");
			instance.GooglevertexaiInferenceId.FormatCode(sb);
		}

		{
			...
			hasProps = true;
			sb.Append("TaskType = ");
			Elastic.Clients.Elasticsearch.Inference.GoogleVertexAITaskTypeCodeFormatter.FormatCode(instance.TaskType, sb);
		}
