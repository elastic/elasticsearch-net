...
public partial class PutElasticsearchRequest : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		var hasProps = false;
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("ElasticsearchInferenceId = ");
			instance.ElasticsearchInferenceId.FormatCode(sb);
		}

		{
			...
			hasProps = true;
			sb.Append("TaskType = ");
			Elastic.Clients.Elasticsearch.Inference.ElasticsearchTaskTypeCodeFormatter.FormatCode(instance.TaskType, sb);
		}
