...
public partial class PutNvidiaRequest : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		var hasProps = false;
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("NvidiaInferenceId = ");
			instance.NvidiaInferenceId.FormatCode(sb);
		}

		{
			...
			hasProps = true;
			sb.Append("TaskType = ");
			Elastic.Clients.Elasticsearch.Inference.NvidiaTaskTypeCodeFormatter.FormatCode(instance.TaskType, sb);
		}
