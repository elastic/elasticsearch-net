...
public partial class PutOpenshiftAiRequest : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		var hasProps = false;
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("OpenshiftaiInferenceId = ");
			instance.OpenshiftaiInferenceId.FormatCode(sb);
		}

		{
			...
			hasProps = true;
			sb.Append("TaskType = ");
			Elastic.Clients.Elasticsearch.Inference.OpenShiftAiTaskTypeCodeFormatter.FormatCode(instance.TaskType, sb);
		}
