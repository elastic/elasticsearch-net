...
public partial class PutAmazonsagemakerRequest : RequestConverter.IClientCallFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		...
		{
			writer.Write("new ");
			writer.WriteTypeRef("Elastic.Clients.Elasticsearch.Inference.PutAmazonsagemakerRequestDescriptor");
			writer.Write("(");
