...
public partial class PutAmazonsagemakerRequest : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		var hasProps = false;
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("AmazonsagemakerInferenceId = ");
			instance.AmazonsagemakerInferenceId.FormatCode(sb);
		}

		{
			...
			hasProps = true;
			sb.Append("TaskType = ");
			Elastic.Clients.Elasticsearch.Inference.TaskTypeAmazonSageMakerCodeFormatter.FormatCode(instance.TaskType, sb);
		}
