...
public partial class PutVoyageaiRequest : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		var hasProps = false;
		{
			...
			hasProps = true;
			sb.Append("TaskType = ");
			Elastic.Clients.Elasticsearch.Inference.VoyageAITaskTypeCodeFormatter.FormatCode(instance.TaskType, sb);
		}

		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("VoyageaiInferenceId = ");
			instance.VoyageaiInferenceId.FormatCode(sb);
		}
