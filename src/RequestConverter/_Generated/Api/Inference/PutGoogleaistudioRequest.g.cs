...
public partial class PutGoogleaistudioRequest : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		var hasProps = false;
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("GoogleaistudioInferenceId = ");
			instance.GoogleaistudioInferenceId.FormatCode(sb);
		}

		{
			...
			hasProps = true;
			sb.Append("TaskType = ");
			Elastic.Clients.Elasticsearch.Inference.GoogleAiStudioTaskTypeCodeFormatter.FormatCode(instance.TaskType, sb);
		}
