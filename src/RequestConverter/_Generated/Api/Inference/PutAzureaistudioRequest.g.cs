...
public partial class PutAzureaistudioRequest : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		var hasProps = false;
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("AzureaistudioInferenceId = ");
			instance.AzureaistudioInferenceId.FormatCode(sb);
		}

		{
			...
			hasProps = true;
			sb.Append("TaskType = ");
			Elastic.Clients.Elasticsearch.Inference.AzureAiStudioTaskTypeCodeFormatter.FormatCode(instance.TaskType, sb);
		}
