...
public partial class PutAzureopenaiRequest : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		var hasProps = false;
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("AzureopenaiInferenceId = ");
			instance.AzureopenaiInferenceId.FormatCode(sb);
		}

		{
			...
			hasProps = true;
			sb.Append("TaskType = ");
			Elastic.Clients.Elasticsearch.Inference.AzureOpenAITaskTypeCodeFormatter.FormatCode(instance.TaskType, sb);
		}
