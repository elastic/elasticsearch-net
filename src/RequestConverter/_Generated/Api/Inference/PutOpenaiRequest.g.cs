...
public partial class PutOpenaiRequest : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		var hasProps = false;
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("OpenaiInferenceId = ");
			instance.OpenaiInferenceId.FormatCode(sb);
		}

		{
			...
			hasProps = true;
			sb.Append("TaskType = ");
			Elastic.Clients.Elasticsearch.Inference.OpenAITaskTypeCodeFormatter.FormatCode(instance.TaskType, sb);
		}
