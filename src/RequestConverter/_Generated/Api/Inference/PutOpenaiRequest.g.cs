...
public partial class PutOpenaiRequest : RequestConverter.IClientCallFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		...
		{
			writer.Write("new ");
			writer.WriteTypeRef("Elastic.Clients.Elasticsearch.Inference.PutOpenaiRequestDescriptor");
			writer.Write("(");
		...
		{
			var initializer = writer.BeginObjectInitializer("Elastic.Clients.Elasticsearch.Inference.PutOpenaiRequest", false);
			{
				initializer.Property("OpenaiInferenceId");
				OpenaiInferenceId.FormatCode(writer);
			}

			{
				initializer.Property("TaskType");
				Elastic.Clients.Elasticsearch.Inference.OpenAITaskTypeCodeFormatter.FormatCode(TaskType, writer);
			}
	...
	public void FormatDescriptorHeadArguments(RequestConverter.CodeWriter writer)
	{
		...
		writer.Write(", ");
		writer.WriteInlineArgumentLabel("openaiInferenceId");
		{
			using var _oi = writer.ForceObjectInitializer();
			OpenaiInferenceId.FormatCode(writer);
		}
