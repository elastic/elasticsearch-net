...
public partial class PutJinaaiRequest : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		var hasProps = false;
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("JinaaiInferenceId = ");
			instance.JinaaiInferenceId.FormatCode(sb);
		}

		{
			...
			hasProps = true;
			sb.Append("TaskType = ");
			Elastic.Clients.Elasticsearch.Inference.JinaAITaskTypeCodeFormatter.FormatCode(instance.TaskType, sb);
		}
