...
public partial class PutHuggingFaceRequest : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		var hasProps = false;
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("HuggingfaceInferenceId = ");
			instance.HuggingfaceInferenceId.FormatCode(sb);
		}

		{
			...
			hasProps = true;
			sb.Append("TaskType = ");
			Elastic.Clients.Elasticsearch.Inference.HuggingFaceTaskTypeCodeFormatter.FormatCode(instance.TaskType, sb);
		}
