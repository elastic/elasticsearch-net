...
public partial class PutAmazonbedrockRequest : RequestConverter.IClientCallFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		...
		{
			writer.Write("new ");
			writer.WriteTypeRef("Elastic.Clients.Elasticsearch.Inference.PutAmazonbedrockRequestDescriptor");
			writer.Write("(");
	...
	public void FormatDescriptorHeadArguments(RequestConverter.CodeWriter writer)
	{
		...
		writer.Write(", ");
		writer.WriteInlineArgumentLabel("amazonbedrockInferenceId");
		{
			using var _oi = writer.ForceObjectInitializer();
			AmazonbedrockInferenceId.FormatCode(writer);
		}
