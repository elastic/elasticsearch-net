...
public partial class PutSampleConfigurationRequest : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		if (instance.MaxSamples is not null)
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("MaxSamples = ");
			sb.Append(instance.MaxSamples.Value);
		}
