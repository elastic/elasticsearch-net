...
public partial class PutIndicesSettingsRequest : RequestConverter.ICodeFormattable
{
	public void FormatCode(System.Text.StringBuilder sb)
	{
		...
		if (instance.PreserveExisting is not null)
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("PreserveExisting = ");
			sb.Append(instance.PreserveExisting.Value ? "true" : "false");
		}

		if (instance.Reopen is not null)
		{
			sb.Append(hasProps ? ", " : " { ");
			hasProps = true;
			sb.Append("Reopen = ");
			sb.Append(instance.Reopen.Value ? "true" : "false");
		}
