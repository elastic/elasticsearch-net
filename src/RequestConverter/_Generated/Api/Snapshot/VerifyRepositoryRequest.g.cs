...
public partial class VerifyRepositoryRequest : RequestConverter.IClientCallFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		...
		{
			writer.Write("new ");
			writer.WriteTypeRef("Elastic.Clients.Elasticsearch.Snapshot.VerifyRepositoryRequestDescriptor");
			writer.Write("(");
