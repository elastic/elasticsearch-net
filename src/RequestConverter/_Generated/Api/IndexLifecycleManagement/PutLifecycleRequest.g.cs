...
public partial class PutLifecycleRequest : RequestConverter.ICodeFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		...
		{
			writer.Write("new ");
			writer.WriteTypeRef("Elastic.Clients.Elasticsearch.IndexLifecycleManagement.PutLifecycleRequestDescriptor");
			writer.Write("(");
			{
			...
			{
				writer.WriteFluentDescriptorCall("Policy", (w) => { Policy.FormatCode(w); }, (w) => { Policy.FormatCode(w); });
			}
		}
		else
		{
