...
public partial class DeleteIpLocationDatabaseRequest : RequestConverter.IClientCallFormattable
{
	public void FormatCode(RequestConverter.CodeWriter writer)
	{
		...
		{
			writer.Write("new ");
			writer.WriteTypeRef("Elastic.Clients.Elasticsearch.Ingest.DeleteIpLocationDatabaseRequestDescriptor");
			writer.Write("(");
