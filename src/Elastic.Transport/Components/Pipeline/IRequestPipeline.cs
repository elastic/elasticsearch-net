...
namespace Elastic.Transport
{
	public interface IRequestPipeline : IDisposable
	{
		...
		void BadResponse<TResponse>(ref TResponse response, IApiCallDetails callDetails, RequestData data, ClientException exception)
			where TResponse : class, ITransportResponse, new();
		...
		ClientException CreateClientException<TResponse>(TResponse response, IApiCallDetails callDetails, RequestData data,
