...
{
	public class UnexpectedClientException : ClientException
	{
		public UnexpectedClientException(Exception killerException, List<PipelineException> seenExceptions)
