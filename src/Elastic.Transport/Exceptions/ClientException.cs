...
namespace Elastic.Transport
{
	...
	{
		public ClientException(string message) : base(message) => FailureReason = PipelineFailure.Unexpected;

		public ClientException(PipelineFailure failure, string message, Exception innerException)
			: base(message, innerException) => FailureReason = failure;

		public ClientException(PipelineFailure failure, string message, IApiCallDetails apiCall)
			: this(message)
		{
			Response = apiCall;
