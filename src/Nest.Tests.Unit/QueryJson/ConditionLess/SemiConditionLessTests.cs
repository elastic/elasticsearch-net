...
namespace Nest.Tests.Unit.QueryJson.ConditionLess
{
	...
	public class SemiConditionLessTests : BaseJsonTests
	{
		...
		public void Terms()
		{
			this.DoSemiConditionlessQuery(q => q.Terms(p => p.Name, new string[] { _c.Name1, "myterm" }));
			this.DoSemiConditionlessQuery(q => q.Terms(p => p.Name, _c.Name1, _c.Name2, "myterm"));
		}
		...
		{
			this.DoSemiConditionlessQuery(q => q.HasChild<Person>(hcq => hcq.Query(qq => qq.Terms(p => p.FirstName, _c.Name1, "myterm"))));
		}

		[Test]
		public void TopChildren()
		{
			this.DoSemiConditionlessQuery(q => q.TopChildren<Person>(hcq => hcq.Query(qq => qq.Terms(p => p.FirstName, _c.Name1, "myterm"))));
		}
		...
		public void Dismax()
		{
			this.DoSemiConditionlessQuery(q => q.Dismax(dq => dq.Queries(qff => qff.Terms(p => p.Name, _c.Name1, "myterm"))));
		}

		[Test]
		public void ConstantScore()
		{
			this.DoSemiConditionlessQuery(q => q.ConstantScore(cq => cq.Query(qff => qff.Terms(p => p.Name, _c.Name1, "myterm"))));
		}

		[Test]
		public void CustomBoostFactor()
		{
			this.DoSemiConditionlessQuery(q => q.CustomBoostFactor(cbfq => cbfq.Query(qff => qff.Terms(p => p.Name, _c.Name1, "myterm"))));
		}

		[Test]
		public void CustomScore()
		{
			this.DoSemiConditionlessQuery(q => q.CustomScore(csq => csq.Query(qff => qff.Terms(p => p.Name, _c.Name1, "myterm"))));
		}
		...
		public void BoolConditionlessQueries()
		{
			this.DoSemiConditionlessQuery(q => q.Bool(b => b
				.Must(mq => mq.Term(p => p.Name, _c.Name1), mq => mq.Terms(p => p.Name, _c.Name2, "myterm"))
			...
			this.DoSemiConditionlessQuery(q => q.Bool(b => b
				.Must(mq => mq.Term(p => p.Name, _c.Name1), mq => mq.Terms(p => p.Name, _c.Name2))
				.MustNot(mq => mq.Terms(p => p.Name, _c.Name1), mq => mq.Terms(p => p.Name, _c.Name2, "myterm"))
				.Should(mq => mq.Terms(p => p.Name, _c.Name1), mq => mq.Terms(p => p.Name, _c.Name2))
			));
			this.DoSemiConditionlessQuery(q => q.Bool(b => b
				.Must(mq => mq.Term(p => p.Name, _c.Name1), mq => mq.Terms(p => p.Name, _c.Name2))
				.MustNot(mq => mq.Terms(p => p.Name, _c.Name1), mq => mq.Terms(p => p.Name, _c.Name2))
				.Should(mq => mq.Terms(p => p.Name, _c.Name1), mq => mq.Terms(p => p.Name, _c.Name2, "myterm"))
			));
		}
		...
		{
			this.DoSemiConditionlessQuery(q => q.Boosting(bq => bq.Positive(qff => qff.Terms(p => p.Name, _c.Name1, "myterm"))));
			this.DoSemiConditionlessQuery(q => q.Boosting(bq => bq.Negative(qff => qff.Terms(p => p.Name, _c.Name1, "myterm"))));
		}
