...
namespace Nest.Tests.Unit.Cluster
{
	...
	public class BigBadUrlUnitTests 
	{
		...
		public void TestAllTheUrls()
		{
			...
			Do("POST", "/_all/docs/_count", c => c.Count(cc => cc.AllIndices().Type<Doc>()));
			Do("POST", "/mydefaultindex/docs/_count", c => c.Count(cc => cc.Index<Doc>().Type<Doc>()));
			Do("POST", "/mydefaultindex/_count", c => c.Count(cc => cc.Index<Doc>()));
			Do("POST", "/mydefaultindex/docs/_count", c => c.Count<Doc>());
			Do("POST", "/customindex/docs/_count", c => c.Count<Doc>(cc => cc.Index("customindex")));
			Do("POST", "/new-index-name", c => c.CreateIndex("new-index-name"));
			Do("DELETE", "/mydefaultindex/docs/1", c => c.Delete<Doc>(d => d.Id("1")));
			Do("DELETE", "/mydefaultindex/docs/1", c => c.Delete<Doc>(1));
			Do("DELETE", "/customindex/docs/1", c => c.Delete<Doc>(d => d.Index("customindex").Id(1)));
			Do("DELETE", "/customindex/docs/1", c => c.Delete<Doc>(1, d => d.Index("customindex")));
			Do("DELETE", "/mydefaultindex/docs/_query", c => c.DeleteByQuery<Doc>(q => q.MatchAll()));
			Do("DELETE", "/customindex/docs/_query", c => c.DeleteByQuery<Doc>(q => q.Index("customindex").MatchAll()));
			Do("DELETE", "/_all/docs/_query", c => c.DeleteByQuery<Doc>(q => q.AllIndices().MatchAll()));
			...
			Do("DELETE", "/a,b", c => c.DeleteIndex(i => i.Indices("a", "b")));
			...
			Do("DELETE", "/mydefaultindex/docs/_mapping", c => c.DeleteMapping(d => d.Index<Doc>().Type<Doc>()));
			...
			Do("GET", "/mydefaultindex/docs/1", c => c.Get<Doc>(1));
			...
			Do("GET", "/mydefaultindex/docs/_mapping", c => c.GetMapping<Doc>());
			Do("GET", "/mycustomindex/docs/_mapping", c => c.GetMapping<Doc>(m=>m.Index("mycustomindex")));
			...
			Do("POST", "/mydefaultindex/docs/2", c => c.Index(new Doc { Id = "2" }));
			...
			Do("PUT", "/mydefaultindex/docs/_mapping", c => c.Map<Doc>(m => m.MapFromAttributes()));
			Do("PUT", "/mycustomindex/docs/_mapping", c => c.Map<Doc>(m => m.Index("mycustomindex")));
			Do("PUT", "/mycustomindex/customtype/_mapping", c => c.Map<Doc>(m => m.Index("mycustomindex").Type("customtype")));
			Do("GET", "/mydefaultindex/docs/1/_mlt", c => c.MoreLikeThis<Doc>(m=>m.Object(new Doc { Id = "1" })));
			Do("GET", "/mydefaultindex/docs/1/_mlt", c => c.MoreLikeThis<Doc>(m=>m.Id(1)));
			...
			Do("POST", "/mydefaultindex/docs/_percolate", c => c.Percolate(new Doc { Id = "1" }));
			Do("POST", "/mydefaultindex/docs/_percolate", c => c.Percolate<Doc, OtherDoc>(new OtherDoc{Name = "hello"}));
			...
			Do("POST", "/mydefaultindex/docs/_search", c => c.Search<Doc>(s=>s.MatchAll()));
			Do("POST", "/_all/docs/_search", c => c.Search<Doc>(s=>s.AllIndices().MatchAll()));
			...
			Do("POST", "/prefix-*/a,b/_search", c => c.Search<Doc>(s=>s.Index("prefix-*").Types("a", "b").MatchAll()));
			...
			Do("GET", "/mydefaultindex/docs/1", c => c.Source<Doc>(1));
			Do("GET", "/mycustomindex/mytype/1", c => c.Source<Doc>(1, index: "mycustomindex", type: "mytype"));
			Do("GET", "/mycustomindex/docs/1", c => c.Source<Doc>(s=>s.Id(1).Index("mycustomindex")));
			Do("GET", "/mydefaultindex/docs/1?fields=id", c => c.SourceFields<Doc>(g=>g.Id(1).Fields(f=>f.Id)));
			...
			Do("POST", "/mydefaultindex/docs/1/_update", c => c.Update<Doc, OtherDoc>(u=>u.Id(1).Document(new OtherDoc{ Name = "asd"})));
			...
			Do("POST", "/_all/docs/_validate/query", c => c.Validate<Doc>(v => v.AllIndices()));
			Do("POST", "/mydefaultindex/docs/_validate/query", c => c.Validate<Doc>(v => v.Query(q => q.MatchAll())));
