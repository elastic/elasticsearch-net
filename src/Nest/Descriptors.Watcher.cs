...
namespace Nest
{
	...
	public partial class AcknowledgeWatchDescriptor : RequestDescriptorBase<AcknowledgeWatchDescriptor, AcknowledgeWatchRequestParameters, IAcknowledgeWatchRequest>, IAcknowledgeWatchRequest
	{
		...
		public AcknowledgeWatchDescriptor(Id watchId, StringIds actionId): base(r => r.Required("watch_id", watchId).Optional("action_id", actionId))
		{
		}
		...
		public AcknowledgeWatchDescriptor ActionId(StringIds actionId) => Assign(actionId, (a, v) => a.RouteValues.Optional("action_id", v));
	// Request parameters
	}
