...
namespace Nest.Watcher
{
	public class WatcherNamespace : NamespacedClientProxy
	{
		...
		public AckWatchResponse AckWatch(Nest.Name watch_id, Func<AckWatchDescriptor, IAckWatchRequest> selector = null) => AckWatch(selector.InvokeOrDefault(new AckWatchDescriptor(watch_id)));
		public Task<AckWatchResponse> AckWatchAsync(Nest.Name watch_id, Func<AckWatchDescriptor, IAckWatchRequest> selector = null, CancellationToken cancellationToken = default) => AckWatchAsync(selector.InvokeOrDefault(new AckWatchDescriptor(watch_id)), cancellationToken);
		...
		public ActivateWatchResponse ActivateWatch(Nest.Name watch_id, Func<ActivateWatchDescriptor, IActivateWatchRequest> selector = null) => ActivateWatch(selector.InvokeOrDefault(new ActivateWatchDescriptor(watch_id)));
		public Task<ActivateWatchResponse> ActivateWatchAsync(Nest.Name watch_id, Func<ActivateWatchDescriptor, IActivateWatchRequest> selector = null, CancellationToken cancellationToken = default) => ActivateWatchAsync(selector.InvokeOrDefault(new ActivateWatchDescriptor(watch_id)), cancellationToken);
		...
		public DeactivateWatchResponse DeactivateWatch(Nest.Name watch_id, Func<DeactivateWatchDescriptor, IDeactivateWatchRequest> selector = null) => DeactivateWatch(selector.InvokeOrDefault(new DeactivateWatchDescriptor(watch_id)));
		public Task<DeactivateWatchResponse> DeactivateWatchAsync(Nest.Name watch_id, Func<DeactivateWatchDescriptor, IDeactivateWatchRequest> selector = null, CancellationToken cancellationToken = default) => DeactivateWatchAsync(selector.InvokeOrDefault(new DeactivateWatchDescriptor(watch_id)), cancellationToken);
		...
		public DeleteWatchResponse DeleteWatch(Nest.Name id, Func<DeleteWatchDescriptor, IDeleteWatchRequest> selector = null) => DeleteWatch(selector.InvokeOrDefault(new DeleteWatchDescriptor(id)));
		public Task<DeleteWatchResponse> DeleteWatchAsync(Nest.Name id, Func<DeleteWatchDescriptor, IDeleteWatchRequest> selector = null, CancellationToken cancellationToken = default) => DeleteWatchAsync(selector.InvokeOrDefault(new DeleteWatchDescriptor(id)), cancellationToken);
		...
		public GetWatchResponse GetWatch(Nest.Name id, Func<GetWatchDescriptor, IGetWatchRequest> selector = null) => GetWatch(selector.InvokeOrDefault(new GetWatchDescriptor(id)));
		public Task<GetWatchResponse> GetWatchAsync(Nest.Name id, Func<GetWatchDescriptor, IGetWatchRequest> selector = null, CancellationToken cancellationToken = default) => GetWatchAsync(selector.InvokeOrDefault(new GetWatchDescriptor(id)), cancellationToken);
		...
		public PutWatchResponse PutWatch(Nest.Id id, Func<PutWatchDescriptor, IPutWatchRequest> selector = null) => PutWatch(selector.InvokeOrDefault(new PutWatchDescriptor(id)));
		public Task<PutWatchResponse> PutWatchAsync(Nest.Id id, Func<PutWatchDescriptor, IPutWatchRequest> selector = null, CancellationToken cancellationToken = default) => PutWatchAsync(selector.InvokeOrDefault(new PutWatchDescriptor(id)), cancellationToken);
