...
namespace Nest
{
	...
	[JsonObject(MemberSerialization = MemberSerialization.OptIn)]
	public partial interface IRankingEvaluationRequest : IRequest<RankingEvaluationRequestParameters>
	{
		Indices Index { get; }
		Types Type { get; }
	}
	...
	public partial class RankingEvaluationRequest : PlainRequestBase<RankingEvaluationRequestParameters>, IRankingEvaluationRequest
	{
		protected IRankingEvaluationRequest Self => this;
		/// <summary>/_rank_eval</summary>
		public RankingEvaluationRequest(){}

		/// <summary>/{index}/_rank_eval</summary>
		///<param name="index">Optional, accepts null</param>
		public RankingEvaluationRequest(Indices index) : base(r=>r.Optional("index", index)){}

		/// <summary>/{index}/{type}/_rank_eval</summary>
		///<param name="index">Optional, accepts null</param>
		///<param name="type">Optional, accepts null</param>
		public RankingEvaluationRequest(Indices index, Types type) : base(r=>r.Optional("index", index).Optional("type", type)){}
