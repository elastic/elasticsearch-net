...
///<param name="repository">this parameter is required</param>
	...
	///<summary>Request parameters for Create <pre>http://www.elastic.co/guide/en/elasticsearch/reference/2.4/docs-index_.html</pre></summary>
...
///<param name="snapshot">this parameter is required</param>
	...
	public partial class SearchExistsRequest<T>  : PlainRequestBase<SearchExistsRequestParameters>, ISearchExistsRequest
	{
		...
		Types ISearchExistsRequest.Type => Self.RouteValues.Get<Types>("type");
			///<summary>/_search/exists<para><typeparamref name="T"/> describes an elasticsearch document type from which the index, type and id can be inferred</para></summary>
