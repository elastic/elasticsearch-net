...
namespace Nest
{
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<IClearCacheRequest, ClearCacheRequest>))]
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<ICloneIndexRequest, CloneIndexRequest>))]
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<IIndexExistsRequest, IndexExistsRequest>))]
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<IAliasExistsRequest, AliasExistsRequest>))]
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<ITypeExistsRequest, TypeExistsRequest>))]
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<IFlushRequest, FlushRequest>))]
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<IForceMergeRequest, ForceMergeRequest>))]
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<IFreezeIndexRequest, FreezeIndexRequest>))]
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<IGetAliasRequest, GetAliasRequest>))]
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<IGetIndexSettingsRequest, GetIndexSettingsRequest>))]
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<IGetIndexTemplateRequest, GetIndexTemplateRequest>))]
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<IOpenIndexRequest, OpenIndexRequest>))]
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<IUpdateIndexSettingsRequest, UpdateIndexSettingsRequest>))]
	...
	public class UpdateIndexSettingsRequest : PlainRequestBase<UpdateIndexSettingsRequestParameters>, IUpdateIndexSettingsRequest
	{
		...
		protected override bool SupportsBody => true;
		protected override bool CanBeEmpty => true;
		protected override bool IsEmpty => NumberOfReplicas is null;
		///<summary>/_settings</summary>
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<IPutIndexTemplateRequest, PutIndexTemplateRequest>))]
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<IRecoveryStatusRequest, RecoveryStatusRequest>))]
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<IRefreshRequest, RefreshRequest>))]
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<IReloadSearchAnalyzersRequest, ReloadSearchAnalyzersRequest>))]
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<IRolloverIndexRequest, RolloverIndexRequest>))]
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<IIndicesShardStoresRequest, IndicesShardStoresRequest>))]
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<IShrinkIndexRequest, ShrinkIndexRequest>))]
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<IUnfreezeIndexRequest, UnfreezeIndexRequest>))]
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<IBulkAliasRequest, BulkAliasRequest>))]
	...
	[JsonInterfaceConverter(typeof(InterfaceConverter<IValidateQueryRequest, ValidateQueryRequest>))]
