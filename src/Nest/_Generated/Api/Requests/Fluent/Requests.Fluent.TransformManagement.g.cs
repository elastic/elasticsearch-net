...
namespace Nest.TransformManagement
{
	...
	public partial class PreviewTransformDescriptor : RequestDescriptorBase<PreviewTransformDescriptor, PreviewTransformRequestParameters, IPreviewTransformRequest>, IPreviewTransformRequest
	{
		...
		Nest.Global.Reindex.Destination? IPreviewTransformRequest.Dest { get; set; }

		string? IPreviewTransformRequest.Description { get; set; }

		Nest.Time? IPreviewTransformRequest.Frequency { get; set; }

		Nest.TransformManagement.Pivot? IPreviewTransformRequest.Pivot { get; set; }

		Nest.Global.Reindex.Source? IPreviewTransformRequest.Source { get; set; }

		Nest.TransformManagement.Settings? IPreviewTransformRequest.Settings { get; set; }

		Nest.TransformManagement.SyncContainer? IPreviewTransformRequest.Sync { get; set; }

		Nest.TransformManagement.RetentionPolicyContainer? IPreviewTransformRequest.RetentionPolicy { get; set; }

		Nest.TransformManagement.Latest? IPreviewTransformRequest.Latest { get; set; }

		public PreviewTransformDescriptor Dest(Nest.Global.Reindex.Destination? dest) => Assign(dest, (a, v) => a.Dest = v);
		public PreviewTransformDescriptor Description(string? description) => Assign(description, (a, v) => a.Description = v);
		public PreviewTransformDescriptor Frequency(Nest.Time? frequency) => Assign(frequency, (a, v) => a.Frequency = v);
		public PreviewTransformDescriptor Pivot(Nest.TransformManagement.Pivot? pivot) => Assign(pivot, (a, v) => a.Pivot = v);
		public PreviewTransformDescriptor Source(Nest.Global.Reindex.Source? source) => Assign(source, (a, v) => a.Source = v);
		public PreviewTransformDescriptor Settings(Nest.TransformManagement.Settings? settings) => Assign(settings, (a, v) => a.Settings = v);
		public PreviewTransformDescriptor Sync(Nest.TransformManagement.SyncContainer? sync) => Assign(sync, (a, v) => a.Sync = v);
		public PreviewTransformDescriptor RetentionPolicy(Nest.TransformManagement.RetentionPolicyContainer? retentionPolicy) => Assign(retentionPolicy, (a, v) => a.RetentionPolicy = v);
		public PreviewTransformDescriptor Latest(Nest.TransformManagement.Latest? latest) => Assign(latest, (a, v) => a.Latest = v);
	}
	...
	public partial class StartTransformDescriptor : RequestDescriptorBase<StartTransformDescriptor, StartTransformRequestParameters, IStartTransformRequest>, IStartTransformRequest
	{
		...
		public StartTransformDescriptor Timeout(Nest.Time? timeout) => Qs("timeout", timeout);
	}
	...
	public partial class StopTransformDescriptor : RequestDescriptorBase<StopTransformDescriptor, StopTransformRequestParameters, IStopTransformRequest>, IStopTransformRequest
	{
		...
		public StopTransformDescriptor Timeout(Nest.Time? timeout) => Qs("timeout", timeout);
