...
namespace Nest
{
	public partial class BulkResponse : ResponseBase
	{
		...
		public IReadOnlyCollection<Nest.Global.Bulk.ResponseItemContainer> Items
		{
			get;
#if NET5_0
			init;
	...
	public partial class DeleteByQueryRethrottleResponse : ResponseBase
	{
	}
	...
	public partial class MgetResponse<TDocument> : ResponseBase
	{
		...
		public IReadOnlyCollection<Nest.Global.Mget.Hit<TDocument>> Docs
		{
			get;
#if NET5_0
			init;
	...
	public partial class MsearchResponse<TDocument> : ResponseBase
	{
		...
		public IReadOnlyCollection<Union<Nest.Global.Msearch.SearchResult<TDocument>, Nest.ErrorResponseBase>> Responses
		{
			get;
#if NET5_0
			init;
	...
	{
		[JsonPropertyName("responses")]
		public IReadOnlyCollection<Nest.SearchResponse<TDocument>> Responses
		{
			get;
#if NET5_0
			init;
	...
	{
		[JsonPropertyName("docs")]
		public IReadOnlyCollection<Nest.Global.Mtermvectors.TermVectorsResult> Docs
		{
			get;
#if NET5_0
			init;
	...
	public partial class RankEvalResponse : ResponseBase
	{
		...
		public Dictionary<Nest.Id, Nest.Global.RankEval.RankEvalMetricDetail> Details
		{
			get;
#if NET5_0
			init;
	...
	{
		[JsonPropertyName("nodes")]
		public Dictionary<string, Nest.Global.UpdateByQueryRethrottle.UpdateByQueryRethrottleNode> Nodes
		{
			get;
#if NET5_0
			init;
