...
namespace Nest
{
	internal static class ApiUrlsLookups
	{
		...
		internal static ApiUrls AutoscalingDeletePolicy = new ApiUrls(new[]{"_autoscaling/policy/{name}"});
		internal static ApiUrls AutoscalingGetDecision = new ApiUrls(new[]{"_autoscaling/decision"});
		internal static ApiUrls AutoscalingGetPolicy = new ApiUrls(new[]{"_autoscaling/policy/{name}"});
		internal static ApiUrls AutoscalingPutPolicy = new ApiUrls(new[]{"_autoscaling/policy/{name}"});
		...
		internal static ApiUrls IndicesSimulateTemplate = new ApiUrls(new[]{"_index_template/_simulate_index/{name}"});
