...
namespace Nest
{
	...
	public partial class RankingEvaluationDescriptor  : RequestDescriptorBase<RankingEvaluationDescriptor,RankingEvaluationRequestParameters, IRankingEvaluationRequest>, IRankingEvaluationRequest
	{ 
		/// <summary>/_rank_eval</summary>
		public RankingEvaluationDescriptor(){}

		// values part of the url path
		Indices IRankingEvaluationRequest.Index => Self.RouteValues.Get<Indices>("index");
		Types IRankingEvaluationRequest.Type => Self.RouteValues.Get<Types>("type");
		///<summary>A comma-separated list of index names to search; use the special string `_all` or Indices.All to perform the operation on all indices</summary>
		public RankingEvaluationDescriptor Index(Indices index) => Assign(a=>a.RouteValues.Optional("index", index));
		///<summary>a shortcut into calling Index(typeof(TOther))</summary>
		public RankingEvaluationDescriptor Index<TOther>() where TOther : class => Assign(a=>a.RouteValues.Optional("index", (Indices)typeof(TOther)));
		///<summary>A shortcut into calling Index(Indices.All)</summary>
		public RankingEvaluationDescriptor AllIndices() => this.Index(Indices.All);
		///<summary>A comma-separated list of document types to search; leave empty to perform the operation on all types</summary>
		public RankingEvaluationDescriptor Type(Types type) => Assign(a=>a.RouteValues.Optional("type", type));
		///<summary>a shortcut into calling Type(typeof(TOther))</summary>
		public RankingEvaluationDescriptor Type<TOther>() where TOther : class => Assign(a=>a.RouteValues.Optional("type", (Types)typeof(TOther)));
		///<summary>a shortcut into calling Type(Types.All)</summary>
		public RankingEvaluationDescriptor AllTypes() => this.Type(Types.All);
