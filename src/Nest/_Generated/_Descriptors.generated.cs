...
///<param name="document"> describes an elasticsearch document of type <typeparamref name="TDocument"/> from which the index, type and id can be inferred</param>
	...
	///<summary>descriptor for Create <pre>http://www.elastic.co/guide/en/elasticsearch/reference/2.4/docs-index_.html</pre></summary>
...
///<param name="document"> describes an elasticsearch document of type <typeparamref name="TDocument"/> from which the index, type and id can be inferred</param>
		...
		///<summary>Explicit write consistency setting for the operation</summary>
		public CreateDescriptor<TDocument> Consistency(Consistency consistency) => AssignParam(p=>p.Consistency(consistency));
		...
		public CreateDescriptor<TDocument> Refresh(bool refresh = true) => AssignParam(p=>p.Refresh(refresh));
