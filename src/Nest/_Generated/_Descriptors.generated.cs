...
///<param name="repository"> this parameter is required</param>
	...
	///<summary>descriptor for ClusterRemoteInfo <pre>http://www.elastic.co/guide/en/elasticsearch/reference/5.x/cluster-remote-info.html</pre></summary>
...
///<param name="document"> describes an elasticsearch document of type <typeparamref name="TDocument"/> from which the index, type and id can be inferred</param>
	...
	///<summary>descriptor for FieldCaps <pre>http://www.elastic.co/guide/en/elasticsearch/reference/5.x/search-field-caps.html</pre></summary>
...
///<param name="id"> this parameter is required</param>
	...
	{ 
		...
		///<summary>The URL-encoded request definition. Useful for libraries that do not accept a request body for non-POST requests.</summary>
		public GrokProcessorPatternsDescriptor Source(string source) => AssignParam(p=>p.Source(source));
...
///<param name="snapshot_id"> this parameter is required</param>
	...
	{ 
		...
		///<summary>The URL-encoded request definition. Useful for libraries that do not accept a request body for non-POST requests.</summary>
		public DeprecationInfoDescriptor Source(string source) => AssignParam(p=>p.Source(source));
	...
	{ 
		...
		///<summary>Whether to ignore if a wildcard indices expression resolves into no concrete indices. (This includes `_all` string or when no indices have been specified)</summary>
		public MigrationAssistanceDescriptor AllowNoIndices(bool allow_no_indices = true) => AssignParam(p=>p.AllowNoIndices(allow_no_indices));

		///<summary>Whether to expand wildcard expression to concrete indices that are open, closed or both.</summary>
		public MigrationAssistanceDescriptor ExpandWildcards(ExpandWildcards expand_wildcards) => AssignParam(p=>p.ExpandWildcards(expand_wildcards));

		///<summary>Whether specified concrete indices should be ignored when unavailable (missing or closed)</summary>
		public MigrationAssistanceDescriptor IgnoreUnavailable(bool ignore_unavailable = true) => AssignParam(p=>p.IgnoreUnavailable(ignore_unavailable));

		///<summary>Pretty format the returned JSON response.</summary>
		public MigrationAssistanceDescriptor Pretty(bool pretty = true) => AssignParam(p=>p.Pretty(pretty));

		///<summary>Return human readable values for statistics.</summary>
		public MigrationAssistanceDescriptor Human(bool human = true) => AssignParam(p=>p.Human(human));

		///<summary>Include the stack trace of returned errors.</summary>
		public MigrationAssistanceDescriptor ErrorTrace(bool error_trace = true) => AssignParam(p=>p.ErrorTrace(error_trace));

		///<summary>The URL-encoded request definition. Useful for libraries that do not accept a request body for non-POST requests.</summary>
		public MigrationAssistanceDescriptor Source(string source) => AssignParam(p=>p.Source(source));

		///<summary>A comma-separated list of filters used to reduce the respone.</summary>
		public MigrationAssistanceDescriptor FilterPath(params string[] filter_path) => AssignParam(p=>p.FilterPath(filter_path));
...
///<param name="index"> this parameter is required</param>
		...
		public MigrationUpgradeDescriptor WaitForCompletion(bool wait_for_completion = true) => AssignParam(p=>p.WaitForCompletion(wait_for_completion));

		///<summary>Pretty format the returned JSON response.</summary>
		public MigrationUpgradeDescriptor Pretty(bool pretty = true) => AssignParam(p=>p.Pretty(pretty));

		///<summary>Return human readable values for statistics.</summary>
		public MigrationUpgradeDescriptor Human(bool human = true) => AssignParam(p=>p.Human(human));

		///<summary>Include the stack trace of returned errors.</summary>
		public MigrationUpgradeDescriptor ErrorTrace(bool error_trace = true) => AssignParam(p=>p.ErrorTrace(error_trace));

		///<summary>The URL-encoded request definition. Useful for libraries that do not accept a request body for non-POST requests.</summary>
		public MigrationUpgradeDescriptor Source(string source) => AssignParam(p=>p.Source(source));

		///<summary>A comma-separated list of filters used to reduce the respone.</summary>
		public MigrationUpgradeDescriptor FilterPath(params string[] filter_path) => AssignParam(p=>p.FilterPath(filter_path));
