...
using Nest.TransformManagement;
using Nest.Watcher;
using Nest.Xpack;
using System;
...
namespace Nest
{
	public partial class ElasticClient : IElasticClient
	{
		...
		public BulkResponse Bulk<TSource>(IBulkRequest<TSource> request)
		{
			return DoRequest<IBulkRequest<TSource>, BulkResponse>(request, request.RequestParameters);
		}

		public Task<BulkResponse> BulkAsync<TSource>(IBulkRequest<TSource> request, CancellationToken cancellationToken = default)
		{
			return DoRequestAsync<IBulkRequest<TSource>, BulkResponse>(request, request.RequestParameters, cancellationToken);
		}

		public BulkResponse Bulk<TSource>(Func<BulkDescriptor<TSource>, IBulkRequest<TSource>> selector = null)
		{
			return Bulk<TSource>(selector.InvokeOrDefault(new BulkDescriptor<TSource>()));
		}

		public Task<BulkResponse> BulkAsync<TSource>(Func<BulkDescriptor<TSource>, IBulkRequest<TSource>> selector = null, CancellationToken cancellationToken = default)
		{
			return BulkAsync<TSource>(selector.InvokeOrDefault(new BulkDescriptor<TSource>()), cancellationToken);
		}
		...
		public DeleteByQueryRethrottleResponse DeleteByQueryRethrottle(Nest.Id task_id, Func<DeleteByQueryRethrottleDescriptor, IDeleteByQueryRethrottleRequest> selector = null)
		{
			return DeleteByQueryRethrottle(selector.InvokeOrDefault(new DeleteByQueryRethrottleDescriptor(task_id)));
		}

		public Task<DeleteByQueryRethrottleResponse> DeleteByQueryRethrottleAsync(Nest.Id task_id, Func<DeleteByQueryRethrottleDescriptor, IDeleteByQueryRethrottleRequest> selector = null, CancellationToken cancellationToken = default)
		{
			return DeleteByQueryRethrottleAsync(selector.InvokeOrDefault(new DeleteByQueryRethrottleDescriptor(task_id)), cancellationToken);
		}
		...
		public DeleteScriptResponse DeleteScript(Nest.Id id, Func<DeleteScriptDescriptor, IDeleteScriptRequest> selector = null)
		{
			return DeleteScript(selector.InvokeOrDefault(new DeleteScriptDescriptor(id)));
		}

		public Task<DeleteScriptResponse> DeleteScriptAsync(Nest.Id id, Func<DeleteScriptDescriptor, IDeleteScriptRequest> selector = null, CancellationToken cancellationToken = default)
		{
			return DeleteScriptAsync(selector.InvokeOrDefault(new DeleteScriptDescriptor(id)), cancellationToken);
		}
		...
		public MgetResponse<TDocument> Mget<TDocument>(IMgetRequest request)
		{
			return DoRequest<IMgetRequest, MgetResponse<TDocument>>(request, request.RequestParameters);
		}

		public Task<MgetResponse<TDocument>> MgetAsync<TDocument>(IMgetRequest request, CancellationToken cancellationToken = default)
		{
			return DoRequestAsync<IMgetRequest, MgetResponse<TDocument>>(request, request.RequestParameters, cancellationToken);
		}

		public MgetResponse<TDocument> Mget<TDocument>(Func<MgetDescriptor, IMgetRequest> selector = null)
		{
			return Mget<TDocument>(selector.InvokeOrDefault(new MgetDescriptor()));
		}

		public Task<MgetResponse<TDocument>> MgetAsync<TDocument>(Func<MgetDescriptor, IMgetRequest> selector = null, CancellationToken cancellationToken = default)
		{
			return MgetAsync<TDocument>(selector.InvokeOrDefault(new MgetDescriptor()), cancellationToken);
		}

		public MsearchResponse<TDocument> Msearch<TDocument>(IMsearchRequest request)
		{
			return DoRequest<IMsearchRequest, MsearchResponse<TDocument>>(request, request.RequestParameters);
		}

		public Task<MsearchResponse<TDocument>> MsearchAsync<TDocument>(IMsearchRequest request, CancellationToken cancellationToken = default)
		{
			return DoRequestAsync<IMsearchRequest, MsearchResponse<TDocument>>(request, request.RequestParameters, cancellationToken);
		}

		public MsearchResponse<TDocument> Msearch<TDocument>(Func<MsearchDescriptor, IMsearchRequest> selector = null)
		{
			return Msearch<TDocument>(selector.InvokeOrDefault(new MsearchDescriptor()));
		}

		public Task<MsearchResponse<TDocument>> MsearchAsync<TDocument>(Func<MsearchDescriptor, IMsearchRequest> selector = null, CancellationToken cancellationToken = default)
		{
			return MsearchAsync<TDocument>(selector.InvokeOrDefault(new MsearchDescriptor()), cancellationToken);
		}

		public MsearchTemplateResponse<TDocument> MsearchTemplate<TDocument>(IMsearchTemplateRequest request)
		{
			return DoRequest<IMsearchTemplateRequest, MsearchTemplateResponse<TDocument>>(request, request.RequestParameters);
		}

		public Task<MsearchTemplateResponse<TDocument>> MsearchTemplateAsync<TDocument>(IMsearchTemplateRequest request, CancellationToken cancellationToken = default)
		{
			return DoRequestAsync<IMsearchTemplateRequest, MsearchTemplateResponse<TDocument>>(request, request.RequestParameters, cancellationToken);
		}

		public MsearchTemplateResponse<TDocument> MsearchTemplate<TDocument>(Func<MsearchTemplateDescriptor, IMsearchTemplateRequest> selector = null)
		{
			return MsearchTemplate<TDocument>(selector.InvokeOrDefault(new MsearchTemplateDescriptor()));
		}

		public Task<MsearchTemplateResponse<TDocument>> MsearchTemplateAsync<TDocument>(Func<MsearchTemplateDescriptor, IMsearchTemplateRequest> selector = null, CancellationToken cancellationToken = default)
		{
			return MsearchTemplateAsync<TDocument>(selector.InvokeOrDefault(new MsearchTemplateDescriptor()), cancellationToken);
		}

		public MtermvectorsResponse Mtermvectors(IMtermvectorsRequest request)
		{
			return DoRequest<IMtermvectorsRequest, MtermvectorsResponse>(request, request.RequestParameters);
		}

		public Task<MtermvectorsResponse> MtermvectorsAsync(IMtermvectorsRequest request, CancellationToken cancellationToken = default)
		{
			return DoRequestAsync<IMtermvectorsRequest, MtermvectorsResponse>(request, request.RequestParameters, cancellationToken);
		}

		public MtermvectorsResponse Mtermvectors(Func<MtermvectorsDescriptor, IMtermvectorsRequest> selector = null)
		{
			return Mtermvectors(selector.InvokeOrDefault(new MtermvectorsDescriptor()));
		}

		public Task<MtermvectorsResponse> MtermvectorsAsync(Func<MtermvectorsDescriptor, IMtermvectorsRequest> selector = null, CancellationToken cancellationToken = default)
		{
			return MtermvectorsAsync(selector.InvokeOrDefault(new MtermvectorsDescriptor()), cancellationToken);
		}
		...
		public RankEvalResponse RankEval(IRankEvalRequest request)
		{
			return DoRequest<IRankEvalRequest, RankEvalResponse>(request, request.RequestParameters);
		}

		public Task<RankEvalResponse> RankEvalAsync(IRankEvalRequest request, CancellationToken cancellationToken = default)
		{
			return DoRequestAsync<IRankEvalRequest, RankEvalResponse>(request, request.RequestParameters, cancellationToken);
		}

		public RankEvalResponse RankEval(Func<RankEvalDescriptor, IRankEvalRequest> selector = null)
		{
			return RankEval(selector.InvokeOrDefault(new RankEvalDescriptor()));
		}

		public RankEvalResponse RankEval(Nest.Indices index, Func<RankEvalDescriptor, IRankEvalRequest> selector = null)
		{
			return RankEval(selector.InvokeOrDefault(new RankEvalDescriptor(index)));
		}

		public Task<RankEvalResponse> RankEvalAsync(Func<RankEvalDescriptor, IRankEvalRequest> selector = null, CancellationToken cancellationToken = default)
		{
			return RankEvalAsync(selector.InvokeOrDefault(new RankEvalDescriptor()), cancellationToken);
		}

		public Task<RankEvalResponse> RankEvalAsync(Nest.Indices index, Func<RankEvalDescriptor, IRankEvalRequest> selector = null, CancellationToken cancellationToken = default)
		{
			return RankEvalAsync(selector.InvokeOrDefault(new RankEvalDescriptor(index)), cancellationToken);
		}
		...
		public ScriptsPainlessExecuteResponse<TResult> ScriptsPainlessExecute<TResult>(IScriptsPainlessExecuteRequest request)
		{
			return DoRequest<IScriptsPainlessExecuteRequest, ScriptsPainlessExecuteResponse<TResult>>(request, request.RequestParameters);
		}

		public Task<ScriptsPainlessExecuteResponse<TResult>> ScriptsPainlessExecuteAsync<TResult>(IScriptsPainlessExecuteRequest request, CancellationToken cancellationToken = default)
		{
			return DoRequestAsync<IScriptsPainlessExecuteRequest, ScriptsPainlessExecuteResponse<TResult>>(request, request.RequestParameters, cancellationToken);
		}

		public ScriptsPainlessExecuteResponse<TResult> ScriptsPainlessExecute<TResult>(Func<ScriptsPainlessExecuteDescriptor, IScriptsPainlessExecuteRequest> selector = null)
		{
			return ScriptsPainlessExecute<TResult>(selector.InvokeOrDefault(new ScriptsPainlessExecuteDescriptor()));
		}

		public Task<ScriptsPainlessExecuteResponse<TResult>> ScriptsPainlessExecuteAsync<TResult>(Func<ScriptsPainlessExecuteDescriptor, IScriptsPainlessExecuteRequest> selector = null, CancellationToken cancellationToken = default)
		{
			return ScriptsPainlessExecuteAsync<TResult>(selector.InvokeOrDefault(new ScriptsPainlessExecuteDescriptor()), cancellationToken);
		}
		...
		public UpdateByQueryResponse UpdateByQuery(Nest.Indices index, Func<UpdateByQueryDescriptor, IUpdateByQueryRequest> selector = null)
		{
			return UpdateByQuery(selector.InvokeOrDefault(new UpdateByQueryDescriptor(index)));
		}

		public Task<UpdateByQueryResponse> UpdateByQueryAsync(Nest.Indices index, Func<UpdateByQueryDescriptor, IUpdateByQueryRequest> selector = null, CancellationToken cancellationToken = default)
		{
			return UpdateByQueryAsync(selector.InvokeOrDefault(new UpdateByQueryDescriptor(index)), cancellationToken);
		}

		public UpdateByQueryRethrottleResponse UpdateByQueryRethrottle(IUpdateByQueryRethrottleRequest request)
		{
			return DoRequest<IUpdateByQueryRethrottleRequest, UpdateByQueryRethrottleResponse>(request, request.RequestParameters);
		}

		public Task<UpdateByQueryRethrottleResponse> UpdateByQueryRethrottleAsync(IUpdateByQueryRethrottleRequest request, CancellationToken cancellationToken = default)
		{
			return DoRequestAsync<IUpdateByQueryRethrottleRequest, UpdateByQueryRethrottleResponse>(request, request.RequestParameters, cancellationToken);
		}

		public UpdateByQueryRethrottleResponse UpdateByQueryRethrottle(Nest.Id task_id, Func<UpdateByQueryRethrottleDescriptor, IUpdateByQueryRethrottleRequest> selector = null)
		{
			return UpdateByQueryRethrottle(selector.InvokeOrDefault(new UpdateByQueryRethrottleDescriptor(task_id)));
		}

		public Task<UpdateByQueryRethrottleResponse> UpdateByQueryRethrottleAsync(Nest.Id task_id, Func<UpdateByQueryRethrottleDescriptor, IUpdateByQueryRethrottleRequest> selector = null, CancellationToken cancellationToken = default)
		{
			return UpdateByQueryRethrottleAsync(selector.InvokeOrDefault(new UpdateByQueryRethrottleDescriptor(task_id)), cancellationToken);
		}
	}
}