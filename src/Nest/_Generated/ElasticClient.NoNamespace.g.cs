...
namespace Nest
{
	public partial class ElasticClient : IElasticClient
	{
		...
		public CreateResponse Create<TDocument>(TDocument document, Nest.IndexName index, Nest.Id id, Func<CreateDescriptor<TDocument>, ICreateRequest<TDocument>> selector = null) => Create<TDocument>(selector.InvokeOrDefault(new CreateDescriptor<TDocument>(index, id)));
		public Task<CreateResponse> CreateAsync<TDocument>(TDocument document, Nest.IndexName index, Nest.Id id, Func<CreateDescriptor<TDocument>, ICreateRequest<TDocument>> selector = null, CancellationToken cancellationToken = default) => CreateAsync<TDocument>(selector.InvokeOrDefault(new CreateDescriptor<TDocument>(index, id)), cancellationToken);
		...
		public DeleteResponse Delete(Nest.IndexName index, Nest.Id id, Func<DeleteDescriptor, IDeleteRequest> selector = null) => Delete(selector.InvokeOrDefault(new DeleteDescriptor(index, id)));
		public Task<DeleteResponse> DeleteAsync(Nest.IndexName index, Nest.Id id, Func<DeleteDescriptor, IDeleteRequest> selector = null, CancellationToken cancellationToken = default) => DeleteAsync(selector.InvokeOrDefault(new DeleteDescriptor(index, id)), cancellationToken);
		...
		public DeleteByQueryResponse DeleteByQuery(Nest.Indices index, Func<DeleteByQueryDescriptor, IDeleteByQueryRequest> selector = null) => DeleteByQuery(selector.InvokeOrDefault(new DeleteByQueryDescriptor(index)));
		public Task<DeleteByQueryResponse> DeleteByQueryAsync(Nest.Indices index, Func<DeleteByQueryDescriptor, IDeleteByQueryRequest> selector = null, CancellationToken cancellationToken = default) => DeleteByQueryAsync(selector.InvokeOrDefault(new DeleteByQueryDescriptor(index)), cancellationToken);
		...
		public DeleteByQueryRethrottleResponse DeleteByQueryRethrottle(Nest.Id task_id, Func<DeleteByQueryRethrottleDescriptor, IDeleteByQueryRethrottleRequest> selector = null) => DeleteByQueryRethrottle(selector.InvokeOrDefault(new DeleteByQueryRethrottleDescriptor(task_id)));
		public Task<DeleteByQueryRethrottleResponse> DeleteByQueryRethrottleAsync(Nest.Id task_id, Func<DeleteByQueryRethrottleDescriptor, IDeleteByQueryRethrottleRequest> selector = null, CancellationToken cancellationToken = default) => DeleteByQueryRethrottleAsync(selector.InvokeOrDefault(new DeleteByQueryRethrottleDescriptor(task_id)), cancellationToken);
		...
		public DeleteScriptResponse DeleteScript(Nest.Id id, Func<DeleteScriptDescriptor, IDeleteScriptRequest> selector = null) => DeleteScript(selector.InvokeOrDefault(new DeleteScriptDescriptor(id)));
		public Task<DeleteScriptResponse> DeleteScriptAsync(Nest.Id id, Func<DeleteScriptDescriptor, IDeleteScriptRequest> selector = null, CancellationToken cancellationToken = default) => DeleteScriptAsync(selector.InvokeOrDefault(new DeleteScriptDescriptor(id)), cancellationToken);
		...
		public ExistsResponse Exists(Nest.IndexName index, Nest.Id id, Func<ExistsDescriptor, IExistsRequest> selector = null) => Exists(selector.InvokeOrDefault(new ExistsDescriptor(index, id)));
		public Task<ExistsResponse> ExistsAsync(Nest.IndexName index, Nest.Id id, Func<ExistsDescriptor, IExistsRequest> selector = null, CancellationToken cancellationToken = default) => ExistsAsync(selector.InvokeOrDefault(new ExistsDescriptor(index, id)), cancellationToken);
		...
		public ExistsSourceResponse ExistsSource(Nest.IndexName index, Nest.Id id, Func<ExistsSourceDescriptor, IExistsSourceRequest> selector = null) => ExistsSource(selector.InvokeOrDefault(new ExistsSourceDescriptor(index, id)));
		public Task<ExistsSourceResponse> ExistsSourceAsync(Nest.IndexName index, Nest.Id id, Func<ExistsSourceDescriptor, IExistsSourceRequest> selector = null, CancellationToken cancellationToken = default) => ExistsSourceAsync(selector.InvokeOrDefault(new ExistsSourceDescriptor(index, id)), cancellationToken);
		...
		public ExplainResponse<TDocument> Explain<TDocument>(Nest.IndexName index, Nest.Id id, Func<ExplainDescriptor, IExplainRequest> selector = null) => Explain<TDocument>(selector.InvokeOrDefault(new ExplainDescriptor(index, id)));
		public Task<ExplainResponse<TDocument>> ExplainAsync<TDocument>(Nest.IndexName index, Nest.Id id, Func<ExplainDescriptor, IExplainRequest> selector = null, CancellationToken cancellationToken = default) => ExplainAsync<TDocument>(selector.InvokeOrDefault(new ExplainDescriptor(index, id)), cancellationToken);
		...
		public GetResponse<TDocument> Get<TDocument>(Nest.IndexName index, Nest.Id id, Func<GetDescriptor, IGetRequest> selector = null) => Get<TDocument>(selector.InvokeOrDefault(new GetDescriptor(index, id)));
		public Task<GetResponse<TDocument>> GetAsync<TDocument>(Nest.IndexName index, Nest.Id id, Func<GetDescriptor, IGetRequest> selector = null, CancellationToken cancellationToken = default) => GetAsync<TDocument>(selector.InvokeOrDefault(new GetDescriptor(index, id)), cancellationToken);
		...
		public GetScriptResponse GetScript(Nest.Id id, Func<GetScriptDescriptor, IGetScriptRequest> selector = null) => GetScript(selector.InvokeOrDefault(new GetScriptDescriptor(id)));
		public Task<GetScriptResponse> GetScriptAsync(Nest.Id id, Func<GetScriptDescriptor, IGetScriptRequest> selector = null, CancellationToken cancellationToken = default) => GetScriptAsync(selector.InvokeOrDefault(new GetScriptDescriptor(id)), cancellationToken);
		...
		public IndexResponse Index<TDocument>(TDocument document, Nest.IndexName index, Func<IndexDescriptor<TDocument>, IIndexRequest<TDocument>> selector = null) => Index<TDocument>(selector.InvokeOrDefault(new IndexDescriptor<TDocument>(index)));
		public Task<IndexResponse> IndexAsync<TDocument>(TDocument document, Nest.IndexName index, Func<IndexDescriptor<TDocument>, IIndexRequest<TDocument>> selector = null, CancellationToken cancellationToken = default) => IndexAsync<TDocument>(selector.InvokeOrDefault(new IndexDescriptor<TDocument>(index)), cancellationToken);
		...
		public OpenPointInTimeResponse OpenPointInTime(Nest.Indices index, Func<OpenPointInTimeDescriptor, IOpenPointInTimeRequest> selector = null) => OpenPointInTime(selector.InvokeOrDefault(new OpenPointInTimeDescriptor(index)));
		...
		public Task<OpenPointInTimeResponse> OpenPointInTimeAsync(Nest.Indices index, Func<OpenPointInTimeDescriptor, IOpenPointInTimeRequest> selector = null, CancellationToken cancellationToken = default) => OpenPointInTimeAsync(selector.InvokeOrDefault(new OpenPointInTimeDescriptor(index)), cancellationToken);
		...
		public PutScriptResponse PutScript(Nest.Id id, Func<PutScriptDescriptor, IPutScriptRequest> selector = null) => PutScript(selector.InvokeOrDefault(new PutScriptDescriptor(id)));
		public Task<PutScriptResponse> PutScriptAsync(Nest.Id id, Func<PutScriptDescriptor, IPutScriptRequest> selector = null, CancellationToken cancellationToken = default) => PutScriptAsync(selector.InvokeOrDefault(new PutScriptDescriptor(id)), cancellationToken);
		...
		public RankEvalResponse RankEval(Nest.Indices index, Func<RankEvalDescriptor, IRankEvalRequest> selector = null) => RankEval(selector.InvokeOrDefault(new RankEvalDescriptor(index)));
		...
		public Task<RankEvalResponse> RankEvalAsync(Nest.Indices index, Func<RankEvalDescriptor, IRankEvalRequest> selector = null, CancellationToken cancellationToken = default) => RankEvalAsync(selector.InvokeOrDefault(new RankEvalDescriptor(index)), cancellationToken);
		...
		public ReindexRethrottleResponse ReindexRethrottle(Nest.Id task_id, Func<ReindexRethrottleDescriptor, IReindexRethrottleRequest> selector = null) => ReindexRethrottle(selector.InvokeOrDefault(new ReindexRethrottleDescriptor(task_id)));
		public Task<ReindexRethrottleResponse> ReindexRethrottleAsync(Nest.Id task_id, Func<ReindexRethrottleDescriptor, IReindexRethrottleRequest> selector = null, CancellationToken cancellationToken = default) => ReindexRethrottleAsync(selector.InvokeOrDefault(new ReindexRethrottleDescriptor(task_id)), cancellationToken);
		...
		public TermsEnumResponse TermsEnum(Nest.IndexName index, Func<TermsEnumDescriptor, ITermsEnumRequest> selector = null) => TermsEnum(selector.InvokeOrDefault(new TermsEnumDescriptor(index)));
		public Task<TermsEnumResponse> TermsEnumAsync(Nest.IndexName index, Func<TermsEnumDescriptor, ITermsEnumRequest> selector = null, CancellationToken cancellationToken = default) => TermsEnumAsync(selector.InvokeOrDefault(new TermsEnumDescriptor(index)), cancellationToken);
		...
		public TermvectorsResponse Termvectors<TDocument>(TDocument document, Nest.IndexName index, Func<TermvectorsDescriptor<TDocument>, ITermvectorsRequest<TDocument>> selector = null) => Termvectors<TDocument>(selector.InvokeOrDefault(new TermvectorsDescriptor<TDocument>(index)));
		public Task<TermvectorsResponse> TermvectorsAsync<TDocument>(TDocument document, Nest.IndexName index, Func<TermvectorsDescriptor<TDocument>, ITermvectorsRequest<TDocument>> selector = null, CancellationToken cancellationToken = default) => TermvectorsAsync<TDocument>(selector.InvokeOrDefault(new TermvectorsDescriptor<TDocument>(index)), cancellationToken);
		...
		public UpdateResponse<TDocument> Update<TDocument, TPartialDocument>(TDocument document, TPartialDocument partialDocument, Nest.IndexName index, Nest.Id id, Func<UpdateDescriptor<TDocument, TPartialDocument>, IUpdateRequest<TDocument,TPartialDocument>> selector = null) => Update<TDocument, TPartialDocument>(selector.InvokeOrDefault(new UpdateDescriptor<TDocument, TPartialDocument>(index, id)));
		...
		public UpdateByQueryResponse UpdateByQuery(Nest.Indices index, Func<UpdateByQueryDescriptor, IUpdateByQueryRequest> selector = null) => UpdateByQuery(selector.InvokeOrDefault(new UpdateByQueryDescriptor(index)));
		public Task<UpdateByQueryResponse> UpdateByQueryAsync(Nest.Indices index, Func<UpdateByQueryDescriptor, IUpdateByQueryRequest> selector = null, CancellationToken cancellationToken = default) => UpdateByQueryAsync(selector.InvokeOrDefault(new UpdateByQueryDescriptor(index)), cancellationToken);
		...
		public UpdateByQueryRethrottleResponse UpdateByQueryRethrottle(Nest.Id task_id, Func<UpdateByQueryRethrottleDescriptor, IUpdateByQueryRethrottleRequest> selector = null) => UpdateByQueryRethrottle(selector.InvokeOrDefault(new UpdateByQueryRethrottleDescriptor(task_id)));
		public Task<UpdateByQueryRethrottleResponse> UpdateByQueryRethrottleAsync(Nest.Id task_id, Func<UpdateByQueryRethrottleDescriptor, IUpdateByQueryRethrottleRequest> selector = null, CancellationToken cancellationToken = default) => UpdateByQueryRethrottleAsync(selector.InvokeOrDefault(new UpdateByQueryRethrottleDescriptor(task_id)), cancellationToken);
	}
}