...
namespace Nest.Ml.EvaluateDataFrame
{
	public partial class ConfusionMatrixItem
	{
		...
		public IReadOnlyCollection<Nest.Ml.EvaluateDataFrame.ConfusionMatrixPrediction> PredictedClasses
		{
			get;
#if NET5_0
			init;
	...
	public partial class ConfusionMatrixPrediction
	{
		...
		public Nest.Name PredictedClass
		{
			get;
#if NET5_0
			init;
	...
	public partial class DataframeClassificationSummary
	{
		...
		public Nest.Ml.EvaluateDataFrame.DataframeClassificationSummaryAccuracy? Accuracy
		{
			get;
#if NET5_0
			init;
		...
		public Nest.Ml.EvaluateDataFrame.DataframeEvaluationSummaryAucRoc? AucRoc
		{
			get;
#if NET5_0
			init;
		...
		public Nest.Ml.EvaluateDataFrame.DataframeClassificationSummaryMulticlassConfusionMatrix? MulticlassConfusionMatrix
		{
			get;
#if NET5_0
			init;
		...
		public Nest.Ml.EvaluateDataFrame.DataframeClassificationSummaryPrecision? Precision
		{
			get;
#if NET5_0
			init;
		...
		public Nest.Ml.EvaluateDataFrame.DataframeClassificationSummaryRecall? Recall
		{
			get;
#if NET5_0
			init;
	...
	public partial class DataframeClassificationSummaryAccuracy
	{
		...
		public IReadOnlyCollection<Nest.Ml.EvaluateDataFrame.DataframeEvaluationClass> Classes
		{
			get;
#if NET5_0
			init;
	...
	public partial class DataframeClassificationSummaryMulticlassConfusionMatrix
	{
		...
		public IReadOnlyCollection<Nest.Ml.EvaluateDataFrame.ConfusionMatrixItem> ConfusionMatrix
		{
			get;
#if NET5_0
			init;
	...
	public partial class DataframeEvaluationSummaryAucRoc : Ml.EvaluateDataFrame.DataframeEvaluationValue
	{
		...
		public IReadOnlyCollection<Nest.Ml.EvaluateDataFrame.DataframeEvaluationSummaryAucRocCurveItem>? Curve
		{
			get;
#if NET5_0
			init;
	...
	public partial class DataframeOutlierDetectionSummary
	{
		...
		[JsonPropertyName("confusion_matrix")]
		public Dictionary<string, Nest.Ml.EvaluateDataFrame.ConfusionMatrixThreshold>? ConfusionMatrix
		{
			get;
#if NET5_0
			init;
	...
	public partial class DataframeRegressionSummary
	{
		...
		public Nest.Ml.EvaluateDataFrame.DataframeEvaluationValue? Huber
		{
			get;
#if NET5_0
			init;
		...
		public Nest.Ml.EvaluateDataFrame.DataframeEvaluationValue? Mse
		{
			get;
#if NET5_0
			init;
		...
		public Nest.Ml.EvaluateDataFrame.DataframeEvaluationValue? Msle
		{
			get;
#if NET5_0
			init;
		...
		public Nest.Ml.EvaluateDataFrame.DataframeEvaluationValue? RSquared
		{
			get;
#if NET5_0
			init;
