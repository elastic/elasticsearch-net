...
#nullable restore
namespace Nest.Ml.Info
{
	public partial class AnomalyDetectors
	{
		[JsonPropertyName("categorization_analyzer")]
		public Nest.Ml.CategorizationAnalyzer CategorizationAnalyzer
		{
			get;
#if NET5_0
			init;
	...
	public partial class Defaults
	{
		...
		public Nest.Ml.Info.AnomalyDetectors AnomalyDetectors
		{
			get;
#if NET5_0
			init;
		...
		public Nest.Ml.Info.Datafeeds Datafeeds
		{
			get;
#if NET5_0
			init;
