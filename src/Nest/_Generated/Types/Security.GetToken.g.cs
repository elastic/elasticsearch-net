...
namespace Nest.Security.GetToken
{
	public partial class AuthenticatedUser : Security.User
	{
		...
		public Nest.Security.GetToken.AuthenticationProvider? AuthenticationProvider
		{
			get;
#if NET5_0
			init;
		...
		public Nest.Security.GetToken.UserRealm AuthenticationRealm
		{
			get;
#if NET5_0
			init;
		...
		public Nest.Security.GetToken.UserRealm LookupRealm
		{
			get;
#if NET5_0
			init;
