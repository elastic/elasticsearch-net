...
namespace Nest.IndexManagement
{
	public class IndexManagementNamespace : NamespacedClientProxy
	{
		...
		public AddBlockResponse AddBlock(Nest.IndexName index, Nest.IndexManagement.AddBlock.IndicesBlockOptions block, Func<AddBlockDescriptor, IAddBlockRequest> selector = null) => AddBlock(selector.InvokeOrDefault(new AddBlockDescriptor(index, block)));
		public Task<AddBlockResponse> AddBlockAsync(Nest.IndexName index, Nest.IndexManagement.AddBlock.IndicesBlockOptions block, Func<AddBlockDescriptor, IAddBlockRequest> selector = null, CancellationToken cancellationToken = default) => AddBlockAsync(selector.InvokeOrDefault(new AddBlockDescriptor(index, block)), cancellationToken);
		...
		public CloneResponse Clone(Nest.IndexName index, Nest.Name target, Func<CloneDescriptor, ICloneRequest> selector = null) => Clone(selector.InvokeOrDefault(new CloneDescriptor(index, target)));
		public Task<CloneResponse> CloneAsync(Nest.IndexName index, Nest.Name target, Func<CloneDescriptor, ICloneRequest> selector = null, CancellationToken cancellationToken = default) => CloneAsync(selector.InvokeOrDefault(new CloneDescriptor(index, target)), cancellationToken);
		...
		public CloseResponse Close(Nest.Indices index, Func<CloseDescriptor, ICloseRequest> selector = null) => Close(selector.InvokeOrDefault(new CloseDescriptor(index)));
		public Task<CloseResponse> CloseAsync(Nest.Indices index, Func<CloseDescriptor, ICloseRequest> selector = null, CancellationToken cancellationToken = default) => CloseAsync(selector.InvokeOrDefault(new CloseDescriptor(index)), cancellationToken);
		...
		public CreateResponse Create(Nest.IndexName index, Func<CreateDescriptor, ICreateRequest> selector = null) => Create(selector.InvokeOrDefault(new CreateDescriptor(index)));
		public Task<CreateResponse> CreateAsync(Nest.IndexName index, Func<CreateDescriptor, ICreateRequest> selector = null, CancellationToken cancellationToken = default) => CreateAsync(selector.InvokeOrDefault(new CreateDescriptor(index)), cancellationToken);
		...
		public CreateDataStreamResponse CreateDataStream(Nest.DataStreamName name, Func<CreateDataStreamDescriptor, ICreateDataStreamRequest> selector = null) => CreateDataStream(selector.InvokeOrDefault(new CreateDataStreamDescriptor(name)));
		public Task<CreateDataStreamResponse> CreateDataStreamAsync(Nest.DataStreamName name, Func<CreateDataStreamDescriptor, ICreateDataStreamRequest> selector = null, CancellationToken cancellationToken = default) => CreateDataStreamAsync(selector.InvokeOrDefault(new CreateDataStreamDescriptor(name)), cancellationToken);
		...
		public DeleteResponse Delete(Nest.Indices index, Func<DeleteDescriptor, IDeleteRequest> selector = null) => Delete(selector.InvokeOrDefault(new DeleteDescriptor(index)));
		public Task<DeleteResponse> DeleteAsync(Nest.Indices index, Func<DeleteDescriptor, IDeleteRequest> selector = null, CancellationToken cancellationToken = default) => DeleteAsync(selector.InvokeOrDefault(new DeleteDescriptor(index)), cancellationToken);
		...
		public DeleteAliasResponse DeleteAlias(Nest.Indices index, Nest.Names name, Func<DeleteAliasDescriptor, IDeleteAliasRequest> selector = null) => DeleteAlias(selector.InvokeOrDefault(new DeleteAliasDescriptor(index, name)));
		public Task<DeleteAliasResponse> DeleteAliasAsync(Nest.Indices index, Nest.Names name, Func<DeleteAliasDescriptor, IDeleteAliasRequest> selector = null, CancellationToken cancellationToken = default) => DeleteAliasAsync(selector.InvokeOrDefault(new DeleteAliasDescriptor(index, name)), cancellationToken);
		...
		public DeleteDataStreamResponse DeleteDataStream(Nest.DataStreamName name, Func<DeleteDataStreamDescriptor, IDeleteDataStreamRequest> selector = null) => DeleteDataStream(selector.InvokeOrDefault(new DeleteDataStreamDescriptor(name)));
		public Task<DeleteDataStreamResponse> DeleteDataStreamAsync(Nest.DataStreamName name, Func<DeleteDataStreamDescriptor, IDeleteDataStreamRequest> selector = null, CancellationToken cancellationToken = default) => DeleteDataStreamAsync(selector.InvokeOrDefault(new DeleteDataStreamDescriptor(name)), cancellationToken);
		...
		public DeleteIndexTemplateResponse DeleteIndexTemplate(Nest.Name name, Func<DeleteIndexTemplateDescriptor, IDeleteIndexTemplateRequest> selector = null) => DeleteIndexTemplate(selector.InvokeOrDefault(new DeleteIndexTemplateDescriptor(name)));
		public Task<DeleteIndexTemplateResponse> DeleteIndexTemplateAsync(Nest.Name name, Func<DeleteIndexTemplateDescriptor, IDeleteIndexTemplateRequest> selector = null, CancellationToken cancellationToken = default) => DeleteIndexTemplateAsync(selector.InvokeOrDefault(new DeleteIndexTemplateDescriptor(name)), cancellationToken);
		...
		public DeleteTemplateResponse DeleteTemplate(Nest.Name name, Func<DeleteTemplateDescriptor, IDeleteTemplateRequest> selector = null) => DeleteTemplate(selector.InvokeOrDefault(new DeleteTemplateDescriptor(name)));
		public Task<DeleteTemplateResponse> DeleteTemplateAsync(Nest.Name name, Func<DeleteTemplateDescriptor, IDeleteTemplateRequest> selector = null, CancellationToken cancellationToken = default) => DeleteTemplateAsync(selector.InvokeOrDefault(new DeleteTemplateDescriptor(name)), cancellationToken);
		...
		public ExistsResponse Exists(Nest.Indices index, Func<ExistsDescriptor, IExistsRequest> selector = null) => Exists(selector.InvokeOrDefault(new ExistsDescriptor(index)));
		public Task<ExistsResponse> ExistsAsync(Nest.Indices index, Func<ExistsDescriptor, IExistsRequest> selector = null, CancellationToken cancellationToken = default) => ExistsAsync(selector.InvokeOrDefault(new ExistsDescriptor(index)), cancellationToken);
		...
		public ExistsAliasResponse ExistsAlias(Nest.Names name, Func<ExistsAliasDescriptor, IExistsAliasRequest> selector = null) => ExistsAlias(selector.InvokeOrDefault(new ExistsAliasDescriptor(name)));
		public Task<ExistsAliasResponse> ExistsAliasAsync(Nest.Names name, Func<ExistsAliasDescriptor, IExistsAliasRequest> selector = null, CancellationToken cancellationToken = default) => ExistsAliasAsync(selector.InvokeOrDefault(new ExistsAliasDescriptor(name)), cancellationToken);
		...
		public ExistsIndexTemplateResponse ExistsIndexTemplate(Nest.Name name, Func<ExistsIndexTemplateDescriptor, IExistsIndexTemplateRequest> selector = null) => ExistsIndexTemplate(selector.InvokeOrDefault(new ExistsIndexTemplateDescriptor(name)));
		public Task<ExistsIndexTemplateResponse> ExistsIndexTemplateAsync(Nest.Name name, Func<ExistsIndexTemplateDescriptor, IExistsIndexTemplateRequest> selector = null, CancellationToken cancellationToken = default) => ExistsIndexTemplateAsync(selector.InvokeOrDefault(new ExistsIndexTemplateDescriptor(name)), cancellationToken);
		...
		public ExistsTemplateResponse ExistsTemplate(Nest.Names name, Func<ExistsTemplateDescriptor, IExistsTemplateRequest> selector = null) => ExistsTemplate(selector.InvokeOrDefault(new ExistsTemplateDescriptor(name)));
		public Task<ExistsTemplateResponse> ExistsTemplateAsync(Nest.Names name, Func<ExistsTemplateDescriptor, IExistsTemplateRequest> selector = null, CancellationToken cancellationToken = default) => ExistsTemplateAsync(selector.InvokeOrDefault(new ExistsTemplateDescriptor(name)), cancellationToken);
		...
		public GetResponse Get(Nest.Indices index, Func<GetDescriptor, IGetRequest> selector = null) => Get(selector.InvokeOrDefault(new GetDescriptor(index)));
		public Task<GetResponse> GetAsync(Nest.Indices index, Func<GetDescriptor, IGetRequest> selector = null, CancellationToken cancellationToken = default) => GetAsync(selector.InvokeOrDefault(new GetDescriptor(index)), cancellationToken);
		...
		public GetFieldMappingResponse GetFieldMapping(Nest.Fields fields, Func<GetFieldMappingDescriptor, IGetFieldMappingRequest> selector = null) => GetFieldMapping(selector.InvokeOrDefault(new GetFieldMappingDescriptor(fields)));
		public Task<GetFieldMappingResponse> GetFieldMappingAsync(Nest.Fields fields, Func<GetFieldMappingDescriptor, IGetFieldMappingRequest> selector = null, CancellationToken cancellationToken = default) => GetFieldMappingAsync(selector.InvokeOrDefault(new GetFieldMappingDescriptor(fields)), cancellationToken);
		...
		public MigrateToDataStreamResponse MigrateToDataStream(Nest.IndexName name, Func<MigrateToDataStreamDescriptor, IMigrateToDataStreamRequest> selector = null) => MigrateToDataStream(selector.InvokeOrDefault(new MigrateToDataStreamDescriptor(name)));
		public Task<MigrateToDataStreamResponse> MigrateToDataStreamAsync(Nest.IndexName name, Func<MigrateToDataStreamDescriptor, IMigrateToDataStreamRequest> selector = null, CancellationToken cancellationToken = default) => MigrateToDataStreamAsync(selector.InvokeOrDefault(new MigrateToDataStreamDescriptor(name)), cancellationToken);
		...
		public OpenResponse Open(Nest.Indices index, Func<OpenDescriptor, IOpenRequest> selector = null) => Open(selector.InvokeOrDefault(new OpenDescriptor(index)));
		public Task<OpenResponse> OpenAsync(Nest.Indices index, Func<OpenDescriptor, IOpenRequest> selector = null, CancellationToken cancellationToken = default) => OpenAsync(selector.InvokeOrDefault(new OpenDescriptor(index)), cancellationToken);
		...
		public PromoteDataStreamResponse PromoteDataStream(Nest.IndexName name, Func<PromoteDataStreamDescriptor, IPromoteDataStreamRequest> selector = null) => PromoteDataStream(selector.InvokeOrDefault(new PromoteDataStreamDescriptor(name)));
		public Task<PromoteDataStreamResponse> PromoteDataStreamAsync(Nest.IndexName name, Func<PromoteDataStreamDescriptor, IPromoteDataStreamRequest> selector = null, CancellationToken cancellationToken = default) => PromoteDataStreamAsync(selector.InvokeOrDefault(new PromoteDataStreamDescriptor(name)), cancellationToken);
		...
		public PutAliasResponse PutAlias(Nest.Indices index, Nest.Name name, Func<PutAliasDescriptor, IPutAliasRequest> selector = null) => PutAlias(selector.InvokeOrDefault(new PutAliasDescriptor(index, name)));
		public Task<PutAliasResponse> PutAliasAsync(Nest.Indices index, Nest.Name name, Func<PutAliasDescriptor, IPutAliasRequest> selector = null, CancellationToken cancellationToken = default) => PutAliasAsync(selector.InvokeOrDefault(new PutAliasDescriptor(index, name)), cancellationToken);
		...
		public PutIndexTemplateResponse PutIndexTemplate(Nest.Name name, Func<PutIndexTemplateDescriptor, IPutIndexTemplateRequest> selector = null) => PutIndexTemplate(selector.InvokeOrDefault(new PutIndexTemplateDescriptor(name)));
		public Task<PutIndexTemplateResponse> PutIndexTemplateAsync(Nest.Name name, Func<PutIndexTemplateDescriptor, IPutIndexTemplateRequest> selector = null, CancellationToken cancellationToken = default) => PutIndexTemplateAsync(selector.InvokeOrDefault(new PutIndexTemplateDescriptor(name)), cancellationToken);
		...
		public PutMappingResponse PutMapping(Nest.Indices index, Func<PutMappingDescriptor, IPutMappingRequest> selector = null) => PutMapping(selector.InvokeOrDefault(new PutMappingDescriptor(index)));
		public Task<PutMappingResponse> PutMappingAsync(Nest.Indices index, Func<PutMappingDescriptor, IPutMappingRequest> selector = null, CancellationToken cancellationToken = default) => PutMappingAsync(selector.InvokeOrDefault(new PutMappingDescriptor(index)), cancellationToken);
		...
		public PutTemplateResponse PutTemplate(Nest.Name name, Func<PutTemplateDescriptor, IPutTemplateRequest> selector = null) => PutTemplate(selector.InvokeOrDefault(new PutTemplateDescriptor(name)));
		public Task<PutTemplateResponse> PutTemplateAsync(Nest.Name name, Func<PutTemplateDescriptor, IPutTemplateRequest> selector = null, CancellationToken cancellationToken = default) => PutTemplateAsync(selector.InvokeOrDefault(new PutTemplateDescriptor(name)), cancellationToken);
		...
		public ReloadSearchAnalyzersResponse ReloadSearchAnalyzers(Nest.Indices index, Func<ReloadSearchAnalyzersDescriptor, IReloadSearchAnalyzersRequest> selector = null) => ReloadSearchAnalyzers(selector.InvokeOrDefault(new ReloadSearchAnalyzersDescriptor(index)));
		public Task<ReloadSearchAnalyzersResponse> ReloadSearchAnalyzersAsync(Nest.Indices index, Func<ReloadSearchAnalyzersDescriptor, IReloadSearchAnalyzersRequest> selector = null, CancellationToken cancellationToken = default) => ReloadSearchAnalyzersAsync(selector.InvokeOrDefault(new ReloadSearchAnalyzersDescriptor(index)), cancellationToken);
		...
		public ResolveIndexResponse ResolveIndex(Nest.Names name, Func<ResolveIndexDescriptor, IResolveIndexRequest> selector = null) => ResolveIndex(selector.InvokeOrDefault(new ResolveIndexDescriptor(name)));
		public Task<ResolveIndexResponse> ResolveIndexAsync(Nest.Names name, Func<ResolveIndexDescriptor, IResolveIndexRequest> selector = null, CancellationToken cancellationToken = default) => ResolveIndexAsync(selector.InvokeOrDefault(new ResolveIndexDescriptor(name)), cancellationToken);
		...
		public RolloverResponse Rollover(Nest.IndexAlias alias, Func<RolloverDescriptor, IRolloverRequest> selector = null) => Rollover(selector.InvokeOrDefault(new RolloverDescriptor(alias)));
		public Task<RolloverResponse> RolloverAsync(Nest.IndexAlias alias, Func<RolloverDescriptor, IRolloverRequest> selector = null, CancellationToken cancellationToken = default) => RolloverAsync(selector.InvokeOrDefault(new RolloverDescriptor(alias)), cancellationToken);
		...
		public ShrinkResponse Shrink(Nest.IndexName index, Nest.IndexName target, Func<ShrinkDescriptor, IShrinkRequest> selector = null) => Shrink(selector.InvokeOrDefault(new ShrinkDescriptor(index, target)));
		public Task<ShrinkResponse> ShrinkAsync(Nest.IndexName index, Nest.IndexName target, Func<ShrinkDescriptor, IShrinkRequest> selector = null, CancellationToken cancellationToken = default) => ShrinkAsync(selector.InvokeOrDefault(new ShrinkDescriptor(index, target)), cancellationToken);
		...
		public SplitResponse Split(Nest.IndexName index, Nest.IndexName target, Func<SplitDescriptor, ISplitRequest> selector = null) => Split(selector.InvokeOrDefault(new SplitDescriptor(index, target)));
		public Task<SplitResponse> SplitAsync(Nest.IndexName index, Nest.IndexName target, Func<SplitDescriptor, ISplitRequest> selector = null, CancellationToken cancellationToken = default) => SplitAsync(selector.InvokeOrDefault(new SplitDescriptor(index, target)), cancellationToken);
