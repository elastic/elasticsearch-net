...
namespace Nest.Security
{
	public class SecurityNamespace : NamespacedClientProxy
	{
		...
		public ClearApiKeyCacheResponse ClearApiKeyCache(Nest.Ids ids, Func<ClearApiKeyCacheDescriptor, IClearApiKeyCacheRequest> selector = null) => ClearApiKeyCache(selector.InvokeOrDefault(new ClearApiKeyCacheDescriptor(ids)));
		public Task<ClearApiKeyCacheResponse> ClearApiKeyCacheAsync(Nest.Ids ids, Func<ClearApiKeyCacheDescriptor, IClearApiKeyCacheRequest> selector = null, CancellationToken cancellationToken = default) => ClearApiKeyCacheAsync(selector.InvokeOrDefault(new ClearApiKeyCacheDescriptor(ids)), cancellationToken);
		...
		public ClearCachedPrivilegesResponse ClearCachedPrivileges(Nest.Name application, Func<ClearCachedPrivilegesDescriptor, IClearCachedPrivilegesRequest> selector = null) => ClearCachedPrivileges(selector.InvokeOrDefault(new ClearCachedPrivilegesDescriptor(application)));
		public Task<ClearCachedPrivilegesResponse> ClearCachedPrivilegesAsync(Nest.Name application, Func<ClearCachedPrivilegesDescriptor, IClearCachedPrivilegesRequest> selector = null, CancellationToken cancellationToken = default) => ClearCachedPrivilegesAsync(selector.InvokeOrDefault(new ClearCachedPrivilegesDescriptor(application)), cancellationToken);
		...
		public ClearCachedRealmsResponse ClearCachedRealms(Nest.Names realms, Func<ClearCachedRealmsDescriptor, IClearCachedRealmsRequest> selector = null) => ClearCachedRealms(selector.InvokeOrDefault(new ClearCachedRealmsDescriptor(realms)));
		public Task<ClearCachedRealmsResponse> ClearCachedRealmsAsync(Nest.Names realms, Func<ClearCachedRealmsDescriptor, IClearCachedRealmsRequest> selector = null, CancellationToken cancellationToken = default) => ClearCachedRealmsAsync(selector.InvokeOrDefault(new ClearCachedRealmsDescriptor(realms)), cancellationToken);
		...
		public ClearCachedRolesResponse ClearCachedRoles(Nest.Names name, Func<ClearCachedRolesDescriptor, IClearCachedRolesRequest> selector = null) => ClearCachedRoles(selector.InvokeOrDefault(new ClearCachedRolesDescriptor(name)));
		public Task<ClearCachedRolesResponse> ClearCachedRolesAsync(Nest.Names name, Func<ClearCachedRolesDescriptor, IClearCachedRolesRequest> selector = null, CancellationToken cancellationToken = default) => ClearCachedRolesAsync(selector.InvokeOrDefault(new ClearCachedRolesDescriptor(name)), cancellationToken);
		...
		public ClearCachedServiceTokensResponse ClearCachedServiceTokens(Nest.Namespace ns, Nest.Service service, Nest.Names name, Func<ClearCachedServiceTokensDescriptor, IClearCachedServiceTokensRequest> selector = null) => ClearCachedServiceTokens(selector.InvokeOrDefault(new ClearCachedServiceTokensDescriptor(ns, service, name)));
		public Task<ClearCachedServiceTokensResponse> ClearCachedServiceTokensAsync(Nest.Namespace ns, Nest.Service service, Nest.Names name, Func<ClearCachedServiceTokensDescriptor, IClearCachedServiceTokensRequest> selector = null, CancellationToken cancellationToken = default) => ClearCachedServiceTokensAsync(selector.InvokeOrDefault(new ClearCachedServiceTokensDescriptor(ns, service, name)), cancellationToken);
		...
		public CreateServiceTokenResponse CreateServiceToken(Nest.Namespace ns, Nest.Service service, Nest.Name name, Func<CreateServiceTokenDescriptor, ICreateServiceTokenRequest> selector = null) => CreateServiceToken(selector.InvokeOrDefault(new CreateServiceTokenDescriptor(ns, service, name)));
		public CreateServiceTokenResponse CreateServiceToken(Nest.Namespace ns, Nest.Service service, Func<CreateServiceTokenDescriptor, ICreateServiceTokenRequest> selector = null) => CreateServiceToken(selector.InvokeOrDefault(new CreateServiceTokenDescriptor(ns, service)));
		public Task<CreateServiceTokenResponse> CreateServiceTokenAsync(Nest.Namespace ns, Nest.Service service, Nest.Name name, Func<CreateServiceTokenDescriptor, ICreateServiceTokenRequest> selector = null, CancellationToken cancellationToken = default) => CreateServiceTokenAsync(selector.InvokeOrDefault(new CreateServiceTokenDescriptor(ns, service, name)), cancellationToken);
		public Task<CreateServiceTokenResponse> CreateServiceTokenAsync(Nest.Namespace ns, Nest.Service service, Func<CreateServiceTokenDescriptor, ICreateServiceTokenRequest> selector = null, CancellationToken cancellationToken = default) => CreateServiceTokenAsync(selector.InvokeOrDefault(new CreateServiceTokenDescriptor(ns, service)), cancellationToken);
		...
		public DeletePrivilegesResponse DeletePrivileges(Nest.Name application, Nest.Name name, Func<DeletePrivilegesDescriptor, IDeletePrivilegesRequest> selector = null) => DeletePrivileges(selector.InvokeOrDefault(new DeletePrivilegesDescriptor(application, name)));
		public Task<DeletePrivilegesResponse> DeletePrivilegesAsync(Nest.Name application, Nest.Name name, Func<DeletePrivilegesDescriptor, IDeletePrivilegesRequest> selector = null, CancellationToken cancellationToken = default) => DeletePrivilegesAsync(selector.InvokeOrDefault(new DeletePrivilegesDescriptor(application, name)), cancellationToken);
		...
		public DeleteRoleResponse DeleteRole(Nest.Name name, Func<DeleteRoleDescriptor, IDeleteRoleRequest> selector = null) => DeleteRole(selector.InvokeOrDefault(new DeleteRoleDescriptor(name)));
		public Task<DeleteRoleResponse> DeleteRoleAsync(Nest.Name name, Func<DeleteRoleDescriptor, IDeleteRoleRequest> selector = null, CancellationToken cancellationToken = default) => DeleteRoleAsync(selector.InvokeOrDefault(new DeleteRoleDescriptor(name)), cancellationToken);
		...
		public DeleteRoleMappingResponse DeleteRoleMapping(Nest.Name name, Func<DeleteRoleMappingDescriptor, IDeleteRoleMappingRequest> selector = null) => DeleteRoleMapping(selector.InvokeOrDefault(new DeleteRoleMappingDescriptor(name)));
		public Task<DeleteRoleMappingResponse> DeleteRoleMappingAsync(Nest.Name name, Func<DeleteRoleMappingDescriptor, IDeleteRoleMappingRequest> selector = null, CancellationToken cancellationToken = default) => DeleteRoleMappingAsync(selector.InvokeOrDefault(new DeleteRoleMappingDescriptor(name)), cancellationToken);
		...
		public DeleteServiceTokenResponse DeleteServiceToken(Nest.Namespace ns, Nest.Service service, Nest.Name name, Func<DeleteServiceTokenDescriptor, IDeleteServiceTokenRequest> selector = null) => DeleteServiceToken(selector.InvokeOrDefault(new DeleteServiceTokenDescriptor(ns, service, name)));
		public Task<DeleteServiceTokenResponse> DeleteServiceTokenAsync(Nest.Namespace ns, Nest.Service service, Nest.Name name, Func<DeleteServiceTokenDescriptor, IDeleteServiceTokenRequest> selector = null, CancellationToken cancellationToken = default) => DeleteServiceTokenAsync(selector.InvokeOrDefault(new DeleteServiceTokenDescriptor(ns, service, name)), cancellationToken);
		...
		public DeleteUserResponse DeleteUser(Nest.Username username, Func<DeleteUserDescriptor, IDeleteUserRequest> selector = null) => DeleteUser(selector.InvokeOrDefault(new DeleteUserDescriptor(username)));
		public Task<DeleteUserResponse> DeleteUserAsync(Nest.Username username, Func<DeleteUserDescriptor, IDeleteUserRequest> selector = null, CancellationToken cancellationToken = default) => DeleteUserAsync(selector.InvokeOrDefault(new DeleteUserDescriptor(username)), cancellationToken);
		...
		public DisableUserResponse DisableUser(Nest.Username username, Func<DisableUserDescriptor, IDisableUserRequest> selector = null) => DisableUser(selector.InvokeOrDefault(new DisableUserDescriptor(username)));
		public Task<DisableUserResponse> DisableUserAsync(Nest.Username username, Func<DisableUserDescriptor, IDisableUserRequest> selector = null, CancellationToken cancellationToken = default) => DisableUserAsync(selector.InvokeOrDefault(new DisableUserDescriptor(username)), cancellationToken);
		...
		public EnableUserResponse EnableUser(Nest.Username username, Func<EnableUserDescriptor, IEnableUserRequest> selector = null) => EnableUser(selector.InvokeOrDefault(new EnableUserDescriptor(username)));
		public Task<EnableUserResponse> EnableUserAsync(Nest.Username username, Func<EnableUserDescriptor, IEnableUserRequest> selector = null, CancellationToken cancellationToken = default) => EnableUserAsync(selector.InvokeOrDefault(new EnableUserDescriptor(username)), cancellationToken);
		...
		public GetServiceCredentialsResponse GetServiceCredentials(Nest.Namespace ns, Nest.Name service, Func<GetServiceCredentialsDescriptor, IGetServiceCredentialsRequest> selector = null) => GetServiceCredentials(selector.InvokeOrDefault(new GetServiceCredentialsDescriptor(ns, service)));
		public Task<GetServiceCredentialsResponse> GetServiceCredentialsAsync(Nest.Namespace ns, Nest.Name service, Func<GetServiceCredentialsDescriptor, IGetServiceCredentialsRequest> selector = null, CancellationToken cancellationToken = default) => GetServiceCredentialsAsync(selector.InvokeOrDefault(new GetServiceCredentialsDescriptor(ns, service)), cancellationToken);
		...
		public PutRoleResponse PutRole(Nest.Name name, Func<PutRoleDescriptor, IPutRoleRequest> selector = null) => PutRole(selector.InvokeOrDefault(new PutRoleDescriptor(name)));
		public Task<PutRoleResponse> PutRoleAsync(Nest.Name name, Func<PutRoleDescriptor, IPutRoleRequest> selector = null, CancellationToken cancellationToken = default) => PutRoleAsync(selector.InvokeOrDefault(new PutRoleDescriptor(name)), cancellationToken);
		...
		public PutRoleMappingResponse PutRoleMapping(Nest.Name name, Func<PutRoleMappingDescriptor, IPutRoleMappingRequest> selector = null) => PutRoleMapping(selector.InvokeOrDefault(new PutRoleMappingDescriptor(name)));
		public Task<PutRoleMappingResponse> PutRoleMappingAsync(Nest.Name name, Func<PutRoleMappingDescriptor, IPutRoleMappingRequest> selector = null, CancellationToken cancellationToken = default) => PutRoleMappingAsync(selector.InvokeOrDefault(new PutRoleMappingDescriptor(name)), cancellationToken);
		...
		public PutUserResponse PutUser(Nest.Username username, Func<PutUserDescriptor, IPutUserRequest> selector = null) => PutUser(selector.InvokeOrDefault(new PutUserDescriptor(username)));
		public Task<PutUserResponse> PutUserAsync(Nest.Username username, Func<PutUserDescriptor, IPutUserRequest> selector = null, CancellationToken cancellationToken = default) => PutUserAsync(selector.InvokeOrDefault(new PutUserDescriptor(username)), cancellationToken);
	}
}