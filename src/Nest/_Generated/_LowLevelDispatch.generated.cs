...
namespace Nest
{
	...
	{
		internal ElasticsearchResponse<T> BulkDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> BulkDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> CatAliasesDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> CatAliasesDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> CatAllocationDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> CatAllocationDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> CatCountDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> CatCountDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> CatFielddataDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> CatFielddataDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> CatHealthDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> CatHealthDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> CatHelpDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> CatHelpDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> CatIndicesDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> CatIndicesDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> CatMasterDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> CatMasterDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> CatNodeattrsDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> CatNodeattrsDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> CatNodesDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> CatNodesDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> CatPendingTasksDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> CatPendingTasksDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> CatPluginsDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> CatPluginsDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> CatRecoveryDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> CatRecoveryDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> CatSegmentsDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> CatSegmentsDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> CatShardsDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> CatShardsDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> CatThreadPoolDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> CatThreadPoolDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> ClearScrollDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal Task<ElasticsearchResponse<T>> ClearScrollDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal ElasticsearchResponse<T> ClusterGetSettingsDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> ClusterGetSettingsDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> ClusterHealthDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> ClusterHealthDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> ClusterPendingTasksDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> ClusterPendingTasksDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> ClusterPutSettingsDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal Task<ElasticsearchResponse<T>> ClusterPutSettingsDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal ElasticsearchResponse<T> ClusterRerouteDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> ClusterRerouteDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> ClusterStateDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> ClusterStateDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> ClusterStatsDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> ClusterStatsDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> CountDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> CountDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> CountPercolateDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> CountPercolateDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> DeleteDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal Task<ElasticsearchResponse<T>> DeleteDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal ElasticsearchResponse<T> DeleteByQueryDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal Task<ElasticsearchResponse<T>> DeleteByQueryDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal ElasticsearchResponse<T> DeleteScriptDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal Task<ElasticsearchResponse<T>> DeleteScriptDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal ElasticsearchResponse<T> DeleteTemplateDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal Task<ElasticsearchResponse<T>> DeleteTemplateDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal ElasticsearchResponse<T> ExistsDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case HEAD:
		...
		internal Task<ElasticsearchResponse<T>> ExistsDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case HEAD:
		...
		internal ElasticsearchResponse<T> ExplainDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> ExplainDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> FieldStatsDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> FieldStatsDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> GetDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> GetDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> GetScriptDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> GetScriptDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> GetSourceDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> GetSourceDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> GetTemplateDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> GetTemplateDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> IndexDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> IndexDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> IndicesAnalyzeDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> IndicesAnalyzeDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> IndicesClearCacheDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> IndicesClearCacheDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> IndicesCloseDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> IndicesCloseDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> IndicesCreateDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal Task<ElasticsearchResponse<T>> IndicesCreateDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal ElasticsearchResponse<T> IndicesDeleteDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal Task<ElasticsearchResponse<T>> IndicesDeleteDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal ElasticsearchResponse<T> IndicesDeleteAliasDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal Task<ElasticsearchResponse<T>> IndicesDeleteAliasDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal ElasticsearchResponse<T> IndicesDeleteTemplateDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal Task<ElasticsearchResponse<T>> IndicesDeleteTemplateDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal ElasticsearchResponse<T> IndicesDeleteWarmerDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal Task<ElasticsearchResponse<T>> IndicesDeleteWarmerDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal ElasticsearchResponse<T> IndicesExistsDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case HEAD:
		...
		internal Task<ElasticsearchResponse<T>> IndicesExistsDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case HEAD:
		...
		internal ElasticsearchResponse<T> IndicesExistsAliasDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case HEAD:
		...
		internal Task<ElasticsearchResponse<T>> IndicesExistsAliasDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case HEAD:
		...
		internal ElasticsearchResponse<T> IndicesExistsTemplateDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case HEAD:
		...
		internal Task<ElasticsearchResponse<T>> IndicesExistsTemplateDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case HEAD:
		...
		internal ElasticsearchResponse<T> IndicesExistsTypeDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case HEAD:
		...
		internal Task<ElasticsearchResponse<T>> IndicesExistsTypeDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case HEAD:
		...
		internal ElasticsearchResponse<T> IndicesFlushDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> IndicesFlushDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> IndicesFlushSyncedDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> IndicesFlushSyncedDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> IndicesGetDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> IndicesGetDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> IndicesGetAliasDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> IndicesGetAliasDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> IndicesGetAliasesDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> IndicesGetAliasesDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> IndicesGetFieldMappingDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> IndicesGetFieldMappingDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> IndicesGetMappingDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> IndicesGetMappingDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> IndicesGetSettingsDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> IndicesGetSettingsDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> IndicesGetTemplateDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> IndicesGetTemplateDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> IndicesGetUpgradeDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> IndicesGetUpgradeDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> IndicesGetWarmerDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> IndicesGetWarmerDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> IndicesOpenDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> IndicesOpenDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> IndicesOptimizeDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> IndicesOptimizeDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> IndicesPutAliasDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal Task<ElasticsearchResponse<T>> IndicesPutAliasDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal ElasticsearchResponse<T> IndicesPutMappingDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal Task<ElasticsearchResponse<T>> IndicesPutMappingDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal ElasticsearchResponse<T> IndicesPutSettingsDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal Task<ElasticsearchResponse<T>> IndicesPutSettingsDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal ElasticsearchResponse<T> IndicesPutTemplateDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal Task<ElasticsearchResponse<T>> IndicesPutTemplateDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal ElasticsearchResponse<T> IndicesPutWarmerDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal Task<ElasticsearchResponse<T>> IndicesPutWarmerDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal ElasticsearchResponse<T> IndicesRecoveryDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> IndicesRecoveryDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> IndicesRefreshDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> IndicesRefreshDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> IndicesSegmentsDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> IndicesSegmentsDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> IndicesShardStoresDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> IndicesShardStoresDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> IndicesStatsDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> IndicesStatsDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> IndicesUpdateAliasesDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> IndicesUpdateAliasesDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> IndicesUpgradeDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> IndicesUpgradeDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> IndicesValidateQueryDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> IndicesValidateQueryDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> InfoDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> InfoDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> MgetDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> MgetDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> MpercolateDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> MpercolateDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> MsearchDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> MsearchDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> MtermvectorsDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> MtermvectorsDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> NodesHotThreadsDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> NodesHotThreadsDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> NodesInfoDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> NodesInfoDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> NodesStatsDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> NodesStatsDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> PercolateDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> PercolateDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> PingDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case HEAD:
		...
		internal Task<ElasticsearchResponse<T>> PingDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case HEAD:
		...
		internal ElasticsearchResponse<T> PutScriptDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal Task<ElasticsearchResponse<T>> PutScriptDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal ElasticsearchResponse<T> PutTemplateDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal Task<ElasticsearchResponse<T>> PutTemplateDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal ElasticsearchResponse<T> RenderSearchTemplateDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> RenderSearchTemplateDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> ScrollDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> ScrollDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> SearchDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> SearchDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> SearchExistsDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> SearchExistsDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> SearchShardsDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> SearchShardsDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> SearchTemplateDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> SearchTemplateDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> SnapshotCreateDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal Task<ElasticsearchResponse<T>> SnapshotCreateDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal ElasticsearchResponse<T> SnapshotCreateRepositoryDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal Task<ElasticsearchResponse<T>> SnapshotCreateRepositoryDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal ElasticsearchResponse<T> SnapshotDeleteDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal Task<ElasticsearchResponse<T>> SnapshotDeleteDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal ElasticsearchResponse<T> SnapshotDeleteRepositoryDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal Task<ElasticsearchResponse<T>> SnapshotDeleteRepositoryDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal ElasticsearchResponse<T> SnapshotGetDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> SnapshotGetDispatchAsync<T>(IRequest<SnapshotRequestParameters> p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
					if (AllSet(p.RouteValues.Repository, p.Snapshot)) return _lowLevel.SnapshotGetAsync<T>(p.Repository,p.Snapshot,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> SnapshotGetRepositoryDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> SnapshotGetRepositoryDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> SnapshotRestoreDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> SnapshotRestoreDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> SnapshotStatusDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> SnapshotStatusDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> SnapshotVerifyRepositoryDispatch<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> SnapshotVerifyRepositoryDispatchAsync<T>(RequestPath p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> SuggestDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> SuggestDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> TermvectorsDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> TermvectorsDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> UpdateDispatch<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> UpdateDispatchAsync<T>(RequestPath p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
