...
namespace Nest
{
	...
	internal partial class LowLevelDispatch
	{
		...
		internal ElasticsearchResponse<T> XpackMigrationDeprecationsDispatch<T>(IRequest<DeprecationInfoRequestParameters> p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
					if (AllSet(p.RouteValues.Index)) return _lowLevel.XpackMigrationDeprecations<T>(p.RouteValues.Index,u => p.RequestParameters);
					return _lowLevel.XpackMigrationDeprecations<T>(u => p.RequestParameters);
		...
		internal Task<ElasticsearchResponse<T>> XpackMigrationDeprecationsDispatchAsync<T>(IRequest<DeprecationInfoRequestParameters> p , CancellationToken cancellationToken) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
					if (AllSet(p.RouteValues.Index)) return _lowLevel.XpackMigrationDeprecationsAsync<T>(p.RouteValues.Index,u => p.RequestParameters,cancellationToken);
					return _lowLevel.XpackMigrationDeprecationsAsync<T>(u => p.RequestParameters,cancellationToken);

			}
			throw InvalidDispatch("XpackMigrationDeprecations", p, new [] { GET }, "/_xpack/migration/deprecations", "/{index}/_xpack/migration/deprecations");
		}
		
		internal ElasticsearchResponse<T> XpackMigrationGetAssistanceDispatch<T>(IRequest<MigrationAssistanceRequestParameters> p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
					if (AllSet(p.RouteValues.Index)) return _lowLevel.XpackMigrationGetAssistance<T>(p.RouteValues.Index,u => p.RequestParameters);
					return _lowLevel.XpackMigrationGetAssistance<T>(u => p.RequestParameters);
		...
		internal Task<ElasticsearchResponse<T>> XpackMigrationGetAssistanceDispatchAsync<T>(IRequest<MigrationAssistanceRequestParameters> p , CancellationToken cancellationToken) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
					if (AllSet(p.RouteValues.Index)) return _lowLevel.XpackMigrationGetAssistanceAsync<T>(p.RouteValues.Index,u => p.RequestParameters,cancellationToken);
					return _lowLevel.XpackMigrationGetAssistanceAsync<T>(u => p.RequestParameters,cancellationToken);

			}
			throw InvalidDispatch("XpackMigrationGetAssistance", p, new [] { GET }, "/_xpack/migration/assistance", "/_xpack/migration/assistance/{index}");
		}
		
		internal ElasticsearchResponse<T> XpackMigrationUpgradeDispatch<T>(IRequest<MigrationUpgradeRequestParameters> p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
					if (AllSetNoFallback(p.RouteValues.Index)) return _lowLevel.XpackMigrationUpgrade<T>(p.RouteValues.Index,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> XpackMigrationUpgradeDispatchAsync<T>(IRequest<MigrationUpgradeRequestParameters> p , CancellationToken cancellationToken) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
					if (AllSetNoFallback(p.RouteValues.Index)) return _lowLevel.XpackMigrationUpgradeAsync<T>(p.RouteValues.Index,u => p.RequestParameters,cancellationToken);
					break;
