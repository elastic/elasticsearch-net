...
namespace Nest
{
	...
	{
		internal ElasticsearchResponse<T> BulkDispatch<T>(IRequest<BulkRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> BulkDispatchAsync<T>(IRequest<BulkRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> ClearScrollDispatch<T>(IRequest<ClearScrollRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal Task<ElasticsearchResponse<T>> ClearScrollDispatchAsync<T>(IRequest<ClearScrollRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal ElasticsearchResponse<T> ClusterRerouteDispatch<T>(IRequest<ClusterRerouteRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> ClusterRerouteDispatchAsync<T>(IRequest<ClusterRerouteRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> CountDispatch<T>(IRequest<CountRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> CountDispatchAsync<T>(IRequest<CountRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> CountPercolateDispatch<T>(IRequest<PercolateCountRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
					...
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type)) return _lowLevel.CountPercolateGet<T>(p.RouteValues.Index,p.RouteValues.Type,u => p.RequestParameters);
					break;
				...
				case POST:
					...
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type)) return _lowLevel.CountPercolate<T>(p.RouteValues.Index,p.RouteValues.Type,body,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> CountPercolateDispatchAsync<T>(IRequest<PercolateCountRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
					...
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type)) return _lowLevel.CountPercolateGetAsync<T>(p.RouteValues.Index,p.RouteValues.Type,u => p.RequestParameters);
					break;
				...
				case POST:
					...
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type)) return _lowLevel.CountPercolateAsync<T>(p.RouteValues.Index,p.RouteValues.Type,body,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> DeleteDispatch<T>(IRequest<DeleteRequestParameters> p ) where T : class
		{
			...
			{
				case DELETE:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type, p.RouteValues.Id)) return _lowLevel.Delete<T>(p.RouteValues.Index,p.RouteValues.Type,p.RouteValues.Id,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> DeleteDispatchAsync<T>(IRequest<DeleteRequestParameters> p ) where T : class
		{
			...
			{
				case DELETE:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type, p.RouteValues.Id)) return _lowLevel.DeleteAsync<T>(p.RouteValues.Index,p.RouteValues.Type,p.RouteValues.Id,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> DeleteByQueryDispatch<T>(IRequest<DeleteByQueryRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
					...
					if (AllSet(p.RouteValues.Index)) return _lowLevel.DeleteByQuery<T>(p.RouteValues.Index,body,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> DeleteByQueryDispatchAsync<T>(IRequest<DeleteByQueryRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
					...
					if (AllSet(p.RouteValues.Index)) return _lowLevel.DeleteByQueryAsync<T>(p.RouteValues.Index,body,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> DeleteScriptDispatch<T>(IRequest<DeleteScriptRequestParameters> p ) where T : class
		{
			...
			{
				case DELETE:
					if (AllSet(p.RouteValues.Lang, p.RouteValues.Id)) return _lowLevel.DeleteScript<T>(p.RouteValues.Lang,p.RouteValues.Id,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> DeleteScriptDispatchAsync<T>(IRequest<DeleteScriptRequestParameters> p ) where T : class
		{
			...
			{
				case DELETE:
					if (AllSet(p.RouteValues.Lang, p.RouteValues.Id)) return _lowLevel.DeleteScriptAsync<T>(p.RouteValues.Lang,p.RouteValues.Id,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> DeleteTemplateDispatch<T>(IRequest<DeleteTemplateRequestParameters> p ) where T : class
		{
			...
			{
				case DELETE:
					if (AllSet(p.RouteValues.Id)) return _lowLevel.DeleteTemplate<T>(p.RouteValues.Id,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> DeleteTemplateDispatchAsync<T>(IRequest<DeleteTemplateRequestParameters> p ) where T : class
		{
			...
			{
				case DELETE:
					if (AllSet(p.RouteValues.Id)) return _lowLevel.DeleteTemplateAsync<T>(p.RouteValues.Id,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> ExistsDispatch<T>(IRequest<DocumentExistsRequestParameters> p ) where T : class
		{
			...
			{
				case HEAD:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type, p.RouteValues.Id)) return _lowLevel.Exists<T>(p.RouteValues.Index,p.RouteValues.Type,p.RouteValues.Id,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> ExistsDispatchAsync<T>(IRequest<DocumentExistsRequestParameters> p ) where T : class
		{
			...
			{
				case HEAD:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type, p.RouteValues.Id)) return _lowLevel.ExistsAsync<T>(p.RouteValues.Index,p.RouteValues.Type,p.RouteValues.Id,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> ExplainDispatch<T>(IRequest<ExplainRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type, p.RouteValues.Id)) return _lowLevel.ExplainGet<T>(p.RouteValues.Index,p.RouteValues.Type,p.RouteValues.Id,u => p.RequestParameters);
					break;

				case POST:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type, p.RouteValues.Id)) return _lowLevel.Explain<T>(p.RouteValues.Index,p.RouteValues.Type,p.RouteValues.Id,body,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> ExplainDispatchAsync<T>(IRequest<ExplainRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type, p.RouteValues.Id)) return _lowLevel.ExplainGetAsync<T>(p.RouteValues.Index,p.RouteValues.Type,p.RouteValues.Id,u => p.RequestParameters);
					break;

				case POST:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type, p.RouteValues.Id)) return _lowLevel.ExplainAsync<T>(p.RouteValues.Index,p.RouteValues.Type,p.RouteValues.Id,body,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> FieldStatsDispatch<T>(IRequest<FieldStatsRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> FieldStatsDispatchAsync<T>(IRequest<FieldStatsRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> GetDispatch<T>(IRequest<GetRequestParameters> p ) where T : class
		{
			...
			{
				case GET:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type, p.RouteValues.Id)) return _lowLevel.Get<T>(p.RouteValues.Index,p.RouteValues.Type,p.RouteValues.Id,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> GetDispatchAsync<T>(IRequest<GetRequestParameters> p ) where T : class
		{
			...
			{
				case GET:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type, p.RouteValues.Id)) return _lowLevel.GetAsync<T>(p.RouteValues.Index,p.RouteValues.Type,p.RouteValues.Id,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> GetScriptDispatch<T>(IRequest<GetScriptRequestParameters> p ) where T : class
		{
			...
			{
				case GET:
					if (AllSet(p.RouteValues.Lang, p.RouteValues.Id)) return _lowLevel.GetScript<T>(p.RouteValues.Lang,p.RouteValues.Id,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> GetScriptDispatchAsync<T>(IRequest<GetScriptRequestParameters> p ) where T : class
		{
			...
			{
				case GET:
					if (AllSet(p.RouteValues.Lang, p.RouteValues.Id)) return _lowLevel.GetScriptAsync<T>(p.RouteValues.Lang,p.RouteValues.Id,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> GetSourceDispatch<T>(IRequest<SourceRequestParameters> p ) where T : class
		{
			...
			{
				case GET:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type, p.RouteValues.Id)) return _lowLevel.GetSource<T>(p.RouteValues.Index,p.RouteValues.Type,p.RouteValues.Id,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> GetSourceDispatchAsync<T>(IRequest<SourceRequestParameters> p ) where T : class
		{
			...
			{
				case GET:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type, p.RouteValues.Id)) return _lowLevel.GetSourceAsync<T>(p.RouteValues.Index,p.RouteValues.Type,p.RouteValues.Id,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> GetTemplateDispatch<T>(IRequest<GetTemplateRequestParameters> p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
					if (AllSet(p.RouteValues.Id)) return _lowLevel.GetTemplate<T>(p.RouteValues.Id,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> GetTemplateDispatchAsync<T>(IRequest<GetTemplateRequestParameters> p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
					if (AllSet(p.RouteValues.Id)) return _lowLevel.GetTemplateAsync<T>(p.RouteValues.Id,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> IndexDispatch<T>(IRequest<IndexRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
					...
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type)) return _lowLevel.Index<T>(p.RouteValues.Index,p.RouteValues.Type,body,u => p.RequestParameters);
					break;
				...
				case PUT:
					...
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type)) return _lowLevel.IndexPut<T>(p.RouteValues.Index,p.RouteValues.Type,body,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> IndexDispatchAsync<T>(IRequest<IndexRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
					...
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type)) return _lowLevel.IndexAsync<T>(p.RouteValues.Index,p.RouteValues.Type,body,u => p.RequestParameters);
					break;
				...
				case PUT:
					...
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type)) return _lowLevel.IndexPutAsync<T>(p.RouteValues.Index,p.RouteValues.Type,body,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> IndicesAnalyzeDispatch<T>(IRequest<AnalyzeRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> IndicesAnalyzeDispatchAsync<T>(IRequest<AnalyzeRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> IndicesCloseDispatch<T>(IRequest<CloseIndexRequestParameters> p ) where T : class
		{
			...
			{
				case POST:
					if (AllSet(p.RouteValues.Index)) return _lowLevel.IndicesClose<T>(p.RouteValues.Index,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> IndicesCloseDispatchAsync<T>(IRequest<CloseIndexRequestParameters> p ) where T : class
		{
			...
			{
				case POST:
					if (AllSet(p.RouteValues.Index)) return _lowLevel.IndicesCloseAsync<T>(p.RouteValues.Index,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> IndicesCreateDispatch<T>(IRequest<CreateIndexRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
					if (AllSet(p.RouteValues.Index)) return _lowLevel.IndicesCreate<T>(p.RouteValues.Index,body,u => p.RequestParameters);
					break;

				case POST:
					if (AllSet(p.RouteValues.Index)) return _lowLevel.IndicesCreatePost<T>(p.RouteValues.Index,body,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> IndicesCreateDispatchAsync<T>(IRequest<CreateIndexRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
					if (AllSet(p.RouteValues.Index)) return _lowLevel.IndicesCreateAsync<T>(p.RouteValues.Index,body,u => p.RequestParameters);
					break;

				case POST:
					if (AllSet(p.RouteValues.Index)) return _lowLevel.IndicesCreatePostAsync<T>(p.RouteValues.Index,body,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> IndicesDeleteDispatch<T>(IRequest<DeleteIndexRequestParameters> p ) where T : class
		{
			...
			{
				case DELETE:
					if (AllSet(p.RouteValues.Index)) return _lowLevel.IndicesDelete<T>(p.RouteValues.Index,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> IndicesDeleteDispatchAsync<T>(IRequest<DeleteIndexRequestParameters> p ) where T : class
		{
			...
			{
				case DELETE:
					if (AllSet(p.RouteValues.Index)) return _lowLevel.IndicesDeleteAsync<T>(p.RouteValues.Index,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> IndicesDeleteAliasDispatch<T>(IRequest<DeleteAliasRequestParameters> p ) where T : class
		{
			...
			{
				case DELETE:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Name)) return _lowLevel.IndicesDeleteAlias<T>(p.RouteValues.Index,p.RouteValues.Name,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> IndicesDeleteAliasDispatchAsync<T>(IRequest<DeleteAliasRequestParameters> p ) where T : class
		{
			...
			{
				case DELETE:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Name)) return _lowLevel.IndicesDeleteAliasAsync<T>(p.RouteValues.Index,p.RouteValues.Name,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> IndicesDeleteTemplateDispatch<T>(IRequest<DeleteTemplateRequestParameters> p ) where T : class
		{
			...
			{
				case DELETE:
					if (AllSet(p.RouteValues.Name)) return _lowLevel.IndicesDeleteTemplateForAll<T>(p.RouteValues.Name,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> IndicesDeleteTemplateDispatchAsync<T>(IRequest<DeleteTemplateRequestParameters> p ) where T : class
		{
			...
			{
				case DELETE:
					if (AllSet(p.RouteValues.Name)) return _lowLevel.IndicesDeleteTemplateForAllAsync<T>(p.RouteValues.Name,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> IndicesDeleteWarmerDispatch<T>(IRequest<DeleteWarmerRequestParameters> p ) where T : class
		{
			...
			{
				case DELETE:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Name)) return _lowLevel.IndicesDeleteWarmer<T>(p.RouteValues.Index,p.RouteValues.Name,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> IndicesDeleteWarmerDispatchAsync<T>(IRequest<DeleteWarmerRequestParameters> p ) where T : class
		{
			...
			{
				case DELETE:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Name)) return _lowLevel.IndicesDeleteWarmerAsync<T>(p.RouteValues.Index,p.RouteValues.Name,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> IndicesExistsDispatch<T>(IRequest<IndexExistsRequestParameters> p ) where T : class
		{
			...
			{
				case HEAD:
					if (AllSet(p.RouteValues.Index)) return _lowLevel.IndicesExists<T>(p.RouteValues.Index,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> IndicesExistsDispatchAsync<T>(IRequest<IndexExistsRequestParameters> p ) where T : class
		{
			...
			{
				case HEAD:
					if (AllSet(p.RouteValues.Index)) return _lowLevel.IndicesExistsAsync<T>(p.RouteValues.Index,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> IndicesExistsTemplateDispatchAsync<T>(IRequest<TemplateExistsRequestParameters> p ) where T : class
		{
			...
			{
				case HEAD:
					if (AllSet(p.RouteValues.Name)) return _lowLevel.IndicesExistsTemplateForAllAsync<T>(p.RouteValues.Name,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> IndicesExistsTypeDispatch<T>(IRequest<TypeExistsRequestParameters> p ) where T : class
		{
			...
			{
				case HEAD:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type)) return _lowLevel.IndicesExistsType<T>(p.RouteValues.Index,p.RouteValues.Type,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> IndicesExistsTypeDispatchAsync<T>(IRequest<TypeExistsRequestParameters> p ) where T : class
		{
			...
			{
				case HEAD:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type)) return _lowLevel.IndicesExistsTypeAsync<T>(p.RouteValues.Index,p.RouteValues.Type,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> IndicesGetDispatch<T>(IRequest<GetIndexRequestParameters> p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
					...
					if (AllSet(p.RouteValues.Index)) return _lowLevel.IndicesGet<T>(p.RouteValues.Index,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> IndicesGetDispatchAsync<T>(IRequest<GetIndexRequestParameters> p ) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
					...
					if (AllSet(p.RouteValues.Index)) return _lowLevel.IndicesGetAsync<T>(p.RouteValues.Index,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> IndicesOpenDispatch<T>(IRequest<OpenIndexRequestParameters> p ) where T : class
		{
			...
			{
				case POST:
					if (AllSet(p.RouteValues.Index)) return _lowLevel.IndicesOpen<T>(p.RouteValues.Index,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> IndicesOpenDispatchAsync<T>(IRequest<OpenIndexRequestParameters> p ) where T : class
		{
			...
			{
				case POST:
					if (AllSet(p.RouteValues.Index)) return _lowLevel.IndicesOpenAsync<T>(p.RouteValues.Index,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> IndicesPutAliasDispatch<T>(IRequest<PutAliasRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Name)) return _lowLevel.IndicesPutAlias<T>(p.RouteValues.Index,p.RouteValues.Name,body,u => p.RequestParameters);
					break;

				case POST:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Name)) return _lowLevel.IndicesPutAliasPost<T>(p.RouteValues.Index,p.RouteValues.Name,body,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> IndicesPutAliasDispatchAsync<T>(IRequest<PutAliasRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Name)) return _lowLevel.IndicesPutAliasAsync<T>(p.RouteValues.Index,p.RouteValues.Name,body,u => p.RequestParameters);
					break;

				case POST:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Name)) return _lowLevel.IndicesPutAliasPostAsync<T>(p.RouteValues.Index,p.RouteValues.Name,body,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> IndicesPutMappingDispatch<T>(IRequest<PutMappingRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
					...
					if (AllSet(p.RouteValues.Type)) return _lowLevel.IndicesPutMappingForAll<T>(p.RouteValues.Type,body,u => p.RequestParameters);
					break;
				...
				case POST:
					...
					if (AllSet(p.RouteValues.Type)) return _lowLevel.IndicesPutMappingPostForAll<T>(p.RouteValues.Type,body,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> IndicesPutMappingDispatchAsync<T>(IRequest<PutMappingRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
					...
					if (AllSet(p.RouteValues.Type)) return _lowLevel.IndicesPutMappingForAllAsync<T>(p.RouteValues.Type,body,u => p.RequestParameters);
					break;
				...
				case POST:
					...
					if (AllSet(p.RouteValues.Type)) return _lowLevel.IndicesPutMappingPostForAllAsync<T>(p.RouteValues.Type,body,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> IndicesPutTemplateDispatch<T>(IRequest<PutTemplateRequestParameters> p , object body) where T : class
		{
			...
			{
				case PUT:
					if (AllSet(p.RouteValues.Name)) return _lowLevel.IndicesPutTemplateForAll<T>(p.RouteValues.Name,body,u => p.RequestParameters);
					break;

				case POST:
					if (AllSet(p.RouteValues.Name)) return _lowLevel.IndicesPutTemplatePostForAll<T>(p.RouteValues.Name,body,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> IndicesPutTemplateDispatchAsync<T>(IRequest<PutTemplateRequestParameters> p , object body) where T : class
		{
			...
			{
				case PUT:
					if (AllSet(p.RouteValues.Name)) return _lowLevel.IndicesPutTemplateForAllAsync<T>(p.RouteValues.Name,body,u => p.RequestParameters);
					break;

				case POST:
					if (AllSet(p.RouteValues.Name)) return _lowLevel.IndicesPutTemplatePostForAllAsync<T>(p.RouteValues.Name,body,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> IndicesPutWarmerDispatch<T>(IRequest<PutWarmerRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
					...
					if (AllSet(p.RouteValues.Name)) return _lowLevel.IndicesPutWarmerForAll<T>(p.RouteValues.Name,body,u => p.RequestParameters);
					break;
				...
				case POST:
					...
					if (AllSet(p.RouteValues.Name)) return _lowLevel.IndicesPutWarmerPostForAll<T>(p.RouteValues.Name,body,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> IndicesPutWarmerDispatchAsync<T>(IRequest<PutWarmerRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
					...
					if (AllSet(p.RouteValues.Name)) return _lowLevel.IndicesPutWarmerForAllAsync<T>(p.RouteValues.Name,body,u => p.RequestParameters);
					break;
				...
				case POST:
					...
					if (AllSet(p.RouteValues.Name)) return _lowLevel.IndicesPutWarmerPostForAllAsync<T>(p.RouteValues.Name,body,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> IndicesUpdateAliasesDispatch<T>(IRequest<BulkAliasRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> IndicesUpdateAliasesDispatchAsync<T>(IRequest<BulkAliasRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> IndicesValidateQueryDispatch<T>(IRequest<ValidateQueryRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> IndicesValidateQueryDispatchAsync<T>(IRequest<ValidateQueryRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> MgetDispatch<T>(IRequest<MultiGetRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> MgetDispatchAsync<T>(IRequest<MultiGetRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> MpercolateDispatch<T>(IRequest<MultiPercolateRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> MpercolateDispatchAsync<T>(IRequest<MultiPercolateRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> MsearchDispatch<T>(IRequest<MultiSearchRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> MsearchDispatchAsync<T>(IRequest<MultiSearchRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> MtermvectorsDispatch<T>(IRequest<MultiTermVectorsRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> MtermvectorsDispatchAsync<T>(IRequest<MultiTermVectorsRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> PercolateDispatch<T>(IRequest<PercolateRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
					...
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type)) return _lowLevel.PercolateGet<T>(p.RouteValues.Index,p.RouteValues.Type,u => p.RequestParameters);
					break;
				...
				case POST:
					...
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type)) return _lowLevel.Percolate<T>(p.RouteValues.Index,p.RouteValues.Type,body,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> PercolateDispatchAsync<T>(IRequest<PercolateRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
					...
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type)) return _lowLevel.PercolateGetAsync<T>(p.RouteValues.Index,p.RouteValues.Type,u => p.RequestParameters);
					break;
				...
				case POST:
					...
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type)) return _lowLevel.PercolateAsync<T>(p.RouteValues.Index,p.RouteValues.Type,body,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> PutScriptDispatch<T>(IRequest<PutScriptRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
					if (AllSet(p.RouteValues.Lang, p.RouteValues.Id)) return _lowLevel.PutScript<T>(p.RouteValues.Lang,p.RouteValues.Id,body,u => p.RequestParameters);
					break;

				case POST:
					if (AllSet(p.RouteValues.Lang, p.RouteValues.Id)) return _lowLevel.PutScriptPost<T>(p.RouteValues.Lang,p.RouteValues.Id,body,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> PutScriptDispatchAsync<T>(IRequest<PutScriptRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
					if (AllSet(p.RouteValues.Lang, p.RouteValues.Id)) return _lowLevel.PutScriptAsync<T>(p.RouteValues.Lang,p.RouteValues.Id,body,u => p.RequestParameters);
					break;

				case POST:
					if (AllSet(p.RouteValues.Lang, p.RouteValues.Id)) return _lowLevel.PutScriptPostAsync<T>(p.RouteValues.Lang,p.RouteValues.Id,body,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> PutTemplateDispatch<T>(IRequest<PutTemplateRequestParameters> p , object body) where T : class
		{
			...
			{
				case PUT:
					if (AllSet(p.RouteValues.Id)) return _lowLevel.PutTemplate<T>(p.RouteValues.Id,body,u => p.RequestParameters);
					break;

				case POST:
					if (AllSet(p.RouteValues.Id)) return _lowLevel.PutTemplatePost<T>(p.RouteValues.Id,body,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> PutTemplateDispatchAsync<T>(IRequest<PutTemplateRequestParameters> p , object body) where T : class
		{
			...
			{
				case PUT:
					if (AllSet(p.RouteValues.Id)) return _lowLevel.PutTemplateAsync<T>(p.RouteValues.Id,body,u => p.RequestParameters);
					break;

				case POST:
					if (AllSet(p.RouteValues.Id)) return _lowLevel.PutTemplatePostAsync<T>(p.RouteValues.Id,body,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> RenderSearchTemplateDispatch<T>(IRequest<RenderSearchTemplateRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> RenderSearchTemplateDispatchAsync<T>(IRequest<RenderSearchTemplateRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> ScrollDispatch<T>(IRequest<ScrollRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> ScrollDispatchAsync<T>(IRequest<ScrollRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> SearchDispatch<T>(IRequest<SearchRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> SearchDispatchAsync<T>(IRequest<SearchRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> SearchExistsDispatch<T>(IRequest<SearchExistsRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> SearchExistsDispatchAsync<T>(IRequest<SearchExistsRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> SearchTemplateDispatch<T>(IRequest<SearchTemplateRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> SearchTemplateDispatchAsync<T>(IRequest<SearchTemplateRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal ElasticsearchResponse<T> SnapshotCreateDispatch<T>(IRequest<SnapshotRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
					if (AllSet(p.RouteValues.Repository, p.RouteValues.Snapshot)) return _lowLevel.SnapshotCreate<T>(p.RouteValues.Repository,p.RouteValues.Snapshot,body,u => p.RequestParameters);
					break;

				case POST:
					if (AllSet(p.RouteValues.Repository, p.RouteValues.Snapshot)) return _lowLevel.SnapshotCreatePost<T>(p.RouteValues.Repository,p.RouteValues.Snapshot,body,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> SnapshotCreateDispatchAsync<T>(IRequest<SnapshotRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
					if (AllSet(p.RouteValues.Repository, p.RouteValues.Snapshot)) return _lowLevel.SnapshotCreateAsync<T>(p.RouteValues.Repository,p.RouteValues.Snapshot,body,u => p.RequestParameters);
					break;

				case POST:
					if (AllSet(p.RouteValues.Repository, p.RouteValues.Snapshot)) return _lowLevel.SnapshotCreatePostAsync<T>(p.RouteValues.Repository,p.RouteValues.Snapshot,body,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> SnapshotCreateRepositoryDispatch<T>(IRequest<CreateRepositoryRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
					if (AllSet(p.RouteValues.Repository)) return _lowLevel.SnapshotCreateRepository<T>(p.RouteValues.Repository,body,u => p.RequestParameters);
					break;

				case POST:
					if (AllSet(p.RouteValues.Repository)) return _lowLevel.SnapshotCreateRepositoryPost<T>(p.RouteValues.Repository,body,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> SnapshotCreateRepositoryDispatchAsync<T>(IRequest<CreateRepositoryRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
					if (AllSet(p.RouteValues.Repository)) return _lowLevel.SnapshotCreateRepositoryAsync<T>(p.RouteValues.Repository,body,u => p.RequestParameters);
					break;

				case POST:
					if (AllSet(p.RouteValues.Repository)) return _lowLevel.SnapshotCreateRepositoryPostAsync<T>(p.RouteValues.Repository,body,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> SnapshotDeleteDispatch<T>(IRequest<DeleteSnapshotRequestParameters> p ) where T : class
		{
			...
			{
				case DELETE:
					if (AllSet(p.RouteValues.Repository, p.RouteValues.Snapshot)) return _lowLevel.SnapshotDelete<T>(p.RouteValues.Repository,p.RouteValues.Snapshot,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> SnapshotDeleteDispatchAsync<T>(IRequest<DeleteSnapshotRequestParameters> p ) where T : class
		{
			...
			{
				case DELETE:
					if (AllSet(p.RouteValues.Repository, p.RouteValues.Snapshot)) return _lowLevel.SnapshotDeleteAsync<T>(p.RouteValues.Repository,p.RouteValues.Snapshot,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> SnapshotDeleteRepositoryDispatch<T>(IRequest<DeleteRepositoryRequestParameters> p ) where T : class
		{
			...
			{
				case DELETE:
					if (AllSet(p.RouteValues.Repository)) return _lowLevel.SnapshotDeleteRepository<T>(p.RouteValues.Repository,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> SnapshotDeleteRepositoryDispatchAsync<T>(IRequest<DeleteRepositoryRequestParameters> p ) where T : class
		{
			...
			{
				case DELETE:
					if (AllSet(p.RouteValues.Repository)) return _lowLevel.SnapshotDeleteRepositoryAsync<T>(p.RouteValues.Repository,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> SnapshotGetDispatch<T>(IRequest<GetSnapshotRequestParameters> p ) where T : class
		{
			...
			{
				case GET:
					if (AllSet(p.RouteValues.Repository, p.RouteValues.Snapshot)) return _lowLevel.SnapshotGet<T>(p.RouteValues.Repository,p.RouteValues.Snapshot,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> SnapshotGetDispatchAsync<T>(IRequest<GetSnapshotRequestParameters> p ) where T : class
		{
			...
			{
				case GET:
					if (AllSet(p.RouteValues.Repository, p.RouteValues.Snapshot)) return _lowLevel.SnapshotGetAsync<T>(p.RouteValues.Repository,p.RouteValues.Snapshot,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> SnapshotRestoreDispatch<T>(IRequest<RestoreRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
					if (AllSet(p.RouteValues.Repository, p.RouteValues.Snapshot)) return _lowLevel.SnapshotRestore<T>(p.RouteValues.Repository,p.RouteValues.Snapshot,body,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> SnapshotRestoreDispatchAsync<T>(IRequest<RestoreRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
					if (AllSet(p.RouteValues.Repository, p.RouteValues.Snapshot)) return _lowLevel.SnapshotRestoreAsync<T>(p.RouteValues.Repository,p.RouteValues.Snapshot,body,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> SnapshotVerifyRepositoryDispatch<T>(IRequest<VerifyRepositoryRequestParameters> p ) where T : class
		{
			...
			{
				case POST:
					if (AllSet(p.RouteValues.Repository)) return _lowLevel.SnapshotVerifyRepository<T>(p.RouteValues.Repository,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> SnapshotVerifyRepositoryDispatchAsync<T>(IRequest<VerifyRepositoryRequestParameters> p ) where T : class
		{
			...
			{
				case POST:
					if (AllSet(p.RouteValues.Repository)) return _lowLevel.SnapshotVerifyRepositoryAsync<T>(p.RouteValues.Repository,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> SuggestDispatch<T>(IRequest<SuggestRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> SuggestDispatchAsync<T>(IRequest<SuggestRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal ElasticsearchResponse<T> TermvectorsDispatch<T>(IRequest<TermVectorsRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
					...
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type)) return _lowLevel.TermvectorsGet<T>(p.RouteValues.Index,p.RouteValues.Type,u => p.RequestParameters);
					break;
				...
				case POST:
					...
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type)) return _lowLevel.Termvectors<T>(p.RouteValues.Index,p.RouteValues.Type,body,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> TermvectorsDispatchAsync<T>(IRequest<TermVectorsRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
					...
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type)) return _lowLevel.TermvectorsGetAsync<T>(p.RouteValues.Index,p.RouteValues.Type,u => p.RequestParameters);
					break;
				...
				case POST:
					...
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type)) return _lowLevel.TermvectorsAsync<T>(p.RouteValues.Index,p.RouteValues.Type,body,u => p.RequestParameters);
					break;
		...
		internal ElasticsearchResponse<T> UpdateDispatch<T>(IRequest<UpdateRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type, p.RouteValues.Id)) return _lowLevel.Update<T>(p.RouteValues.Index,p.RouteValues.Type,p.RouteValues.Id,body,u => p.RequestParameters);
					break;
		...
		internal Task<ElasticsearchResponse<T>> UpdateDispatchAsync<T>(IRequest<UpdateRequestParameters> p , object body) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
					if (AllSet(p.RouteValues.Index, p.RouteValues.Type, p.RouteValues.Id)) return _lowLevel.UpdateAsync<T>(p.RouteValues.Index,p.RouteValues.Type,p.RouteValues.Id,body,u => p.RequestParameters);
					break;
