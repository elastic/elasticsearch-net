namespace Nest
{
	...
	{
		/// <summary>
		///     Controls the high watermark. It defaults to 90%, meaning ES will attempt to relocate shards to another node if the node disk usage
		///     rises above 90%.
		...
		/// <summary>
		///     Defaults to true, which means that Elasticsearch will take into account shards that are currently being relocated to the target node
		///     when computing
		...
		/// <summary>
		///     Controls the low watermark for disk usage. It defaults to 85%, meaning ES will not allocate new shards to nodes once they have more
		///     than 85% disk used. It can also be set
