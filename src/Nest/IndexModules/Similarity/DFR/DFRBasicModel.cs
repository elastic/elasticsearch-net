...
namespace Nest
{
	...
	{
		/// <summary>
		///     Limiting form of the Bose-Einstein model. The formula used in Lucene differs slightly from the one in the original paper: F is
		///     increased by tfn+1 and N is increased by F
		/// </summary>
		[EnumMember(Value = "be")]
		BE,
		...
		/// <summary>
		///     Geometric as limiting form of the Bose-Einstein model. The formula used in Lucene differs slightly from the one in the original paper:
