	...
	internal class IndexSettingsFormatter : IJsonFormatter<IDynamicIndexSettings>
	{
		...
		private static void SetKnownIndexSettings(ref JsonReader reader, IJsonFormatterResolver formatterResolver, IIndexSettings s)
		{
			...
			Set<Time>(s, settings, SlowlogIndexingThresholdFetchWarn,
				v => indexing.ThresholdWarn = v, formatterResolver);
			Set<Time>(s, settings, SlowlogIndexingThresholdFetchInfo,
				v => indexing.ThresholdInfo = v, formatterResolver);
			Set<Time>(s, settings, SlowlogIndexingThresholdFetchDebug,
				v => indexing.ThresholdDebug = v, formatterResolver);
			Set<Time>(s, settings, SlowlogIndexingThresholdFetchTrace,
				v => indexing.ThresholdTrace = v, formatterResolver);
