...
namespace Nest.Specification.XpackApi
{
	...
	public class XpackNamespace : NamespacedClientProxy
	{
		...
		///<inheritdoc cref = "IXPackInfoRequest"/>
		public Task<XPackInfoResponse> XPackInfoAsync(Func<XPackInfoDescriptor, IXPackInfoRequest> selector = null, CancellationToken ct = default) => XPackInfoAsync(selector.InvokeOrDefault(new XPackInfoDescriptor()), ct);
		///<inheritdoc cref = "IXPackInfoRequest"/>
		...
		///<inheritdoc cref = "IXPackUsageRequest"/>
		public Task<XPackUsageResponse> XPackUsageAsync(Func<XPackUsageDescriptor, IXPackUsageRequest> selector = null, CancellationToken ct = default) => XPackUsageAsync(selector.InvokeOrDefault(new XPackUsageDescriptor()), ct);
		///<inheritdoc cref = "IXPackUsageRequest"/>
