...
namespace Nest
{
	...
	public enum FieldType
	{
		...
		/// <summary>
		/// The attachment type allows to index different “attachment” type field (encoded as base64), for example, microsoft office formats, open
		/// document formats, ePub, HTML...
		/// </summary>
