...
namespace Nest
{
		...
		where T : class
	{
		...
		public TypeMappingDescriptor<T> AutoMap(IPropertyVisitor visitor = null, int maxRecursion = 20) =>
		...
		/// <param name="visitor">Use a visitor implementation to control defaults</param>
		/// <param name="maxRecursion">By default this will only recurse 20 levels deep to prevent circular references blowing up</param>
		public TypeMappingDescriptor<T> AutoMap<TDocument>(IPropertyVisitor visitor = null, int maxRecursion = 20)
