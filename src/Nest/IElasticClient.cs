...
namespace Nest
{
	interface IElasticClient
	{
		...
		ConnectionStatus Index<T>(System.Collections.Generic.IEnumerable<BulkParameters<T>> objects) where T : class;
		ConnectionStatus Index<T>(System.Collections.Generic.IEnumerable<BulkParameters<T>> objects, SimpleBulkParameters bulkParameters) where T : class;
		ConnectionStatus Index<T>(System.Collections.Generic.IEnumerable<BulkParameters<T>> objects, string index) where T : class;
		ConnectionStatus Index<T>(System.Collections.Generic.IEnumerable<BulkParameters<T>> objects, string index, SimpleBulkParameters bulkParameters) where T : class;
		ConnectionStatus Index<T>(System.Collections.Generic.IEnumerable<BulkParameters<T>> objects, string index, string type) where T : class;
		ConnectionStatus Index<T>(System.Collections.Generic.IEnumerable<BulkParameters<T>> objects, string index, string type, SimpleBulkParameters bulkParameters) where T : class;
		ConnectionStatus Index<T>(System.Collections.Generic.IEnumerable<T> objects) where T : class;
		ConnectionStatus Index<T>(System.Collections.Generic.IEnumerable<T> objects, SimpleBulkParameters bulkParameters) where T : class;
		ConnectionStatus Index<T>(System.Collections.Generic.IEnumerable<T> objects, string index) where T : class;
		ConnectionStatus Index<T>(System.Collections.Generic.IEnumerable<T> objects, string index, SimpleBulkParameters bulkParameters) where T : class;
		ConnectionStatus Index<T>(System.Collections.Generic.IEnumerable<T> objects, string index, string type) where T : class;
		ConnectionStatus Index<T>(System.Collections.Generic.IEnumerable<T> objects, string index, string type, SimpleBulkParameters bulkParameters) where T : class;
		...
		System.Threading.Tasks.Task<ConnectionStatus> IndexAsync<T>(System.Collections.Generic.IEnumerable<BulkParameters<T>> objects) where T : class;
		System.Threading.Tasks.Task<ConnectionStatus> IndexAsync<T>(System.Collections.Generic.IEnumerable<BulkParameters<T>> objects, SimpleBulkParameters bulkParameters) where T : class;
		System.Threading.Tasks.Task<ConnectionStatus> IndexAsync<T>(System.Collections.Generic.IEnumerable<BulkParameters<T>> objects, string index) where T : class;
		System.Threading.Tasks.Task<ConnectionStatus> IndexAsync<T>(System.Collections.Generic.IEnumerable<BulkParameters<T>> objects, string index, SimpleBulkParameters bulkParameters) where T : class;
		System.Threading.Tasks.Task<ConnectionStatus> IndexAsync<T>(System.Collections.Generic.IEnumerable<BulkParameters<T>> objects, string index, string type) where T : class;
		System.Threading.Tasks.Task<ConnectionStatus> IndexAsync<T>(System.Collections.Generic.IEnumerable<BulkParameters<T>> objects, string index, string type, SimpleBulkParameters bulkParameters) where T : class;
		System.Threading.Tasks.Task<ConnectionStatus> IndexAsync<T>(System.Collections.Generic.IEnumerable<T> objects) where T : class;
		System.Threading.Tasks.Task<ConnectionStatus> IndexAsync<T>(System.Collections.Generic.IEnumerable<T> objects, SimpleBulkParameters bulkParameters) where T : class;
		System.Threading.Tasks.Task<ConnectionStatus> IndexAsync<T>(System.Collections.Generic.IEnumerable<T> objects, string index) where T : class;
		System.Threading.Tasks.Task<ConnectionStatus> IndexAsync<T>(System.Collections.Generic.IEnumerable<T> objects, string index, SimpleBulkParameters bulkParameters) where T : class;
		System.Threading.Tasks.Task<ConnectionStatus> IndexAsync<T>(System.Collections.Generic.IEnumerable<T> objects, string index, string type) where T : class;
		System.Threading.Tasks.Task<ConnectionStatus> IndexAsync<T>(System.Collections.Generic.IEnumerable<T> objects, string index, string type, SimpleBulkParameters bulkParameters) where T : class;
