...
namespace Nest
{
		...
		where K : class
	{
		...
		ElasticsearchPathInfo<UpdateQueryString> IPathInfo<UpdateQueryString>.ToPathInfo(IConnectionSettingsValues settings)
		{
			var pathInfo = base.ToPathInfo<UpdateQueryString>(settings, this._QueryString);
