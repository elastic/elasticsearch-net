...
namespace Nest
{
	...
	public class MtermvectorsQueryString : FluentQueryString<MtermvectorsQueryString> 
	{
		...
		///<summary>A comma-separated list of fields to return. Applies to all returned documents unless otherwise specified in body &quot;params&quot; or &quot;docs&quot;.</summary>
		internal MtermvectorsQueryString _Fields<T>(IEnumerable<Expression<Func<T, object>>>  fields)
			where T : class
		{
			this._fields = fields.Select(e=>(PropertyPathMarker)e);
			this.Add("fields", this._fields);
	...
	public class NodesStatsQueryString : FluentQueryString<NodesStatsQueryString> 
	{
		...
		///<summary>A comma-separated list of fields for `fielddata` and `suggest` index metric (supports wildcards)</summary>
		internal NodesStatsQueryString _CompletionFields<T>(IEnumerable<Expression<Func<T, object>>>  completion_fields)
			where T : class
		{
			this._completion_fields = completion_fields.Select(e=>(PropertyPathMarker)e);
			this.Add("completion_fields", this._completion_fields);
		...
		///<summary>A comma-separated list of fields for `fielddata` index metric (supports wildcards)</summary>
		internal NodesStatsQueryString _FielddataFields<T>(IEnumerable<Expression<Func<T, object>>>  fielddata_fields)
			where T : class
		{
			this._fielddata_fields = fielddata_fields.Select(e=>(PropertyPathMarker)e);
			this.Add("fielddata_fields", this._fielddata_fields);
		...
		///<summary>A comma-separated list of fields for `fielddata` and `completion` index metric (supports wildcards)</summary>
		internal NodesStatsQueryString _Fields<T>(IEnumerable<Expression<Func<T, object>>>  fields)
			where T : class
		{
			this._fields = fields.Select(e=>(PropertyPathMarker)e);
			this.Add("fields", this._fields);
	...
	public class TermvectorQueryString : FluentQueryString<TermvectorQueryString> 
	{
		...
		///<summary>A comma-separated list of fields to return.</summary>
		internal TermvectorQueryString _Fields<T>(IEnumerable<Expression<Func<T, object>>>  fields)
			where T : class
		{
			this._fields = fields.Select(e=>(PropertyPathMarker)e);
			this.Add("fields", this._fields);
