...
namespace Nest
{
	public partial interface IElasticClient
	{
		...
		IGetResponse<T> Get<T>(Func<GetDescriptor<T>, IGetRequest> getSelector) where T : class;

		/// <inheritdoc/>
		IGetResponse<T> Get<T>(IGetRequest getRequest) where T : class;

		/// <inheritdoc/>
		Task<IGetResponse<T>> GetAsync<T>(Func<GetDescriptor<T>, IGetRequest> getSelector) where T : class;
	...
	public partial class ElasticClient
	{
		...
		/// <inheritdoc/>
		public IGetResponse<T> Get<T>(Func<GetDescriptor<T>, IGetRequest> getSelector) where T : class =>
			this.Get<T>(getSelector?.Invoke(new GetDescriptor<T>()));
		...
		/// <inheritdoc/>
		public Task<IGetResponse<T>> GetAsync<T>(Func<GetDescriptor<T>, IGetRequest> getSelector) where T : class=>
			this.GetAsync<T>(getSelector?.Invoke(new GetDescriptor<T>()));
