...
namespace Nest
{
		...
		where T : class
	{
		...
		IDictionary<PropertyPath, string> ITermvectorRequest.PerFieldAnalyzer { get; set; }
		...
		where T : class
	{
		...
		public TermvectorDescriptor<T> PerFieldAnalyzer(Func<FluentDictionary<PropertyPath, string>, FluentDictionary<PropertyPath, string>> analyzerSelector)
		{
