...
namespace Nest
{
	public partial interface IElasticClient
	{
		...
		/// <inheritdoc/>
		IBulkResponse Bulk(Func<BulkDescriptor, IBulkRequest> bulkSelector);

		/// <inheritdoc/>
		Task<IBulkResponse> BulkAsync(IBulkRequest bulkRequest);

		/// <inheritdoc/>
		Task<IBulkResponse> BulkAsync(Func<BulkDescriptor, IBulkRequest> bulkSelector);
	...
	public partial class ElasticClient
	{
		...
		/// <inheritdoc/>
		public IBulkResponse Bulk(Func<BulkDescriptor, IBulkRequest> bulkSelector) =>
			this.Bulk(bulkSelector?.Invoke(new BulkDescriptor()));
		...
		/// <inheritdoc/>
		public Task<IBulkResponse> BulkAsync(Func<BulkDescriptor, IBulkRequest> bulkSelector) =>
			this.BulkAsync(bulkSelector?.Invoke(new BulkDescriptor()));
	}
}