...
namespace Nest.Specification.CatApi
{
	...
	public class CatNamespace : NamespacedClientProxy
	{
		...
		///<inheritdoc cref = "ICatAliasesRequest"/>
		public Task<CatResponse<CatAliasesRecord>> AliasesAsync(Func<CatAliasesDescriptor, ICatAliasesRequest> selector = null, CancellationToken ct = default) => AliasesAsync(selector.InvokeOrDefault(new CatAliasesDescriptor()), ct: ct);
		///<inheritdoc cref = "ICatAliasesRequest"/>
		...
		///<inheritdoc cref = "ICatAllocationRequest"/>
		public Task<CatResponse<CatAllocationRecord>> AllocationAsync(Func<CatAllocationDescriptor, ICatAllocationRequest> selector = null, CancellationToken ct = default) => AllocationAsync(selector.InvokeOrDefault(new CatAllocationDescriptor()), ct: ct);
		///<inheritdoc cref = "ICatAllocationRequest"/>
		...
		///<inheritdoc cref = "ICatCountRequest"/>
		public Task<CatResponse<CatCountRecord>> CountAsync(Func<CatCountDescriptor, ICatCountRequest> selector = null, CancellationToken ct = default) => CountAsync(selector.InvokeOrDefault(new CatCountDescriptor()), ct: ct);
		///<inheritdoc cref = "ICatCountRequest"/>
		...
		///<inheritdoc cref = "ICatFielddataRequest"/>
		public Task<CatResponse<CatFielddataRecord>> FielddataAsync(Func<CatFielddataDescriptor, ICatFielddataRequest> selector = null, CancellationToken ct = default) => FielddataAsync(selector.InvokeOrDefault(new CatFielddataDescriptor()), ct: ct);
		///<inheritdoc cref = "ICatFielddataRequest"/>
		...
		///<inheritdoc cref = "ICatHealthRequest"/>
		public Task<CatResponse<CatHealthRecord>> HealthAsync(Func<CatHealthDescriptor, ICatHealthRequest> selector = null, CancellationToken ct = default) => HealthAsync(selector.InvokeOrDefault(new CatHealthDescriptor()), ct: ct);
		///<inheritdoc cref = "ICatHealthRequest"/>
		...
		///<inheritdoc cref = "ICatHelpRequest"/>
		public Task<CatResponse<CatHelpRecord>> HelpAsync(Func<CatHelpDescriptor, ICatHelpRequest> selector = null, CancellationToken ct = default) => HelpAsync(selector.InvokeOrDefault(new CatHelpDescriptor()), ct: ct);
		///<inheritdoc cref = "ICatHelpRequest"/>
		...
		///<inheritdoc cref = "ICatIndicesRequest"/>
		public Task<CatResponse<CatIndicesRecord>> IndicesAsync(Func<CatIndicesDescriptor, ICatIndicesRequest> selector = null, CancellationToken ct = default) => IndicesAsync(selector.InvokeOrDefault(new CatIndicesDescriptor()), ct: ct);
		///<inheritdoc cref = "ICatIndicesRequest"/>
		...
		///<inheritdoc cref = "ICatMasterRequest"/>
		public Task<CatResponse<CatMasterRecord>> MasterAsync(Func<CatMasterDescriptor, ICatMasterRequest> selector = null, CancellationToken ct = default) => MasterAsync(selector.InvokeOrDefault(new CatMasterDescriptor()), ct: ct);
		///<inheritdoc cref = "ICatMasterRequest"/>
		...
		///<inheritdoc cref = "ICatNodeAttributesRequest"/>
		public Task<CatResponse<CatNodeAttributesRecord>> NodeAttributesAsync(Func<CatNodeAttributesDescriptor, ICatNodeAttributesRequest> selector = null, CancellationToken ct = default) => NodeAttributesAsync(selector.InvokeOrDefault(new CatNodeAttributesDescriptor()), ct: ct);
		///<inheritdoc cref = "ICatNodeAttributesRequest"/>
		...
		///<inheritdoc cref = "ICatNodesRequest"/>
		public Task<CatResponse<CatNodesRecord>> NodesAsync(Func<CatNodesDescriptor, ICatNodesRequest> selector = null, CancellationToken ct = default) => NodesAsync(selector.InvokeOrDefault(new CatNodesDescriptor()), ct: ct);
		///<inheritdoc cref = "ICatNodesRequest"/>
		...
		///<inheritdoc cref = "ICatPendingTasksRequest"/>
		public Task<CatResponse<CatPendingTasksRecord>> PendingTasksAsync(Func<CatPendingTasksDescriptor, ICatPendingTasksRequest> selector = null, CancellationToken ct = default) => PendingTasksAsync(selector.InvokeOrDefault(new CatPendingTasksDescriptor()), ct: ct);
		///<inheritdoc cref = "ICatPendingTasksRequest"/>
		...
		///<inheritdoc cref = "ICatPluginsRequest"/>
		public Task<CatResponse<CatPluginsRecord>> PluginsAsync(Func<CatPluginsDescriptor, ICatPluginsRequest> selector = null, CancellationToken ct = default) => PluginsAsync(selector.InvokeOrDefault(new CatPluginsDescriptor()), ct: ct);
		///<inheritdoc cref = "ICatPluginsRequest"/>
		...
		///<inheritdoc cref = "ICatRecoveryRequest"/>
		public Task<CatResponse<CatRecoveryRecord>> RecoveryAsync(Func<CatRecoveryDescriptor, ICatRecoveryRequest> selector = null, CancellationToken ct = default) => RecoveryAsync(selector.InvokeOrDefault(new CatRecoveryDescriptor()), ct: ct);
		///<inheritdoc cref = "ICatRecoveryRequest"/>
		...
		///<inheritdoc cref = "ICatRepositoriesRequest"/>
		public Task<CatResponse<CatRepositoriesRecord>> RepositoriesAsync(Func<CatRepositoriesDescriptor, ICatRepositoriesRequest> selector = null, CancellationToken ct = default) => RepositoriesAsync(selector.InvokeOrDefault(new CatRepositoriesDescriptor()), ct: ct);
		///<inheritdoc cref = "ICatRepositoriesRequest"/>
		...
		///<inheritdoc cref = "ICatSegmentsRequest"/>
		public Task<CatResponse<CatSegmentsRecord>> SegmentsAsync(Func<CatSegmentsDescriptor, ICatSegmentsRequest> selector = null, CancellationToken ct = default) => SegmentsAsync(selector.InvokeOrDefault(new CatSegmentsDescriptor()), ct: ct);
		///<inheritdoc cref = "ICatSegmentsRequest"/>
		...
		///<inheritdoc cref = "ICatShardsRequest"/>
		public Task<CatResponse<CatShardsRecord>> ShardsAsync(Func<CatShardsDescriptor, ICatShardsRequest> selector = null, CancellationToken ct = default) => ShardsAsync(selector.InvokeOrDefault(new CatShardsDescriptor()), ct: ct);
		///<inheritdoc cref = "ICatShardsRequest"/>
		...
		///<inheritdoc cref = "ICatSnapshotsRequest"/>
		public Task<CatResponse<CatSnapshotsRecord>> SnapshotsAsync(Func<CatSnapshotsDescriptor, ICatSnapshotsRequest> selector = null, CancellationToken ct = default) => SnapshotsAsync(selector.InvokeOrDefault(new CatSnapshotsDescriptor()), ct: ct);
		///<inheritdoc cref = "ICatSnapshotsRequest"/>
		...
		///<inheritdoc cref = "ICatTasksRequest"/>
		public Task<CatResponse<CatTasksRecord>> TasksAsync(Func<CatTasksDescriptor, ICatTasksRequest> selector = null, CancellationToken ct = default) => TasksAsync(selector.InvokeOrDefault(new CatTasksDescriptor()), ct: ct);
		///<inheritdoc cref = "ICatTasksRequest"/>
		...
		///<inheritdoc cref = "ICatTemplatesRequest"/>
		public Task<CatResponse<CatTemplatesRecord>> TemplatesAsync(Func<CatTemplatesDescriptor, ICatTemplatesRequest> selector = null, CancellationToken ct = default) => TemplatesAsync(selector.InvokeOrDefault(new CatTemplatesDescriptor()), ct: ct);
		///<inheritdoc cref = "ICatTemplatesRequest"/>
		...
		///<inheritdoc cref = "ICatThreadPoolRequest"/>
		public Task<CatResponse<CatThreadPoolRecord>> ThreadPoolAsync(Func<CatThreadPoolDescriptor, ICatThreadPoolRequest> selector = null, CancellationToken ct = default) => ThreadPoolAsync(selector.InvokeOrDefault(new CatThreadPoolDescriptor()), ct: ct);
		///<inheritdoc cref = "ICatThreadPoolRequest"/>
