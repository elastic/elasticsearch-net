...
namespace Nest
{
	...
	///<summary>Descriptor for Transform <para>https://www.elastic.co/guide/en/elasticsearch/reference/current/cat-transforms.html</para></summary>
	public partial class CatTransformDescriptor : RequestDescriptorBase<CatTransformDescriptor, CatTransformRequestParameters, ICatTransformRequest>, ICatTransformRequest
	{
		...
		public CatTransformDescriptor(Id transformId): base(r => r.Optional("transform_id", transformId))
		{
		}
		...
		public CatTransformDescriptor TransformId(Id transformId) => Assign(transformId, (a, v) => a.RouteValues.Optional("transform_id", v));
		// Request parameters
