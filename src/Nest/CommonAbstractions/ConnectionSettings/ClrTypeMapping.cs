...
namespace Nest
{
		...
		where T : class
	{
		...
		/// <summary>
		/// When specified allows you to ignore
		/// <param name="property"></param>
		/// on clr type <typeparamref name="T" />
		/// </summary>
		...
		/// <summary>
		/// When specified allows you to rename
		/// <param name="property"></param>
		/// on clr type <typeparamref name="T" />
		/// </summary>
	...
	public abstract class ClrPropertyMappingBase<T> : IClrTypePropertyMapping<T>
		where T : class
	{
		protected ClrPropertyMappingBase(Expression<Func<T, object>> property) => Self.Property = property;
		...
		IPropertyMapping IClrTypePropertyMapping<T>.ToPropertyMapping() =>
			Self.Ignore ? PropertyMapping.Ignored : new PropertyMapping { Name = Self.NewName };
	}

	public class IgnorePropertyMapping<T> : ClrPropertyMappingBase<T> where T : class
	{
		public IgnorePropertyMapping(Expression<Func<T, object>> property) : base(property) => Self.Ignore = true;
	}
