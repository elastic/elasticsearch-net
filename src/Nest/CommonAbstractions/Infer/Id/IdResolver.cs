...
namespace Nest
{
	public class IdResolver
	{
		...
		public string Resolve<T>(T @object) =>
			_connectionSettings.DisableAllIdInference || @object == null ? null : Resolve(@object.GetType(), @object);

		public string Resolve(Type type, object @object)
		{
			if (type == null || @object == null) return null;
			if (_connectionSettings.DisableAllIdInference || _connectionSettings.DisableIdInference.Contains(type))
				return null;
