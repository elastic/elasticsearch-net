...
namespace Nest
{
	...
	public class BucketInfluencer
	{
		...
		///     Updated by a re-normalization process as new data is analyzed.
		/// </summary>
		...
		/// <summary>
		///     The probability that the influencer has this behavior, in the range 0 to 1. This value can be held to a high precision of over 300
		///     decimal places.
		/// </summary>
