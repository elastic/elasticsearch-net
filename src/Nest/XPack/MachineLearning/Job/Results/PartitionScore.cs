...
namespace Nest
{
	...
	{
		/// <summary>
		///     A normalized score between 0-100, which is based on the probability of the anomalousness of this record. This is the initial value that
		...
		/// <summary>
		///     The probability of the individual anomaly occurring, in the range 0 to 1. This value can be held to a high precision of over 300
		///     decimal places.
		/// </summary>
		...
		/// <summary>
		///     A normalized score between 0-100, which is based on the probability of the anomalousness of this record. Unlike initial_record_score,
