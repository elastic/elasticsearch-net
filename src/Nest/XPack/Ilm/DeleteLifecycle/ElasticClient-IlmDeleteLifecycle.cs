...
namespace Nest
{
	public partial interface IElasticClient
	{
		...
		/// </summary>
		IIlmDeleteLifecycleResponse IlmDeleteLifecycle(Policy policy, Func<IlmDeleteLifecycleDescriptor, IIlmDeleteLifecycleRequest> selector = null);

		/// <inheritdoc cref="IlmDeleteLifecycle(Nest.Policy,System.Func{Nest.IlmDeleteLifecycleDescriptor,Nest.IIlmDeleteLifecycleRequest})" />
		IIlmDeleteLifecycleResponse IlmDeleteLifecycle(IIlmDeleteLifecycleRequest request);

		/// <inheritdoc cref="IlmDeleteLifecycle(Nest.Policy,System.Func{Nest.IlmDeleteLifecycleDescriptor,Nest.IIlmDeleteLifecycleRequest})" />
		Task<IIlmDeleteLifecycleResponse> IlmDeleteLifecycleAsync(Policy policy, Func<IlmDeleteLifecycleDescriptor, IIlmDeleteLifecycleRequest> selector = null,
	...
	{
		/// <inheritdoc cref="IlmDeleteLifecycle(Nest.Policy,System.Func{Nest.IlmDeleteLifecycleDescriptor,Nest.IIlmDeleteLifecycleRequest})" />
		public IIlmDeleteLifecycleResponse IlmDeleteLifecycle(Policy policy, Func<IlmDeleteLifecycleDescriptor, IIlmDeleteLifecycleRequest> selector = null) =>
			IlmDeleteLifecycle(selector.InvokeOrDefault(new IlmDeleteLifecycleDescriptor(policy)));
		...
		/// <inheritdoc cref="IlmDeleteLifecycle(Nest.Policy,System.Func{Nest.IlmDeleteLifecycleDescriptor,Nest.IIlmDeleteLifecycleRequest})" />
		public Task<IIlmDeleteLifecycleResponse> IlmDeleteLifecycleAsync(Policy policy, Func<IlmDeleteLifecycleDescriptor, IIlmDeleteLifecycleRequest> selector = null,
			CancellationToken cancellationToken = default(CancellationToken)
		) =>
			IlmDeleteLifecycleAsync(selector.InvokeOrDefault(new IlmDeleteLifecycleDescriptor(policy)), cancellationToken);
