...
namespace Nest
{
	public partial interface IElasticClient
	{
		...
		/// </summary>
		IIlmRetryResponse IlmRetry(Func<IlmRetryDescriptor, IIlmRetryRequest> selector = null);

		/// <inheritdoc cref="IlmRetry(System.Func{Nest.IlmRetryDescriptor,Nest.IIlmRetryRequest})" />
		IIlmRetryResponse IlmRetry(IIlmRetryRequest request);

		/// <inheritdoc cref="IlmRetry(System.Func{Nest.IlmRetryDescriptor,Nest.IIlmRetryRequest})" />
		Task<IIlmRetryResponse> IlmRetryAsync(Func<IlmRetryDescriptor, IIlmRetryRequest> selector = null,
	...
	{
		/// <inheritdoc cref="IlmRetry(System.Func{Nest.IlmRetryDescriptor,Nest.IIlmRetryRequest})" />
		public IIlmRetryResponse IlmRetry(Func<IlmRetryDescriptor, IIlmRetryRequest> selector = null) =>
			IlmRetry(selector.InvokeOrDefault(new IlmRetryDescriptor()));
		...
		/// <inheritdoc cref="IlmRetry(System.Func{Nest.IlmRetryDescriptor,Nest.IIlmRetryRequest})" />
		public Task<IIlmRetryResponse> IlmRetryAsync(Func<IlmRetryDescriptor, IIlmRetryRequest> selector = null,
			CancellationToken cancellationToken = default(CancellationToken)
		) =>
			IlmRetryAsync(selector.InvokeOrDefault(new IlmRetryDescriptor()), cancellationToken);
