...
namespace Nest.Specification.IndicesApi
{
	...
	public class IndicesNamespace : NamespacedClientProxy
	{
		...
		///<inheritdoc cref = "IAnalyzeRequest"/>
		public Task<AnalyzeResponse> AnalyzeAsync(Func<AnalyzeDescriptor, IAnalyzeRequest> selector = null, CancellationToken ct = default) => AnalyzeAsync(selector.InvokeOrDefault(new AnalyzeDescriptor()), ct: ct);
		///<inheritdoc cref = "IAnalyzeRequest"/>
		...
		///<inheritdoc cref = "IClearCacheRequest"/>
		public Task<ClearCacheResponse> ClearCacheAsync(Indices index = null, Func<ClearCacheDescriptor, IClearCacheRequest> selector = null, CancellationToken ct = default) => ClearCacheAsync(selector.InvokeOrDefault(new ClearCacheDescriptor().Index(index: index)), ct: ct);
		///<inheritdoc cref = "IClearCacheRequest"/>
		...
		///<inheritdoc cref = "ICloseIndexRequest"/>
		public Task<CloseIndexResponse> CloseIndexAsync(Indices index, Func<CloseIndexDescriptor, ICloseIndexRequest> selector = null, CancellationToken ct = default) => CloseIndexAsync(selector.InvokeOrDefault(new CloseIndexDescriptor(index: index)), ct: ct);
		///<inheritdoc cref = "ICloseIndexRequest"/>
		...
		///<inheritdoc cref = "ICreateIndexRequest"/>
		public Task<CreateIndexResponse> CreateIndexAsync(IndexName index, Func<CreateIndexDescriptor, ICreateIndexRequest> selector = null, CancellationToken ct = default) => CreateIndexAsync(selector.InvokeOrDefault(new CreateIndexDescriptor(index: index)), ct: ct);
		///<inheritdoc cref = "ICreateIndexRequest"/>
		...
		///<inheritdoc cref = "IDeleteIndexRequest"/>
		public Task<DeleteIndexResponse> DeleteIndexAsync(Indices index, Func<DeleteIndexDescriptor, IDeleteIndexRequest> selector = null, CancellationToken ct = default) => DeleteIndexAsync(selector.InvokeOrDefault(new DeleteIndexDescriptor(index: index)), ct: ct);
		///<inheritdoc cref = "IDeleteIndexRequest"/>
		...
		///<inheritdoc cref = "IDeleteAliasRequest"/>
		public Task<DeleteAliasResponse> DeleteAliasAsync(Indices index, Names name, Func<DeleteAliasDescriptor, IDeleteAliasRequest> selector = null, CancellationToken ct = default) => DeleteAliasAsync(selector.InvokeOrDefault(new DeleteAliasDescriptor(index: index, name: name)), ct: ct);
		///<inheritdoc cref = "IDeleteAliasRequest"/>
		...
		///<inheritdoc cref = "IDeleteIndexTemplateRequest"/>
		public Task<DeleteIndexTemplateResponse> DeleteIndexTemplateAsync(Name name, Func<DeleteIndexTemplateDescriptor, IDeleteIndexTemplateRequest> selector = null, CancellationToken ct = default) => DeleteIndexTemplateAsync(selector.InvokeOrDefault(new DeleteIndexTemplateDescriptor(name: name)), ct: ct);
		///<inheritdoc cref = "IDeleteIndexTemplateRequest"/>
		...
		///<inheritdoc cref = "IIndexExistsRequest"/>
		public Task<ExistsResponse> IndexExistsAsync(Indices index, Func<IndexExistsDescriptor, IIndexExistsRequest> selector = null, CancellationToken ct = default) => IndexExistsAsync(selector.InvokeOrDefault(new IndexExistsDescriptor(index: index)), ct: ct);
		///<inheritdoc cref = "IIndexExistsRequest"/>
		...
		///<inheritdoc cref = "IAliasExistsRequest"/>
		public Task<ExistsResponse> AliasExistsAsync(Names name, Func<AliasExistsDescriptor, IAliasExistsRequest> selector = null, CancellationToken ct = default) => AliasExistsAsync(selector.InvokeOrDefault(new AliasExistsDescriptor(name: name)), ct: ct);
		///<inheritdoc cref = "IAliasExistsRequest"/>
		...
		///<inheritdoc cref = "IIndexTemplateExistsRequest"/>
		public Task<ExistsResponse> IndexTemplateExistsAsync(Names name, Func<IndexTemplateExistsDescriptor, IIndexTemplateExistsRequest> selector = null, CancellationToken ct = default) => IndexTemplateExistsAsync(selector.InvokeOrDefault(new IndexTemplateExistsDescriptor(name: name)), ct: ct);
		///<inheritdoc cref = "IIndexTemplateExistsRequest"/>
		...
		///<inheritdoc cref = "ITypeExistsRequest"/>
		public Task<ExistsResponse> TypeExistsAsync(Indices index, Names type, Func<TypeExistsDescriptor, ITypeExistsRequest> selector = null, CancellationToken ct = default) => TypeExistsAsync(selector.InvokeOrDefault(new TypeExistsDescriptor(index: index, type: type)), ct: ct);
		///<inheritdoc cref = "ITypeExistsRequest"/>
		...
		///<inheritdoc cref = "IFlushRequest"/>
		public Task<FlushResponse> FlushAsync(Indices index = null, Func<FlushDescriptor, IFlushRequest> selector = null, CancellationToken ct = default) => FlushAsync(selector.InvokeOrDefault(new FlushDescriptor().Index(index: index)), ct: ct);
		///<inheritdoc cref = "IFlushRequest"/>
		...
		///<inheritdoc cref = "ISyncedFlushRequest"/>
		public Task<SyncedFlushResponse> SyncedFlushAsync(Indices index = null, Func<SyncedFlushDescriptor, ISyncedFlushRequest> selector = null, CancellationToken ct = default) => SyncedFlushAsync(selector.InvokeOrDefault(new SyncedFlushDescriptor().Index(index: index)), ct: ct);
		///<inheritdoc cref = "ISyncedFlushRequest"/>
		...
		///<inheritdoc cref = "IForceMergeRequest"/>
		public Task<ForceMergeResponse> ForceMergeAsync(Indices index = null, Func<ForceMergeDescriptor, IForceMergeRequest> selector = null, CancellationToken ct = default) => ForceMergeAsync(selector.InvokeOrDefault(new ForceMergeDescriptor().Index(index: index)), ct: ct);
		///<inheritdoc cref = "IForceMergeRequest"/>
		...
		///<inheritdoc cref = "IGetIndexRequest"/>
		public Task<GetIndexResponse> GetIndexAsync(Indices index, Func<GetIndexDescriptor, IGetIndexRequest> selector = null, CancellationToken ct = default) => GetIndexAsync(selector.InvokeOrDefault(new GetIndexDescriptor(index: index)), ct: ct);
		///<inheritdoc cref = "IGetIndexRequest"/>
		...
		///<inheritdoc cref = "IGetAliasRequest"/>
		public Task<GetAliasResponse> GetAliasAsync(Indices index = null, Func<GetAliasDescriptor, IGetAliasRequest> selector = null, CancellationToken ct = default) => GetAliasAsync(selector.InvokeOrDefault(new GetAliasDescriptor().Index(index: index)), ct: ct);
		///<inheritdoc cref = "IGetAliasRequest"/>
		...
		public Task<GetFieldMappingResponse> GetFieldMappingAsync<TDocument>(Fields fields, Func<GetFieldMappingDescriptor<TDocument>, IGetFieldMappingRequest> selector = null, CancellationToken ct = default)
			where TDocument : class => GetFieldMappingAsync(selector.InvokeOrDefault(new GetFieldMappingDescriptor<TDocument>(fields: fields)), ct: ct);
		///<inheritdoc cref = "IGetFieldMappingRequest"/>
		...
		public Task<GetMappingResponse> GetMappingAsync<TDocument>(Func<GetMappingDescriptor<TDocument>, IGetMappingRequest> selector = null, CancellationToken ct = default)
			where TDocument : class => GetMappingAsync(selector.InvokeOrDefault(new GetMappingDescriptor<TDocument>()), ct: ct);
		///<inheritdoc cref = "IGetMappingRequest"/>
		...
		///<inheritdoc cref = "IGetIndexSettingsRequest"/>
		public Task<GetIndexSettingsResponse> GetIndexSettingsAsync(Indices index = null, Func<GetIndexSettingsDescriptor, IGetIndexSettingsRequest> selector = null, CancellationToken ct = default) => GetIndexSettingsAsync(selector.InvokeOrDefault(new GetIndexSettingsDescriptor().Index(index: index)), ct: ct);
		///<inheritdoc cref = "IGetIndexSettingsRequest"/>
		...
		///<inheritdoc cref = "IGetIndexTemplateRequest"/>
		public Task<GetIndexTemplateResponse> GetIndexTemplateAsync(Names name = null, Func<GetIndexTemplateDescriptor, IGetIndexTemplateRequest> selector = null, CancellationToken ct = default) => GetIndexTemplateAsync(selector.InvokeOrDefault(new GetIndexTemplateDescriptor().Name(name: name)), ct: ct);
		///<inheritdoc cref = "IGetIndexTemplateRequest"/>
		...
		///<inheritdoc cref = "IUpgradeStatusRequest"/>
		public Task<UpgradeStatusResponse> UpgradeStatusAsync(Indices index = null, Func<UpgradeStatusDescriptor, IUpgradeStatusRequest> selector = null, CancellationToken ct = default) => UpgradeStatusAsync(selector.InvokeOrDefault(new UpgradeStatusDescriptor().Index(index: index)), ct: ct);
		///<inheritdoc cref = "IUpgradeStatusRequest"/>
		...
		///<inheritdoc cref = "IOpenIndexRequest"/>
		public Task<OpenIndexResponse> OpenIndexAsync(Indices index, Func<OpenIndexDescriptor, IOpenIndexRequest> selector = null, CancellationToken ct = default) => OpenIndexAsync(selector.InvokeOrDefault(new OpenIndexDescriptor(index: index)), ct: ct);
		///<inheritdoc cref = "IOpenIndexRequest"/>
		...
		///<inheritdoc cref = "IPutAliasRequest"/>
		public Task<PutAliasResponse> PutAliasAsync(Indices index, Name name, Func<PutAliasDescriptor, IPutAliasRequest> selector = null, CancellationToken ct = default) => PutAliasAsync(selector.InvokeOrDefault(new PutAliasDescriptor(index: index, name: name)), ct: ct);
		///<inheritdoc cref = "IPutAliasRequest"/>
		...
		public Task<PutMappingResponse> PutMappingAsync<TDocument>(Func<PutMappingDescriptor<TDocument>, IPutMappingRequest> selector, CancellationToken ct = default)
			where TDocument : class => PutMappingAsync(selector.InvokeOrDefault(new PutMappingDescriptor<TDocument>()), ct: ct);
		///<inheritdoc cref = "IPutMappingRequest"/>
		...
		///<inheritdoc cref = "IUpdateIndexSettingsRequest"/>
		public Task<UpdateIndexSettingsResponse> UpdateIndexSettingsAsync(Indices index, Func<UpdateIndexSettingsDescriptor, IUpdateIndexSettingsRequest> selector, CancellationToken ct = default) => UpdateIndexSettingsAsync(selector.InvokeOrDefault(new UpdateIndexSettingsDescriptor().Index(index: index)), ct: ct);
		///<inheritdoc cref = "IUpdateIndexSettingsRequest"/>
		...
		///<inheritdoc cref = "IPutIndexTemplateRequest"/>
		public Task<PutIndexTemplateResponse> PutIndexTemplateAsync(Name name, Func<PutIndexTemplateDescriptor, IPutIndexTemplateRequest> selector, CancellationToken ct = default) => PutIndexTemplateAsync(selector.InvokeOrDefault(new PutIndexTemplateDescriptor(name: name)), ct: ct);
		///<inheritdoc cref = "IPutIndexTemplateRequest"/>
		...
		///<inheritdoc cref = "IRecoveryStatusRequest"/>
		public Task<RecoveryStatusResponse> RecoveryStatusAsync(Indices index = null, Func<RecoveryStatusDescriptor, IRecoveryStatusRequest> selector = null, CancellationToken ct = default) => RecoveryStatusAsync(selector.InvokeOrDefault(new RecoveryStatusDescriptor().Index(index: index)), ct: ct);
		///<inheritdoc cref = "IRecoveryStatusRequest"/>
		...
		///<inheritdoc cref = "IRefreshRequest"/>
		public Task<RefreshResponse> RefreshAsync(Indices index = null, Func<RefreshDescriptor, IRefreshRequest> selector = null, CancellationToken ct = default) => RefreshAsync(selector.InvokeOrDefault(new RefreshDescriptor().Index(index: index)), ct: ct);
		///<inheritdoc cref = "IRefreshRequest"/>
		...
		///<inheritdoc cref = "IRolloverIndexRequest"/>
		public Task<RolloverIndexResponse> RolloverIndexAsync(Name alias, Func<RolloverIndexDescriptor, IRolloverIndexRequest> selector = null, CancellationToken ct = default) => RolloverIndexAsync(selector.InvokeOrDefault(new RolloverIndexDescriptor(alias: alias)), ct: ct);
		///<inheritdoc cref = "IRolloverIndexRequest"/>
		...
		///<inheritdoc cref = "ISegmentsRequest"/>
		public Task<SegmentsResponse> SegmentsAsync(Indices index = null, Func<SegmentsDescriptor, ISegmentsRequest> selector = null, CancellationToken ct = default) => SegmentsAsync(selector.InvokeOrDefault(new SegmentsDescriptor().Index(index: index)), ct: ct);
		///<inheritdoc cref = "ISegmentsRequest"/>
		...
		///<inheritdoc cref = "IIndicesShardStoresRequest"/>
		public Task<IndicesShardStoresResponse> ShardStoresAsync(Indices index = null, Func<IndicesShardStoresDescriptor, IIndicesShardStoresRequest> selector = null, CancellationToken ct = default) => ShardStoresAsync(selector.InvokeOrDefault(new IndicesShardStoresDescriptor().Index(index: index)), ct: ct);
		///<inheritdoc cref = "IIndicesShardStoresRequest"/>
		...
		///<inheritdoc cref = "IShrinkIndexRequest"/>
		public Task<ShrinkIndexResponse> ShrinkIndexAsync(IndexName index, IndexName target, Func<ShrinkIndexDescriptor, IShrinkIndexRequest> selector = null, CancellationToken ct = default) => ShrinkIndexAsync(selector.InvokeOrDefault(new ShrinkIndexDescriptor(index: index, target: target)), ct: ct);
		///<inheritdoc cref = "IShrinkIndexRequest"/>
		...
		///<inheritdoc cref = "ISplitIndexRequest"/>
		public Task<SplitIndexResponse> SplitIndexAsync(IndexName index, IndexName target, Func<SplitIndexDescriptor, ISplitIndexRequest> selector = null, CancellationToken ct = default) => SplitIndexAsync(selector.InvokeOrDefault(new SplitIndexDescriptor(index: index, target: target)), ct: ct);
		///<inheritdoc cref = "ISplitIndexRequest"/>
		...
		///<inheritdoc cref = "IIndicesStatsRequest"/>
		public Task<IndicesStatsResponse> StatsAsync(Indices index = null, Func<IndicesStatsDescriptor, IIndicesStatsRequest> selector = null, CancellationToken ct = default) => StatsAsync(selector.InvokeOrDefault(new IndicesStatsDescriptor().Index(index: index)), ct: ct);
		///<inheritdoc cref = "IIndicesStatsRequest"/>
		...
		///<inheritdoc cref = "IBulkAliasRequest"/>
		public Task<BulkAliasResponse> BulkAliasAsync(Func<BulkAliasDescriptor, IBulkAliasRequest> selector, CancellationToken ct = default) => BulkAliasAsync(selector.InvokeOrDefault(new BulkAliasDescriptor()), ct: ct);
		///<inheritdoc cref = "IBulkAliasRequest"/>
		...
		///<inheritdoc cref = "IUpgradeRequest"/>
		public Task<UpgradeResponse> UpgradeAsync(Indices index = null, Func<UpgradeDescriptor, IUpgradeRequest> selector = null, CancellationToken ct = default) => UpgradeAsync(selector.InvokeOrDefault(new UpgradeDescriptor().Index(index: index)), ct: ct);
		///<inheritdoc cref = "IUpgradeRequest"/>
		...
		public Task<ValidateQueryResponse> ValidateQueryAsync<TDocument>(Func<ValidateQueryDescriptor<TDocument>, IValidateQueryRequest> selector = null, CancellationToken ct = default)
			where TDocument : class => ValidateQueryAsync(selector.InvokeOrDefault(new ValidateQueryDescriptor<TDocument>()), ct: ct);
		///<inheritdoc cref = "IValidateQueryRequest"/>
