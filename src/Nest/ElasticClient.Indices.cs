...
namespace Nest.Specification.IndicesApi
{
	...
	public class IndicesNamespace : NamespacedClientProxy
	{
		...
		/// </summary>
		public CreateIndexResponse Create(IndexName index, Func<CreateIndexDescriptor, CreateIndexDescriptor> selector = null) => Create(selector.InvokeOrDefault(new CreateIndexDescriptor(index: index)));
		public CreateIndexResponse Create(string index, Func<CreateIndexDescriptor, CreateIndexDescriptor> selector = null) => Create(selector.InvokeOrDefault(new CreateIndexDescriptor(index: index)));
		/// <summary>
		/// <c>PUT</c> request to the <c>indices.create</c> API, read more about this API online:
		/// <para></para>
		/// <a href = "https://www.elastic.co/guide/en/elasticsearch/reference/master/indices-create-index.html">https://www.elastic.co/guide/en/elasticsearch/reference/master/indices-create-index.html</a>
		/// </summary>
		public Task<CreateIndexResponse> CreateAsync(IndexName index, Func<CreateIndexDescriptor, CreateIndexDescriptor> selector = null, CancellationToken ct = default) => CreateAsync(selector.InvokeOrDefault(new CreateIndexDescriptor(index: index)), ct);
		/// <summary>
		/// <c>PUT</c> request to the <c>indices.create</c> API, read more about this API online:
		/// <para></para>
		/// <a href = "https://www.elastic.co/guide/en/elasticsearch/reference/master/indices-create-index.html">https://www.elastic.co/guide/en/elasticsearch/reference/master/indices-create-index.html</a>
