...
namespace Nest.Specification.ClusterApi
{
	...
	public class ClusterNamespace : NamespacedClientProxy
	{
		...
		///<inheritdoc cref = "IClusterAllocationExplainRequest"/>
		public Task<ClusterAllocationExplainResponse> AllocationExplainAsync(Func<ClusterAllocationExplainDescriptor, IClusterAllocationExplainRequest> selector = null, CancellationToken ct = default) => AllocationExplainAsync(selector.InvokeOrDefault(new ClusterAllocationExplainDescriptor()), ct: ct);
		///<inheritdoc cref = "IClusterAllocationExplainRequest"/>
		...
		///<inheritdoc cref = "IClusterGetSettingsRequest"/>
		public Task<ClusterGetSettingsResponse> GetSettingsAsync(Func<ClusterGetSettingsDescriptor, IClusterGetSettingsRequest> selector = null, CancellationToken ct = default) => GetSettingsAsync(selector.InvokeOrDefault(new ClusterGetSettingsDescriptor()), ct: ct);
		///<inheritdoc cref = "IClusterGetSettingsRequest"/>
		...
		///<inheritdoc cref = "IClusterHealthRequest"/>
		public Task<ClusterHealthResponse> HealthAsync(Indices index = null, Func<ClusterHealthDescriptor, IClusterHealthRequest> selector = null, CancellationToken ct = default) => HealthAsync(selector.InvokeOrDefault(new ClusterHealthDescriptor().Index(index: index)), ct: ct);
		///<inheritdoc cref = "IClusterHealthRequest"/>
		...
		///<inheritdoc cref = "IClusterPendingTasksRequest"/>
		public Task<ClusterPendingTasksResponse> PendingTasksAsync(Func<ClusterPendingTasksDescriptor, IClusterPendingTasksRequest> selector = null, CancellationToken ct = default) => PendingTasksAsync(selector.InvokeOrDefault(new ClusterPendingTasksDescriptor()), ct: ct);
		///<inheritdoc cref = "IClusterPendingTasksRequest"/>
		...
		///<inheritdoc cref = "IClusterPutSettingsRequest"/>
		public Task<ClusterPutSettingsResponse> PutSettingsAsync(Func<ClusterPutSettingsDescriptor, IClusterPutSettingsRequest> selector, CancellationToken ct = default) => PutSettingsAsync(selector.InvokeOrDefault(new ClusterPutSettingsDescriptor()), ct: ct);
		///<inheritdoc cref = "IClusterPutSettingsRequest"/>
		...
		///<inheritdoc cref = "IRemoteInfoRequest"/>
		public Task<RemoteInfoResponse> RemoteInfoAsync(Func<RemoteInfoDescriptor, IRemoteInfoRequest> selector = null, CancellationToken ct = default) => RemoteInfoAsync(selector.InvokeOrDefault(new RemoteInfoDescriptor()), ct: ct);
		///<inheritdoc cref = "IRemoteInfoRequest"/>
		...
		///<inheritdoc cref = "IClusterRerouteRequest"/>
		public Task<ClusterRerouteResponse> RerouteAsync(Func<ClusterRerouteDescriptor, IClusterRerouteRequest> selector = null, CancellationToken ct = default) => RerouteAsync(selector.InvokeOrDefault(new ClusterRerouteDescriptor()), ct: ct);
		///<inheritdoc cref = "IClusterRerouteRequest"/>
		...
		///<inheritdoc cref = "IClusterStateRequest"/>
		public Task<ClusterStateResponse> StateAsync(Indices index = null, Func<ClusterStateDescriptor, IClusterStateRequest> selector = null, CancellationToken ct = default) => StateAsync(selector.InvokeOrDefault(new ClusterStateDescriptor().Index(index: index)), ct: ct);
		///<inheritdoc cref = "IClusterStateRequest"/>
		...
		///<inheritdoc cref = "IClusterStatsRequest"/>
		public Task<ClusterStatsResponse> StatsAsync(Func<ClusterStatsDescriptor, IClusterStatsRequest> selector = null, CancellationToken ct = default) => StatsAsync(selector.InvokeOrDefault(new ClusterStatsDescriptor()), ct: ct);
		///<inheritdoc cref = "IClusterStatsRequest"/>
