...
namespace Nest
{
	...
	public partial interface ISearchTemplateRequest : ISearchTypeInformation
	{
		[DataMember(Name ="id")]
		string Id { get; set; }
	...
	public partial class SearchTemplateRequest
	{
		...
		Type ISearchTypeInformation.ClrType => ClrType;
	...
	{
		Type ISearchTypeInformation.ClrType => typeof(TDocument);
