...
namespace Nest
{
	...
	public partial class SearchDescriptor<T> where T : class
	{
		...
		/// <summary>
		///     Allow to highlight search results on one or more fields. The implementation uses the either lucene fast-vector-highlighter or
		///     highlighter.
		/// </summary>
		...
		/// <summary>
		///     For scroll queries that return a lot of documents it is possible to split the scroll in multiple slices which can be consumed
		///     independently
		/// </summary>
