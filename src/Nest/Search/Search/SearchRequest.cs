...
namespace Nest
{
	...
	public partial class SearchRequest
	{
		...
		public Union<bool,ISearchRequest> Source { get; set; }
	...
	public partial class SearchDescriptor<T> where T : class
	{
		...
		public SearchDescriptor<T> Source(bool include = true) => Assign(a => a.Source = !include ? new Union<bool, ISourceFilter>(false) : null);
