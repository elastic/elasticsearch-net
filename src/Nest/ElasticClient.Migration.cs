...
namespace Nest.Apis.MigrationApi
{
	///<summary>
	...
	public class MigrationNamespace : NamespacedClientProxy
	{
		...
		public DeprecationInfoResponse DeprecationInfo(IndexName index, Func<DeprecationInfoDescriptor, IDeprecationInfoRequest> selector = null) => throw new NotImplementedException();
		///<inheritdoc cref = "IDeprecationInfoRequest"/>
		public Task<DeprecationInfoResponse> DeprecationInfoAsync(IndexName index, Func<DeprecationInfoDescriptor, IDeprecationInfoRequest> selector = null, CancellationToken ct = default) => throw new NotImplementedException();
		///<inheritdoc cref = "IDeprecationInfoRequest"/>
