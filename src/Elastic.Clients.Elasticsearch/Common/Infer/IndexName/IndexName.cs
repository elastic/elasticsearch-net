...
namespace Elastic.Clients.Elasticsearch
{
	...
	//		{
	//			throw new Exception(
	//				"Tried to pass index name on querystring but it could not be resolved because no Elastic.Clients.Elasticsearch settings are available");
	//		}

	//		return Elastic.Clients.ElasticsearchSettings.Inferrer.IndexName(this);
	//	}
	...
	//	public Elastic.Clients.Elasticsearch.Indices And<T>() => new(new[] {this, typeof(T)});

	//	public Elastic.Clients.Elasticsearch.Indices And<T>(string clusterName) => new(new[] {this, From(typeof(T), clusterName)});

	//	public Elastic.Clients.Elasticsearch.Indices And(IndexName index) => new(new[] {this, index});
