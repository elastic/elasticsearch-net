...
//		//{
//		//	var Elastic.Clients.ElasticsearchSettings = (IElasticsearchClientSettings)settings;
//		//	return Elastic.Clients.ElasticsearchSettings.Inferrer.Id(Document) ?? StringOrLongValue;
//		//}
