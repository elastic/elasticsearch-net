...
namespace Elastic.Clients.Elasticsearch.Enrich
{
	public class EnrichNamespace : NamespacedClientProxy
	{
		...
		public DeletePolicyResponse DeletePolicy(Elastic.Clients.Elasticsearch.Name name, Func<DeletePolicyDescriptor, IDeletePolicyRequest> selector = null) => DeletePolicy(selector.InvokeOrDefault(new DeletePolicyDescriptor(name)));
		public Task<DeletePolicyResponse> DeletePolicyAsync(Elastic.Clients.Elasticsearch.Name name, Func<DeletePolicyDescriptor, IDeletePolicyRequest> selector = null, CancellationToken cancellationToken = default) => DeletePolicyAsync(selector.InvokeOrDefault(new DeletePolicyDescriptor(name)), cancellationToken);
		...
		public ExecutePolicyResponse ExecutePolicy(Elastic.Clients.Elasticsearch.Name name, Func<ExecutePolicyDescriptor, IExecutePolicyRequest> selector = null) => ExecutePolicy(selector.InvokeOrDefault(new ExecutePolicyDescriptor(name)));
		public Task<ExecutePolicyResponse> ExecutePolicyAsync(Elastic.Clients.Elasticsearch.Name name, Func<ExecutePolicyDescriptor, IExecutePolicyRequest> selector = null, CancellationToken cancellationToken = default) => ExecutePolicyAsync(selector.InvokeOrDefault(new ExecutePolicyDescriptor(name)), cancellationToken);
		...
		public PutPolicyResponse PutPolicy(Elastic.Clients.Elasticsearch.Name name, Func<PutPolicyDescriptor, IPutPolicyRequest> selector = null) => PutPolicy(selector.InvokeOrDefault(new PutPolicyDescriptor(name)));
		public Task<PutPolicyResponse> PutPolicyAsync(Elastic.Clients.Elasticsearch.Name name, Func<PutPolicyDescriptor, IPutPolicyRequest> selector = null, CancellationToken cancellationToken = default) => PutPolicyAsync(selector.InvokeOrDefault(new PutPolicyDescriptor(name)), cancellationToken);
