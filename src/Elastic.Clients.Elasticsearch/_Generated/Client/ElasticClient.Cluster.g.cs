...
namespace Elastic.Clients.Elasticsearch.Cluster
{
	public class ClusterNamespace : NamespacedClientProxy
	{
		...
		public ClusterRemoteInfoResponse RemoteInfo(IClusterRemoteInfoRequest request) => DoRequest<IClusterRemoteInfoRequest, ClusterRemoteInfoResponse>(request, request.RequestParameters);
		public Task<ClusterRemoteInfoResponse> RemoteInfoAsync(IClusterRemoteInfoRequest request, CancellationToken cancellationToken = default) => DoRequestAsync<IClusterRemoteInfoRequest, ClusterRemoteInfoResponse>(request, request.RequestParameters, cancellationToken);
		public ClusterRemoteInfoResponse RemoteInfo(Func<ClusterRemoteInfoRequestDescriptor, IClusterRemoteInfoRequest> selector = null) => RemoteInfo(selector.InvokeOrDefault(new ClusterRemoteInfoRequestDescriptor()));
		public Task<ClusterRemoteInfoResponse> RemoteInfoAsync(Func<ClusterRemoteInfoRequestDescriptor, IClusterRemoteInfoRequest> selector = null, CancellationToken cancellationToken = default) => RemoteInfoAsync(selector.InvokeOrDefault(new ClusterRemoteInfoRequestDescriptor()), cancellationToken);
