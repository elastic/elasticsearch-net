...
public partial class XpackNamespacedClient : NamespacedClientProxy
{
	...
	/// </item>
	/// </list>
	/// <para><see href="https://www.elastic.co/guide/en/elasticsearch/reference/8.18/info-api.html">Learn more about this API in the Elasticsearch documentation.</see></para>
	/// </summary>
	...
	/// </para>
	/// <para><see href="https://www.elastic.co/docs/api/doc/elasticsearch/v8/group/endpoint-xpack">Learn more about this API in the Elasticsearch documentation.</see></para>
	/// </summary>
	[Obsolete("Synchronous methods are deprecated and could be removed in the future.")]
