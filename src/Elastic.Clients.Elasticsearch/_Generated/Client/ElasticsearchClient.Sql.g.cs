...
{
	/// <summary>
	/// Initializes a new instance of the <cref:Elastic.Clients.Elasticsearch.Sql.SqlNamespacedClient> class for mocking.
	/// </summary>
	...
	/// <include file="../Api/Sql/ClearCursorRequest.g.xml" path="doc/member[@key='sql.clear_cursor.Request']/*"/>
	...
	/// <include file="../Api/Sql/DeleteAsyncRequest.g.xml" path="doc/member[@key='sql.delete_async.Request']/*"/>
	...
	/// <include file="../Api/Sql/GetAsyncRequest.g.xml" path="doc/member[@key='sql.get_async.Request']/*"/>
	...
	/// <include file="../Api/Sql/GetAsyncStatusRequest.g.xml" path="doc/member[@key='sql.get_async_status.Request']/*"/>
	...
	/// <include file="../Api/Sql/QueryRequest.g.xml" path="doc/member[@key='sql.query.Request']/*"/>
	...
	/// <include file="../Api/Sql/TranslateRequest.g.xml" path="doc/member[@key='sql.translate.Request']/*"/>
