...
public partial class IndicesNamespacedClient : Elastic.Clients.Elasticsearch.NamespacedClientProxy
{
	...
	/// <include file="../Api/IndexManagement/GetDataStreamMappingsRequest.g.xml" path="doc/member[@key='indices.get_data_stream_mappings.Request']/*"/>
	...
	/// <include file="../Api/IndexManagement/PutDataStreamMappingsRequest.g.xml" path="doc/member[@key='indices.put_data_stream_mappings.Request']/*"/>
	...
	/// <include file="../Api/IndexManagement/RemoveBlockRequest.g.xml" path="doc/member[@key='indices.remove_block.Request']/*"/>
