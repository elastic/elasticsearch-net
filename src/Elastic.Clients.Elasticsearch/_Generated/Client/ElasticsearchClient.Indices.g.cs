...
public partial class IndicesNamespacedClient : Elastic.Clients.Elasticsearch.NamespacedClientProxy
{
	...
	/// <include file="../Api/IndexManagement/AddBlockRequest.g.xml" path="doc/member[@key='indices.add_block.Request']/*"/>
	/// <include file="../SpecReferences.xml" path="doc/member[@key='indices.add_block.Request']/*"/>
	public virtual Elastic.Clients.Elasticsearch.IndexManagement.AddBlockResponse AddBlock(Elastic.Clients.Elasticsearch.IndexName index, Elastic.Clients.Elasticsearch.IndexManagement.IndicesBlockOptions block)
	{
		var builder = new Elastic.Clients.Elasticsearch.IndexManagement.AddBlockRequestDescriptor(index, block);
	...
	/// <include file="../Api/IndexManagement/AddBlockRequest.g.xml" path="doc/member[@key='indices.add_block.Request']/*"/>
	/// <include file="../SpecReferences.xml" path="doc/member[@key='indices.add_block.Request']/*"/>
	public virtual Elastic.Clients.Elasticsearch.IndexManagement.AddBlockResponse AddBlock(Elastic.Clients.Elasticsearch.IndexName index, Elastic.Clients.Elasticsearch.IndexManagement.IndicesBlockOptions block, System.Action<Elastic.Clients.Elasticsearch.IndexManagement.AddBlockRequestDescriptor> action)
	{
		var builder = new Elastic.Clients.Elasticsearch.IndexManagement.AddBlockRequestDescriptor(index, block);
	...
	/// <include file="../Api/IndexManagement/AddBlockRequest.g.xml" path="doc/member[@key='indices.add_block.Request']/*"/>
	/// <include file="../SpecReferences.xml" path="doc/member[@key='indices.add_block.Request']/*"/>
	public virtual Elastic.Clients.Elasticsearch.IndexManagement.AddBlockResponse AddBlock<TDocument>(Elastic.Clients.Elasticsearch.IndexName index, Elastic.Clients.Elasticsearch.IndexManagement.IndicesBlockOptions block, System.Action<Elastic.Clients.Elasticsearch.IndexManagement.AddBlockRequestDescriptor<TDocument>> action)
	{
		var builder = new Elastic.Clients.Elasticsearch.IndexManagement.AddBlockRequestDescriptor<TDocument>(index, block);
		action.Invoke(builder);
		var request = builder.Instance;
		request.BeforeRequest();
		return DoRequest<Elastic.Clients.Elasticsearch.IndexManagement.AddBlockRequest, Elastic.Clients.Elasticsearch.IndexManagement.AddBlockResponse, Elastic.Clients.Elasticsearch.IndexManagement.AddBlockRequestParameters>(request);
	...
	/// <include file="../Api/IndexManagement/AddBlockRequest.g.xml" path="doc/member[@key='indices.add_block.Request']/*"/>
	/// <include file="../SpecReferences.xml" path="doc/member[@key='indices.add_block.Request']/*"/>
	public virtual System.Threading.Tasks.Task<Elastic.Clients.Elasticsearch.IndexManagement.AddBlockResponse> AddBlockAsync(Elastic.Clients.Elasticsearch.IndexName index, Elastic.Clients.Elasticsearch.IndexManagement.IndicesBlockOptions block, System.Threading.CancellationToken cancellationToken = default)
	{
		var builder = new Elastic.Clients.Elasticsearch.IndexManagement.AddBlockRequestDescriptor(index, block);
		var request = builder.Instance;
		request.BeforeRequest();
