...
public sealed partial class ListReindexResponseConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.ListReindexResponse>
{
	...
	private static readonly System.Text.Json.JsonEncodedText PropReindex = System.Text.Json.JsonEncodedText.Encode("reindex"u8);
	...
	public override Elastic.Clients.Elasticsearch.ListReindexResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonValue<System.Collections.Generic.IReadOnlyCollection<Elastic.Clients.Elasticsearch.ReindexTaskInfo>> propReindex = default;
		...
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propReindex.TryReadProperty(ref reader, options, PropReindex, static System.Collections.Generic.IReadOnlyCollection<Elastic.Clients.Elasticsearch.ReindexTaskInfo> (ref System.Text.Json.Utf8JsonReader r, System.Text.Json.JsonSerializerOptions o) => r.ReadCollectionValue<Elastic.Clients.Elasticsearch.ReindexTaskInfo>(o, null)!))
			{
				continue;
			}
		...
		return new Elastic.Clients.Elasticsearch.ListReindexResponse(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance)
		{
			NodeFailures = propNodeFailures.Value,
			Reindex = propReindex.Value,
			TaskFailures = propTaskFailures.Value
		};
	}

	public override void Write(System.Text.Json.Utf8JsonWriter writer, Elastic.Clients.Elasticsearch.ListReindexResponse value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropReindex, value.Reindex, null, static (System.Text.Json.Utf8JsonWriter w, System.Text.Json.JsonSerializerOptions o, System.Collections.Generic.IReadOnlyCollection<Elastic.Clients.Elasticsearch.ReindexTaskInfo> v) => w.WriteCollectionValue<Elastic.Clients.Elasticsearch.ReindexTaskInfo>(o, v, null));
