...
/// <include file="PutInferenceRequest.g.xml" path="doc/member[@key='inference.put.Request']/*"/>
...
{
	/// <include file="PutInferenceRequest.g.xml" path="doc/member[@key='inference.put.Request#timeout']/*"/>
...
public sealed partial class PutInferenceRequest : Elastic.Clients.Elasticsearch.Requests.PlainRequest<Elastic.Clients.Elasticsearch.Inference.PutInferenceRequestParameters>
{
	...
	/// <include file="PutInferenceRequest.g.xml" path="doc/member[@key='inference.put.Request#inference_id']/*"/>
	...
	/// <include file="PutInferenceRequest.g.xml" path="doc/member[@key='inference.put.Request#task_type']/*"/>
