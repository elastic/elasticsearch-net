...
public sealed partial class PutAzureopenaiRequestParameters : RequestParameters
{
}
...
public sealed partial class PutAzureopenaiRequest : PlainRequest<PutAzureopenaiRequestParameters>
{
	...
	internal override ApiUrls ApiUrls => ApiUrlLookup.InferencePutAzureopenai;
	...
	public Elastic.Clients.Elasticsearch.Inference.AzureOpenAIServiceType Service { get; set; }
	...
	public Elastic.Clients.Elasticsearch.Inference.AzureOpenAIServiceSettings ServiceSettings { get; set; }
...
{
	internal PutAzureopenaiRequestDescriptor(Action<PutAzureopenaiRequestDescriptor> configure) => configure.Invoke(this);

	public PutAzureopenaiRequestDescriptor(Elastic.Clients.Elasticsearch.Inference.AzureOpenAITaskType taskType, Elastic.Clients.Elasticsearch.Id azureopenaiInferenceId) : base(r => r.Required("task_type", taskType).Required("azureopenai_inference_id", azureopenaiInferenceId))
	{
	}
	...
	public PutAzureopenaiRequestDescriptor AzureopenaiInferenceId(Elastic.Clients.Elasticsearch.Id azureopenaiInferenceId)
	{
		RouteValues.Required("azureopenai_inference_id", azureopenaiInferenceId);
		return Self;
	}

	public PutAzureopenaiRequestDescriptor TaskType(Elastic.Clients.Elasticsearch.Inference.AzureOpenAITaskType taskType)
	{
	...
	private Elastic.Clients.Elasticsearch.Inference.AzureOpenAIServiceType ServiceValue { get; set; }
	private Elastic.Clients.Elasticsearch.Inference.AzureOpenAIServiceSettings ServiceSettingsValue { get; set; }
	private Elastic.Clients.Elasticsearch.Inference.AzureOpenAIServiceSettingsDescriptor ServiceSettingsDescriptor { get; set; }
	private Action<Elastic.Clients.Elasticsearch.Inference.AzureOpenAIServiceSettingsDescriptor> ServiceSettingsDescriptorAction { get; set; }
	private Elastic.Clients.Elasticsearch.Inference.AzureOpenAITaskSettings? TaskSettingsValue { get; set; }
	private Elastic.Clients.Elasticsearch.Inference.AzureOpenAITaskSettingsDescriptor TaskSettingsDescriptor { get; set; }
	private Action<Elastic.Clients.Elasticsearch.Inference.AzureOpenAITaskSettingsDescriptor> TaskSettingsDescriptorAction { get; set; }
	...
	/// </para>
	/// </summary>
	public PutAzureopenaiRequestDescriptor ChunkingSettings(Elastic.Clients.Elasticsearch.Inference.InferenceChunkingSettings? chunkingSettings)
	{
	...
	public PutAzureopenaiRequestDescriptor ChunkingSettings(Elastic.Clients.Elasticsearch.Inference.InferenceChunkingSettingsDescriptor descriptor)
	{
	...
	public PutAzureopenaiRequestDescriptor ChunkingSettings(Action<Elastic.Clients.Elasticsearch.Inference.InferenceChunkingSettingsDescriptor> configure)
	{
		ChunkingSettingsValue = null;
		ChunkingSettingsDescriptor = null;
	...
	/// </para>
	/// </summary>
	public PutAzureopenaiRequestDescriptor Service(Elastic.Clients.Elasticsearch.Inference.AzureOpenAIServiceType service)
	{
	...
	/// </para>
	/// </summary>
	public PutAzureopenaiRequestDescriptor ServiceSettings(Elastic.Clients.Elasticsearch.Inference.AzureOpenAIServiceSettings serviceSettings)
	{
	...
	public PutAzureopenaiRequestDescriptor ServiceSettings(Elastic.Clients.Elasticsearch.Inference.AzureOpenAIServiceSettingsDescriptor descriptor)
	{
	...
	public PutAzureopenaiRequestDescriptor ServiceSettings(Action<Elastic.Clients.Elasticsearch.Inference.AzureOpenAIServiceSettingsDescriptor> configure)
	{
		ServiceSettingsValue = null;
		ServiceSettingsDescriptor = null;
	...
	/// </para>
	/// </summary>
	public PutAzureopenaiRequestDescriptor TaskSettings(Elastic.Clients.Elasticsearch.Inference.AzureOpenAITaskSettings? taskSettings)
	{
	...
	public PutAzureopenaiRequestDescriptor TaskSettings(Elastic.Clients.Elasticsearch.Inference.AzureOpenAITaskSettingsDescriptor descriptor)
	{
	...
	public PutAzureopenaiRequestDescriptor TaskSettings(Action<Elastic.Clients.Elasticsearch.Inference.AzureOpenAITaskSettingsDescriptor> configure)
	{
		TaskSettingsValue = null;
		TaskSettingsDescriptor = null;
	...
	protected override void Serialize(Utf8JsonWriter writer, JsonSerializerOptions options, IElasticsearchClientSettings settings)
	{
		...
		{
			writer.WritePropertyName("service_settings");
			JsonSerializer.Serialize(writer, new Elastic.Clients.Elasticsearch.Inference.AzureOpenAIServiceSettingsDescriptor(ServiceSettingsDescriptorAction), options);
		}
		else
		{
			writer.WritePropertyName("service_settings");
		...
		{
			writer.WritePropertyName("task_settings");
			JsonSerializer.Serialize(writer, new Elastic.Clients.Elasticsearch.Inference.AzureOpenAITaskSettingsDescriptor(TaskSettingsDescriptorAction), options);
		}
