...
public sealed partial class PutNvidiaRequest : Elastic.Clients.Elasticsearch.Requests.PlainRequest<Elastic.Clients.Elasticsearch.Inference.PutNvidiaRequestParameters>
{
	...
	public PutNvidiaRequest(Elastic.Clients.Elasticsearch.Inference.NvidiaTaskType taskType, Elastic.Clients.Elasticsearch.Id nvidiaInferenceId) : base(r => r.Required("task_type", taskType).Required("nvidia_inference_id", nvidiaInferenceId))
	{
	}

	[System.Diagnostics.CodeAnalysis.SetsRequiredMembers]
	public PutNvidiaRequest(Elastic.Clients.Elasticsearch.Inference.NvidiaTaskType taskType, Elastic.Clients.Elasticsearch.Id nvidiaInferenceId, Elastic.Clients.Elasticsearch.Inference.NvidiaServiceSettings serviceSettings) : base(r => r.Required("task_type", taskType).Required("nvidia_inference_id", nvidiaInferenceId))
	{
		ServiceSettings = serviceSettings;
	}

	public PutNvidiaRequest()
	{
	}

	[System.Diagnostics.CodeAnalysis.SetsRequiredMembers]
	internal PutNvidiaRequest(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel sentinel)
	{
		_ = sentinel;
	}

	internal override Elastic.Clients.Elasticsearch.Requests.ApiUrls ApiUrls => Elastic.Clients.Elasticsearch.Requests.ApiUrlLookup.InferencePutNvidia;
...
public readonly partial struct PutNvidiaRequestDescriptor
{
	...
	[System.Diagnostics.CodeAnalysis.SetsRequiredMembers]
	public PutNvidiaRequestDescriptor(Elastic.Clients.Elasticsearch.Inference.PutNvidiaRequest instance)
	{
		Instance = instance;
	}

	public PutNvidiaRequestDescriptor(Elastic.Clients.Elasticsearch.Inference.NvidiaTaskType taskType, Elastic.Clients.Elasticsearch.Id nvidiaInferenceId)
	{
#pragma warning disable CS0618
		Instance = new Elastic.Clients.Elasticsearch.Inference.PutNvidiaRequest(taskType, nvidiaInferenceId);
#pragma warning restore CS0618
	}

	[System.Obsolete("The use of the parameterless constructor is not permitted for this type.")]
	public PutNvidiaRequestDescriptor()
	{
	...
	internal static Elastic.Clients.Elasticsearch.Inference.PutNvidiaRequest Build(System.Action<Elastic.Clients.Elasticsearch.Inference.PutNvidiaRequestDescriptor> action)
	{
		var builder = new Elastic.Clients.Elasticsearch.Inference.PutNvidiaRequestDescriptor(new Elastic.Clients.Elasticsearch.Inference.PutNvidiaRequest(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance));
		action.Invoke(builder);
		return builder.Instance;
	}

	public Elastic.Clients.Elasticsearch.Inference.PutNvidiaRequestDescriptor ErrorTrace(bool? value)
	{
	...
	public Elastic.Clients.Elasticsearch.Inference.PutNvidiaRequestDescriptor FilterPath(params string[]? value)
	{
		Instance.FilterPath = value;
		return this;
	}

	public Elastic.Clients.Elasticsearch.Inference.PutNvidiaRequestDescriptor Human(bool? value)
	{
		Instance.Human = value;
		return this;
	}

	public Elastic.Clients.Elasticsearch.Inference.PutNvidiaRequestDescriptor Pretty(bool? value)
	{
		Instance.Pretty = value;
		return this;
	}

	public Elastic.Clients.Elasticsearch.Inference.PutNvidiaRequestDescriptor SourceQueryString(string? value)
	{
		Instance.SourceQueryString = value;
		return this;
	}

	public Elastic.Clients.Elasticsearch.Inference.PutNvidiaRequestDescriptor RequestConfiguration(Elastic.Transport.IRequestConfiguration? value)
	{
		Instance.RequestConfiguration = value;
		return this;
	}

	public Elastic.Clients.Elasticsearch.Inference.PutNvidiaRequestDescriptor RequestConfiguration(System.Func<Elastic.Transport.RequestConfigurationDescriptor, Elastic.Transport.IRequestConfiguration>? configurationSelector)
	{
