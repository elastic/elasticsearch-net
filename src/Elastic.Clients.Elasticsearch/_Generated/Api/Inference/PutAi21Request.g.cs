...
internal sealed partial class PutAi21RequestConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Inference.PutAi21Request>
{
	...
	public override Elastic.Clients.Elasticsearch.Inference.PutAi21Request Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		reader.ValidateToken(System.Text.Json.JsonTokenType.StartObject);
		LocalJsonValue<Elastic.Clients.Elasticsearch.Inference.Ai21ServiceSettings> propServiceSettings = default;
		...
		return new Elastic.Clients.Elasticsearch.Inference.PutAi21Request(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance)
		{
			ServiceSettings = propServiceSettings.Value
		};
	}

	public override void Write(System.Text.Json.Utf8JsonWriter writer, Elastic.Clients.Elasticsearch.Inference.PutAi21Request value, System.Text.Json.JsonSerializerOptions options)
	{
...
/// </para>
/// </summary>
[System.Text.Json.Serialization.JsonConverter(typeof(Elastic.Clients.Elasticsearch.Inference.PutAi21RequestConverter))]
public sealed partial class PutAi21Request : Elastic.Clients.Elasticsearch.Requests.PlainRequest<Elastic.Clients.Elasticsearch.Inference.PutAi21RequestParameters>
{
	...
	public PutAi21Request(Elastic.Clients.Elasticsearch.Inference.Ai21TaskType taskType, Elastic.Clients.Elasticsearch.Id ai21InferenceId) : base(r => r.Required("task_type", taskType).Required("ai21_inference_id", ai21InferenceId))
	{
	}

	[System.Diagnostics.CodeAnalysis.SetsRequiredMembers]
	public PutAi21Request(Elastic.Clients.Elasticsearch.Inference.Ai21TaskType taskType, Elastic.Clients.Elasticsearch.Id ai21InferenceId, Elastic.Clients.Elasticsearch.Inference.Ai21ServiceSettings serviceSettings) : base(r => r.Required("task_type", taskType).Required("ai21_inference_id", ai21InferenceId))
	{
	...
	internal override Elastic.Clients.Elasticsearch.Requests.ApiUrls ApiUrls => Elastic.Clients.Elasticsearch.Requests.ApiUrlLookup.InferencePutAi21;
...
public readonly partial struct PutAi21RequestDescriptor
{
	...
	[System.Diagnostics.CodeAnalysis.SetsRequiredMembers]
	public PutAi21RequestDescriptor(Elastic.Clients.Elasticsearch.Inference.PutAi21Request instance)
	{
		Instance = instance;
	}

	public PutAi21RequestDescriptor(Elastic.Clients.Elasticsearch.Inference.Ai21TaskType taskType, Elastic.Clients.Elasticsearch.Id ai21InferenceId)
	{
#pragma warning disable CS0618
		Instance = new Elastic.Clients.Elasticsearch.Inference.PutAi21Request(taskType, ai21InferenceId);
#pragma warning restore CS0618
	}

	[System.Obsolete("The use of the parameterless constructor is not permitted for this type.")]
	public PutAi21RequestDescriptor()
	{
	...
	internal static Elastic.Clients.Elasticsearch.Inference.PutAi21Request Build(System.Action<Elastic.Clients.Elasticsearch.Inference.PutAi21RequestDescriptor> action)
	{
		var builder = new Elastic.Clients.Elasticsearch.Inference.PutAi21RequestDescriptor(new Elastic.Clients.Elasticsearch.Inference.PutAi21Request(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance));
		action.Invoke(builder);
		return builder.Instance;
	}

	public Elastic.Clients.Elasticsearch.Inference.PutAi21RequestDescriptor ErrorTrace(bool? value)
	{
	...
	public Elastic.Clients.Elasticsearch.Inference.PutAi21RequestDescriptor Human(bool? value)
	{
		Instance.Human = value;
		return this;
	}

	public Elastic.Clients.Elasticsearch.Inference.PutAi21RequestDescriptor Pretty(bool? value)
	{
		Instance.Pretty = value;
		return this;
	}

	public Elastic.Clients.Elasticsearch.Inference.PutAi21RequestDescriptor SourceQueryString(string? value)
	{
		Instance.SourceQueryString = value;
		return this;
	}

	public Elastic.Clients.Elasticsearch.Inference.PutAi21RequestDescriptor RequestConfiguration(Elastic.Transport.IRequestConfiguration? value)
	{
		Instance.RequestConfiguration = value;
		return this;
	}

	public Elastic.Clients.Elasticsearch.Inference.PutAi21RequestDescriptor RequestConfiguration(System.Func<Elastic.Transport.RequestConfigurationDescriptor, Elastic.Transport.IRequestConfiguration>? configurationSelector)
	{
