...
internal sealed partial class PutCustomResponseConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Inference.PutCustomResponse>
{
...
[System.Text.Json.Serialization.JsonConverter(typeof(Elastic.Clients.Elasticsearch.Inference.PutCustomResponseConverter))]
public sealed partial class PutCustomResponse : Elastic.Transport.Products.Elasticsearch.ElasticsearchResponse
{
	...
	[System.Diagnostics.CodeAnalysis.SetsRequiredMembers]
	internal PutCustomResponse(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel sentinel)
	{
		_ = sentinel;
	}
	...
	required
#endif
	Elastic.Clients.Elasticsearch.Inference.TaskTypeCustom TaskType { get; set; }
}