...
public sealed partial class PutAmazonsagemakerResponseConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Inference.PutAmazonsagemakerResponse>
{
	...
	private static readonly System.Text.Json.JsonEncodedText PropTaskType = System.Text.Json.JsonEncodedText.Encode("task_type"u8);

	public override Elastic.Clients.Elasticsearch.Inference.PutAmazonsagemakerResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonValue<Elastic.Clients.Elasticsearch.Inference.TaskTypeAmazonSageMaker> propTaskType = default;
		...
		return new Elastic.Clients.Elasticsearch.Inference.PutAmazonsagemakerResponse(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance)
		{
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, Elastic.Clients.Elasticsearch.Inference.PutAmazonsagemakerResponse value, System.Text.Json.JsonSerializerOptions options)
	{
