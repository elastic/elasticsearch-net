...
{
	public class CreateSnapshotRequestParameters : RequestParameters<CreateSnapshotRequestParameters>
	{
		[JsonIgnore]
	...
	public sealed partial class CreateSnapshotRequestDescriptor : RequestDescriptorBase<CreateSnapshotRequestDescriptor, CreateSnapshotRequestParameters>
	{
		...
		protected override HttpMethod HttpMethod => HttpMethod.PUT;
		protected override bool SupportsBody => true;
		public CreateSnapshotRequestDescriptor MasterTimeout(Elastic.Clients.Elasticsearch.Time? masterTimeout) => Qs("master_timeout", masterTimeout);
