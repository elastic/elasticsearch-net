...
{
	public class SnapshotCleanupRepositoryRequestParameters : RequestParameters<SnapshotCleanupRepositoryRequestParameters>
	{
		[JsonIgnore]
	...
	{
		internal SnapshotCleanupRepositoryRequestDescriptor(Action<SnapshotCleanupRepositoryRequestDescriptor> configure) => configure.Invoke(this);
		public SnapshotCleanupRepositoryRequestDescriptor(Elastic.Clients.Elasticsearch.Name repository) : base(r => r.Required("repository", repository))
		{
		}

		internal SnapshotCleanupRepositoryRequestDescriptor()
		{
		}
