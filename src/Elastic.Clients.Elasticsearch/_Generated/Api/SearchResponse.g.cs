...
[System.Text.Json.Serialization.JsonConverter(typeof(Elastic.Clients.Elasticsearch.Json.SearchResponseConverterFactory))]
public partial class SearchResponse<TDocument> : Elastic.Transport.Products.Elasticsearch.ElasticsearchResponse
{
	...
	/// <include file="SearchResponse.g.xml" path="doc/member[@key='_global.search.Response#hits']/*"/>
	...
	/// <include file="SearchResponse.g.xml" path="doc/member[@key='_global.search.Response#_scroll_id']/*"/>
	public Elastic.Clients.Elasticsearch.ScrollId? ScrollId { get; set; }

	/// <include file="SearchResponse.g.xml" path="doc/member[@key='_global.search.Response#_shards']/*"/>
	...
	/// <include file="SearchResponse.g.xml" path="doc/member[@key='_global.search.Response#timed_out']/*"/>
	public required bool TimedOut { get; set; }

	/// <include file="SearchResponse.g.xml" path="doc/member[@key='_global.search.Response#took']/*"/>
