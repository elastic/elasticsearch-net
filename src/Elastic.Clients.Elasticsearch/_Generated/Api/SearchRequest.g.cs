	...
	public override SearchRequest Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
	{
		...
		while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
		{
			if (reader.TokenType == JsonTokenType.PropertyName)
			{
				...
				if (property == "sort")
				{
					variant.Sort = JsonSerializer.Deserialize<ICollection<Elastic.Clients.Elasticsearch.SortCombinations>?>(ref reader, options);
					continue;
				}
...
public sealed partial class SearchRequestDescriptor<TDocument> : RequestDescriptor<SearchRequestDescriptor<TDocument>, SearchRequestParameters>
{
	...
	/// <para>Defines the aggregations that are run as part of the search request.</para>
	/// </summary>
	public SearchRequestDescriptor<TDocument> Aggregations(Func<FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>, FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>> selector)
	{
		AggregationsValue = selector?.Invoke(new FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>());
		return Self;
	}
	...
	public SearchRequestDescriptor<TDocument> Knn(Elastic.Clients.Elasticsearch.KnnQueryDescriptor<TDocument> descriptor)
	{
		KnnValue = null;
		KnnDescriptorAction = null;
		KnnDescriptorActions = null;
	...
	public SearchRequestDescriptor<TDocument> Knn(Action<Elastic.Clients.Elasticsearch.KnnQueryDescriptor<TDocument>> configure)
	{
		KnnValue = null;
		KnnDescriptor = null;
		KnnDescriptorActions = null;
	...
	public SearchRequestDescriptor<TDocument> Knn(params Action<Elastic.Clients.Elasticsearch.KnnQueryDescriptor<TDocument>>[] configure)
	{
		KnnValue = null;
		KnnDescriptor = null;
		KnnDescriptorAction = null;
	...
	/// <para>A comma-separated list of <field>:<direction> pairs.</para>
	/// </summary>
	public SearchRequestDescriptor<TDocument> Sort(ICollection<Elastic.Clients.Elasticsearch.SortCombinations>? sort)
	{
		SortValue = sort;
		return Self;
	}
...
public sealed partial class SearchRequestDescriptor : RequestDescriptor<SearchRequestDescriptor, SearchRequestParameters>
{
	...
	/// <para>Defines the aggregations that are run as part of the search request.</para>
	/// </summary>
	public SearchRequestDescriptor Aggregations(Func<FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>, FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>> selector)
	{
		AggregationsValue = selector?.Invoke(new FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>());
		return Self;
	}
	...
	public SearchRequestDescriptor Knn(Elastic.Clients.Elasticsearch.KnnQueryDescriptor descriptor)
	{
		KnnValue = null;
		KnnDescriptorAction = null;
		KnnDescriptorActions = null;
	...
	public SearchRequestDescriptor Knn(Action<Elastic.Clients.Elasticsearch.KnnQueryDescriptor> configure)
	{
		KnnValue = null;
		KnnDescriptor = null;
		KnnDescriptorActions = null;
	...
	public SearchRequestDescriptor Knn(params Action<Elastic.Clients.Elasticsearch.KnnQueryDescriptor>[] configure)
	{
		KnnValue = null;
		KnnDescriptor = null;
		KnnDescriptorAction = null;
	...
	/// <para>A comma-separated list of <field>:<direction> pairs.</para>
	/// </summary>
	public SearchRequestDescriptor Sort(ICollection<Elastic.Clients.Elasticsearch.SortCombinations>? sort)
	{
		SortValue = sort;
		return Self;
	}
