...
public sealed partial class FindMessageStructureRequestParameters : Elastic.Transport.RequestParameters
{
	...
	/// <include file="FindMessageStructureRequest.g.xml" path="doc/member[@key='text_structure.find_message_structure.Request#should_parse_recursively']/*"/>
...
public readonly partial struct FindMessageStructureRequestDescriptor
{
	...
	/// <include file="FindMessageStructureRequest.g.xml" path="doc/member[@key='text_structure.find_message_structure.Request#should_parse_recursively']/*"/>
	public Elastic.Clients.Elasticsearch.TextStructure.FindMessageStructureRequestDescriptor ShouldParseRecursively(bool? value = true)
	{
...
public readonly partial struct FindMessageStructureRequestDescriptor<TDocument>
{
	...
	/// <include file="FindMessageStructureRequest.g.xml" path="doc/member[@key='text_structure.find_message_structure.Request#should_parse_recursively']/*"/>
	public Elastic.Clients.Elasticsearch.TextStructure.FindMessageStructureRequestDescriptor<TDocument> ShouldParseRecursively(bool? value = true)
	{
		Instance.ShouldParseRecursively = value;
		return this;
	}
