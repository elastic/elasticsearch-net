...
public sealed partial class SearchMvtRequestDescriptor<TDocument> : RequestDescriptor<SearchMvtRequestDescriptor<TDocument>, SearchMvtRequestParameters>
{
	...
	private IDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>? AggsValue { get; set; }
	...
	/// <para>Supports the following aggregation types:<br/>- avg<br/>- cardinality<br/>- max<br/>- min<br/>- sum</para>
	/// </summary>
	public SearchMvtRequestDescriptor<TDocument> Aggs(Func<FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>, FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>> selector)
	{
		AggsValue = selector?.Invoke(new FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>());
		return Self;
	}
	...
	/// <para>Defines one or more runtime fields in the search request. These fields take<br/>precedence over mapped fields with the same name.</para>
	/// </summary>
	public SearchMvtRequestDescriptor<TDocument> RuntimeMappings(Func<FluentDictionary<Elastic.Clients.Elasticsearch.Field, Elastic.Clients.Elasticsearch.Mapping.RuntimeField>, FluentDictionary<Elastic.Clients.Elasticsearch.Field, Elastic.Clients.Elasticsearch.Mapping.RuntimeField>> selector)
	{
	...
	/// <para>Sorts features in the hits layer. By default, the API calculates a bounding<br/>box for each feature. It sorts features based on this box’s diagonal length,<br/>from longest to shortest.</para>
	/// </summary>
	public SearchMvtRequestDescriptor<TDocument> Sort(ICollection<Elastic.Clients.Elasticsearch.SortCombinations>? sort)
	{
		SortValue = sort;
		return Self;
	}
...
public sealed partial class SearchMvtRequestDescriptor : RequestDescriptor<SearchMvtRequestDescriptor, SearchMvtRequestParameters>
{
	...
	/// <para>Supports the following aggregation types:<br/>- avg<br/>- cardinality<br/>- max<br/>- min<br/>- sum</para>
	/// </summary>
	public SearchMvtRequestDescriptor Aggs(Func<FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>, FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>> selector)
	{
		AggsValue = selector?.Invoke(new FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>());
		return Self;
	}
	...
	/// <para>Defines one or more runtime fields in the search request. These fields take<br/>precedence over mapped fields with the same name.</para>
	/// </summary>
	public SearchMvtRequestDescriptor RuntimeMappings(Func<FluentDictionary<Elastic.Clients.Elasticsearch.Field, Elastic.Clients.Elasticsearch.Mapping.RuntimeField>, FluentDictionary<Elastic.Clients.Elasticsearch.Field, Elastic.Clients.Elasticsearch.Mapping.RuntimeField>> selector)
	{
		RuntimeMappingsValue = selector?.Invoke(new FluentDictionary<Elastic.Clients.Elasticsearch.Field, Elastic.Clients.Elasticsearch.Mapping.RuntimeField>());
		return Self;
	}
	...
	/// <para>Sorts features in the hits layer. By default, the API calculates a bounding<br/>box for each feature. It sorts features based on this box’s diagonal length,<br/>from longest to shortest.</para>
	/// </summary>
	public SearchMvtRequestDescriptor Sort(ICollection<Elastic.Clients.Elasticsearch.SortCombinations>? sort)
	{
		SortValue = sort;
		return Self;
	}
