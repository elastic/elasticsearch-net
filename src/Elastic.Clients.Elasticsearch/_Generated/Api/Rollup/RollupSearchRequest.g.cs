...
public sealed partial class RollupSearchRequestDescriptor<TDocument> : RequestDescriptor<RollupSearchRequestDescriptor<TDocument>, RollupSearchRequestParameters>
{
	...
	/// <para>Specifies aggregations.</para>
	/// </summary>
	public RollupSearchRequestDescriptor<TDocument> Aggregations(Func<FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>, FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>> selector)
	{
...
public sealed partial class RollupSearchRequestDescriptor : RequestDescriptor<RollupSearchRequestDescriptor, RollupSearchRequestParameters>
{
	...
	/// <para>Specifies aggregations.</para>
	/// </summary>
	public RollupSearchRequestDescriptor Aggregations(Func<FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>, FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>> selector)
	{
		AggregationsValue = selector?.Invoke(new FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>());
		return Self;
	}
