...
namespace Elastic.Clients.Elasticsearch.IndexManagement
{
	...
	public partial class OpenRequest : PlainRequestBase<OpenRequestParameters>
	{
	...
	public sealed partial class OpenRequestDescriptor<TDocument> : RequestDescriptorBase<OpenRequestDescriptor<TDocument>, OpenRequestParameters>
	{
		...
		public OpenRequestDescriptor<TDocument> ExpandWildcards(Elastic.Clients.Elasticsearch.ExpandWildcards? expandWildcards) => Qs("expand_wildcards", expandWildcards);
		...
		public OpenRequestDescriptor<TDocument> MasterTimeout(Elastic.Clients.Elasticsearch.Time? masterTimeout) => Qs("master_timeout", masterTimeout);
		public OpenRequestDescriptor<TDocument> Timeout(Elastic.Clients.Elasticsearch.Time? timeout) => Qs("timeout", timeout);
	...
	public sealed partial class OpenRequestDescriptor : RequestDescriptorBase<OpenRequestDescriptor, OpenRequestParameters>
	{
		...
		public OpenRequestDescriptor ExpandWildcards(Elastic.Clients.Elasticsearch.ExpandWildcards? expandWildcards) => Qs("expand_wildcards", expandWildcards);
		public OpenRequestDescriptor IgnoreUnavailable(bool? ignoreUnavailable = true) => Qs("ignore_unavailable", ignoreUnavailable);
		public OpenRequestDescriptor MasterTimeout(Elastic.Clients.Elasticsearch.Time? masterTimeout) => Qs("master_timeout", masterTimeout);
		public OpenRequestDescriptor Timeout(Elastic.Clients.Elasticsearch.Time? timeout) => Qs("timeout", timeout);
