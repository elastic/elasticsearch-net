...
public sealed partial class CancelResponse : Elastic.Transport.Products.Elasticsearch.ElasticsearchResponse
{
	...
	/// <include file="CancelResponse.g.xml" path="doc/member[@key='tasks.cancel.Response#nodes']/*"/>
	...
	/// <include file="CancelResponse.g.xml" path="doc/member[@key='tasks.cancel.Response#tasks']/*"/>
