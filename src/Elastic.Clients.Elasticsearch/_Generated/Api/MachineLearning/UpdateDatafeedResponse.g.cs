...
internal sealed partial class UpdateDatafeedResponseConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.MachineLearning.UpdateDatafeedResponse>
{
	...
	public override Elastic.Clients.Elasticsearch.MachineLearning.UpdateDatafeedResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		return new Elastic.Clients.Elasticsearch.MachineLearning.UpdateDatafeedResponse(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance)
		{
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, Elastic.Clients.Elasticsearch.MachineLearning.UpdateDatafeedResponse value, System.Text.Json.JsonSerializerOptions options)
	{
...
[System.Text.Json.Serialization.JsonConverter(typeof(Elastic.Clients.Elasticsearch.MachineLearning.UpdateDatafeedResponseConverter))]
public sealed partial class UpdateDatafeedResponse : Elastic.Transport.Products.Elasticsearch.ElasticsearchResponse
{
	...
	public UpdateDatafeedResponse(Elastic.Clients.Elasticsearch.MachineLearning.ChunkingConfig chunkingConfig, string datafeedId, System.Collections.Generic.IReadOnlyCollection<string> indices, string jobId, Elastic.Clients.Elasticsearch.QueryDsl.Query query, Elastic.Clients.Elasticsearch.Duration queryDelay, int scrollSize)
	{
