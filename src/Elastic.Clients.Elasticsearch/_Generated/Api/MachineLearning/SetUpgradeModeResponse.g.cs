...
[System.Text.Json.Serialization.JsonConverter(typeof(Elastic.Clients.Elasticsearch.MachineLearning.Json.SetUpgradeModeResponseConverter))]
public sealed partial class SetUpgradeModeResponse : Elastic.Transport.Products.Elasticsearch.ElasticsearchResponse
{
	...
	/// <include file="SetUpgradeModeResponse.g.xml" path="doc/member[@key='ml.set_upgrade_mode.Response#acknowledged']/*"/>
