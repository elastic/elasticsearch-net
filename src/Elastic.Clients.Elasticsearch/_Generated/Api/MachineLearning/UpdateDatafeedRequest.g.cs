...
public sealed partial class UpdateDatafeedRequest : Elastic.Clients.Elasticsearch.Requests.PlainRequest<Elastic.Clients.Elasticsearch.MachineLearning.UpdateDatafeedRequestParameters>
{
	...
	/// <include file="UpdateDatafeedRequest.g.xml" path="doc/member[@key='ml.update_datafeed.Request#max_consecutive_extraction_failures']/*"/>
	...
	/// <include file="UpdateDatafeedRequest.g.xml" path="doc/member[@key='ml.update_datafeed.Request#project_routing']/*"/>
...
public readonly partial struct UpdateDatafeedRequestDescriptor
{
	...
	/// <include file="UpdateDatafeedRequest.g.xml" path="doc/member[@key='ml.update_datafeed.Request#max_consecutive_extraction_failures']/*"/>
	public Elastic.Clients.Elasticsearch.MachineLearning.UpdateDatafeedRequestDescriptor MaxConsecutiveExtractionFailures(int? value)
	{
	...
	/// <include file="UpdateDatafeedRequest.g.xml" path="doc/member[@key='ml.update_datafeed.Request#project_routing']/*"/>
	public Elastic.Clients.Elasticsearch.MachineLearning.UpdateDatafeedRequestDescriptor ProjectRouting(string? value)
	{
...
public readonly partial struct UpdateDatafeedRequestDescriptor<TDocument>
{
	...
	/// <include file="UpdateDatafeedRequest.g.xml" path="doc/member[@key='ml.update_datafeed.Request#max_consecutive_extraction_failures']/*"/>
	public Elastic.Clients.Elasticsearch.MachineLearning.UpdateDatafeedRequestDescriptor<TDocument> MaxConsecutiveExtractionFailures(int? value)
	{
		Instance.MaxConsecutiveExtractionFailures = value;
		return this;
	}
	...
	/// <include file="UpdateDatafeedRequest.g.xml" path="doc/member[@key='ml.update_datafeed.Request#project_routing']/*"/>
	public Elastic.Clients.Elasticsearch.MachineLearning.UpdateDatafeedRequestDescriptor<TDocument> ProjectRouting(string? value)
	{
		Instance.ProjectRouting = value;
		return this;
	}
