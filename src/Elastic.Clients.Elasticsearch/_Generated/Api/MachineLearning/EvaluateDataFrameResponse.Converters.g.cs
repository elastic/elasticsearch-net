...
public sealed partial class EvaluateDataFrameResponseConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.MachineLearning.EvaluateDataFrameResponse>
{
	...
	{
		return new Elastic.Clients.Elasticsearch.MachineLearning.EvaluateDataFrameResponse(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance) { Result = reader.ReadValue<Elastic.Clients.Elasticsearch.MachineLearning.ResponseBody>(options, null) };
	}
