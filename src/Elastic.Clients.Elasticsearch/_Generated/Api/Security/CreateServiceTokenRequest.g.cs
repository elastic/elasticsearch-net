...
/// <include file="CreateServiceTokenRequest.g.xml" path="doc/member[@key='security.create_service_token.Request']/*"/>
...
{
	/// <include file="CreateServiceTokenRequest.g.xml" path="doc/member[@key='security.create_service_token.Request#refresh']/*"/>
	public Elastic.Clients.Elasticsearch.Refresh? Refresh { get => Q<Elastic.Clients.Elasticsearch.Refresh?>("refresh"); set => Q("refresh", value); }
}

/// <include file="CreateServiceTokenRequest.g.xml" path="doc/member[@key='security.create_service_token.Request']/*"/>
/// <include file="../../SpecReferences.xml" path="doc/member[@key='security.create_service_token.Request']/*"/>
[System.Text.Json.Serialization.JsonConverter(typeof(Elastic.Clients.Elasticsearch.Security.Json.CreateServiceTokenRequestConverter))]
public sealed partial class CreateServiceTokenRequest : Elastic.Clients.Elasticsearch.Requests.PlainRequest<Elastic.Clients.Elasticsearch.Security.CreateServiceTokenRequestParameters>
{
	...
	/// <include file="CreateServiceTokenRequest.g.xml" path="doc/member[@key='security.create_service_token.Request#name']/*"/>
	public Elastic.Clients.Elasticsearch.Name? Name { get => P<Elastic.Clients.Elasticsearch.Name?>("name"); set => PO("name", value); }

	/// <include file="CreateServiceTokenRequest.g.xml" path="doc/member[@key='security.create_service_token.Request#namespace']/*"/>
	public required string Namespace { get => P<string>("namespace"); set => PR("namespace", value); }

	/// <include file="CreateServiceTokenRequest.g.xml" path="doc/member[@key='security.create_service_token.Request#service']/*"/>
