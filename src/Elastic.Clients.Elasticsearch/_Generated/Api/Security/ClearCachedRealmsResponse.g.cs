...
internal sealed partial class ClearCachedRealmsResponseConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Security.ClearCachedRealmsResponse>
{
	...
	public override Elastic.Clients.Elasticsearch.Security.ClearCachedRealmsResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		return new Elastic.Clients.Elasticsearch.Security.ClearCachedRealmsResponse(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance)
		{
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, Elastic.Clients.Elasticsearch.Security.ClearCachedRealmsResponse value, System.Text.Json.JsonSerializerOptions options)
	{
...
[System.Text.Json.Serialization.JsonConverter(typeof(Elastic.Clients.Elasticsearch.Security.ClearCachedRealmsResponseConverter))]
public sealed partial class ClearCachedRealmsResponse : Elastic.Transport.Products.Elasticsearch.ElasticsearchResponse
{
	...
	public ClearCachedRealmsResponse(string clusterName, System.Collections.Generic.IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Security.ClusterNode> nodes, Elastic.Clients.Elasticsearch.NodeStatistics nodeStats)
	{
	...
	[System.Diagnostics.CodeAnalysis.SetsRequiredMembers]
	public ClearCachedRealmsResponse()
	{
	}

	[System.Diagnostics.CodeAnalysis.SetsRequiredMembers]
	internal ClearCachedRealmsResponse(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel sentinel)
	{
		_ = sentinel;
	}
