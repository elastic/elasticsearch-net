...
namespace Elastic.Clients.Elasticsearch.Shutdown
{
	...
	public partial class DeleteNodeRequest : PlainRequestBase<DeleteNodeRequestParameters>, IDeleteNodeRequest
	{
        ...
        public DeleteNodeRequest(Elastic.Clients.Elasticsearch.NodeId node_id) : base(r => r.Required("node_id", node_id))
		{
		}
	}
	...
	public partial class GetNodeRequest : PlainRequestBase<GetNodeRequestParameters>, IGetNodeRequest
	{
		...
		///<summary>/_nodes/{node_id}/shutdown</summary>
        public GetNodeRequest(Elastic.Clients.Elasticsearch.NodeIds node_id) : base(r => r.Required("node_id", node_id))
		{
		}
	}
	...
	public partial class PutNodeRequest : PlainRequestBase<PutNodeRequestParameters>, IPutNodeRequest
	{
		...
		///<summary>/_nodes/{node_id}/shutdown</summary>
        public PutNodeRequest(Elastic.Clients.Elasticsearch.NodeId node_id) : base(r => r.Required("node_id", node_id))
		{
		}
	}
}