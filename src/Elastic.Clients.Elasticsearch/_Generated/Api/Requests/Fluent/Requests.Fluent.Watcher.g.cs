...
namespace Elastic.Clients.Elasticsearch.Watcher
{
	...
	public partial class QueryWatchesDescriptor : RequestDescriptorBase<QueryWatchesDescriptor, QueryWatchesRequestParameters, IQueryWatchesRequest>, IQueryWatchesRequest
	{
		...
		Elastic.Clients.Elasticsearch.QueryDsl.QueryContainer? IQueryWatchesRequest.Query { get; set; }
		...
		public QueryWatchesDescriptor Query(Elastic.Clients.Elasticsearch.QueryDsl.QueryContainer? query) => Assign(query, (a, v) => a.Query = v);
