...
namespace Elastic.Clients.Elasticsearch
{
	...
	public partial class GetSourceDescriptor : RequestDescriptorBase<GetSourceDescriptor, GetSourceRequestParameters, IGetSourceRequest>, IGetSourceRequest
	{
		...
		protected override bool SupportsBody => false;
		///<summary>/{index}/_source/{id}</summary>
        public GetSourceDescriptor(Elastic.Clients.Elasticsearch.IndexName index, Elastic.Clients.Elasticsearch.Id id) : base(r => r.Required("index", index).Required("id", id))
		{
		}
	}
	...
	public partial class SearchMvtDescriptor : RequestDescriptorBase<SearchMvtDescriptor, SearchMvtRequestParameters, ISearchMvtRequest>, ISearchMvtRequest
	{
        ...
        public SearchMvtDescriptor(Elastic.Clients.Elasticsearch.Indices index, Elastic.Clients.Elasticsearch.Field field, int zoom, int x, int y) : base(r => r.Required("index", index).Required("field", field).Required("zoom", zoom).Required("x", x).Required("y", y))
		{
		}
