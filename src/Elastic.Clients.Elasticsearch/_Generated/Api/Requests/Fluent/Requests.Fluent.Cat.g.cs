...
namespace Elastic.Clients.Elasticsearch.Cat
{
	public partial class AliasesDescriptor : RequestDescriptorBase<AliasesDescriptor, AliasesRequestParameters, IAliasesRequest>, IAliasesRequest
	{
        ...
        public AliasesDescriptor(Elastic.Clients.Elasticsearch.Names? name) : base(r => r.Optional("name", name))
		{
		}

		public AliasesDescriptor ExpandWildcards(Elastic.Clients.Elasticsearch.ExpandWildcards? expandWildcards) => Qs("expand_wildcards", expandWildcards);
	}
	...
	public partial class AllocationDescriptor : RequestDescriptorBase<AllocationDescriptor, AllocationRequestParameters, IAllocationRequest>, IAllocationRequest
	{
        ...
        public AllocationDescriptor(Elastic.Clients.Elasticsearch.NodeIds? node_id) : base(r => r.Optional("node_id", node_id))
		{
		}

		public AllocationDescriptor Bytes(Elastic.Clients.Elasticsearch.Bytes? bytes) => Qs("bytes", bytes);
	}
	...
	public partial class FielddataDescriptor : RequestDescriptorBase<FielddataDescriptor, FielddataRequestParameters, IFielddataRequest>, IFielddataRequest
	{
        ...
        public FielddataDescriptor(Elastic.Clients.Elasticsearch.Fields? fields) : base(r => r.Optional("fields", fields))
		{
		}

		public FielddataDescriptor Bytes(Elastic.Clients.Elasticsearch.Bytes? bytes) => Qs("bytes", bytes);
	}
	...
	public partial class IndicesDescriptor : RequestDescriptorBase<IndicesDescriptor, IndicesRequestParameters, IIndicesRequest>, IIndicesRequest
	{
        ...
        public IndicesDescriptor(Elastic.Clients.Elasticsearch.Indices? index) : base(r => r.Optional("index", index))
		{
		}

		public IndicesDescriptor Bytes(Elastic.Clients.Elasticsearch.Bytes? bytes) => Qs("bytes", bytes);
		public IndicesDescriptor ExpandWildcards(Elastic.Clients.Elasticsearch.ExpandWildcards? expandWildcards) => Qs("expand_wildcards", expandWildcards);
		public IndicesDescriptor Health(Elastic.Clients.Elasticsearch.Health? health) => Qs("health", health);
	...
	public partial class MlDataFrameAnalyticsDescriptor : RequestDescriptorBase<MlDataFrameAnalyticsDescriptor, MlDataFrameAnalyticsRequestParameters, IMlDataFrameAnalyticsRequest>, IMlDataFrameAnalyticsRequest
	{
        ...
        public MlDataFrameAnalyticsDescriptor(Elastic.Clients.Elasticsearch.Id? id) : base(r => r.Optional("id", id))
		{
		}

		public MlDataFrameAnalyticsDescriptor AllowNoMatch(bool? allowNoMatch = true) => Qs("allow_no_match", allowNoMatch);
		public MlDataFrameAnalyticsDescriptor Bytes(Elastic.Clients.Elasticsearch.Bytes? bytes) => Qs("bytes", bytes);
	}
	...
	public partial class MlDatafeedsDescriptor : RequestDescriptorBase<MlDatafeedsDescriptor, MlDatafeedsRequestParameters, IMlDatafeedsRequest>, IMlDatafeedsRequest
	{
        ...
        public MlDatafeedsDescriptor(Elastic.Clients.Elasticsearch.Id? datafeed_id) : base(r => r.Optional("datafeed_id", datafeed_id))
		{
		}
	...
	public partial class MlJobsDescriptor : RequestDescriptorBase<MlJobsDescriptor, MlJobsRequestParameters, IMlJobsRequest>, IMlJobsRequest
	{
        ...
        public MlJobsDescriptor(Elastic.Clients.Elasticsearch.Id? job_id) : base(r => r.Optional("job_id", job_id))
		{
		}

		public MlJobsDescriptor AllowNoJobs(bool? allowNoJobs = true) => Qs("allow_no_jobs", allowNoJobs);
		public MlJobsDescriptor Bytes(Elastic.Clients.Elasticsearch.Bytes? bytes) => Qs("bytes", bytes);
	}
	...
	public partial class MlTrainedModelsDescriptor : RequestDescriptorBase<MlTrainedModelsDescriptor, MlTrainedModelsRequestParameters, IMlTrainedModelsRequest>, IMlTrainedModelsRequest
	{
        ...
        public MlTrainedModelsDescriptor(Elastic.Clients.Elasticsearch.Id? model_id) : base(r => r.Optional("model_id", model_id))
		{
		}

		public MlTrainedModelsDescriptor AllowNoMatch(bool? allowNoMatch = true) => Qs("allow_no_match", allowNoMatch);
		public MlTrainedModelsDescriptor Bytes(Elastic.Clients.Elasticsearch.Bytes? bytes) => Qs("bytes", bytes);
	...
	public partial class NodesDescriptor : RequestDescriptorBase<NodesDescriptor, NodesRequestParameters, INodesRequest>, INodesRequest
	{
		...
		public NodesDescriptor Bytes(Elastic.Clients.Elasticsearch.Bytes? bytes) => Qs("bytes", bytes);
	...
	public partial class RecoveryDescriptor : RequestDescriptorBase<RecoveryDescriptor, RecoveryRequestParameters, IRecoveryRequest>, IRecoveryRequest
	{
		...
		public RecoveryDescriptor Bytes(Elastic.Clients.Elasticsearch.Bytes? bytes) => Qs("bytes", bytes);
	...
	public partial class SegmentsDescriptor : RequestDescriptorBase<SegmentsDescriptor, SegmentsRequestParameters, ISegmentsRequest>, ISegmentsRequest
	{
		...
		public SegmentsDescriptor Bytes(Elastic.Clients.Elasticsearch.Bytes? bytes) => Qs("bytes", bytes);
	}
	...
	public partial class ShardsDescriptor : RequestDescriptorBase<ShardsDescriptor, ShardsRequestParameters, IShardsRequest>, IShardsRequest
	{
        ...
        public ShardsDescriptor(Elastic.Clients.Elasticsearch.Indices? index) : base(r => r.Optional("index", index))
		{
		}

		public ShardsDescriptor Bytes(Elastic.Clients.Elasticsearch.Bytes? bytes) => Qs("bytes", bytes);
	}
	...
	public partial class SnapshotsDescriptor : RequestDescriptorBase<SnapshotsDescriptor, SnapshotsRequestParameters, ISnapshotsRequest>, ISnapshotsRequest
	{
        ...
        public SnapshotsDescriptor(Elastic.Clients.Elasticsearch.Names? repository) : base(r => r.Optional("repository", repository))
		{
		}
	...
	public partial class TemplatesDescriptor : RequestDescriptorBase<TemplatesDescriptor, TemplatesRequestParameters, ITemplatesRequest>, ITemplatesRequest
	{
        ...
        public TemplatesDescriptor(Elastic.Clients.Elasticsearch.Name? name) : base(r => r.Optional("name", name))
		{
		}
	}
	...
	public partial class ThreadPoolDescriptor : RequestDescriptorBase<ThreadPoolDescriptor, ThreadPoolRequestParameters, IThreadPoolRequest>, IThreadPoolRequest
	{
        ...
        public ThreadPoolDescriptor(Elastic.Clients.Elasticsearch.Names? thread_pool_patterns) : base(r => r.Optional("thread_pool_patterns", thread_pool_patterns))
		{
		}

		public ThreadPoolDescriptor Size(Union<Elastic.Clients.Elasticsearch.Size, bool>? size) => Qs("size", size);
	}
	...
	public partial class TransformsDescriptor : RequestDescriptorBase<TransformsDescriptor, TransformsRequestParameters, ITransformsRequest>, ITransformsRequest
	{
        ...
        public TransformsDescriptor(Elastic.Clients.Elasticsearch.Id? transform_id) : base(r => r.Optional("transform_id", transform_id))
		{
		}
