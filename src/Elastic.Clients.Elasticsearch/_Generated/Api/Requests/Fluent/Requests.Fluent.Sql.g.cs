...
namespace Elastic.Clients.Elasticsearch.Sql
{
	...
	public partial class QueryDescriptor : RequestDescriptorBase<QueryDescriptor, QueryRequestParameters, IQueryRequest>, IQueryRequest
	{
		...
		Elastic.Clients.Elasticsearch.QueryDsl.IQueryContainer? IQueryRequest.Filter { get; set; }

		string? IQueryRequest.Query { get; set; }

		Elastic.Clients.Elasticsearch.Time? IQueryRequest.RequestTimeout { get; set; }

		Elastic.Clients.Elasticsearch.Time? IQueryRequest.PageTimeout { get; set; }
		...
		public QueryDescriptor Filter(Elastic.Clients.Elasticsearch.QueryDsl.IQueryContainer? filter) => Assign(filter, (a, v) => a.Filter = v);
		public QueryDescriptor Query(string? query) => Assign(query, (a, v) => a.Query = v);
		public QueryDescriptor RequestTimeout(Elastic.Clients.Elasticsearch.Time? requestTimeout) => Assign(requestTimeout, (a, v) => a.RequestTimeout = v);
		public QueryDescriptor PageTimeout(Elastic.Clients.Elasticsearch.Time? pageTimeout) => Assign(pageTimeout, (a, v) => a.PageTimeout = v);
	...
	public partial class TranslateDescriptor : RequestDescriptorBase<TranslateDescriptor, TranslateRequestParameters, ITranslateRequest>, ITranslateRequest
	{
		...
		Elastic.Clients.Elasticsearch.QueryDsl.IQueryContainer? ITranslateRequest.Filter { get; set; }
		...
		public TranslateDescriptor Filter(Elastic.Clients.Elasticsearch.QueryDsl.IQueryContainer? filter) => Assign(filter, (a, v) => a.Filter = v);
