...
public sealed partial class KuromojiIterationMarkCharFilterConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Analysis.KuromojiIterationMarkCharFilter>
{
	private static readonly System.Text.Json.JsonEncodedText PropNormalizeKana = System.Text.Json.JsonEncodedText.Encode("normalize_kana"u8);
	private static readonly System.Text.Json.JsonEncodedText PropNormalizeKanji = System.Text.Json.JsonEncodedText.Encode("normalize_kanji"u8);
