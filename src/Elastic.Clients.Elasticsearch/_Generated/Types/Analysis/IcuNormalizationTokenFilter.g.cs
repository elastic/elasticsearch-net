...
/// <include file="../../SpecReferences.xml" path="doc/member[@key='_types.analysis.IcuNormalizationTokenFilter']/*"/>
...
public sealed partial class IcuNormalizationTokenFilter : Elastic.Clients.Elasticsearch.Analysis.ITokenFilter
{
	...
	public required Elastic.Clients.Elasticsearch.Analysis.IcuNormalizationType Name { get; set; }
