...
public sealed partial class PercentageConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Percentage>
{
	public override Elastic.Clients.Elasticsearch.Percentage Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		{
			1 => new Elastic.Clients.Elasticsearch.Percentage(reader.ReadValue<string>(options, null)),
			2 => new Elastic.Clients.Elasticsearch.Percentage(reader.ReadValue<float>(options, null)),
