...
public sealed partial class IndexUpdateAliasesActionDescriptor : SerializableDescriptor<IndexUpdateAliasesActionDescriptor>
{
	...
	public IndexUpdateAliasesActionDescriptor Add(Action<Elastic.Clients.Elasticsearch.IndexManagement.AddActionDescriptor> configure) => Set(configure, "add");
	public IndexUpdateAliasesActionDescriptor Add<TDocument>(Action<Elastic.Clients.Elasticsearch.IndexManagement.AddActionDescriptor<TDocument>> configure) => Set(configure, "add");
