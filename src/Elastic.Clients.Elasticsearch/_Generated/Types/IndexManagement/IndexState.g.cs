...
public readonly partial struct IndexStateDescriptor<TDocument>
{
	...
	public Elastic.Clients.Elasticsearch.IndexManagement.IndexStateDescriptor<TDocument> Aliases(System.Action<Elastic.Clients.Elasticsearch.Fluent.FluentIDictionaryOfIndexNameAlias<TDocument>>? action)
	{
...
public readonly partial struct IndexStateDescriptor
{
	...
	public Elastic.Clients.Elasticsearch.IndexManagement.IndexStateDescriptor Aliases(System.Action<Elastic.Clients.Elasticsearch.Fluent.FluentIDictionaryOfIndexNameAlias>? action)
	{
		Instance.Aliases = Elastic.Clients.Elasticsearch.Fluent.FluentIDictionaryOfIndexNameAlias.Build(action);
		return this;
	}

	public Elastic.Clients.Elasticsearch.IndexManagement.IndexStateDescriptor Aliases<T>(System.Action<Elastic.Clients.Elasticsearch.Fluent.FluentIDictionaryOfIndexNameAlias<T>>? action)
	{
