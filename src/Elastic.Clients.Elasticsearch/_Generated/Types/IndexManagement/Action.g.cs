...
public sealed partial class Action
{
	...
	public static Action Remove(Elastic.Clients.Elasticsearch.IndexManagement.RemoveAction removeAction) => new Action("remove", removeAction);
	public static Action RemoveIndex(Elastic.Clients.Elasticsearch.IndexManagement.RemoveIndexAction removeIndexAction) => new Action("remove_index", removeIndexAction);
}
