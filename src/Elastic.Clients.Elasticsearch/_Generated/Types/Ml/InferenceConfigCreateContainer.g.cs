...
namespace Elastic.Clients.Elasticsearch.Ml
{
	...
	{
		internal InferenceConfigCreateContainer(string variantName, IInferenceConfigCreateVariant variant)
		{
	...
	public sealed partial class InferenceConfigCreateContainerDescriptor<TDocument> : SerializableDescriptorBase<InferenceConfigCreateContainerDescriptor<TDocument>>
	{
		...
		{
			if (ContainsVariant)
				throw new InvalidOperationException("A variant has already been assigned to the InferenceConfigCreateContainerDescriptor. Only a single InferenceConfigCreateContainer can be added to this container type.");
		...
		{
			if (ContainsVariant)
				throw new Exception("A variant has already been assigned to the InferenceConfigCreateContainerDescriptor. Only a single InferenceConfigCreateContainer can be added to this container type.");
