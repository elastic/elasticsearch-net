...
{
	public partial class DataframeEvaluationOutlierDetection : IDataframeEvaluationContainerVariant
	{
		[JsonIgnore]
		string IDataframeEvaluationContainerVariant.DataframeEvaluationContainerVariantName => "outlier_detection";
		[JsonInclude]
