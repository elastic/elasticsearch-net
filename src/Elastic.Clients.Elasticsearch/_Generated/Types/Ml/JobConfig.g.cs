...
namespace Elastic.Clients.Elasticsearch.Ml
{
	...
	public sealed partial class JobConfigDescriptor<TDocument> : SerializableDescriptorBase<JobConfigDescriptor<TDocument>>
	{
		...
		private string? JobTypeValue { get; set; }
		...
		public JobConfigDescriptor<TDocument> AnalysisConfig(Elastic.Clients.Elasticsearch.Ml.AnalysisConfig analysisConfig)
		{
		...
		public JobConfigDescriptor<TDocument> AnalysisConfig(AnalysisConfigDescriptor<TDocument> descriptor)
		{
		...
		public JobConfigDescriptor<TDocument> DataDescription(Elastic.Clients.Elasticsearch.Ml.DataDescription dataDescription)
		{
		...
		public JobConfigDescriptor<TDocument> DataDescription(DataDescriptionDescriptor<TDocument> descriptor)
		{
		...
		public JobConfigDescriptor<TDocument> DatafeedConfig(Elastic.Clients.Elasticsearch.Ml.DatafeedConfig? datafeedConfig)
		{
		...
		public JobConfigDescriptor<TDocument> DatafeedConfig(DatafeedConfigDescriptor<TDocument> descriptor)
		{
		...
		public JobConfigDescriptor<TDocument> ModelPlotConfig(Elastic.Clients.Elasticsearch.Ml.ModelPlotConfig? modelPlotConfig)
		{
		...
		public JobConfigDescriptor<TDocument> ModelPlotConfig(ModelPlotConfigDescriptor<TDocument> descriptor)
		{
		...
		public JobConfigDescriptor<TDocument> AllowLazyOpen(bool? allowLazyOpen = true)
		{
			AllowLazyOpenValue = allowLazyOpen;
			return Self;
		}

		public JobConfigDescriptor<TDocument> AnalysisLimits(Elastic.Clients.Elasticsearch.Ml.AnalysisLimits? analysisLimits)
		{
		...
		public JobConfigDescriptor<TDocument> AnalysisLimits(AnalysisLimitsDescriptor descriptor)
		{
		...
		public JobConfigDescriptor<TDocument> CustomSettings(object? customSettings)
		{
			CustomSettingsValue = customSettings;
			return Self;
		}

		public JobConfigDescriptor<TDocument> DailyModelSnapshotRetentionAfterDays(long? dailyModelSnapshotRetentionAfterDays)
		{
			DailyModelSnapshotRetentionAfterDaysValue = dailyModelSnapshotRetentionAfterDays;
			return Self;
		}

		public JobConfigDescriptor<TDocument> Description(string? description)
		{
			DescriptionValue = description;
			return Self;
		}

		public JobConfigDescriptor<TDocument> Groups(IEnumerable<string>? groups)
		{
			GroupsValue = groups;
			return Self;
		}

		public JobConfigDescriptor<TDocument> JobId(Elastic.Clients.Elasticsearch.Id? jobId)
		{
			JobIdValue = jobId;
			return Self;
		}

		public JobConfigDescriptor<TDocument> JobType(string? jobType)
		{
			JobTypeValue = jobType;
			return Self;
		}

		public JobConfigDescriptor<TDocument> ModelSnapshotRetentionDays(long? modelSnapshotRetentionDays)
		{
			ModelSnapshotRetentionDaysValue = modelSnapshotRetentionDays;
			return Self;
		}

		public JobConfigDescriptor<TDocument> RenormalizationWindowDays(long? renormalizationWindowDays)
		{
			RenormalizationWindowDaysValue = renormalizationWindowDays;
			return Self;
		}

		public JobConfigDescriptor<TDocument> ResultsIndexName(Elastic.Clients.Elasticsearch.IndexName? resultsIndexName)
		{
			ResultsIndexNameValue = resultsIndexName;
			return Self;
		}

		public JobConfigDescriptor<TDocument> ResultsRetentionDays(long? resultsRetentionDays)
		{
		...
		protected override void Serialize(Utf8JsonWriter writer, JsonSerializerOptions options, IElasticsearchClientSettings settings)
		{
			...
			if (!string.IsNullOrEmpty(JobTypeValue))
			{
				writer.WritePropertyName("job_type");
				writer.WriteStringValue(JobTypeValue);
			}
	...
	public sealed partial class JobConfigDescriptor : SerializableDescriptorBase<JobConfigDescriptor>
	{
		...
		public JobConfigDescriptor AnalysisConfig(Elastic.Clients.Elasticsearch.Ml.AnalysisConfig analysisConfig)
		{
			AnalysisConfigDescriptor = null;
			AnalysisConfigDescriptorAction = null;
			AnalysisConfigValue = analysisConfig;
		...
		public JobConfigDescriptor AnalysisConfig(AnalysisConfigDescriptor descriptor)
		{
			AnalysisConfigValue = null;
			AnalysisConfigDescriptorAction = null;
			AnalysisConfigDescriptor = descriptor;
		...
		public JobConfigDescriptor DataDescription(Elastic.Clients.Elasticsearch.Ml.DataDescription dataDescription)
		{
			DataDescriptionDescriptor = null;
			DataDescriptionDescriptorAction = null;
			DataDescriptionValue = dataDescription;
		...
		public JobConfigDescriptor DataDescription(DataDescriptionDescriptor descriptor)
		{
			DataDescriptionValue = null;
			DataDescriptionDescriptorAction = null;
			DataDescriptionDescriptor = descriptor;
		...
		public JobConfigDescriptor DatafeedConfig(Elastic.Clients.Elasticsearch.Ml.DatafeedConfig? datafeedConfig)
		{
			DatafeedConfigDescriptor = null;
			DatafeedConfigDescriptorAction = null;
			DatafeedConfigValue = datafeedConfig;
		...
		public JobConfigDescriptor DatafeedConfig(DatafeedConfigDescriptor descriptor)
		{
			DatafeedConfigValue = null;
			DatafeedConfigDescriptorAction = null;
			DatafeedConfigDescriptor = descriptor;
		...
		public JobConfigDescriptor ModelPlotConfig(Elastic.Clients.Elasticsearch.Ml.ModelPlotConfig? modelPlotConfig)
		{
			ModelPlotConfigDescriptor = null;
			ModelPlotConfigDescriptorAction = null;
			ModelPlotConfigValue = modelPlotConfig;
		...
		public JobConfigDescriptor ModelPlotConfig(ModelPlotConfigDescriptor descriptor)
		{
			ModelPlotConfigValue = null;
			ModelPlotConfigDescriptorAction = null;
			ModelPlotConfigDescriptor = descriptor;
		...
		public JobConfigDescriptor AllowLazyOpen(bool? allowLazyOpen = true)
		{
			AllowLazyOpenValue = allowLazyOpen;
			return Self;
		}

		public JobConfigDescriptor AnalysisLimits(Elastic.Clients.Elasticsearch.Ml.AnalysisLimits? analysisLimits)
		{
			AnalysisLimitsDescriptor = null;
			AnalysisLimitsDescriptorAction = null;
			AnalysisLimitsValue = analysisLimits;
		...
		public JobConfigDescriptor AnalysisLimits(AnalysisLimitsDescriptor descriptor)
		{
			AnalysisLimitsValue = null;
			AnalysisLimitsDescriptorAction = null;
			AnalysisLimitsDescriptor = descriptor;
		...
		public JobConfigDescriptor CustomSettings(object? customSettings)
		{
			CustomSettingsValue = customSettings;
			return Self;
		}

		public JobConfigDescriptor DailyModelSnapshotRetentionAfterDays(long? dailyModelSnapshotRetentionAfterDays)
		{
			DailyModelSnapshotRetentionAfterDaysValue = dailyModelSnapshotRetentionAfterDays;
			return Self;
		}

		public JobConfigDescriptor Description(string? description)
		{
			DescriptionValue = description;
			return Self;
		}

		public JobConfigDescriptor Groups(IEnumerable<string>? groups)
		{
			GroupsValue = groups;
			return Self;
		}

		public JobConfigDescriptor JobId(Elastic.Clients.Elasticsearch.Id? jobId)
		{
			JobIdValue = jobId;
			return Self;
		}

		public JobConfigDescriptor JobType(string? jobType)
		{
			JobTypeValue = jobType;
			return Self;
		}

		public JobConfigDescriptor ModelSnapshotRetentionDays(long? modelSnapshotRetentionDays)
		{
			ModelSnapshotRetentionDaysValue = modelSnapshotRetentionDays;
			return Self;
		}

		public JobConfigDescriptor RenormalizationWindowDays(long? renormalizationWindowDays)
		{
			RenormalizationWindowDaysValue = renormalizationWindowDays;
			return Self;
		}

		public JobConfigDescriptor ResultsIndexName(Elastic.Clients.Elasticsearch.IndexName? resultsIndexName)
		{
			ResultsIndexNameValue = resultsIndexName;
			return Self;
		}

		public JobConfigDescriptor ResultsRetentionDays(long? resultsRetentionDays)
		{
			ResultsRetentionDaysValue = resultsRetentionDays;
			return Self;
		}
