...
namespace Elastic.Clients.Elasticsearch.Ml
{
	...
	public sealed partial class PreprocessorDescriptor<TDocument> : SerializableDescriptorBase<PreprocessorDescriptor<TDocument>>
	{
		...
		{
			if (ContainsVariant)
				throw new InvalidOperationException("A variant has already been assigned to the PreprocessorDescriptor. Only a single Preprocessor can be added to this container type.");
		...
		{
			if (ContainsVariant)
				throw new Exception("A variant has already been assigned to the PreprocessorDescriptor. Only a single Preprocessor can be added to this container type.");
