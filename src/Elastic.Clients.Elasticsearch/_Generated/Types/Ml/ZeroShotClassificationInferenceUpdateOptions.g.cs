...
{
	public partial class ZeroShotClassificationInferenceUpdateOptions : IInferenceConfigUpdateVariant
	{
		[JsonIgnore]
		string IInferenceConfigUpdateVariant.InferenceConfigUpdateVariantName => "zero_shot_classification";
		[JsonInclude]
