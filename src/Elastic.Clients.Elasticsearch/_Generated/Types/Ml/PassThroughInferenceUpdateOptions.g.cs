...
{
	public partial class PassThroughInferenceUpdateOptions : IInferenceConfigUpdateVariant
	{
		[JsonIgnore]
		string IInferenceConfigUpdateVariant.InferenceConfigUpdateVariantName => "pass_through";
		[JsonInclude]
