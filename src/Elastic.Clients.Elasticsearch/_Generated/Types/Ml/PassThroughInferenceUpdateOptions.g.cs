...
{
	public partial class PassThroughInferenceUpdateOptions : IInferenceConfigUpdateContainerVariant
	{
		[JsonIgnore]
		string IInferenceConfigUpdateContainerVariant.InferenceConfigUpdateContainerVariantName => "pass_through";
		[JsonInclude]
	...
	public sealed partial class PassThroughInferenceUpdateOptionsDescriptor : SerializableDescriptorBase<PassThroughInferenceUpdateOptionsDescriptor>
	{
		...
		public PassThroughInferenceUpdateOptionsDescriptor Tokenization(Elastic.Clients.Elasticsearch.Ml.NlpTokenizationUpdateOptions? tokenization)
		{
		...
		public PassThroughInferenceUpdateOptionsDescriptor Tokenization(NlpTokenizationUpdateOptionsDescriptor descriptor)
		{
		...
		public PassThroughInferenceUpdateOptionsDescriptor Tokenization(Action<NlpTokenizationUpdateOptionsDescriptor> configure)
		{
			TokenizationValue = null;
			TokenizationDescriptor = null;
