...
{
	public partial class DataframeEvaluationClassificationMetrics : DataframeEvaluationMetrics
	{
		[JsonInclude]
	...
	public sealed partial class DataframeEvaluationClassificationMetricsDescriptor : SerializableDescriptorBase<DataframeEvaluationClassificationMetricsDescriptor>
	{
		...
		private Dictionary<string, object>? AccuracyValue { get; set; }
		...
		private Dictionary<string, object>? MulticlassConfusionMatrixValue { get; set; }
		...
		public DataframeEvaluationClassificationMetricsDescriptor AucRoc(Elastic.Clients.Elasticsearch.Ml.DataframeEvaluationClassificationMetricsAucRoc? aucRoc)
		{
		...
		public DataframeEvaluationClassificationMetricsDescriptor AucRoc(DataframeEvaluationClassificationMetricsAucRocDescriptor descriptor)
		{
			AucRocValue = null;
			AucRocDescriptorAction = null;
		...
		public DataframeEvaluationClassificationMetricsDescriptor AucRoc(Action<DataframeEvaluationClassificationMetricsAucRocDescriptor> configure)
		{
			AucRocValue = null;
			AucRocDescriptorAction = null;
