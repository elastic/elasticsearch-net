...
/// <include file="../../SpecReferences.xml" path="doc/member[@key='_types.mapping.UnsignedLongNumberProperty']/*"/>
...
public sealed partial class UnsignedLongNumberProperty : Elastic.Clients.Elasticsearch.Mapping.IProperty
{
	...
	/// <include file="UnsignedLongNumberProperty.g.xml" path="doc/member[@key='_types.mapping.UnsignedLongNumberProperty#meta']/*"/>
	...
	/// <include file="UnsignedLongNumberProperty.g.xml" path="doc/member[@key='_types.mapping.UnsignedLongNumberProperty#time_series_dimension']/*"/>
	public bool? TimeSeriesDimension { get; set; }

	/// <include file="UnsignedLongNumberProperty.g.xml" path="doc/member[@key='_types.mapping.UnsignedLongNumberProperty#time_series_metric']/*"/>
...
public readonly partial struct UnsignedLongNumberPropertyDescriptor<TDocument>
{
	...
	public Elastic.Clients.Elasticsearch.Mapping.UnsignedLongNumberPropertyDescriptor<TDocument> DocValues(Elastic.Clients.Elasticsearch.Union<bool, Elastic.Clients.Elasticsearch.Mapping.DocValuesConfig>? value)
	{
...
public readonly partial struct UnsignedLongNumberPropertyDescriptor
{
	...
	public Elastic.Clients.Elasticsearch.Mapping.UnsignedLongNumberPropertyDescriptor DocValues(Elastic.Clients.Elasticsearch.Union<bool, Elastic.Clients.Elasticsearch.Mapping.DocValuesConfig>? value)
	{
		Instance.DocValues = value;
		return this;
	}
