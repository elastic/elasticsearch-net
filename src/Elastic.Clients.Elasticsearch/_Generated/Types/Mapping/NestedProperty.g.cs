...
public readonly partial struct NestedPropertyDescriptor<TDocument>
{
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Mapping.NestedPropertyDescriptor<TDocument> Meta(System.Action<Elastic.Clients.Elasticsearch.Fluent.FluentIDictionaryOfStringString>? action)
	{
...
public readonly partial struct NestedPropertyDescriptor
{
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Mapping.NestedPropertyDescriptor Meta(System.Action<Elastic.Clients.Elasticsearch.Fluent.FluentIDictionaryOfStringString>? action)
	{
		Instance.Meta = Elastic.Clients.Elasticsearch.Fluent.FluentIDictionaryOfStringString.Build(action);
		return this;
	}
