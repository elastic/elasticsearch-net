...
namespace Elastic.Clients.Elasticsearch.Mapping
{
	...
	public sealed partial class HalfFloatNumberPropertyDescriptor<TDocument> : SerializableDescriptorBase<HalfFloatNumberPropertyDescriptor<TDocument>>
	{
		...
		public HalfFloatNumberPropertyDescriptor<TDocument> Name(Elastic.Clients.Elasticsearch.PropertyName? name)
		{
			NameValue = name;
			return Self;
		}

		public HalfFloatNumberPropertyDescriptor<TDocument> Name<TValue>(Expression<Func<TDocument, TValue>> name)
		{
			NameValue = name;
			return Self;
		}
	...
	public sealed partial class HalfFloatNumberPropertyDescriptor : SerializableDescriptorBase<HalfFloatNumberPropertyDescriptor>
	{
		...
		public HalfFloatNumberPropertyDescriptor Name(Elastic.Clients.Elasticsearch.PropertyName? name)
		{
			NameValue = name;
			return Self;
		}

		public HalfFloatNumberPropertyDescriptor Name<TDocument, TValue>(Expression<Func<TDocument, TValue>> name)
		{
			NameValue = name;
			return Self;
		}

		public HalfFloatNumberPropertyDescriptor Name<TDocument>(Expression<Func<TDocument, object>> name)
		{
			NameValue = name;
			return Self;
		}
