...
namespace Elastic.Clients.Elasticsearch.Mapping
{
	...
	public sealed partial class IntegerRangePropertyDescriptor<TDocument> : SerializableDescriptorBase<IntegerRangePropertyDescriptor<TDocument>>
	{
		...
		public IntegerRangePropertyDescriptor<TDocument> Name(Elastic.Clients.Elasticsearch.PropertyName? name)
		{
			NameValue = name;
			return Self;
		}

		public IntegerRangePropertyDescriptor<TDocument> Name<TValue>(Expression<Func<TDocument, TValue>> name)
		{
			NameValue = name;
			return Self;
		}
	...
	public sealed partial class IntegerRangePropertyDescriptor : SerializableDescriptorBase<IntegerRangePropertyDescriptor>
	{
		...
		public IntegerRangePropertyDescriptor Name(Elastic.Clients.Elasticsearch.PropertyName? name)
		{
			NameValue = name;
			return Self;
		}

		public IntegerRangePropertyDescriptor Name<TDocument, TValue>(Expression<Func<TDocument, TValue>> name)
		{
			NameValue = name;
			return Self;
		}

		public IntegerRangePropertyDescriptor Name<TDocument>(Expression<Func<TDocument, object>> name)
		{
			NameValue = name;
			return Self;
		}
