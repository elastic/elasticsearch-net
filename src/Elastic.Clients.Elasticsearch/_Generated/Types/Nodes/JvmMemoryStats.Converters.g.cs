...
{
	private static readonly System.Text.Json.JsonEncodedText PropHeapCommitted = System.Text.Json.JsonEncodedText.Encode("heap_committed"u8);
	...
	private static readonly System.Text.Json.JsonEncodedText PropNonHeapCommitted = System.Text.Json.JsonEncodedText.Encode("non_heap_committed"u8);
	...
	private static readonly System.Text.Json.JsonEncodedText PropNonHeapUsed = System.Text.Json.JsonEncodedText.Encode("non_heap_used"u8);
	...
	public override Elastic.Clients.Elasticsearch.Nodes.JvmMemoryStats Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonValue<Elastic.Clients.Elasticsearch.ByteSize?> propHeapCommitted = default;
		...
		LocalJsonValue<Elastic.Clients.Elasticsearch.ByteSize?> propNonHeapCommitted = default;
		LocalJsonValue<long?> propNonHeapCommittedInBytes = default;
		LocalJsonValue<Elastic.Clients.Elasticsearch.ByteSize?> propNonHeapUsed = default;
		...
		{
			if (propHeapCommitted.TryReadProperty(ref reader, options, PropHeapCommitted, null))
			{
				continue;
			}
			...
			if (propNonHeapCommitted.TryReadProperty(ref reader, options, PropNonHeapCommitted, null))
			{
				continue;
			}
			...
			if (propNonHeapUsed.TryReadProperty(ref reader, options, PropNonHeapUsed, null))
			{
				continue;
			}
		...
		{
			HeapCommitted = propHeapCommitted.Value,
			...
			NonHeapCommitted = propNonHeapCommitted.Value,
			NonHeapCommittedInBytes = propNonHeapCommittedInBytes.Value,
			NonHeapUsed = propNonHeapUsed.Value,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, Elastic.Clients.Elasticsearch.Nodes.JvmMemoryStats value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropHeapCommitted, value.HeapCommitted, null, null);
		...
		writer.WriteProperty(options, PropNonHeapCommitted, value.NonHeapCommitted, null, null);
		...
		writer.WriteProperty(options, PropNonHeapUsed, value.NonHeapUsed, null, null);
