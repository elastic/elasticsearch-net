...
internal sealed partial class FlushStatsConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.FlushStats>
{
	...
	public override Elastic.Clients.Elasticsearch.FlushStats Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		{
			if (propPeriodic.TryReadProperty(ref reader, options, PropPeriodic, null))
			{
				continue;
			}
		...
		return new Elastic.Clients.Elasticsearch.FlushStats(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance)
		{
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, Elastic.Clients.Elasticsearch.FlushStats value, System.Text.Json.JsonSerializerOptions options)
	{
...
[System.Text.Json.Serialization.JsonConverter(typeof(Elastic.Clients.Elasticsearch.FlushStatsConverter))]
