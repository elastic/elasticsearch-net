...
{
	public partial class KeyValueProcessor : ProcessorBase, IProcessorVariant
	{
		[JsonIgnore]
		string IProcessorVariant.ProcessorVariantName => "kv";
		[JsonInclude]
	...
	public sealed partial class KeyValueProcessorDescriptor<TDocument> : SerializableDescriptorBase<KeyValueProcessorDescriptor<TDocument>>
	{
		...
		public KeyValueProcessorDescriptor<TDocument> OnFailure(ProcessorContainerDescriptor<TDocument> descriptor)
		{
			OnFailureValue = null;
			OnFailureDescriptorAction = null;
			OnFailureDescriptorActions = null;
		...
		public KeyValueProcessorDescriptor<TDocument> OnFailure(Action<ProcessorContainerDescriptor<TDocument>> configure)
		{
			OnFailureValue = null;
			OnFailureDescriptor = null;
			OnFailureDescriptorActions = null;
		...
		public KeyValueProcessorDescriptor<TDocument> OnFailure(params Action<ProcessorContainerDescriptor<TDocument>>[] configure)
		{
			OnFailureValue = null;
			OnFailureDescriptor = null;
			OnFailureDescriptorAction = null;
	...
	public sealed partial class KeyValueProcessorDescriptor : SerializableDescriptorBase<KeyValueProcessorDescriptor>
	{
		...
		public KeyValueProcessorDescriptor OnFailure(ProcessorContainerDescriptor descriptor)
		{
			OnFailureValue = null;
			OnFailureDescriptorAction = null;
			OnFailureDescriptorActions = null;
		...
		public KeyValueProcessorDescriptor OnFailure(Action<ProcessorContainerDescriptor> configure)
		{
			OnFailureValue = null;
			OnFailureDescriptor = null;
			OnFailureDescriptorActions = null;
