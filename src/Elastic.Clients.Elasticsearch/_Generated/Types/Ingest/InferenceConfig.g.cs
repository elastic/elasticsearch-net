...
public sealed partial class InferenceConfigDescriptor : SerializableDescriptor<InferenceConfigDescriptor>
{
	...
	public InferenceConfigDescriptor Classification(Action<Elastic.Clients.Elasticsearch.Ingest.InferenceConfigClassificationDescriptor> configure) => Set(configure, "classification");
	public InferenceConfigDescriptor Classification<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.InferenceConfigClassificationDescriptor<TDocument>> configure) => Set(configure, "classification");
	...
	public InferenceConfigDescriptor Regression(Action<Elastic.Clients.Elasticsearch.Ingest.InferenceConfigRegressionDescriptor> configure) => Set(configure, "regression");
	public InferenceConfigDescriptor Regression<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.InferenceConfigRegressionDescriptor<TDocument>> configure) => Set(configure, "regression");
