...
public sealed partial class Pipeline
{
	...
	/// <include file="Pipeline.g.xml" path="doc/member[@key='ingest._types.Pipeline#created_date']/*"/>
	public System.DateTimeOffset? CreatedDate { get; set; }

	/// <include file="Pipeline.g.xml" path="doc/member[@key='ingest._types.Pipeline#created_date_millis']/*"/>
	...
	/// <include file="Pipeline.g.xml" path="doc/member[@key='ingest._types.Pipeline#field_access_pattern']/*"/>
	...
	/// <include file="Pipeline.g.xml" path="doc/member[@key='ingest._types.Pipeline#modified_date']/*"/>
	public System.DateTimeOffset? ModifiedDate { get; set; }

	/// <include file="Pipeline.g.xml" path="doc/member[@key='ingest._types.Pipeline#modified_date_millis']/*"/>
