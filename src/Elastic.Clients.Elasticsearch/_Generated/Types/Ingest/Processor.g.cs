...
public sealed partial class ProcessorDescriptor : SerializableDescriptor<ProcessorDescriptor>
{
	...
	public ProcessorDescriptor Append(Action<Elastic.Clients.Elasticsearch.Ingest.AppendProcessorDescriptor> configure) => Set(configure, "append");
	public ProcessorDescriptor Append<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.AppendProcessorDescriptor<TDocument>> configure) => Set(configure, "append");
	...
	public ProcessorDescriptor Attachment(Action<Elastic.Clients.Elasticsearch.Ingest.AttachmentProcessorDescriptor> configure) => Set(configure, "attachment");
	public ProcessorDescriptor Attachment<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.AttachmentProcessorDescriptor<TDocument>> configure) => Set(configure, "attachment");
	...
	public ProcessorDescriptor Bytes(Action<Elastic.Clients.Elasticsearch.Ingest.BytesProcessorDescriptor> configure) => Set(configure, "bytes");
	public ProcessorDescriptor Bytes<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.BytesProcessorDescriptor<TDocument>> configure) => Set(configure, "bytes");
	...
	public ProcessorDescriptor Circle(Action<Elastic.Clients.Elasticsearch.Ingest.CircleProcessorDescriptor> configure) => Set(configure, "circle");
	public ProcessorDescriptor Circle<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.CircleProcessorDescriptor<TDocument>> configure) => Set(configure, "circle");
	...
	public ProcessorDescriptor Convert(Action<Elastic.Clients.Elasticsearch.Ingest.ConvertProcessorDescriptor> configure) => Set(configure, "convert");
	public ProcessorDescriptor Convert<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.ConvertProcessorDescriptor<TDocument>> configure) => Set(configure, "convert");
	public ProcessorDescriptor Csv(Elastic.Clients.Elasticsearch.Ingest.CsvProcessor csvProcessor) => Set(csvProcessor, "csv");
	public ProcessorDescriptor Csv(Action<Elastic.Clients.Elasticsearch.Ingest.CsvProcessorDescriptor> configure) => Set(configure, "csv");
	public ProcessorDescriptor Csv<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.CsvProcessorDescriptor<TDocument>> configure) => Set(configure, "csv");
	public ProcessorDescriptor Date(Elastic.Clients.Elasticsearch.Ingest.DateProcessor dateProcessor) => Set(dateProcessor, "date");
	public ProcessorDescriptor Date(Action<Elastic.Clients.Elasticsearch.Ingest.DateProcessorDescriptor> configure) => Set(configure, "date");
	public ProcessorDescriptor Date<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.DateProcessorDescriptor<TDocument>> configure) => Set(configure, "date");
	...
	public ProcessorDescriptor DateIndexName(Action<Elastic.Clients.Elasticsearch.Ingest.DateIndexNameProcessorDescriptor> configure) => Set(configure, "date_index_name");
	public ProcessorDescriptor DateIndexName<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.DateIndexNameProcessorDescriptor<TDocument>> configure) => Set(configure, "date_index_name");
	...
	public ProcessorDescriptor Dissect(Action<Elastic.Clients.Elasticsearch.Ingest.DissectProcessorDescriptor> configure) => Set(configure, "dissect");
	public ProcessorDescriptor Dissect<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.DissectProcessorDescriptor<TDocument>> configure) => Set(configure, "dissect");
	...
	public ProcessorDescriptor DotExpander(Action<Elastic.Clients.Elasticsearch.Ingest.DotExpanderProcessorDescriptor> configure) => Set(configure, "dot_expander");
	public ProcessorDescriptor DotExpander<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.DotExpanderProcessorDescriptor<TDocument>> configure) => Set(configure, "dot_expander");
	public ProcessorDescriptor Drop(Elastic.Clients.Elasticsearch.Ingest.DropProcessor dropProcessor) => Set(dropProcessor, "drop");
	public ProcessorDescriptor Drop(Action<Elastic.Clients.Elasticsearch.Ingest.DropProcessorDescriptor> configure) => Set(configure, "drop");
	public ProcessorDescriptor Drop<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.DropProcessorDescriptor<TDocument>> configure) => Set(configure, "drop");
	...
	public ProcessorDescriptor Enrich(Action<Elastic.Clients.Elasticsearch.Ingest.EnrichProcessorDescriptor> configure) => Set(configure, "enrich");
	public ProcessorDescriptor Enrich<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.EnrichProcessorDescriptor<TDocument>> configure) => Set(configure, "enrich");
	public ProcessorDescriptor Fail(Elastic.Clients.Elasticsearch.Ingest.FailProcessor failProcessor) => Set(failProcessor, "fail");
	public ProcessorDescriptor Fail(Action<Elastic.Clients.Elasticsearch.Ingest.FailProcessorDescriptor> configure) => Set(configure, "fail");
	public ProcessorDescriptor Fail<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.FailProcessorDescriptor<TDocument>> configure) => Set(configure, "fail");
	...
	public ProcessorDescriptor Foreach(Action<Elastic.Clients.Elasticsearch.Ingest.ForeachProcessorDescriptor> configure) => Set(configure, "foreach");
	public ProcessorDescriptor Foreach<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.ForeachProcessorDescriptor<TDocument>> configure) => Set(configure, "foreach");
	...
	public ProcessorDescriptor Geoip(Action<Elastic.Clients.Elasticsearch.Ingest.GeoIpProcessorDescriptor> configure) => Set(configure, "geoip");
	public ProcessorDescriptor Geoip<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.GeoIpProcessorDescriptor<TDocument>> configure) => Set(configure, "geoip");
	public ProcessorDescriptor Grok(Elastic.Clients.Elasticsearch.Ingest.GrokProcessor grokProcessor) => Set(grokProcessor, "grok");
	public ProcessorDescriptor Grok(Action<Elastic.Clients.Elasticsearch.Ingest.GrokProcessorDescriptor> configure) => Set(configure, "grok");
	public ProcessorDescriptor Grok<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.GrokProcessorDescriptor<TDocument>> configure) => Set(configure, "grok");
	public ProcessorDescriptor Gsub(Elastic.Clients.Elasticsearch.Ingest.GsubProcessor gsubProcessor) => Set(gsubProcessor, "gsub");
	public ProcessorDescriptor Gsub(Action<Elastic.Clients.Elasticsearch.Ingest.GsubProcessorDescriptor> configure) => Set(configure, "gsub");
	public ProcessorDescriptor Gsub<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.GsubProcessorDescriptor<TDocument>> configure) => Set(configure, "gsub");
	...
	public ProcessorDescriptor Inference(Action<Elastic.Clients.Elasticsearch.Ingest.InferenceProcessorDescriptor> configure) => Set(configure, "inference");
	public ProcessorDescriptor Inference<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.InferenceProcessorDescriptor<TDocument>> configure) => Set(configure, "inference");
	public ProcessorDescriptor Join(Elastic.Clients.Elasticsearch.Ingest.JoinProcessor joinProcessor) => Set(joinProcessor, "join");
	public ProcessorDescriptor Join(Action<Elastic.Clients.Elasticsearch.Ingest.JoinProcessorDescriptor> configure) => Set(configure, "join");
	public ProcessorDescriptor Join<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.JoinProcessorDescriptor<TDocument>> configure) => Set(configure, "join");
	public ProcessorDescriptor Json(Elastic.Clients.Elasticsearch.Ingest.JsonProcessor jsonProcessor) => Set(jsonProcessor, "json");
	public ProcessorDescriptor Json(Action<Elastic.Clients.Elasticsearch.Ingest.JsonProcessorDescriptor> configure) => Set(configure, "json");
	public ProcessorDescriptor Json<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.JsonProcessorDescriptor<TDocument>> configure) => Set(configure, "json");
	...
	public ProcessorDescriptor Kv(Action<Elastic.Clients.Elasticsearch.Ingest.KeyValueProcessorDescriptor> configure) => Set(configure, "kv");
	public ProcessorDescriptor Kv<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.KeyValueProcessorDescriptor<TDocument>> configure) => Set(configure, "kv");
	...
	public ProcessorDescriptor Lowercase(Action<Elastic.Clients.Elasticsearch.Ingest.LowercaseProcessorDescriptor> configure) => Set(configure, "lowercase");
	public ProcessorDescriptor Lowercase<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.LowercaseProcessorDescriptor<TDocument>> configure) => Set(configure, "lowercase");
	...
	public ProcessorDescriptor Pipeline(Action<Elastic.Clients.Elasticsearch.Ingest.PipelineProcessorDescriptor> configure) => Set(configure, "pipeline");
	public ProcessorDescriptor Pipeline<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.PipelineProcessorDescriptor<TDocument>> configure) => Set(configure, "pipeline");
	...
	public ProcessorDescriptor Remove(Action<Elastic.Clients.Elasticsearch.Ingest.RemoveProcessorDescriptor> configure) => Set(configure, "remove");
	public ProcessorDescriptor Remove<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.RemoveProcessorDescriptor<TDocument>> configure) => Set(configure, "remove");
	...
	public ProcessorDescriptor Rename(Action<Elastic.Clients.Elasticsearch.Ingest.RenameProcessorDescriptor> configure) => Set(configure, "rename");
	public ProcessorDescriptor Rename<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.RenameProcessorDescriptor<TDocument>> configure) => Set(configure, "rename");
	...
	public ProcessorDescriptor Reroute(Action<Elastic.Clients.Elasticsearch.Ingest.RerouteProcessorDescriptor> configure) => Set(configure, "reroute");
	public ProcessorDescriptor Reroute<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.RerouteProcessorDescriptor<TDocument>> configure) => Set(configure, "reroute");
	...
	public ProcessorDescriptor Script(Action<Elastic.Clients.Elasticsearch.Ingest.ScriptProcessorDescriptor> configure) => Set(configure, "script");
	public ProcessorDescriptor Script<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.ScriptProcessorDescriptor<TDocument>> configure) => Set(configure, "script");
	public ProcessorDescriptor Set(Elastic.Clients.Elasticsearch.Ingest.SetProcessor setProcessor) => Set(setProcessor, "set");
	public ProcessorDescriptor Set(Action<Elastic.Clients.Elasticsearch.Ingest.SetProcessorDescriptor> configure) => Set(configure, "set");
	public ProcessorDescriptor Set<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.SetProcessorDescriptor<TDocument>> configure) => Set(configure, "set");
	...
	public ProcessorDescriptor SetSecurityUser(Action<Elastic.Clients.Elasticsearch.Ingest.SetSecurityUserProcessorDescriptor> configure) => Set(configure, "set_security_user");
	public ProcessorDescriptor SetSecurityUser<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.SetSecurityUserProcessorDescriptor<TDocument>> configure) => Set(configure, "set_security_user");
	public ProcessorDescriptor Sort(Elastic.Clients.Elasticsearch.Ingest.SortProcessor sortProcessor) => Set(sortProcessor, "sort");
	public ProcessorDescriptor Sort(Action<Elastic.Clients.Elasticsearch.Ingest.SortProcessorDescriptor> configure) => Set(configure, "sort");
	public ProcessorDescriptor Sort<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.SortProcessorDescriptor<TDocument>> configure) => Set(configure, "sort");
	...
	public ProcessorDescriptor Split(Action<Elastic.Clients.Elasticsearch.Ingest.SplitProcessorDescriptor> configure) => Set(configure, "split");
	public ProcessorDescriptor Split<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.SplitProcessorDescriptor<TDocument>> configure) => Set(configure, "split");
	public ProcessorDescriptor Trim(Elastic.Clients.Elasticsearch.Ingest.TrimProcessor trimProcessor) => Set(trimProcessor, "trim");
	public ProcessorDescriptor Trim(Action<Elastic.Clients.Elasticsearch.Ingest.TrimProcessorDescriptor> configure) => Set(configure, "trim");
	public ProcessorDescriptor Trim<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.TrimProcessorDescriptor<TDocument>> configure) => Set(configure, "trim");
	...
	public ProcessorDescriptor Uppercase(Action<Elastic.Clients.Elasticsearch.Ingest.UppercaseProcessorDescriptor> configure) => Set(configure, "uppercase");
	public ProcessorDescriptor Uppercase<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.UppercaseProcessorDescriptor<TDocument>> configure) => Set(configure, "uppercase");
	...
	public ProcessorDescriptor UrlDecode(Action<Elastic.Clients.Elasticsearch.Ingest.UrlDecodeProcessorDescriptor> configure) => Set(configure, "urldecode");
	public ProcessorDescriptor UrlDecode<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.UrlDecodeProcessorDescriptor<TDocument>> configure) => Set(configure, "urldecode");
	...
	public ProcessorDescriptor UserAgent(Action<Elastic.Clients.Elasticsearch.Ingest.UserAgentProcessorDescriptor> configure) => Set(configure, "user_agent");
	public ProcessorDescriptor UserAgent<TDocument>(Action<Elastic.Clients.Elasticsearch.Ingest.UserAgentProcessorDescriptor<TDocument>> configure) => Set(configure, "user_agent");
