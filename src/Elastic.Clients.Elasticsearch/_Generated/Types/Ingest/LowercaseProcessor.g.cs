...
internal sealed partial class LowercaseProcessorConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Ingest.LowercaseProcessor>
{
	...
	public override Elastic.Clients.Elasticsearch.Ingest.LowercaseProcessor Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		return new Elastic.Clients.Elasticsearch.Ingest.LowercaseProcessor(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance)
		{
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, Elastic.Clients.Elasticsearch.Ingest.LowercaseProcessor value, System.Text.Json.JsonSerializerOptions options)
	{
...
[System.Text.Json.Serialization.JsonConverter(typeof(Elastic.Clients.Elasticsearch.Ingest.LowercaseProcessorConverter))]
public sealed partial class LowercaseProcessor
{
	[System.Diagnostics.CodeAnalysis.SetsRequiredMembers]
	public LowercaseProcessor(Elastic.Clients.Elasticsearch.Field field)
	{
		Field = field;
	}
...
#endif
	[System.Diagnostics.CodeAnalysis.SetsRequiredMembers]
	internal LowercaseProcessor(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel sentinel)
	{
		_ = sentinel;
	}
...
public readonly partial struct LowercaseProcessorDescriptor<TDocument>
{
	...
	[System.Diagnostics.CodeAnalysis.SetsRequiredMembers]
	public LowercaseProcessorDescriptor(Elastic.Clients.Elasticsearch.Ingest.LowercaseProcessor instance)
	{
		Instance = instance;
	}
	...
	{
		Instance = new Elastic.Clients.Elasticsearch.Ingest.LowercaseProcessor(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance);
	}
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Ingest.LowercaseProcessorDescriptor<TDocument> OnFailure()
	{
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Ingest.LowercaseProcessorDescriptor<TDocument> OnFailure(System.Action<Elastic.Clients.Elasticsearch.Fluent.FluentICollectionOfProcessor<TDocument>>? action)
	{
	...
	internal static Elastic.Clients.Elasticsearch.Ingest.LowercaseProcessor Build(System.Action<Elastic.Clients.Elasticsearch.Ingest.LowercaseProcessorDescriptor<TDocument>> action)
	{
		var builder = new Elastic.Clients.Elasticsearch.Ingest.LowercaseProcessorDescriptor<TDocument>(new Elastic.Clients.Elasticsearch.Ingest.LowercaseProcessor(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance));
...
public readonly partial struct LowercaseProcessorDescriptor
{
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Ingest.LowercaseProcessorDescriptor OnFailure()
	{
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Ingest.LowercaseProcessorDescriptor OnFailure(System.Action<Elastic.Clients.Elasticsearch.Fluent.FluentICollectionOfProcessor>? action)
	{
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Ingest.LowercaseProcessorDescriptor OnFailure<T>(System.Action<Elastic.Clients.Elasticsearch.Fluent.FluentICollectionOfProcessor<T>>? action)
	{
	...
	[System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
	internal static Elastic.Clients.Elasticsearch.Ingest.LowercaseProcessor Build(System.Action<Elastic.Clients.Elasticsearch.Ingest.LowercaseProcessorDescriptor> action)
	{
		var builder = new Elastic.Clients.Elasticsearch.Ingest.LowercaseProcessorDescriptor(new Elastic.Clients.Elasticsearch.Ingest.LowercaseProcessor(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance));
		action.Invoke(builder);
		return builder.Instance;
	}
}