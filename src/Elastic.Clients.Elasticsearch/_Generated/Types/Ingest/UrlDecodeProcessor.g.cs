...
{
	public partial class UrlDecodeProcessor : ProcessorBase, IProcessorContainerVariant
	{
		[JsonIgnore]
		string IProcessorContainerVariant.ProcessorContainerVariantName => "urldecode";
		[JsonInclude]
