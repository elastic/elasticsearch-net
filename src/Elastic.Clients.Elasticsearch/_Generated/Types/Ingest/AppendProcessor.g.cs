...
public readonly partial struct AppendProcessorDescriptor<TDocument>
{
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Ingest.AppendProcessorDescriptor<TDocument> If(string? value)
	{
		Instance.If = value;
		return this;
	}
...
public readonly partial struct AppendProcessorDescriptor
{
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Ingest.AppendProcessorDescriptor If(string? value)
	{
		Instance.If = value;
		return this;
	}
