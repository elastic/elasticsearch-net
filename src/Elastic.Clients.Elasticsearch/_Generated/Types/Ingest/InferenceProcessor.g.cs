...
public readonly partial struct InferenceProcessorDescriptor<TDocument>
{
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Ingest.InferenceProcessorDescriptor<TDocument> If(string? value)
	{
		Instance.If = value;
		return this;
	}
...
public readonly partial struct InferenceProcessorDescriptor
{
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Ingest.InferenceProcessorDescriptor If(string? value)
	{
		Instance.If = value;
		return this;
	}
