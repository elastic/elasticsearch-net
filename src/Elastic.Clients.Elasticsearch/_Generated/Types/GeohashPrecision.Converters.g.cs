...
public sealed partial class GeohashPrecisionConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.GeohashPrecision>
{
	public override Elastic.Clients.Elasticsearch.GeohashPrecision Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		{
			1 => new Elastic.Clients.Elasticsearch.GeohashPrecision(reader.ReadValue<long>(options, null)),
			2 => new Elastic.Clients.Elasticsearch.GeohashPrecision(reader.ReadValue<string>(options, null)),
