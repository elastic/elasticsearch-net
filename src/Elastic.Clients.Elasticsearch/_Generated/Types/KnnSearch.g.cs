...
public sealed partial class KnnSearchDescriptor<TDocument> : SerializableDescriptor<KnnSearchDescriptor<TDocument>>
{
	...
	/// </para>
	/// </summary>
	public KnnSearchDescriptor<TDocument> RescoreVector(Elastic.Clients.Elasticsearch.RescoreVector? rescoreVector)
	{
	...
	public KnnSearchDescriptor<TDocument> RescoreVector(Elastic.Clients.Elasticsearch.RescoreVectorDescriptor descriptor)
	{
	...
	public KnnSearchDescriptor<TDocument> RescoreVector(Action<Elastic.Clients.Elasticsearch.RescoreVectorDescriptor> configure)
	{
		RescoreVectorValue = null;
		RescoreVectorDescriptor = null;
...
public sealed partial class KnnSearchDescriptor : SerializableDescriptor<KnnSearchDescriptor>
{
	...
	/// </para>
	/// </summary>
	public KnnSearchDescriptor RescoreVector(Elastic.Clients.Elasticsearch.RescoreVector? rescoreVector)
	{
		RescoreVectorDescriptor = null;
		RescoreVectorDescriptorAction = null;
		RescoreVectorValue = rescoreVector;
	...
	public KnnSearchDescriptor RescoreVector(Elastic.Clients.Elasticsearch.RescoreVectorDescriptor descriptor)
	{
		RescoreVectorValue = null;
		RescoreVectorDescriptorAction = null;
		RescoreVectorDescriptor = descriptor;
	...
	public KnnSearchDescriptor RescoreVector(Action<Elastic.Clients.Elasticsearch.RescoreVectorDescriptor> configure)
	{
		RescoreVectorValue = null;
		RescoreVectorDescriptor = null;
		RescoreVectorDescriptorAction = configure;
