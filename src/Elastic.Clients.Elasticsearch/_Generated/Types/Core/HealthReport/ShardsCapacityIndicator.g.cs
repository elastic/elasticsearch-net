...
internal sealed partial class ShardsCapacityIndicatorConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Core.HealthReport.ShardsCapacityIndicator>
{
	...
	public override Elastic.Clients.Elasticsearch.Core.HealthReport.ShardsCapacityIndicator Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		reader.ValidateToken(System.Text.Json.JsonTokenType.StartObject);
		LocalJsonValue<Elastic.Clients.Elasticsearch.Core.HealthReport.ShardsCapacityIndicatorDetails?> propDetails = default;
		...
		return new Elastic.Clients.Elasticsearch.Core.HealthReport.ShardsCapacityIndicator(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance)
		{
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, Elastic.Clients.Elasticsearch.Core.HealthReport.ShardsCapacityIndicator value, System.Text.Json.JsonSerializerOptions options)
	{
...
/// </para>
/// </summary>
[System.Text.Json.Serialization.JsonConverter(typeof(Elastic.Clients.Elasticsearch.Core.HealthReport.ShardsCapacityIndicatorConverter))]
public sealed partial class ShardsCapacityIndicator
{
	[System.Diagnostics.CodeAnalysis.SetsRequiredMembers]
	public ShardsCapacityIndicator(Elastic.Clients.Elasticsearch.Core.HealthReport.IndicatorHealthStatus status, string symptom)
	{
		Status = status;
		Symptom = symptom;
	}
#if NET7_0_OR_GREATER
	public ShardsCapacityIndicator()
	{
	}
#endif
#if !NET7_0_OR_GREATER
...
#endif
	[System.Diagnostics.CodeAnalysis.SetsRequiredMembers]
	internal ShardsCapacityIndicator(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel sentinel)
	{
		_ = sentinel;
	}

	public Elastic.Clients.Elasticsearch.Core.HealthReport.ShardsCapacityIndicatorDetails? Details { get; set; }
