...
public sealed partial class FieldSuggesterDescriptor : SerializableDescriptor<FieldSuggesterDescriptor>
{
	...
	public FieldSuggesterDescriptor Completion(Action<Elastic.Clients.Elasticsearch.Core.Search.CompletionSuggesterDescriptor> configure) => Set(configure, "completion");
	public FieldSuggesterDescriptor Completion<TDocument>(Action<Elastic.Clients.Elasticsearch.Core.Search.CompletionSuggesterDescriptor<TDocument>> configure) => Set(configure, "completion");
	...
	public FieldSuggesterDescriptor Phrase(Action<Elastic.Clients.Elasticsearch.Core.Search.PhraseSuggesterDescriptor> configure) => Set(configure, "phrase");
	public FieldSuggesterDescriptor Phrase<TDocument>(Action<Elastic.Clients.Elasticsearch.Core.Search.PhraseSuggesterDescriptor<TDocument>> configure) => Set(configure, "phrase");
	...
	public FieldSuggesterDescriptor Term(Action<Elastic.Clients.Elasticsearch.Core.Search.TermSuggesterDescriptor> configure) => Set(configure, "term");
	public FieldSuggesterDescriptor Term<TDocument>(Action<Elastic.Clients.Elasticsearch.Core.Search.TermSuggesterDescriptor<TDocument>> configure) => Set(configure, "term");
