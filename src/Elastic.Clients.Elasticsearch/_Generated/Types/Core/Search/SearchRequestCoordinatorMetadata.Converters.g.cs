...
public sealed partial class SearchRequestCoordinatorMetadataConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Core.Search.SearchRequestCoordinatorMetadata>
{
	...
	public override Elastic.Clients.Elasticsearch.Core.Search.SearchRequestCoordinatorMetadata Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		reader.ValidateToken(System.Text.Json.JsonTokenType.StartObject);
		LocalJsonValue<System.Collections.Generic.IReadOnlyCollection<string>?> propIndices = default;
		LocalJsonValue<Elastic.Clients.Elasticsearch.Core.MSearch.MultisearchBody?> propSource = default;
		...
		return new Elastic.Clients.Elasticsearch.Core.Search.SearchRequestCoordinatorMetadata(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance)
		{
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, Elastic.Clients.Elasticsearch.Core.Search.SearchRequestCoordinatorMetadata value, System.Text.Json.JsonSerializerOptions options)
	{
