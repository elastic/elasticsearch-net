...
public sealed partial class SuggesterDescriptor<TDocument> : SerializableDescriptor<SuggesterDescriptor<TDocument>>
{
	...
	/// <para>The named suggesters</para>
	/// </summary>
	public SuggesterDescriptor<TDocument> Suggesters(Func<FluentDictionary<string, Elastic.Clients.Elasticsearch.Core.Search.FieldSuggester>, FluentDictionary<string, Elastic.Clients.Elasticsearch.Core.Search.FieldSuggester>> selector)
	{
