...
internal sealed partial class MultiSearchItemConverter<TDocument> : System.Text.Json.Serialization.JsonConverter<MultiSearchItem<TDocument>>
{
	...
	public override MultiSearchItem<TDocument> Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		return new MultiSearchItem<TDocument>
		{
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, MultiSearchItem<TDocument> value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(MultiSearchItemConverterFactory))]
