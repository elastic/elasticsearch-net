...
internal sealed partial class MultisearchBodyConverter : JsonConverter<MultisearchBody>
{
	public override MultisearchBody Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
	{
		...
		int? size = default;
		IReadOnlyCollection<Elastic.Clients.Elasticsearch.SortCombinations>? sort = default;
		...
		while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
		{
			if (reader.TokenType == JsonTokenType.PropertyName)
			{
				...
				if (property == "sort")
				{
					sort = JsonSerializer.Deserialize<IReadOnlyCollection<Elastic.Clients.Elasticsearch.SortCombinations>?>(ref reader, options);
					continue;
				}
...
public sealed partial class MultisearchBody
{
	...
	public IReadOnlyCollection<Elastic.Clients.Elasticsearch.SortCombinations>? Sort { get; init; }
