...
internal sealed partial class ReindexNodeConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Core.ReindexRethrottle.ReindexNode>
{
...
[System.Text.Json.Serialization.JsonConverter(typeof(Elastic.Clients.Elasticsearch.Core.ReindexRethrottle.ReindexNodeConverter))]
public sealed partial class ReindexNode
{
	...
	required
#endif
	System.Collections.Generic.IReadOnlyDictionary<Elastic.Clients.Elasticsearch.TaskId, Elastic.Clients.Elasticsearch.Core.ReindexRethrottle.ReindexTask> Tasks { get; set; }
	public
#if NET7_0_OR_GREATER
	required
#endif
