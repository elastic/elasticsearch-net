...
public sealed partial class ParentReindexTaskConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Core.ReindexRethrottle.ParentReindexTask>
{
	...
	public override Elastic.Clients.Elasticsearch.Core.ReindexRethrottle.ParentReindexTask Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonValue<System.Collections.Generic.IReadOnlyCollection<Elastic.Clients.Elasticsearch.Core.ReindexRethrottle.ReindexTask>?> propChildren = default;
		...
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propChildren.TryReadProperty(ref reader, options, PropChildren, static System.Collections.Generic.IReadOnlyCollection<Elastic.Clients.Elasticsearch.Core.ReindexRethrottle.ReindexTask>? (ref System.Text.Json.Utf8JsonReader r, System.Text.Json.JsonSerializerOptions o) => r.ReadCollectionValue<Elastic.Clients.Elasticsearch.Core.ReindexRethrottle.ReindexTask>(o, null)))
			{
				continue;
			}
		...
		return new Elastic.Clients.Elasticsearch.Core.ReindexRethrottle.ParentReindexTask(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance)
		{
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, Elastic.Clients.Elasticsearch.Core.ReindexRethrottle.ParentReindexTask value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropChildren, value.Children, null, static (System.Text.Json.Utf8JsonWriter w, System.Text.Json.JsonSerializerOptions o, System.Collections.Generic.IReadOnlyCollection<Elastic.Clients.Elasticsearch.Core.ReindexRethrottle.ReindexTask>? v) => w.WriteCollectionValue<Elastic.Clients.Elasticsearch.Core.ReindexRethrottle.ReindexTask>(o, v, null));
