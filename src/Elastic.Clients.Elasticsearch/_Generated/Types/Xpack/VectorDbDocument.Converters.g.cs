...
public sealed partial class VectorDbDocumentConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Xpack.VectorDbDocument>
{
	...
	public override Elastic.Clients.Elasticsearch.Xpack.VectorDbDocument Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		return new Elastic.Clients.Elasticsearch.Xpack.VectorDbDocument(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance)
		{
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, Elastic.Clients.Elasticsearch.Xpack.VectorDbDocument value, System.Text.Json.JsonSerializerOptions options)
	{
