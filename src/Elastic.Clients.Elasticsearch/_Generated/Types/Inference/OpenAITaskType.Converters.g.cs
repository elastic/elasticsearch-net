...
public sealed partial class OpenAITaskTypeConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Inference.OpenAITaskType>
{
	...
	public override Elastic.Clients.Elasticsearch.Inference.OpenAITaskType Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		{
			return Elastic.Clients.Elasticsearch.Inference.OpenAITaskType.Embedding;
		}
