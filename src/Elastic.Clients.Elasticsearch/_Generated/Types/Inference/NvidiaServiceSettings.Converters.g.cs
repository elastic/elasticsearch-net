...
public sealed partial class NvidiaServiceSettingsConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Inference.NvidiaServiceSettings>
{
	...
	public override Elastic.Clients.Elasticsearch.Inference.NvidiaServiceSettings Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonValue<Elastic.Clients.Elasticsearch.Inference.NvidiaSimilarityType?> propSimilarity = default;
		...
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propSimilarity.TryReadProperty(ref reader, options, PropSimilarity, static Elastic.Clients.Elasticsearch.Inference.NvidiaSimilarityType? (ref System.Text.Json.Utf8JsonReader r, System.Text.Json.JsonSerializerOptions o) => r.ReadNullableValue<Elastic.Clients.Elasticsearch.Inference.NvidiaSimilarityType>(o)))
			{
				continue;
			}
		...
		return new Elastic.Clients.Elasticsearch.Inference.NvidiaServiceSettings(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance)
		{
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, Elastic.Clients.Elasticsearch.Inference.NvidiaServiceSettings value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropSimilarity, value.Similarity, null, static (System.Text.Json.Utf8JsonWriter w, System.Text.Json.JsonSerializerOptions o, Elastic.Clients.Elasticsearch.Inference.NvidiaSimilarityType? v) => w.WriteNullableValue<Elastic.Clients.Elasticsearch.Inference.NvidiaSimilarityType>(o, v));
