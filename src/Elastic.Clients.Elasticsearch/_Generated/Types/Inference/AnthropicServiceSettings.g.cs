...
public sealed partial class AnthropicServiceSettingsDescriptor : SerializableDescriptor<AnthropicServiceSettingsDescriptor>
{
	internal AnthropicServiceSettingsDescriptor(Action<AnthropicServiceSettingsDescriptor> configure) => configure.Invoke(this);

	public AnthropicServiceSettingsDescriptor() : base()
	{
	}
	...
	/// </para>
	/// </summary>
	public AnthropicServiceSettingsDescriptor ApiKey(string apiKey)
	{
		ApiKeyValue = apiKey;
		return Self;
	}
	...
	/// </para>
	/// </summary>
	public AnthropicServiceSettingsDescriptor ModelId(string modelId)
	{
	...
	/// </para>
	/// </summary>
	public AnthropicServiceSettingsDescriptor RateLimit(Elastic.Clients.Elasticsearch.Inference.RateLimitSetting? rateLimit)
	{
	...
	public AnthropicServiceSettingsDescriptor RateLimit(Elastic.Clients.Elasticsearch.Inference.RateLimitSettingDescriptor descriptor)
	{
		RateLimitValue = null;
		RateLimitDescriptorAction = null;
	...
	public AnthropicServiceSettingsDescriptor RateLimit(Action<Elastic.Clients.Elasticsearch.Inference.RateLimitSettingDescriptor> configure)
	{
		RateLimitValue = null;
		RateLimitDescriptor = null;
