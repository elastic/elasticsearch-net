...
public readonly partial struct MessageDescriptor
{
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Inference.MessageDescriptor ToolCalls()
	{
		Instance.ToolCalls = Elastic.Clients.Elasticsearch.Fluent.FluentICollectionOfToolCall.Build(null);
		return this;
	}
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Inference.MessageDescriptor ToolCalls(System.Action<Elastic.Clients.Elasticsearch.Fluent.FluentICollectionOfToolCall>? action)
	{
		Instance.ToolCalls = Elastic.Clients.Elasticsearch.Fluent.FluentICollectionOfToolCall.Build(action);
		return this;
	}
