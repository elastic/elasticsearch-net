...
public sealed partial class CustomResponseParams
{
	...
	public CustomResponseParams(System.Collections.Generic.IDictionary<string, string> jsonParser)
	{
	...
	public required System.Collections.Generic.IDictionary<string, string> JsonParser { get; set; }
}
...
public readonly partial struct CustomResponseParamsDescriptor
{
	...
	/// <include file="CustomResponseParams.g.xml" path="doc/member[@key='inference._types.CustomResponseParams#json_parser']/*"/>
	public Elastic.Clients.Elasticsearch.Inference.CustomResponseParamsDescriptor JsonParser(System.Collections.Generic.IDictionary<string, string> value)
	{
	...
	/// <include file="CustomResponseParams.g.xml" path="doc/member[@key='inference._types.CustomResponseParams#json_parser']/*"/>
	public Elastic.Clients.Elasticsearch.Inference.CustomResponseParamsDescriptor JsonParser(System.Action<Elastic.Clients.Elasticsearch.Fluent.FluentDictionaryOfStringString>? action)
	{
	...
	{
		Instance.JsonParser ??= new System.Collections.Generic.Dictionary<string, string>();
