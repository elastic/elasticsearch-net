...
public sealed partial class TaskTypeNvidiaConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Inference.TaskTypeNvidia>
{
	...
	public override Elastic.Clients.Elasticsearch.Inference.TaskTypeNvidia Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		if (reader.ValueTextEquals(MemberChatCompletion))
		{
			return Elastic.Clients.Elasticsearch.Inference.TaskTypeNvidia.ChatCompletion;
		}

		if (reader.ValueTextEquals(MemberCompletion))
		{
			return Elastic.Clients.Elasticsearch.Inference.TaskTypeNvidia.Completion;
		}

		if (reader.ValueTextEquals(MemberRerank))
		{
			return Elastic.Clients.Elasticsearch.Inference.TaskTypeNvidia.Rerank;
		}

		if (reader.ValueTextEquals(MemberTextEmbedding))
		{
			return Elastic.Clients.Elasticsearch.Inference.TaskTypeNvidia.TextEmbedding;
		}
		...
		throw new System.Text.Json.JsonException($"Unknown member '{value}' for enum '{nameof(Elastic.Clients.Elasticsearch.Inference.TaskTypeNvidia)}'.");
	}

	public override void Write(System.Text.Json.Utf8JsonWriter writer, Elastic.Clients.Elasticsearch.Inference.TaskTypeNvidia value, System.Text.Json.JsonSerializerOptions options)
	{
		switch (value)
		{
			...
			case Elastic.Clients.Elasticsearch.Inference.TaskTypeNvidia.TextEmbedding:
				...
				break;
			default:
				throw new System.Text.Json.JsonException($"Invalid value '{value}' for enum '{nameof(Elastic.Clients.Elasticsearch.Inference.TaskTypeNvidia)}'.");
		}
	}

	public override Elastic.Clients.Elasticsearch.Inference.TaskTypeNvidia ReadAsPropertyName(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		return Read(ref reader, typeToConvert, options);
	}

	public override void WriteAsPropertyName(System.Text.Json.Utf8JsonWriter writer, Elastic.Clients.Elasticsearch.Inference.TaskTypeNvidia value, System.Text.Json.JsonSerializerOptions options)
	{
