...
public sealed partial class ElasticsearchServiceSettings
{
	...
	/// <include file="ElasticsearchServiceSettings.g.xml" path="doc/member[@key='inference._types.ElasticsearchServiceSettings#long_document_strategy']/*"/>
	public string? LongDocumentStrategy { get; set; }

	/// <include file="ElasticsearchServiceSettings.g.xml" path="doc/member[@key='inference._types.ElasticsearchServiceSettings#max_chunks_per_doc']/*"/>
