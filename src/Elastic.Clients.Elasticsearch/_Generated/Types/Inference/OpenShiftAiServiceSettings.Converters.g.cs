...
public sealed partial class OpenShiftAiServiceSettingsConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Inference.OpenShiftAiServiceSettings>
{
	...
	public override Elastic.Clients.Elasticsearch.Inference.OpenShiftAiServiceSettings Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonValue<Elastic.Clients.Elasticsearch.Inference.OpenShiftAiSimilarityType?> propSimilarity = default;
		...
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propSimilarity.TryReadProperty(ref reader, options, PropSimilarity, static Elastic.Clients.Elasticsearch.Inference.OpenShiftAiSimilarityType? (ref System.Text.Json.Utf8JsonReader r, System.Text.Json.JsonSerializerOptions o) => r.ReadNullableValue<Elastic.Clients.Elasticsearch.Inference.OpenShiftAiSimilarityType>(o)))
			{
				continue;
			}
		...
		return new Elastic.Clients.Elasticsearch.Inference.OpenShiftAiServiceSettings(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance)
		{
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, Elastic.Clients.Elasticsearch.Inference.OpenShiftAiServiceSettings value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropSimilarity, value.Similarity, null, static (System.Text.Json.Utf8JsonWriter w, System.Text.Json.JsonSerializerOptions o, Elastic.Clients.Elasticsearch.Inference.OpenShiftAiSimilarityType? v) => w.WriteNullableValue<Elastic.Clients.Elasticsearch.Inference.OpenShiftAiSimilarityType>(o, v));
