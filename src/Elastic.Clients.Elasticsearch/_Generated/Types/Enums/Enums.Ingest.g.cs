...
namespace Elastic.Clients.Elasticsearch.Ingest
{
	...
	{
		public override DateRounding Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
		{
			var enumString = reader.GetString();
			switch (enumString)
			{
		...
		public override void Write(Utf8JsonWriter writer, DateRounding value, JsonSerializerOptions options)
		{
			switch (value)
			{
				case DateRounding.y:
