...
{
	[JsonInclude, JsonPropertyName("executed_searches_total")]
	...
	[JsonInclude, JsonPropertyName("remote_requests_current")]
	public int RemoteRequestsCurrent { get; init; }
	[JsonInclude, JsonPropertyName("remote_requests_total")]
