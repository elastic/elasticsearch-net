...
public sealed partial class RoleQuery
{
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Security.RoleQuery(Elastic.Clients.Elasticsearch.QueryDsl.LongNumberRangeQuery value) => new Elastic.Clients.Elasticsearch.Security.RoleQuery { Range = value };
...
public readonly partial struct RoleQueryDescriptor<TDocument>
{
	...
	[System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
	public Elastic.Clients.Elasticsearch.Security.RoleQueryDescriptor<TDocument> CustomVariant<T>(string variantName, T? value)
	{
...
public readonly partial struct RoleQueryDescriptor
{
	...
	[System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
	public Elastic.Clients.Elasticsearch.Security.RoleQueryDescriptor CustomVariant<T>(string variantName, T? value)
	{
		Instance.SetCustomVariant<T>(variantName, value);
		return this;
	}
