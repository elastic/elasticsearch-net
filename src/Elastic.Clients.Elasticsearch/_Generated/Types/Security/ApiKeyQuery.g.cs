...
[System.Text.Json.Serialization.JsonConverter(typeof(Elastic.Clients.Elasticsearch.Security.Json.ApiKeyQueryConverter))]
public sealed partial class ApiKeyQuery
{
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Security.ApiKeyQuery(Elastic.Clients.Elasticsearch.QueryDsl.LongNumberRangeQuery value) => new Elastic.Clients.Elasticsearch.Security.ApiKeyQuery { Range = value };
...
public readonly partial struct ApiKeyQueryDescriptor<TDocument>
{
	...
	[System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
	public Elastic.Clients.Elasticsearch.Security.ApiKeyQueryDescriptor<TDocument> CustomVariant<T>(string variantName, T? value)
	{
...
public readonly partial struct ApiKeyQueryDescriptor
{
	...
	[System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
	public Elastic.Clients.Elasticsearch.Security.ApiKeyQueryDescriptor CustomVariant<T>(string variantName, T? value)
	{
		Instance.SetCustomVariant<T>(variantName, value);
		return this;
	}
