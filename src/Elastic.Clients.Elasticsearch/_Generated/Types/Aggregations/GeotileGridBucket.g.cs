...
internal sealed partial class GeotileGridBucketConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Aggregations.GeotileGridBucket>
{
	...
	public override Elastic.Clients.Elasticsearch.Aggregations.GeotileGridBucket Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		return new Elastic.Clients.Elasticsearch.Aggregations.GeotileGridBucket(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance)
		{
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, Elastic.Clients.Elasticsearch.Aggregations.GeotileGridBucket value, System.Text.Json.JsonSerializerOptions options)
	{
...
[System.Text.Json.Serialization.JsonConverter(typeof(Elastic.Clients.Elasticsearch.Aggregations.GeotileGridBucketConverter))]
public sealed partial class GeotileGridBucket
{
	[System.Diagnostics.CodeAnalysis.SetsRequiredMembers]
	public GeotileGridBucket(long docCount, string key)
	{
		DocCount = docCount;
		Key = key;
	}
#if NET7_0_OR_GREATER
	public GeotileGridBucket()
	{
	}
#endif
#if !NET7_0_OR_GREATER
...
#endif
	[System.Diagnostics.CodeAnalysis.SetsRequiredMembers]
	internal GeotileGridBucket(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel sentinel)
	{
		_ = sentinel;
	}
