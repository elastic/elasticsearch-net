...
public sealed partial class GeotileGridBucket : AggregateDictionary
{
	public GeotileGridBucket(IReadOnlyDictionary<string, IAggregate> backingDictionary) : base(backingDictionary)
	{
	}
...
internal sealed class GeotileGridBucketConverter : JsonConverter<GeotileGridBucket>
{
	public override GeotileGridBucket? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
	{
		...
		return new GeotileGridBucket(subAggs) { DocCount = docCount, Key = key };
	}
