...
public sealed partial class ChangePointAggregateConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Aggregations.ChangePointAggregate>
{
	...
	public override Elastic.Clients.Elasticsearch.Aggregations.ChangePointAggregate Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonValue<Elastic.Clients.Elasticsearch.Aggregations.ChangePointBucket?> propBucket = default;
		LocalJsonValue<System.Collections.Generic.IReadOnlyDictionary<string, object>?> propMeta = default;
		LocalJsonValue<Elastic.Clients.Elasticsearch.Aggregations.ChangeType> propType = default;
