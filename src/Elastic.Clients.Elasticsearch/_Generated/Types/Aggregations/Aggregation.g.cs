...
public sealed partial class AggregationDescriptor<TDocument> : SerializableDescriptor<AggregationDescriptor<TDocument>>
{
	...
	private IDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>? AggregationsValue { get; set; }
	private IDictionary<string, object>? MetaValue { get; set; }

	/// <summary>
	/// <para>Sub-aggregations for this aggregation.<br/>Only applies to bucket aggregations.</para>
	/// </summary>
	public AggregationDescriptor<TDocument> Aggregations(IDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>? aggregations)
	{
		AggregationsValue = aggregations;
		return Self;
	}

	public AggregationDescriptor<TDocument> Meta(IDictionary<string, object>? meta)
	{
		MetaValue = meta;
		return Self;
	}
...
public sealed partial class AggregationDescriptor : SerializableDescriptor<AggregationDescriptor>
{
	...
	/// <para>Sub-aggregations for this aggregation.<br/>Only applies to bucket aggregations.</para>
	/// </summary>
	public AggregationDescriptor Aggregations(IDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>? aggregations)
	{
		AggregationsValue = aggregations;
		return Self;
	}

	public AggregationDescriptor Meta(IDictionary<string, object>? meta)
	{
		MetaValue = meta;
		return Self;
	}
	...
	public AggregationDescriptor AdjacencyMatrix(Action<Elastic.Clients.Elasticsearch.Aggregations.AdjacencyMatrixAggregationDescriptor> configure) => Set(configure, "adjacency_matrix");
	public AggregationDescriptor AdjacencyMatrix<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.AdjacencyMatrixAggregationDescriptor<TDocument>> configure) => Set(configure, "adjacency_matrix");
	...
	public AggregationDescriptor AutoDateHistogram(Action<Elastic.Clients.Elasticsearch.Aggregations.AutoDateHistogramAggregationDescriptor> configure) => Set(configure, "auto_date_histogram");
	public AggregationDescriptor AutoDateHistogram<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.AutoDateHistogramAggregationDescriptor<TDocument>> configure) => Set(configure, "auto_date_histogram");
	...
	public AggregationDescriptor Avg(Action<Elastic.Clients.Elasticsearch.Aggregations.AverageAggregationDescriptor> configure) => Set(configure, "avg");
	public AggregationDescriptor Avg<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.AverageAggregationDescriptor<TDocument>> configure) => Set(configure, "avg");
	...
	public AggregationDescriptor Boxplot(Action<Elastic.Clients.Elasticsearch.Aggregations.BoxplotAggregationDescriptor> configure) => Set(configure, "boxplot");
	public AggregationDescriptor Boxplot<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.BoxplotAggregationDescriptor<TDocument>> configure) => Set(configure, "boxplot");
	...
	public AggregationDescriptor BucketSort(Action<Elastic.Clients.Elasticsearch.Aggregations.BucketSortAggregationDescriptor> configure) => Set(configure, "bucket_sort");
	public AggregationDescriptor BucketSort<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.BucketSortAggregationDescriptor<TDocument>> configure) => Set(configure, "bucket_sort");
	...
	public AggregationDescriptor Cardinality(Action<Elastic.Clients.Elasticsearch.Aggregations.CardinalityAggregationDescriptor> configure) => Set(configure, "cardinality");
	public AggregationDescriptor Cardinality<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.CardinalityAggregationDescriptor<TDocument>> configure) => Set(configure, "cardinality");
	...
	public AggregationDescriptor CategorizeText(Action<Elastic.Clients.Elasticsearch.Aggregations.CategorizeTextAggregationDescriptor> configure) => Set(configure, "categorize_text");
	public AggregationDescriptor CategorizeText<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.CategorizeTextAggregationDescriptor<TDocument>> configure) => Set(configure, "categorize_text");
	...
	public AggregationDescriptor Composite(Action<Elastic.Clients.Elasticsearch.Aggregations.CompositeAggregationDescriptor> configure) => Set(configure, "composite");
	public AggregationDescriptor Composite<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.CompositeAggregationDescriptor<TDocument>> configure) => Set(configure, "composite");
	...
	public AggregationDescriptor DateHistogram(Action<Elastic.Clients.Elasticsearch.Aggregations.DateHistogramAggregationDescriptor> configure) => Set(configure, "date_histogram");
	public AggregationDescriptor DateHistogram<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.DateHistogramAggregationDescriptor<TDocument>> configure) => Set(configure, "date_histogram");
	...
	public AggregationDescriptor DateRange(Action<Elastic.Clients.Elasticsearch.Aggregations.DateRangeAggregationDescriptor> configure) => Set(configure, "date_range");
	public AggregationDescriptor DateRange<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.DateRangeAggregationDescriptor<TDocument>> configure) => Set(configure, "date_range");
	...
	public AggregationDescriptor DiversifiedSampler(Action<Elastic.Clients.Elasticsearch.Aggregations.DiversifiedSamplerAggregationDescriptor> configure) => Set(configure, "diversified_sampler");
	public AggregationDescriptor DiversifiedSampler<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.DiversifiedSamplerAggregationDescriptor<TDocument>> configure) => Set(configure, "diversified_sampler");
	...
	public AggregationDescriptor ExtendedStats(Action<Elastic.Clients.Elasticsearch.Aggregations.ExtendedStatsAggregationDescriptor> configure) => Set(configure, "extended_stats");
	public AggregationDescriptor ExtendedStats<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.ExtendedStatsAggregationDescriptor<TDocument>> configure) => Set(configure, "extended_stats");
	...
	public AggregationDescriptor Filters(Action<Elastic.Clients.Elasticsearch.Aggregations.FiltersAggregationDescriptor> configure) => Set(configure, "filters");
	public AggregationDescriptor Filters<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.FiltersAggregationDescriptor<TDocument>> configure) => Set(configure, "filters");
	...
	public AggregationDescriptor FrequentItemSets(Action<Elastic.Clients.Elasticsearch.Aggregations.FrequentItemSetsAggregationDescriptor> configure) => Set(configure, "frequent_item_sets");
	public AggregationDescriptor FrequentItemSets<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.FrequentItemSetsAggregationDescriptor<TDocument>> configure) => Set(configure, "frequent_item_sets");
	...
	public AggregationDescriptor GeoBounds(Action<Elastic.Clients.Elasticsearch.Aggregations.GeoBoundsAggregationDescriptor> configure) => Set(configure, "geo_bounds");
	public AggregationDescriptor GeoBounds<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.GeoBoundsAggregationDescriptor<TDocument>> configure) => Set(configure, "geo_bounds");
	...
	public AggregationDescriptor GeoCentroid(Action<Elastic.Clients.Elasticsearch.Aggregations.GeoCentroidAggregationDescriptor> configure) => Set(configure, "geo_centroid");
	public AggregationDescriptor GeoCentroid<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.GeoCentroidAggregationDescriptor<TDocument>> configure) => Set(configure, "geo_centroid");
	...
	public AggregationDescriptor GeoDistance(Action<Elastic.Clients.Elasticsearch.Aggregations.GeoDistanceAggregationDescriptor> configure) => Set(configure, "geo_distance");
	public AggregationDescriptor GeoDistance<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.GeoDistanceAggregationDescriptor<TDocument>> configure) => Set(configure, "geo_distance");
	...
	public AggregationDescriptor GeohashGrid(Action<Elastic.Clients.Elasticsearch.Aggregations.GeohashGridAggregationDescriptor> configure) => Set(configure, "geohash_grid");
	public AggregationDescriptor GeohashGrid<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.GeohashGridAggregationDescriptor<TDocument>> configure) => Set(configure, "geohash_grid");
	...
	public AggregationDescriptor GeohexGrid(Action<Elastic.Clients.Elasticsearch.Aggregations.GeohexGridAggregationDescriptor> configure) => Set(configure, "geohex_grid");
	public AggregationDescriptor GeohexGrid<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.GeohexGridAggregationDescriptor<TDocument>> configure) => Set(configure, "geohex_grid");
	...
	public AggregationDescriptor GeoLine(Action<Elastic.Clients.Elasticsearch.Aggregations.GeoLineAggregationDescriptor> configure) => Set(configure, "geo_line");
	public AggregationDescriptor GeoLine<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.GeoLineAggregationDescriptor<TDocument>> configure) => Set(configure, "geo_line");
	...
	public AggregationDescriptor GeotileGrid(Action<Elastic.Clients.Elasticsearch.Aggregations.GeotileGridAggregationDescriptor> configure) => Set(configure, "geotile_grid");
	public AggregationDescriptor GeotileGrid<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.GeotileGridAggregationDescriptor<TDocument>> configure) => Set(configure, "geotile_grid");
	...
	public AggregationDescriptor Histogram(Action<Elastic.Clients.Elasticsearch.Aggregations.HistogramAggregationDescriptor> configure) => Set(configure, "histogram");
	public AggregationDescriptor Histogram<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.HistogramAggregationDescriptor<TDocument>> configure) => Set(configure, "histogram");
	...
	public AggregationDescriptor Inference(Action<Elastic.Clients.Elasticsearch.Aggregations.InferenceAggregationDescriptor> configure) => Set(configure, "inference");
	public AggregationDescriptor Inference<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.InferenceAggregationDescriptor<TDocument>> configure) => Set(configure, "inference");
	...
	public AggregationDescriptor IpPrefix(Action<Elastic.Clients.Elasticsearch.Aggregations.IpPrefixAggregationDescriptor> configure) => Set(configure, "ip_prefix");
	public AggregationDescriptor IpPrefix<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.IpPrefixAggregationDescriptor<TDocument>> configure) => Set(configure, "ip_prefix");
	...
	public AggregationDescriptor IpRange(Action<Elastic.Clients.Elasticsearch.Aggregations.IpRangeAggregationDescriptor> configure) => Set(configure, "ip_range");
	public AggregationDescriptor IpRange<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.IpRangeAggregationDescriptor<TDocument>> configure) => Set(configure, "ip_range");
	...
	public AggregationDescriptor MatrixStats(Action<Elastic.Clients.Elasticsearch.Aggregations.MatrixStatsAggregationDescriptor> configure) => Set(configure, "matrix_stats");
	public AggregationDescriptor MatrixStats<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.MatrixStatsAggregationDescriptor<TDocument>> configure) => Set(configure, "matrix_stats");
	...
	public AggregationDescriptor Max(Action<Elastic.Clients.Elasticsearch.Aggregations.MaxAggregationDescriptor> configure) => Set(configure, "max");
	public AggregationDescriptor Max<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.MaxAggregationDescriptor<TDocument>> configure) => Set(configure, "max");
	...
	public AggregationDescriptor MedianAbsoluteDeviation(Action<Elastic.Clients.Elasticsearch.Aggregations.MedianAbsoluteDeviationAggregationDescriptor> configure) => Set(configure, "median_absolute_deviation");
	public AggregationDescriptor MedianAbsoluteDeviation<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.MedianAbsoluteDeviationAggregationDescriptor<TDocument>> configure) => Set(configure, "median_absolute_deviation");
	...
	public AggregationDescriptor Min(Action<Elastic.Clients.Elasticsearch.Aggregations.MinAggregationDescriptor> configure) => Set(configure, "min");
	public AggregationDescriptor Min<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.MinAggregationDescriptor<TDocument>> configure) => Set(configure, "min");
	...
	public AggregationDescriptor Missing(Action<Elastic.Clients.Elasticsearch.Aggregations.MissingAggregationDescriptor> configure) => Set(configure, "missing");
	public AggregationDescriptor Missing<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.MissingAggregationDescriptor<TDocument>> configure) => Set(configure, "missing");
	...
	public AggregationDescriptor MultiTerms(Action<Elastic.Clients.Elasticsearch.Aggregations.MultiTermsAggregationDescriptor> configure) => Set(configure, "multi_terms");
	public AggregationDescriptor MultiTerms<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.MultiTermsAggregationDescriptor<TDocument>> configure) => Set(configure, "multi_terms");
	...
	public AggregationDescriptor Nested(Action<Elastic.Clients.Elasticsearch.Aggregations.NestedAggregationDescriptor> configure) => Set(configure, "nested");
	public AggregationDescriptor Nested<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.NestedAggregationDescriptor<TDocument>> configure) => Set(configure, "nested");
	...
	public AggregationDescriptor PercentileRanks(Action<Elastic.Clients.Elasticsearch.Aggregations.PercentileRanksAggregationDescriptor> configure) => Set(configure, "percentile_ranks");
	public AggregationDescriptor PercentileRanks<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.PercentileRanksAggregationDescriptor<TDocument>> configure) => Set(configure, "percentile_ranks");
	...
	public AggregationDescriptor Percentiles(Action<Elastic.Clients.Elasticsearch.Aggregations.PercentilesAggregationDescriptor> configure) => Set(configure, "percentiles");
	public AggregationDescriptor Percentiles<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.PercentilesAggregationDescriptor<TDocument>> configure) => Set(configure, "percentiles");
	...
	public AggregationDescriptor Range(Action<Elastic.Clients.Elasticsearch.Aggregations.RangeAggregationDescriptor> configure) => Set(configure, "range");
	public AggregationDescriptor Range<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.RangeAggregationDescriptor<TDocument>> configure) => Set(configure, "range");
	...
	public AggregationDescriptor RareTerms(Action<Elastic.Clients.Elasticsearch.Aggregations.RareTermsAggregationDescriptor> configure) => Set(configure, "rare_terms");
	public AggregationDescriptor RareTerms<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.RareTermsAggregationDescriptor<TDocument>> configure) => Set(configure, "rare_terms");
	...
	public AggregationDescriptor Rate(Action<Elastic.Clients.Elasticsearch.Aggregations.RateAggregationDescriptor> configure) => Set(configure, "rate");
	public AggregationDescriptor Rate<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.RateAggregationDescriptor<TDocument>> configure) => Set(configure, "rate");
	...
	public AggregationDescriptor ReverseNested(Action<Elastic.Clients.Elasticsearch.Aggregations.ReverseNestedAggregationDescriptor> configure) => Set(configure, "reverse_nested");
	public AggregationDescriptor ReverseNested<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.ReverseNestedAggregationDescriptor<TDocument>> configure) => Set(configure, "reverse_nested");
	...
	public AggregationDescriptor ScriptedMetric(Action<Elastic.Clients.Elasticsearch.Aggregations.ScriptedMetricAggregationDescriptor> configure) => Set(configure, "scripted_metric");
	public AggregationDescriptor ScriptedMetric<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.ScriptedMetricAggregationDescriptor<TDocument>> configure) => Set(configure, "scripted_metric");
	...
	public AggregationDescriptor SignificantTerms(Action<Elastic.Clients.Elasticsearch.Aggregations.SignificantTermsAggregationDescriptor> configure) => Set(configure, "significant_terms");
	public AggregationDescriptor SignificantTerms<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.SignificantTermsAggregationDescriptor<TDocument>> configure) => Set(configure, "significant_terms");
	...
	public AggregationDescriptor SignificantText(Action<Elastic.Clients.Elasticsearch.Aggregations.SignificantTextAggregationDescriptor> configure) => Set(configure, "significant_text");
	public AggregationDescriptor SignificantText<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.SignificantTextAggregationDescriptor<TDocument>> configure) => Set(configure, "significant_text");
	...
	public AggregationDescriptor Stats(Action<Elastic.Clients.Elasticsearch.Aggregations.StatsAggregationDescriptor> configure) => Set(configure, "stats");
	public AggregationDescriptor Stats<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.StatsAggregationDescriptor<TDocument>> configure) => Set(configure, "stats");
	...
	public AggregationDescriptor StringStats(Action<Elastic.Clients.Elasticsearch.Aggregations.StringStatsAggregationDescriptor> configure) => Set(configure, "string_stats");
	public AggregationDescriptor StringStats<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.StringStatsAggregationDescriptor<TDocument>> configure) => Set(configure, "string_stats");
	...
	public AggregationDescriptor Sum(Action<Elastic.Clients.Elasticsearch.Aggregations.SumAggregationDescriptor> configure) => Set(configure, "sum");
	public AggregationDescriptor Sum<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.SumAggregationDescriptor<TDocument>> configure) => Set(configure, "sum");
	...
	public AggregationDescriptor Terms(Action<Elastic.Clients.Elasticsearch.Aggregations.TermsAggregationDescriptor> configure) => Set(configure, "terms");
	public AggregationDescriptor Terms<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.TermsAggregationDescriptor<TDocument>> configure) => Set(configure, "terms");
	...
	public AggregationDescriptor TopHits(Action<Elastic.Clients.Elasticsearch.Aggregations.TopHitsAggregationDescriptor> configure) => Set(configure, "top_hits");
	public AggregationDescriptor TopHits<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.TopHitsAggregationDescriptor<TDocument>> configure) => Set(configure, "top_hits");
	...
	public AggregationDescriptor TopMetrics(Action<Elastic.Clients.Elasticsearch.Aggregations.TopMetricsAggregationDescriptor> configure) => Set(configure, "top_metrics");
	public AggregationDescriptor TopMetrics<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.TopMetricsAggregationDescriptor<TDocument>> configure) => Set(configure, "top_metrics");
	...
	public AggregationDescriptor TTest(Action<Elastic.Clients.Elasticsearch.Aggregations.TTestAggregationDescriptor> configure) => Set(configure, "t_test");
	public AggregationDescriptor TTest<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.TTestAggregationDescriptor<TDocument>> configure) => Set(configure, "t_test");
	...
	public AggregationDescriptor ValueCount(Action<Elastic.Clients.Elasticsearch.Aggregations.ValueCountAggregationDescriptor> configure) => Set(configure, "value_count");
	public AggregationDescriptor ValueCount<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.ValueCountAggregationDescriptor<TDocument>> configure) => Set(configure, "value_count");
	...
	public AggregationDescriptor VariableWidthHistogram(Action<Elastic.Clients.Elasticsearch.Aggregations.VariableWidthHistogramAggregationDescriptor> configure) => Set(configure, "variable_width_histogram");
	public AggregationDescriptor VariableWidthHistogram<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.VariableWidthHistogramAggregationDescriptor<TDocument>> configure) => Set(configure, "variable_width_histogram");
	...
	public AggregationDescriptor WeightedAvg(Action<Elastic.Clients.Elasticsearch.Aggregations.WeightedAverageAggregationDescriptor> configure) => Set(configure, "weighted_avg");
	public AggregationDescriptor WeightedAvg<TDocument>(Action<Elastic.Clients.Elasticsearch.Aggregations.WeightedAverageAggregationDescriptor<TDocument>> configure) => Set(configure, "weighted_avg");
