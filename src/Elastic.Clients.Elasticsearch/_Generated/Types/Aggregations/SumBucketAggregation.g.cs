...
{
	internal sealed class SumBucketAggregationConverter : JsonConverter<SumBucketAggregation>
	{
		public override SumBucketAggregation Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
		{
			if (reader.TokenType != JsonTokenType.StartObject)
				throw new JsonException("Unexpected JSON detected.");
			reader.Read();
			var aggName = reader.GetString();
			if (aggName != "sum_bucket")
				throw new JsonException("Unexpected JSON detected.");
			var agg = new SumBucketAggregation(aggName);
		...
		public override void Write(Utf8JsonWriter writer, SumBucketAggregation value, JsonSerializerOptions options)
		{
	...
	public sealed partial class SumBucketAggregationDescriptor : DescriptorBase<SumBucketAggregationDescriptor>
	{
		...
		public SumBucketAggregationDescriptor BucketsPath(Elastic.Clients.Elasticsearch.Aggregations.BucketsPath? bucketsPath) => Assign(bucketsPath, (a, v) => a.BucketsPathValue = v);
		public SumBucketAggregationDescriptor Format(string? format) => Assign(format, (a, v) => a.FormatValue = v);
		public SumBucketAggregationDescriptor GapPolicy(Elastic.Clients.Elasticsearch.Aggregations.GapPolicy? gapPolicy) => Assign(gapPolicy, (a, v) => a.GapPolicyValue = v);
		public SumBucketAggregationDescriptor Meta(Func<FluentDictionary<string, object>, FluentDictionary<string, object>> selector) => Assign(selector, (a, v) => a.MetaValue = v?.Invoke(new FluentDictionary<string, object>()));
