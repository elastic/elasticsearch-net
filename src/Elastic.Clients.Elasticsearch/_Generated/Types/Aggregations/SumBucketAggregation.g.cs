...
public sealed partial class SumBucketAggregation
{
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Aggregations.Aggregation(SumBucketAggregation sumBucketAggregation) => Elastic.Clients.Elasticsearch.Aggregations.Aggregation.SumBucket(sumBucketAggregation);
}
...
public sealed partial class SumBucketAggregationDescriptor : SerializableDescriptor<SumBucketAggregationDescriptor>
{
	...
	/// <para>Path to the buckets that contain one set of values to correlate.</para>
	/// </summary>
	public SumBucketAggregationDescriptor BucketsPath(Elastic.Clients.Elasticsearch.Aggregations.BucketsPath? bucketsPath)
	{
	...
	/// <para>Policy to apply when gaps are found in the data.</para>
	/// </summary>
	public SumBucketAggregationDescriptor GapPolicy(Elastic.Clients.Elasticsearch.Aggregations.GapPolicy? gapPolicy)
	{
