...
public sealed partial class CumulativeSumAggregation
{
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Aggregations.Aggregation(CumulativeSumAggregation cumulativeSumAggregation) => Elastic.Clients.Elasticsearch.Aggregations.Aggregation.CumulativeSum(cumulativeSumAggregation);
}
...
public sealed partial class CumulativeSumAggregationDescriptor : SerializableDescriptor<CumulativeSumAggregationDescriptor>
{
	...
	/// <para>Path to the buckets that contain one set of values to correlate.</para>
	/// </summary>
	public CumulativeSumAggregationDescriptor BucketsPath(Elastic.Clients.Elasticsearch.Aggregations.BucketsPath? bucketsPath)
	{
	...
	/// <para>Policy to apply when gaps are found in the data.</para>
	/// </summary>
	public CumulativeSumAggregationDescriptor GapPolicy(Elastic.Clients.Elasticsearch.Aggregations.GapPolicy? gapPolicy)
	{
