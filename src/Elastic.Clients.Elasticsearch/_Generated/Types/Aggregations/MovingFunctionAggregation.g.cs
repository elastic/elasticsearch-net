...
public sealed partial class MovingFunctionAggregation
{
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Aggregations.Aggregation(MovingFunctionAggregation movingFunctionAggregation) => Elastic.Clients.Elasticsearch.Aggregations.Aggregation.MovingFn(movingFunctionAggregation);
}
...
public sealed partial class MovingFunctionAggregationDescriptor : SerializableDescriptor<MovingFunctionAggregationDescriptor>
{
	...
	/// <para>Path to the buckets that contain one set of values to correlate.</para>
	/// </summary>
	public MovingFunctionAggregationDescriptor BucketsPath(Elastic.Clients.Elasticsearch.Aggregations.BucketsPath? bucketsPath)
	{
