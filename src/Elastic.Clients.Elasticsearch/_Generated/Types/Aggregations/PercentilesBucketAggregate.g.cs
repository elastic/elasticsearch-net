...
internal sealed partial class PercentilesBucketAggregateConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Aggregations.PercentilesBucketAggregate>
{
	...
	public override Elastic.Clients.Elasticsearch.Aggregations.PercentilesBucketAggregate Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		return new Elastic.Clients.Elasticsearch.Aggregations.PercentilesBucketAggregate(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance)
		{
			Meta = propMeta.Value,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, Elastic.Clients.Elasticsearch.Aggregations.PercentilesBucketAggregate value, System.Text.Json.JsonSerializerOptions options)
	{
...
[System.Text.Json.Serialization.JsonConverter(typeof(Elastic.Clients.Elasticsearch.Aggregations.PercentilesBucketAggregateConverter))]
public sealed partial class PercentilesBucketAggregate : Elastic.Clients.Elasticsearch.Aggregations.IAggregate
{
	[System.Diagnostics.CodeAnalysis.SetsRequiredMembers]
	public PercentilesBucketAggregate(System.Collections.Generic.IReadOnlyCollection<Elastic.Clients.Elasticsearch.Aggregations.PercentilesItem> values)
	{
		Values = values;
	}
#if NET7_0_OR_GREATER
	public PercentilesBucketAggregate()
	{
	}
#endif
#if !NET7_0_OR_GREATER
...
#endif
	[System.Diagnostics.CodeAnalysis.SetsRequiredMembers]
	internal PercentilesBucketAggregate(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel sentinel)
	{
		_ = sentinel;
	}
	...
	string Elastic.Clients.Elasticsearch.Aggregations.IAggregate.Type => "percentiles_bucket";
