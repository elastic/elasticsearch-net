...
public sealed partial class CategorizeTextAnalyzerConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Aggregations.CategorizeTextAnalyzer>
{
	public override Elastic.Clients.Elasticsearch.Aggregations.CategorizeTextAnalyzer Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		{
			1 => new Elastic.Clients.Elasticsearch.Aggregations.CategorizeTextAnalyzer(reader.ReadValue<string>(options, null)),
			2 => new Elastic.Clients.Elasticsearch.Aggregations.CategorizeTextAnalyzer(reader.ReadValue<Elastic.Clients.Elasticsearch.Aggregations.CustomCategorizeTextAnalyzer>(options, null)),
