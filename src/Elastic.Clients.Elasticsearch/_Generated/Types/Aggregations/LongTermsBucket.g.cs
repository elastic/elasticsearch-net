...
internal sealed partial class LongTermsBucketConverter : JsonConverter<LongTermsBucket>
{
	public override LongTermsBucket Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
	{
		...
		return new LongTermsBucket { Aggregations = new Elastic.Clients.Elasticsearch.Aggregations.AggregateDictionary(additionalProperties), DocCount = docCount, DocCountError = docCountError, Key = key, KeyAsString = keyAsString };
	}
