...
namespace Elastic.Clients.Elasticsearch.Aggregations
{
	...
	public partial class AggregateDictionary : IsAReadOnlyDictionaryBase<string, AggregateBase>
	{
		...
		public Elastic.Clients.Elasticsearch.Aggregations.HdrPercentilesAggregate? HdrPercentiles(string key) => TryGet<Elastic.Clients.Elasticsearch.Aggregations.HdrPercentilesAggregate?>(key);
		public Elastic.Clients.Elasticsearch.Aggregations.HdrPercentileRanksAggregate? HdrPercentileRanks(string key) => TryGet<Elastic.Clients.Elasticsearch.Aggregations.HdrPercentileRanksAggregate?>(key);
		public Elastic.Clients.Elasticsearch.Aggregations.TDigestPercentilesAggregate? TDigestPercentiles(string key) => TryGet<Elastic.Clients.Elasticsearch.Aggregations.TDigestPercentilesAggregate?>(key);
		...
		public Elastic.Clients.Elasticsearch.Aggregations.SimpleValueAggregate? SimpleValue(string key) => TryGet<Elastic.Clients.Elasticsearch.Aggregations.SimpleValueAggregate?>(key);
		...
		public Elastic.Clients.Elasticsearch.Aggregations.BucketMetricValueAggregate? BucketMetricValue(string key) => TryGet<Elastic.Clients.Elasticsearch.Aggregations.BucketMetricValueAggregate?>(key);
		...
		public Elastic.Clients.Elasticsearch.Aggregations.GeoBoundsAggregate? GeoBounds(string key) => TryGet<Elastic.Clients.Elasticsearch.Aggregations.GeoBoundsAggregate?>(key);
		public Elastic.Clients.Elasticsearch.Aggregations.GeoCentroidAggregate? GeoCentroid(string key) => TryGet<Elastic.Clients.Elasticsearch.Aggregations.GeoCentroidAggregate?>(key);
		...
		public Elastic.Clients.Elasticsearch.Aggregations.LongRareTermsAggregate? LongRareTerms(string key) => TryGet<Elastic.Clients.Elasticsearch.Aggregations.LongRareTermsAggregate?>(key);
		public Elastic.Clients.Elasticsearch.Aggregations.StringRareTermsAggregate? StringRareTerms(string key) => TryGet<Elastic.Clients.Elasticsearch.Aggregations.StringRareTermsAggregate?>(key);
		...
		public Elastic.Clients.Elasticsearch.Aggregations.GeoDistanceAggregate? GeoDistance(string key) => TryGet<Elastic.Clients.Elasticsearch.Aggregations.GeoDistanceAggregate?>(key);
		...
		public Elastic.Clients.Elasticsearch.Aggregations.SignificantLongTermsAggregate? SignificantLongTerms(string key) => TryGet<Elastic.Clients.Elasticsearch.Aggregations.SignificantLongTermsAggregate?>(key);
		public Elastic.Clients.Elasticsearch.Aggregations.SignificantStringTermsAggregate? SignificantStringTerms(string key) => TryGet<Elastic.Clients.Elasticsearch.Aggregations.SignificantStringTermsAggregate?>(key);
