...
namespace Elastic.Clients.Elasticsearch.Aggregations
{
	...
	public sealed partial class GlobalAggregationDescriptor<TDocument> : DescriptorBase<GlobalAggregationDescriptor<TDocument>>
	{
		...
		public GlobalAggregationDescriptor<TDocument> Meta(Func<FluentDictionary<string, object>, FluentDictionary<string, object>> selector) => Assign(selector, (a, v) => a.MetaValue = v?.Invoke(new FluentDictionary<string, object>()));
