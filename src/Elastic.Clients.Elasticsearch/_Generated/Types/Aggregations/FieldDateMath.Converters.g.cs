...
public sealed partial class FieldDateMathConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Aggregations.FieldDateMath>
{
	public override Elastic.Clients.Elasticsearch.Aggregations.FieldDateMath Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		{
			1 => new Elastic.Clients.Elasticsearch.Aggregations.FieldDateMath(reader.ReadValue<Elastic.Clients.Elasticsearch.DateMath>(options, null)),
			2 => new Elastic.Clients.Elasticsearch.Aggregations.FieldDateMath(reader.ReadValue<long>(options, null)),
