...
internal sealed partial class StringRareTermsBucketConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Aggregations.StringRareTermsBucket>
{
	...
	public override Elastic.Clients.Elasticsearch.Aggregations.StringRareTermsBucket Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		return new Elastic.Clients.Elasticsearch.Aggregations.StringRareTermsBucket(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance)
		{
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, Elastic.Clients.Elasticsearch.Aggregations.StringRareTermsBucket value, System.Text.Json.JsonSerializerOptions options)
	{
...
[System.Text.Json.Serialization.JsonConverter(typeof(Elastic.Clients.Elasticsearch.Aggregations.StringRareTermsBucketConverter))]
public sealed partial class StringRareTermsBucket
{
	[System.Diagnostics.CodeAnalysis.SetsRequiredMembers]
	public StringRareTermsBucket(long docCount, string key)
	{
		DocCount = docCount;
		Key = key;
	}
#if NET7_0_OR_GREATER
	public StringRareTermsBucket()
	{
	}
#endif
#if !NET7_0_OR_GREATER
...
#endif
	[System.Diagnostics.CodeAnalysis.SetsRequiredMembers]
	internal StringRareTermsBucket(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel sentinel)
	{
		_ = sentinel;
	}
