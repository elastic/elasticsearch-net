...
public sealed partial class GeohashGridBucket : AggregateDictionary
{
	public GeohashGridBucket(IReadOnlyDictionary<string, IAggregate> backingDictionary) : base(backingDictionary)
	{
	}
...
internal sealed class GeohashGridBucketConverter : JsonConverter<GeohashGridBucket>
{
	public override GeohashGridBucket? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
	{
		...
		return new GeohashGridBucket(subAggs) { DocCount = docCount, Key = key };
	}
