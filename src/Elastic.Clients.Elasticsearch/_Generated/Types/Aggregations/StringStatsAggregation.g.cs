...
namespace Elastic.Clients.Elasticsearch.Aggregations
{
	internal sealed class StringStatsAggregationConverter : JsonConverter<StringStatsAggregation>
	{
		public override StringStatsAggregation Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
		{
			...
			var variant = new StringStatsAggregation();
			while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
			{
				if (reader.TokenType == JsonTokenType.PropertyName)
				{
					...
					if (property == "show_distribution")
					{
						variant.ShowDistribution = JsonSerializer.Deserialize<bool?>(ref reader, options);
						continue;
					}
				}
			}
	...
	{
		public StringStatsAggregation(string name, Field field) => Field = field;
