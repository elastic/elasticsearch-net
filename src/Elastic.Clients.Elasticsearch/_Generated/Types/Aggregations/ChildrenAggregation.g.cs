...
namespace Elastic.Clients.Elasticsearch.Aggregations
{
	...
	public sealed partial class ChildrenAggregationDescriptor<TDocument> : DescriptorBase<ChildrenAggregationDescriptor<TDocument>>
	{
		...
		public ChildrenAggregationDescriptor<TDocument> Type(string? type) => Assign(type, (a, v) => a.TypeValue = v);
		...
		public ChildrenAggregationDescriptor<TDocument> Meta(Func<FluentDictionary<string, object>, FluentDictionary<string, object>> selector) => Assign(selector, (a, v) => a.MetaValue = v?.Invoke(new FluentDictionary<string, object>()));
