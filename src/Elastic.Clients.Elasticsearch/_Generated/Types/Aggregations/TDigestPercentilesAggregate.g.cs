...
internal sealed partial class TDigestPercentilesAggregateConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Aggregations.TDigestPercentilesAggregate>
{
	...
	public override Elastic.Clients.Elasticsearch.Aggregations.TDigestPercentilesAggregate Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		return new Elastic.Clients.Elasticsearch.Aggregations.TDigestPercentilesAggregate(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance)
		{
			Meta = propMeta.Value,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, Elastic.Clients.Elasticsearch.Aggregations.TDigestPercentilesAggregate value, System.Text.Json.JsonSerializerOptions options)
	{
...
[System.Text.Json.Serialization.JsonConverter(typeof(Elastic.Clients.Elasticsearch.Aggregations.TDigestPercentilesAggregateConverter))]
public sealed partial class TDigestPercentilesAggregate : Elastic.Clients.Elasticsearch.Aggregations.IAggregate
{
	[System.Diagnostics.CodeAnalysis.SetsRequiredMembers]
	public TDigestPercentilesAggregate(System.Collections.Generic.IReadOnlyCollection<Elastic.Clients.Elasticsearch.Aggregations.PercentilesItem> values)
	{
		Values = values;
	}
#if NET7_0_OR_GREATER
	public TDigestPercentilesAggregate()
	{
	}
#endif
#if !NET7_0_OR_GREATER
...
#endif
	[System.Diagnostics.CodeAnalysis.SetsRequiredMembers]
	internal TDigestPercentilesAggregate(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel sentinel)
	{
		_ = sentinel;
	}
	...
	string Elastic.Clients.Elasticsearch.Aggregations.IAggregate.Type => "tdigest_percentiles";
