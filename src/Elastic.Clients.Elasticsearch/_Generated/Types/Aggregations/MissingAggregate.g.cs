...
public sealed partial class MissingAggregate : AggregateDictionary, IAggregate
{
	public MissingAggregate(IReadOnlyDictionary<string, IAggregate> backingDictionary) : base(backingDictionary)
	{
	}
...
internal sealed class MissingAggregateConverter : JsonConverter<MissingAggregate>
{
	public override MissingAggregate? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
	{
		...
		return new MissingAggregate(subAggs) { DocCount = docCount, Meta = meta };
	}
