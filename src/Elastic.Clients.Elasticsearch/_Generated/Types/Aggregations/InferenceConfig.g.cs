...
public sealed partial class InferenceConfigDescriptor : SerializableDescriptor<InferenceConfigDescriptor>
{
	...
	public InferenceConfigDescriptor Regression(Action<Elastic.Clients.Elasticsearch.MachineLearning.RegressionInferenceOptionsDescriptor> configure) => Set(configure, "regression");
	public InferenceConfigDescriptor Regression<TDocument>(Action<Elastic.Clients.Elasticsearch.MachineLearning.RegressionInferenceOptionsDescriptor<TDocument>> configure) => Set(configure, "regression");
