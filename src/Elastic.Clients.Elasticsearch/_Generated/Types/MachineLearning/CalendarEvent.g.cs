...
public sealed partial class CalendarEvent
{
	...
	/// <include file="CalendarEvent.g.xml" path="doc/member[@key='ml._types.CalendarEvent#force_time_shift']/*"/>
	public int? ForceTimeShift { get; set; }

	/// <include file="CalendarEvent.g.xml" path="doc/member[@key='ml._types.CalendarEvent#skip_model_update']/*"/>
	public bool? SkipModelUpdate { get; set; }

	/// <include file="CalendarEvent.g.xml" path="doc/member[@key='ml._types.CalendarEvent#skip_result']/*"/>
