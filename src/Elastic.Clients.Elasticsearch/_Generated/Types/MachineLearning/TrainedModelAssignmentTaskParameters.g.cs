...
{
	/// <summary>
	/// <para>The size of the trained model cache.</para>
	/// </summary>
	...
	/// <summary>
	/// <para>The size of the trained model in bytes.</para>
	/// </summary>
	...
	/// <summary>
	/// <para>The total number of allocations this model is assigned across ML nodes.</para>
	/// </summary>
	...
	/// <summary>
	/// <para>Number of inference requests are allowed in the queue at a time.</para>
	/// </summary>
	[JsonInclude, JsonPropertyName("queue_capacity")]
	public int QueueCapacity { get; init; }

	/// <summary>
	/// <para>Number of threads per allocation.</para>
	/// </summary>
