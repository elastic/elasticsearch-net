...
public sealed partial class DataframeAnalysisDescriptor : SerializableDescriptor<DataframeAnalysisDescriptor>
{
	...
	public DataframeAnalysisDescriptor Classification(Action<Elastic.Clients.Elasticsearch.MachineLearning.DataframeAnalysisClassificationDescriptor> configure) => Set(configure, "classification");
	public DataframeAnalysisDescriptor Classification<TDocument>(Action<Elastic.Clients.Elasticsearch.MachineLearning.DataframeAnalysisClassificationDescriptor<TDocument>> configure) => Set(configure, "classification");
	...
	public DataframeAnalysisDescriptor Regression(Action<Elastic.Clients.Elasticsearch.MachineLearning.DataframeAnalysisRegressionDescriptor> configure) => Set(configure, "regression");
	public DataframeAnalysisDescriptor Regression<TDocument>(Action<Elastic.Clients.Elasticsearch.MachineLearning.DataframeAnalysisRegressionDescriptor<TDocument>> configure) => Set(configure, "regression");
