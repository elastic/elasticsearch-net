...
public sealed partial class DataframeEvaluationDescriptor : SerializableDescriptor<DataframeEvaluationDescriptor>
{
	...
	public DataframeEvaluationDescriptor Classification(Action<Elastic.Clients.Elasticsearch.MachineLearning.DataframeEvaluationClassificationDescriptor> configure) => Set(configure, "classification");
	public DataframeEvaluationDescriptor Classification<TDocument>(Action<Elastic.Clients.Elasticsearch.MachineLearning.DataframeEvaluationClassificationDescriptor<TDocument>> configure) => Set(configure, "classification");
	...
	public DataframeEvaluationDescriptor OutlierDetection(Action<Elastic.Clients.Elasticsearch.MachineLearning.DataframeEvaluationOutlierDetectionDescriptor> configure) => Set(configure, "outlier_detection");
	public DataframeEvaluationDescriptor OutlierDetection<TDocument>(Action<Elastic.Clients.Elasticsearch.MachineLearning.DataframeEvaluationOutlierDetectionDescriptor<TDocument>> configure) => Set(configure, "outlier_detection");
	...
	public DataframeEvaluationDescriptor Regression(Action<Elastic.Clients.Elasticsearch.MachineLearning.DataframeEvaluationRegressionDescriptor> configure) => Set(configure, "regression");
	public DataframeEvaluationDescriptor Regression<TDocument>(Action<Elastic.Clients.Elasticsearch.MachineLearning.DataframeEvaluationRegressionDescriptor<TDocument>> configure) => Set(configure, "regression");
