...
public sealed partial class DatafeedConfigDescriptor<TDocument> : SerializableDescriptor<DatafeedConfigDescriptor<TDocument>>
{
	...
	/// <para>If set, the datafeed performs aggregation searches. Support for aggregations is limited and should be used only with low cardinality data.</para>
	/// </summary>
	public DatafeedConfigDescriptor<TDocument> Aggregations(Func<FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>, FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>> selector)
	{
...
public sealed partial class DatafeedConfigDescriptor : SerializableDescriptor<DatafeedConfigDescriptor>
{
	...
	/// <para>If set, the datafeed performs aggregation searches. Support for aggregations is limited and should be used only with low cardinality data.</para>
	/// </summary>
	public DatafeedConfigDescriptor Aggregations(Func<FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>, FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>> selector)
	{
		AggregationsValue = selector?.Invoke(new FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>());
		return Self;
	}
