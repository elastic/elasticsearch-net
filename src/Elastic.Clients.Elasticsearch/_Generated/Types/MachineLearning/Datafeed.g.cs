...
public sealed partial class Datafeed
{
	...
	/// <include file="Datafeed.g.xml" path="doc/member[@key='ml._types.Datafeed#frequency']/*"/>
	...
	/// <include file="Datafeed.g.xml" path="doc/member[@key='ml._types.Datafeed#project_routing']/*"/>
