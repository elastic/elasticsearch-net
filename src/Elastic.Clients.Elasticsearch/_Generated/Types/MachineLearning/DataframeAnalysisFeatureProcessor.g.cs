...
public sealed partial class DataframeAnalysisFeatureProcessorDescriptor : SerializableDescriptor<DataframeAnalysisFeatureProcessorDescriptor>
{
	...
	public DataframeAnalysisFeatureProcessorDescriptor FrequencyEncoding(Action<Elastic.Clients.Elasticsearch.MachineLearning.DataframeAnalysisFeatureProcessorFrequencyEncodingDescriptor> configure) => Set(configure, "frequency_encoding");
	public DataframeAnalysisFeatureProcessorDescriptor FrequencyEncoding<TDocument>(Action<Elastic.Clients.Elasticsearch.MachineLearning.DataframeAnalysisFeatureProcessorFrequencyEncodingDescriptor<TDocument>> configure) => Set(configure, "frequency_encoding");
	...
	public DataframeAnalysisFeatureProcessorDescriptor NGramEncoding(Action<Elastic.Clients.Elasticsearch.MachineLearning.DataframeAnalysisFeatureProcessorNGramEncodingDescriptor> configure) => Set(configure, "n_gram_encoding");
	public DataframeAnalysisFeatureProcessorDescriptor NGramEncoding<TDocument>(Action<Elastic.Clients.Elasticsearch.MachineLearning.DataframeAnalysisFeatureProcessorNGramEncodingDescriptor<TDocument>> configure) => Set(configure, "n_gram_encoding");
	...
	public DataframeAnalysisFeatureProcessorDescriptor OneHotEncoding(Action<Elastic.Clients.Elasticsearch.MachineLearning.DataframeAnalysisFeatureProcessorOneHotEncodingDescriptor> configure) => Set(configure, "one_hot_encoding");
	public DataframeAnalysisFeatureProcessorDescriptor OneHotEncoding<TDocument>(Action<Elastic.Clients.Elasticsearch.MachineLearning.DataframeAnalysisFeatureProcessorOneHotEncodingDescriptor<TDocument>> configure) => Set(configure, "one_hot_encoding");
	...
	public DataframeAnalysisFeatureProcessorDescriptor TargetMeanEncoding(Action<Elastic.Clients.Elasticsearch.MachineLearning.DataframeAnalysisFeatureProcessorTargetMeanEncodingDescriptor> configure) => Set(configure, "target_mean_encoding");
	public DataframeAnalysisFeatureProcessorDescriptor TargetMeanEncoding<TDocument>(Action<Elastic.Clients.Elasticsearch.MachineLearning.DataframeAnalysisFeatureProcessorTargetMeanEncodingDescriptor<TDocument>> configure) => Set(configure, "target_mean_encoding");
