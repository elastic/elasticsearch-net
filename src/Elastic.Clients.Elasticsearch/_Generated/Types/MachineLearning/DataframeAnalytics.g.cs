...
public sealed partial class DataframeAnalytics
{
	...
	public Elastic.Clients.Elasticsearch.MachineLearning.DataframeAnalyticsStatsDataCounts DataCounts { get; init; }
	...
	public Elastic.Clients.Elasticsearch.MachineLearning.DataframeAnalyticsStatsMemoryUsage MemoryUsage { get; init; }

	/// <summary>
	/// <para>Contains properties for the node that runs the job. This information is available only for running jobs.</para>
	/// </summary>
	...
	public IReadOnlyCollection<Elastic.Clients.Elasticsearch.MachineLearning.DataframeAnalyticsStatsProgress> Progress { get; init; }
	...
	public Elastic.Clients.Elasticsearch.MachineLearning.DataframeState State { get; init; }
}