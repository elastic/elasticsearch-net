...
public sealed partial class CategorizationAnalyzerConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.MachineLearning.CategorizationAnalyzer>
{
	public override Elastic.Clients.Elasticsearch.MachineLearning.CategorizationAnalyzer Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		{
			1 => new Elastic.Clients.Elasticsearch.MachineLearning.CategorizationAnalyzer(reader.ReadValue<string>(options, null)),
			2 => new Elastic.Clients.Elasticsearch.MachineLearning.CategorizationAnalyzer(reader.ReadValue<Elastic.Clients.Elasticsearch.MachineLearning.CategorizationAnalyzerDefinition>(options, null)),
