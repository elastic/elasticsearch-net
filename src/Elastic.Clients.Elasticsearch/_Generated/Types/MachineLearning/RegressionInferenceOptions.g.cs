...
public sealed partial class RegressionInferenceOptions
{
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Aggregations.InferenceConfig(RegressionInferenceOptions regressionInferenceOptions) => Elastic.Clients.Elasticsearch.Aggregations.InferenceConfig.Regression(regressionInferenceOptions);
	public static implicit operator Elastic.Clients.Elasticsearch.MachineLearning.InferenceConfigCreate(RegressionInferenceOptions regressionInferenceOptions) => Elastic.Clients.Elasticsearch.MachineLearning.InferenceConfigCreate.Regression(regressionInferenceOptions);
	public static implicit operator Elastic.Clients.Elasticsearch.MachineLearning.InferenceConfigUpdate(RegressionInferenceOptions regressionInferenceOptions) => Elastic.Clients.Elasticsearch.MachineLearning.InferenceConfigUpdate.Regression(regressionInferenceOptions);
}
