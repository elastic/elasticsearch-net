...
internal sealed partial class QueryConverter : JsonConverter<Query>
{
	public override Query Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
	{
		...
		while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
		{
			...
			{
				variantValue = JsonSerializer.Deserialize<Elastic.Clients.Elasticsearch.QueryDsl.GeoPolygonQuery?>(ref reader, options);
				variantNameValue = propertyName;
				continue;
			}
			...
			{
				variantValue = JsonSerializer.Deserialize<Elastic.Clients.Elasticsearch.QueryDsl.RangeQuery?>(ref reader, options);
				variantNameValue = propertyName;
				continue;
			}
...
public sealed partial class QueryDescriptor<TDocument> : SerializableDescriptor<QueryDescriptor<TDocument>>
{
	...
	public QueryDescriptor<TDocument> FieldMaskingSpan(Elastic.Clients.Elasticsearch.QueryDsl.SpanFieldMaskingQuery spanFieldMaskingQuery) => Set(spanFieldMaskingQuery, "field_masking_span");
	public QueryDescriptor<TDocument> FieldMaskingSpan(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanFieldMaskingQueryDescriptor<TDocument>> configure) => Set(configure, "field_masking_span");
	...
	public QueryDescriptor<TDocument> Fuzzy(Action<Elastic.Clients.Elasticsearch.QueryDsl.FuzzyQueryDescriptor> configure) => Set(configure, "fuzzy");
	...
	public QueryDescriptor<TDocument> GeoPolygon(Elastic.Clients.Elasticsearch.QueryDsl.GeoPolygonQuery geoPolygonQuery) => Set(geoPolygonQuery, "geo_polygon");
	public QueryDescriptor<TDocument> GeoPolygon(Action<Elastic.Clients.Elasticsearch.QueryDsl.GeoPolygonQueryDescriptor<TDocument>> configure) => Set(configure, "geo_polygon");
	...
	public QueryDescriptor<TDocument> Match(Action<Elastic.Clients.Elasticsearch.QueryDsl.MatchQueryDescriptor> configure) => Set(configure, "match");
	...
	public QueryDescriptor<TDocument> MatchBoolPrefix(Action<Elastic.Clients.Elasticsearch.QueryDsl.MatchBoolPrefixQueryDescriptor> configure) => Set(configure, "match_bool_prefix");
	...
	public QueryDescriptor<TDocument> MatchPhrase(Action<Elastic.Clients.Elasticsearch.QueryDsl.MatchPhraseQueryDescriptor> configure) => Set(configure, "match_phrase");
	...
	public QueryDescriptor<TDocument> MatchPhrasePrefix(Action<Elastic.Clients.Elasticsearch.QueryDsl.MatchPhrasePrefixQueryDescriptor> configure) => Set(configure, "match_phrase_prefix");
	...
	public QueryDescriptor<TDocument> Prefix(Action<Elastic.Clients.Elasticsearch.QueryDsl.PrefixQueryDescriptor> configure) => Set(configure, "prefix");
	...
	public QueryDescriptor<TDocument> Range(Elastic.Clients.Elasticsearch.QueryDsl.RangeQuery rangeQuery) => Set(rangeQuery, "range");
	...
	public QueryDescriptor<TDocument> Regexp(Action<Elastic.Clients.Elasticsearch.QueryDsl.RegexpQueryDescriptor> configure) => Set(configure, "regexp");
	public QueryDescriptor<TDocument> RuleQuery(Elastic.Clients.Elasticsearch.QueryDsl.RuleQuery ruleQuery) => Set(ruleQuery, "rule_query");
	public QueryDescriptor<TDocument> RuleQuery(Action<Elastic.Clients.Elasticsearch.QueryDsl.RuleQueryDescriptor<TDocument>> configure) => Set(configure, "rule_query");
	...
	public QueryDescriptor<TDocument> SpanTerm(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanTermQueryDescriptor> configure) => Set(configure, "span_term");
	...
	public QueryDescriptor<TDocument> Term(Action<Elastic.Clients.Elasticsearch.QueryDsl.TermQueryDescriptor> configure) => Set(configure, "term");
	...
	public QueryDescriptor<TDocument> TextExpansion(Action<Elastic.Clients.Elasticsearch.QueryDsl.TextExpansionQueryDescriptor> configure) => Set(configure, "text_expansion");
	...
	public QueryDescriptor<TDocument> WeightedTokens(Action<Elastic.Clients.Elasticsearch.QueryDsl.WeightedTokensQueryDescriptor> configure) => Set(configure, "weighted_tokens");
	...
	public QueryDescriptor<TDocument> Wildcard(Action<Elastic.Clients.Elasticsearch.QueryDsl.WildcardQueryDescriptor> configure) => Set(configure, "wildcard");
...
public sealed partial class QueryDescriptor : SerializableDescriptor<QueryDescriptor>
{
	...
	public QueryDescriptor Bool(Action<Elastic.Clients.Elasticsearch.QueryDsl.BoolQueryDescriptor> configure) => Set(configure, "bool");
	public QueryDescriptor Bool<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.BoolQueryDescriptor<TDocument>> configure) => Set(configure, "bool");
	...
	public QueryDescriptor Boosting(Action<Elastic.Clients.Elasticsearch.QueryDsl.BoostingQueryDescriptor> configure) => Set(configure, "boosting");
	public QueryDescriptor Boosting<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.BoostingQueryDescriptor<TDocument>> configure) => Set(configure, "boosting");
	...
	public QueryDescriptor CombinedFields(Action<Elastic.Clients.Elasticsearch.QueryDsl.CombinedFieldsQueryDescriptor> configure) => Set(configure, "combined_fields");
	public QueryDescriptor CombinedFields<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.CombinedFieldsQueryDescriptor<TDocument>> configure) => Set(configure, "combined_fields");
	...
	public QueryDescriptor ConstantScore(Action<Elastic.Clients.Elasticsearch.QueryDsl.ConstantScoreQueryDescriptor> configure) => Set(configure, "constant_score");
	public QueryDescriptor ConstantScore<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.ConstantScoreQueryDescriptor<TDocument>> configure) => Set(configure, "constant_score");
	public QueryDescriptor DisMax(Elastic.Clients.Elasticsearch.QueryDsl.DisMaxQuery disMaxQuery) => Set(disMaxQuery, "dis_max");
	public QueryDescriptor DisMax(Action<Elastic.Clients.Elasticsearch.QueryDsl.DisMaxQueryDescriptor> configure) => Set(configure, "dis_max");
	public QueryDescriptor DisMax<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.DisMaxQueryDescriptor<TDocument>> configure) => Set(configure, "dis_max");
	public QueryDescriptor Exists(Elastic.Clients.Elasticsearch.QueryDsl.ExistsQuery existsQuery) => Set(existsQuery, "exists");
	public QueryDescriptor Exists(Action<Elastic.Clients.Elasticsearch.QueryDsl.ExistsQueryDescriptor> configure) => Set(configure, "exists");
	public QueryDescriptor Exists<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.ExistsQueryDescriptor<TDocument>> configure) => Set(configure, "exists");
	public QueryDescriptor FieldMaskingSpan(Elastic.Clients.Elasticsearch.QueryDsl.SpanFieldMaskingQuery spanFieldMaskingQuery) => Set(spanFieldMaskingQuery, "field_masking_span");
	public QueryDescriptor FieldMaskingSpan(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanFieldMaskingQueryDescriptor> configure) => Set(configure, "field_masking_span");
	public QueryDescriptor FieldMaskingSpan<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanFieldMaskingQueryDescriptor<TDocument>> configure) => Set(configure, "field_masking_span");
	...
	public QueryDescriptor FunctionScore(Action<Elastic.Clients.Elasticsearch.QueryDsl.FunctionScoreQueryDescriptor> configure) => Set(configure, "function_score");
	public QueryDescriptor FunctionScore<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.FunctionScoreQueryDescriptor<TDocument>> configure) => Set(configure, "function_score");
	public QueryDescriptor Fuzzy(Elastic.Clients.Elasticsearch.QueryDsl.FuzzyQuery fuzzyQuery) => Set(fuzzyQuery, "fuzzy");
	public QueryDescriptor Fuzzy(Action<Elastic.Clients.Elasticsearch.QueryDsl.FuzzyQueryDescriptor> configure) => Set(configure, "fuzzy");
	...
	public QueryDescriptor GeoBoundingBox(Action<Elastic.Clients.Elasticsearch.QueryDsl.GeoBoundingBoxQueryDescriptor> configure) => Set(configure, "geo_bounding_box");
	public QueryDescriptor GeoBoundingBox<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.GeoBoundingBoxQueryDescriptor<TDocument>> configure) => Set(configure, "geo_bounding_box");
	...
	public QueryDescriptor GeoDistance(Action<Elastic.Clients.Elasticsearch.QueryDsl.GeoDistanceQueryDescriptor> configure) => Set(configure, "geo_distance");
	public QueryDescriptor GeoDistance<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.GeoDistanceQueryDescriptor<TDocument>> configure) => Set(configure, "geo_distance");
	public QueryDescriptor GeoPolygon(Elastic.Clients.Elasticsearch.QueryDsl.GeoPolygonQuery geoPolygonQuery) => Set(geoPolygonQuery, "geo_polygon");
	public QueryDescriptor GeoPolygon(Action<Elastic.Clients.Elasticsearch.QueryDsl.GeoPolygonQueryDescriptor> configure) => Set(configure, "geo_polygon");
	public QueryDescriptor GeoPolygon<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.GeoPolygonQueryDescriptor<TDocument>> configure) => Set(configure, "geo_polygon");
	...
	public QueryDescriptor HasChild(Action<Elastic.Clients.Elasticsearch.QueryDsl.HasChildQueryDescriptor> configure) => Set(configure, "has_child");
	public QueryDescriptor HasChild<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.HasChildQueryDescriptor<TDocument>> configure) => Set(configure, "has_child");
	...
	public QueryDescriptor HasParent(Action<Elastic.Clients.Elasticsearch.QueryDsl.HasParentQueryDescriptor> configure) => Set(configure, "has_parent");
	public QueryDescriptor HasParent<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.HasParentQueryDescriptor<TDocument>> configure) => Set(configure, "has_parent");
	...
	public QueryDescriptor Intervals(Action<Elastic.Clients.Elasticsearch.QueryDsl.IntervalsQueryDescriptor> configure) => Set(configure, "intervals");
	public QueryDescriptor Intervals<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.IntervalsQueryDescriptor<TDocument>> configure) => Set(configure, "intervals");
	public QueryDescriptor Knn(Elastic.Clients.Elasticsearch.KnnQuery knnQuery) => Set(knnQuery, "knn");
	public QueryDescriptor Knn(Action<Elastic.Clients.Elasticsearch.KnnQueryDescriptor> configure) => Set(configure, "knn");
	public QueryDescriptor Knn<TDocument>(Action<Elastic.Clients.Elasticsearch.KnnQueryDescriptor<TDocument>> configure) => Set(configure, "knn");
	public QueryDescriptor Match(Elastic.Clients.Elasticsearch.QueryDsl.MatchQuery matchQuery) => Set(matchQuery, "match");
	public QueryDescriptor Match(Action<Elastic.Clients.Elasticsearch.QueryDsl.MatchQueryDescriptor> configure) => Set(configure, "match");
	...
	public QueryDescriptor MatchBoolPrefix(Action<Elastic.Clients.Elasticsearch.QueryDsl.MatchBoolPrefixQueryDescriptor> configure) => Set(configure, "match_bool_prefix");
	...
	public QueryDescriptor MatchPhrase(Action<Elastic.Clients.Elasticsearch.QueryDsl.MatchPhraseQueryDescriptor> configure) => Set(configure, "match_phrase");
	...
	public QueryDescriptor MatchPhrasePrefix(Action<Elastic.Clients.Elasticsearch.QueryDsl.MatchPhrasePrefixQueryDescriptor> configure) => Set(configure, "match_phrase_prefix");
	...
	public QueryDescriptor MoreLikeThis(Action<Elastic.Clients.Elasticsearch.QueryDsl.MoreLikeThisQueryDescriptor> configure) => Set(configure, "more_like_this");
	public QueryDescriptor MoreLikeThis<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.MoreLikeThisQueryDescriptor<TDocument>> configure) => Set(configure, "more_like_this");
	...
	public QueryDescriptor MultiMatch(Action<Elastic.Clients.Elasticsearch.QueryDsl.MultiMatchQueryDescriptor> configure) => Set(configure, "multi_match");
	public QueryDescriptor MultiMatch<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.MultiMatchQueryDescriptor<TDocument>> configure) => Set(configure, "multi_match");
	public QueryDescriptor Nested(Elastic.Clients.Elasticsearch.QueryDsl.NestedQuery nestedQuery) => Set(nestedQuery, "nested");
	public QueryDescriptor Nested(Action<Elastic.Clients.Elasticsearch.QueryDsl.NestedQueryDescriptor> configure) => Set(configure, "nested");
	public QueryDescriptor Nested<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.NestedQueryDescriptor<TDocument>> configure) => Set(configure, "nested");
	...
	public QueryDescriptor Percolate(Action<Elastic.Clients.Elasticsearch.QueryDsl.PercolateQueryDescriptor> configure) => Set(configure, "percolate");
	public QueryDescriptor Percolate<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.PercolateQueryDescriptor<TDocument>> configure) => Set(configure, "percolate");
	public QueryDescriptor Pinned(Elastic.Clients.Elasticsearch.QueryDsl.PinnedQuery pinnedQuery) => Set(pinnedQuery, "pinned");
	public QueryDescriptor Pinned(Action<Elastic.Clients.Elasticsearch.QueryDsl.PinnedQueryDescriptor> configure) => Set(configure, "pinned");
	public QueryDescriptor Pinned<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.PinnedQueryDescriptor<TDocument>> configure) => Set(configure, "pinned");
	public QueryDescriptor Prefix(Elastic.Clients.Elasticsearch.QueryDsl.PrefixQuery prefixQuery) => Set(prefixQuery, "prefix");
	public QueryDescriptor Prefix(Action<Elastic.Clients.Elasticsearch.QueryDsl.PrefixQueryDescriptor> configure) => Set(configure, "prefix");
	...
	public QueryDescriptor QueryString(Action<Elastic.Clients.Elasticsearch.QueryDsl.QueryStringQueryDescriptor> configure) => Set(configure, "query_string");
	public QueryDescriptor QueryString<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.QueryStringQueryDescriptor<TDocument>> configure) => Set(configure, "query_string");
	public QueryDescriptor Range(Elastic.Clients.Elasticsearch.QueryDsl.RangeQuery rangeQuery) => Set(rangeQuery, "range");
	...
	public QueryDescriptor RankFeature(Action<Elastic.Clients.Elasticsearch.QueryDsl.RankFeatureQueryDescriptor> configure) => Set(configure, "rank_feature");
	public QueryDescriptor RankFeature<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.RankFeatureQueryDescriptor<TDocument>> configure) => Set(configure, "rank_feature");
	...
	public QueryDescriptor Regexp(Action<Elastic.Clients.Elasticsearch.QueryDsl.RegexpQueryDescriptor> configure) => Set(configure, "regexp");
	public QueryDescriptor RuleQuery(Elastic.Clients.Elasticsearch.QueryDsl.RuleQuery ruleQuery) => Set(ruleQuery, "rule_query");
	public QueryDescriptor RuleQuery(Action<Elastic.Clients.Elasticsearch.QueryDsl.RuleQueryDescriptor> configure) => Set(configure, "rule_query");
	public QueryDescriptor RuleQuery<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.RuleQueryDescriptor<TDocument>> configure) => Set(configure, "rule_query");
	...
	public QueryDescriptor ScriptScore(Action<Elastic.Clients.Elasticsearch.QueryDsl.ScriptScoreQueryDescriptor> configure) => Set(configure, "script_score");
	public QueryDescriptor ScriptScore<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.ScriptScoreQueryDescriptor<TDocument>> configure) => Set(configure, "script_score");
	...
	public QueryDescriptor SimpleQueryString(Action<Elastic.Clients.Elasticsearch.QueryDsl.SimpleQueryStringQueryDescriptor> configure) => Set(configure, "simple_query_string");
	public QueryDescriptor SimpleQueryString<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.SimpleQueryStringQueryDescriptor<TDocument>> configure) => Set(configure, "simple_query_string");
	...
	public QueryDescriptor SpanContaining(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanContainingQueryDescriptor> configure) => Set(configure, "span_containing");
	public QueryDescriptor SpanContaining<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanContainingQueryDescriptor<TDocument>> configure) => Set(configure, "span_containing");
	...
	public QueryDescriptor SpanFirst(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanFirstQueryDescriptor> configure) => Set(configure, "span_first");
	public QueryDescriptor SpanFirst<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanFirstQueryDescriptor<TDocument>> configure) => Set(configure, "span_first");
	...
	public QueryDescriptor SpanMulti(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanMultiTermQueryDescriptor> configure) => Set(configure, "span_multi");
	public QueryDescriptor SpanMulti<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanMultiTermQueryDescriptor<TDocument>> configure) => Set(configure, "span_multi");
	...
	public QueryDescriptor SpanNear(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanNearQueryDescriptor> configure) => Set(configure, "span_near");
	public QueryDescriptor SpanNear<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanNearQueryDescriptor<TDocument>> configure) => Set(configure, "span_near");
	...
	public QueryDescriptor SpanNot(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanNotQueryDescriptor> configure) => Set(configure, "span_not");
	public QueryDescriptor SpanNot<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanNotQueryDescriptor<TDocument>> configure) => Set(configure, "span_not");
	public QueryDescriptor SpanOr(Elastic.Clients.Elasticsearch.QueryDsl.SpanOrQuery spanOrQuery) => Set(spanOrQuery, "span_or");
	public QueryDescriptor SpanOr(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanOrQueryDescriptor> configure) => Set(configure, "span_or");
	public QueryDescriptor SpanOr<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanOrQueryDescriptor<TDocument>> configure) => Set(configure, "span_or");
	...
	public QueryDescriptor SpanTerm(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanTermQueryDescriptor> configure) => Set(configure, "span_term");
	...
	public QueryDescriptor SpanWithin(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanWithinQueryDescriptor> configure) => Set(configure, "span_within");
	public QueryDescriptor SpanWithin<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanWithinQueryDescriptor<TDocument>> configure) => Set(configure, "span_within");
	public QueryDescriptor Term(Elastic.Clients.Elasticsearch.QueryDsl.TermQuery termQuery) => Set(termQuery, "term");
	public QueryDescriptor Term(Action<Elastic.Clients.Elasticsearch.QueryDsl.TermQueryDescriptor> configure) => Set(configure, "term");
	public QueryDescriptor Terms(Elastic.Clients.Elasticsearch.QueryDsl.TermsQuery termsQuery) => Set(termsQuery, "terms");
	public QueryDescriptor Terms(Action<Elastic.Clients.Elasticsearch.QueryDsl.TermsQueryDescriptor> configure) => Set(configure, "terms");
	public QueryDescriptor Terms<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.TermsQueryDescriptor<TDocument>> configure) => Set(configure, "terms");
	...
	public QueryDescriptor TermsSet(Action<Elastic.Clients.Elasticsearch.QueryDsl.TermsSetQueryDescriptor> configure) => Set(configure, "terms_set");
	public QueryDescriptor TermsSet<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.TermsSetQueryDescriptor<TDocument>> configure) => Set(configure, "terms_set");
	...
	public QueryDescriptor TextExpansion(Action<Elastic.Clients.Elasticsearch.QueryDsl.TextExpansionQueryDescriptor> configure) => Set(configure, "text_expansion");
	...
	public QueryDescriptor WeightedTokens(Action<Elastic.Clients.Elasticsearch.QueryDsl.WeightedTokensQueryDescriptor> configure) => Set(configure, "weighted_tokens");
	...
	public QueryDescriptor Wildcard(Action<Elastic.Clients.Elasticsearch.QueryDsl.WildcardQueryDescriptor> configure) => Set(configure, "wildcard");
