...
public sealed partial class SpanQuery
{
	...
	public static SpanQuery SpanGap(IReadOnlyDictionary<Elastic.Clients.Elasticsearch.Field, int> integer) => new SpanQuery("span_gap", integer);
...
internal sealed partial class SpanQueryConverter : JsonConverter<SpanQuery>
{
	public override SpanQuery Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
	{
		...
		while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
		{
			...
			{
				variantValue = JsonSerializer.Deserialize<IDictionary<Elastic.Clients.Elasticsearch.Field, int>?>(ref reader, options);
				variantNameValue = propertyName;
				continue;
			}
		...
		if (value.VariantName is not null && value.Variant is not null)
		{
			...
			switch (value.VariantName)
			{
				...
				case "span_first":
					...
					break;
				case "span_gap":
					JsonSerializer.Serialize<IReadOnlyDictionary<Elastic.Clients.Elasticsearch.Field, int>>(writer, (IReadOnlyDictionary<Elastic.Clients.Elasticsearch.Field, int>)value.Variant, options);
					break;
				case "span_multi":
...
public sealed partial class SpanQueryDescriptor<TDocument> : SerializableDescriptor<SpanQueryDescriptor<TDocument>>
{
	...
	public SpanQueryDescriptor<TDocument> SpanGap(IReadOnlyDictionary<Elastic.Clients.Elasticsearch.Field, int> integer) => Set(integer, "span_gap");
	...
	public SpanQueryDescriptor<TDocument> SpanTerm(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanTermQueryDescriptor> configure) => Set(configure, "span_term");
...
public sealed partial class SpanQueryDescriptor : SerializableDescriptor<SpanQueryDescriptor>
{
	...
	public SpanQueryDescriptor FieldMaskingSpan(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanFieldMaskingQueryDescriptor> configure) => Set(configure, "field_masking_span");
	public SpanQueryDescriptor FieldMaskingSpan<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanFieldMaskingQueryDescriptor<TDocument>> configure) => Set(configure, "field_masking_span");
	...
	public SpanQueryDescriptor SpanContaining(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanContainingQueryDescriptor> configure) => Set(configure, "span_containing");
	public SpanQueryDescriptor SpanContaining<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanContainingQueryDescriptor<TDocument>> configure) => Set(configure, "span_containing");
	...
	public SpanQueryDescriptor SpanFirst(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanFirstQueryDescriptor> configure) => Set(configure, "span_first");
	public SpanQueryDescriptor SpanFirst<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanFirstQueryDescriptor<TDocument>> configure) => Set(configure, "span_first");
	public SpanQueryDescriptor SpanGap(IReadOnlyDictionary<Elastic.Clients.Elasticsearch.Field, int> integer) => Set(integer, "span_gap");
	...
	public SpanQueryDescriptor SpanMulti(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanMultiTermQueryDescriptor> configure) => Set(configure, "span_multi");
	public SpanQueryDescriptor SpanMulti<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanMultiTermQueryDescriptor<TDocument>> configure) => Set(configure, "span_multi");
	...
	public SpanQueryDescriptor SpanNear(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanNearQueryDescriptor> configure) => Set(configure, "span_near");
	public SpanQueryDescriptor SpanNear<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanNearQueryDescriptor<TDocument>> configure) => Set(configure, "span_near");
	...
	public SpanQueryDescriptor SpanNot(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanNotQueryDescriptor> configure) => Set(configure, "span_not");
	public SpanQueryDescriptor SpanNot<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanNotQueryDescriptor<TDocument>> configure) => Set(configure, "span_not");
	public SpanQueryDescriptor SpanOr(Elastic.Clients.Elasticsearch.QueryDsl.SpanOrQuery spanOrQuery) => Set(spanOrQuery, "span_or");
	public SpanQueryDescriptor SpanOr(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanOrQueryDescriptor> configure) => Set(configure, "span_or");
	public SpanQueryDescriptor SpanOr<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanOrQueryDescriptor<TDocument>> configure) => Set(configure, "span_or");
	...
	public SpanQueryDescriptor SpanTerm(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanTermQueryDescriptor> configure) => Set(configure, "span_term");
	...
	public SpanQueryDescriptor SpanWithin(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanWithinQueryDescriptor> configure) => Set(configure, "span_within");
	public SpanQueryDescriptor SpanWithin<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.SpanWithinQueryDescriptor<TDocument>> configure) => Set(configure, "span_within");
