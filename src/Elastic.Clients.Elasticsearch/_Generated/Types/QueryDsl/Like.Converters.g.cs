...
public sealed partial class LikeConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.QueryDsl.Like>
{
	public override Elastic.Clients.Elasticsearch.QueryDsl.Like Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		{
			1 => new Elastic.Clients.Elasticsearch.QueryDsl.Like(reader.ReadValue<string>(options, null)),
			2 => new Elastic.Clients.Elasticsearch.QueryDsl.Like(reader.ReadValue<Elastic.Clients.Elasticsearch.QueryDsl.LikeDocument>(options, null)),
