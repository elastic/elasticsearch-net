...
public sealed partial class FunctionScoreDescriptor : SerializableDescriptor<FunctionScoreDescriptor>
{
	...
	public FunctionScoreDescriptor FieldValueFactor(Action<Elastic.Clients.Elasticsearch.QueryDsl.FieldValueFactorScoreFunctionDescriptor> configure) => Set(configure, "field_value_factor");
	public FunctionScoreDescriptor FieldValueFactor<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.FieldValueFactorScoreFunctionDescriptor<TDocument>> configure) => Set(configure, "field_value_factor");
	...
	public FunctionScoreDescriptor RandomScore(Action<Elastic.Clients.Elasticsearch.QueryDsl.RandomScoreFunctionDescriptor> configure) => Set(configure, "random_score");
	public FunctionScoreDescriptor RandomScore<TDocument>(Action<Elastic.Clients.Elasticsearch.QueryDsl.RandomScoreFunctionDescriptor<TDocument>> configure) => Set(configure, "random_score");
