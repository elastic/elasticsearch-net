...
public sealed partial class QueryContainerDescriptor<TDocument> : SerializableDescriptor<QueryContainerDescriptor<TDocument>>
{
	...
	public QueryContainerDescriptor<TDocument> Bool(BoolQuery boolQuery) => Set(boolQuery, "bool");
	public QueryContainerDescriptor<TDocument> Bool(Action<BoolQueryDescriptor<TDocument>> configure) => Set(configure, "bool");
	public QueryContainerDescriptor<TDocument> Boosting(BoostingQuery boostingQuery) => Set(boostingQuery, "boosting");
	...
	public QueryContainerDescriptor<TDocument> CombinedFields(CombinedFieldsQuery combinedFieldsQuery) => Set(combinedFieldsQuery, "combined_fields");
	...
	public QueryContainerDescriptor<TDocument> ConstantScore(ConstantScoreQuery constantScoreQuery) => Set(constantScoreQuery, "constant_score");
	...
	public QueryContainerDescriptor<TDocument> DisMax(DisMaxQuery disMaxQuery) => Set(disMaxQuery, "dis_max");
	public QueryContainerDescriptor<TDocument> DisMax(Action<DisMaxQueryDescriptor<TDocument>> configure) => Set(configure, "dis_max");
	public QueryContainerDescriptor<TDocument> Exists(ExistsQuery existsQuery) => Set(existsQuery, "exists");
	public QueryContainerDescriptor<TDocument> Exists(Action<ExistsQueryDescriptor<TDocument>> configure) => Set(configure, "exists");
	public QueryContainerDescriptor<TDocument> FieldMaskingSpan(SpanFieldMaskingQuery spanFieldMaskingQuery) => Set(spanFieldMaskingQuery, "field_masking_span");
	...
	public QueryContainerDescriptor<TDocument> FunctionScore(FunctionScoreQuery functionScoreQuery) => Set(functionScoreQuery, "function_score");
	...
	public QueryContainerDescriptor<TDocument> Fuzzy(FuzzyQuery fuzzyQuery) => Set(fuzzyQuery, "fuzzy");
	public QueryContainerDescriptor<TDocument> Fuzzy(Action<FuzzyQueryDescriptor<TDocument>> configure) => Set(configure, "fuzzy");
	public QueryContainerDescriptor<TDocument> HasChild(HasChildQuery hasChildQuery) => Set(hasChildQuery, "has_child");
	...
	public QueryContainerDescriptor<TDocument> HasParent(HasParentQuery hasParentQuery) => Set(hasParentQuery, "has_parent");
	...
	public QueryContainerDescriptor<TDocument> Ids(IdsQuery idsQuery) => Set(idsQuery, "ids");
	public QueryContainerDescriptor<TDocument> Ids(Action<IdsQueryDescriptor> configure) => Set(configure, "ids");
	public QueryContainerDescriptor<TDocument> Intervals(IntervalsQuery intervalsQuery) => Set(intervalsQuery, "intervals");
	...
	public QueryContainerDescriptor<TDocument> Match(MatchQuery matchQuery) => Set(matchQuery, "match");
	public QueryContainerDescriptor<TDocument> Match(Action<MatchQueryDescriptor<TDocument>> configure) => Set(configure, "match");
	public QueryContainerDescriptor<TDocument> MatchAll(MatchAllQuery matchAllQuery) => Set(matchAllQuery, "match_all");
	public QueryContainerDescriptor<TDocument> MatchAll(Action<MatchAllQueryDescriptor> configure) => Set(configure, "match_all");
	public QueryContainerDescriptor<TDocument> MatchBoolPrefix(MatchBoolPrefixQuery matchBoolPrefixQuery) => Set(matchBoolPrefixQuery, "match_bool_prefix");
	...
	public QueryContainerDescriptor<TDocument> MatchNone(MatchNoneQuery matchNoneQuery) => Set(matchNoneQuery, "match_none");
	public QueryContainerDescriptor<TDocument> MatchNone(Action<MatchNoneQueryDescriptor> configure) => Set(configure, "match_none");
	public QueryContainerDescriptor<TDocument> MatchPhrase(MatchPhraseQuery matchPhraseQuery) => Set(matchPhraseQuery, "match_phrase");
	...
	public QueryContainerDescriptor<TDocument> MatchPhrasePrefix(MatchPhrasePrefixQuery matchPhrasePrefixQuery) => Set(matchPhrasePrefixQuery, "match_phrase_prefix");
	...
	public QueryContainerDescriptor<TDocument> MoreLikeThis(MoreLikeThisQuery moreLikeThisQuery) => Set(moreLikeThisQuery, "more_like_this");
	...
	public QueryContainerDescriptor<TDocument> MultiMatch(MultiMatchQuery multiMatchQuery) => Set(multiMatchQuery, "multi_match");
	...
	public QueryContainerDescriptor<TDocument> Nested(NestedQuery nestedQuery) => Set(nestedQuery, "nested");
	public QueryContainerDescriptor<TDocument> Nested(Action<NestedQueryDescriptor<TDocument>> configure) => Set(configure, "nested");
	public QueryContainerDescriptor<TDocument> ParentId(ParentIdQuery parentIdQuery) => Set(parentIdQuery, "parent_id");
	public QueryContainerDescriptor<TDocument> ParentId(Action<ParentIdQueryDescriptor> configure) => Set(configure, "parent_id");
	public QueryContainerDescriptor<TDocument> Percolate(PercolateQuery percolateQuery) => Set(percolateQuery, "percolate");
	...
	public QueryContainerDescriptor<TDocument> Prefix(PrefixQuery prefixQuery) => Set(prefixQuery, "prefix");
	public QueryContainerDescriptor<TDocument> Prefix(Action<PrefixQueryDescriptor<TDocument>> configure) => Set(configure, "prefix");
	public QueryContainerDescriptor<TDocument> QueryString(QueryStringQuery queryStringQuery) => Set(queryStringQuery, "query_string");
	...
	public QueryContainerDescriptor<TDocument> Range(RangeQuery rangeQuery) => Set(rangeQuery, "range");
	public QueryContainerDescriptor<TDocument> RankFeature(RankFeatureQuery rankFeatureQuery) => Set(rankFeatureQuery, "rank_feature");
	...
	public QueryContainerDescriptor<TDocument> Regexp(RegexpQuery regexpQuery) => Set(regexpQuery, "regexp");
	public QueryContainerDescriptor<TDocument> Regexp(Action<RegexpQueryDescriptor<TDocument>> configure) => Set(configure, "regexp");
	public QueryContainerDescriptor<TDocument> Script(ScriptQuery scriptQuery) => Set(scriptQuery, "script");
	...
	public QueryContainerDescriptor<TDocument> SpanFirst(SpanFirstQuery spanFirstQuery) => Set(spanFirstQuery, "span_first");
	...
	public QueryContainerDescriptor<TDocument> SpanMulti(SpanMultiTermQuery spanMultiTermQuery) => Set(spanMultiTermQuery, "span_multi");
	...
	public QueryContainerDescriptor<TDocument> SpanNear(SpanNearQuery spanNearQuery) => Set(spanNearQuery, "span_near");
	...
	public QueryContainerDescriptor<TDocument> SpanNot(SpanNotQuery spanNotQuery) => Set(spanNotQuery, "span_not");
	...
	public QueryContainerDescriptor<TDocument> SpanOr(SpanOrQuery spanOrQuery) => Set(spanOrQuery, "span_or");
	public QueryContainerDescriptor<TDocument> SpanOr(Action<SpanOrQueryDescriptor<TDocument>> configure) => Set(configure, "span_or");
	public QueryContainerDescriptor<TDocument> SpanTerm(SpanTermQuery spanTermQuery) => Set(spanTermQuery, "span_term");
	...
	public QueryContainerDescriptor<TDocument> SpanWithin(SpanWithinQuery spanWithinQuery) => Set(spanWithinQuery, "span_within");
	...
	public QueryContainerDescriptor<TDocument> Term(TermQuery termQuery) => Set(termQuery, "term");
	public QueryContainerDescriptor<TDocument> Term(Action<TermQueryDescriptor<TDocument>> configure) => Set(configure, "term");
	public QueryContainerDescriptor<TDocument> Terms(TermsQuery termsQuery) => Set(termsQuery, "terms");
	public QueryContainerDescriptor<TDocument> Terms(Action<TermsQueryDescriptor<TDocument>> configure) => Set(configure, "terms");
	public QueryContainerDescriptor<TDocument> TermsSet(TermsSetQuery termsSetQuery) => Set(termsSetQuery, "terms_set");
	...
	public QueryContainerDescriptor<TDocument> Wildcard(WildcardQuery wildcardQuery) => Set(wildcardQuery, "wildcard");
	...
	public QueryContainerDescriptor<TDocument> Wrapper(WrapperQuery wrapperQuery) => Set(wrapperQuery, "wrapper");
...
public sealed partial class QueryContainerDescriptor : SerializableDescriptor<QueryContainerDescriptor>
{
	...
	public QueryContainerDescriptor Bool(BoolQuery boolQuery) => Set(boolQuery, "bool");
	...
	public QueryContainerDescriptor Boosting(BoostingQuery boostingQuery) => Set(boostingQuery, "boosting");
	...
	public QueryContainerDescriptor CombinedFields(CombinedFieldsQuery combinedFieldsQuery) => Set(combinedFieldsQuery, "combined_fields");
	...
	public QueryContainerDescriptor ConstantScore(ConstantScoreQuery constantScoreQuery) => Set(constantScoreQuery, "constant_score");
	...
	public QueryContainerDescriptor DisMax(DisMaxQuery disMaxQuery) => Set(disMaxQuery, "dis_max");
	...
	public QueryContainerDescriptor Exists(ExistsQuery existsQuery) => Set(existsQuery, "exists");
	...
	public QueryContainerDescriptor FieldMaskingSpan(SpanFieldMaskingQuery spanFieldMaskingQuery) => Set(spanFieldMaskingQuery, "field_masking_span");
	...
	public QueryContainerDescriptor FunctionScore(FunctionScoreQuery functionScoreQuery) => Set(functionScoreQuery, "function_score");
	...
	public QueryContainerDescriptor Fuzzy(FuzzyQuery fuzzyQuery) => Set(fuzzyQuery, "fuzzy");
	...
	public QueryContainerDescriptor HasChild(HasChildQuery hasChildQuery) => Set(hasChildQuery, "has_child");
	...
	public QueryContainerDescriptor HasParent(HasParentQuery hasParentQuery) => Set(hasParentQuery, "has_parent");
	...
	public QueryContainerDescriptor Intervals(IntervalsQuery intervalsQuery) => Set(intervalsQuery, "intervals");
	...
	public QueryContainerDescriptor Match(MatchQuery matchQuery) => Set(matchQuery, "match");
	...
	public QueryContainerDescriptor MatchAll(MatchAllQuery matchAllQuery) => Set(matchAllQuery, "match_all");
	public QueryContainerDescriptor MatchAll(Action<MatchAllQueryDescriptor> configure) => Set(configure, "match_all");
	public QueryContainerDescriptor MatchBoolPrefix(MatchBoolPrefixQuery matchBoolPrefixQuery) => Set(matchBoolPrefixQuery, "match_bool_prefix");
	...
	public QueryContainerDescriptor MatchNone(MatchNoneQuery matchNoneQuery) => Set(matchNoneQuery, "match_none");
	public QueryContainerDescriptor MatchNone(Action<MatchNoneQueryDescriptor> configure) => Set(configure, "match_none");
	public QueryContainerDescriptor MatchPhrase(MatchPhraseQuery matchPhraseQuery) => Set(matchPhraseQuery, "match_phrase");
	...
	public QueryContainerDescriptor MatchPhrasePrefix(MatchPhrasePrefixQuery matchPhrasePrefixQuery) => Set(matchPhrasePrefixQuery, "match_phrase_prefix");
	...
	public QueryContainerDescriptor MoreLikeThis(MoreLikeThisQuery moreLikeThisQuery) => Set(moreLikeThisQuery, "more_like_this");
	...
	public QueryContainerDescriptor MultiMatch(MultiMatchQuery multiMatchQuery) => Set(multiMatchQuery, "multi_match");
	...
	public QueryContainerDescriptor Nested(NestedQuery nestedQuery) => Set(nestedQuery, "nested");
	...
	public QueryContainerDescriptor ParentId(ParentIdQuery parentIdQuery) => Set(parentIdQuery, "parent_id");
	public QueryContainerDescriptor ParentId(Action<ParentIdQueryDescriptor> configure) => Set(configure, "parent_id");
	public QueryContainerDescriptor Percolate(PercolateQuery percolateQuery) => Set(percolateQuery, "percolate");
	...
	public QueryContainerDescriptor Prefix(PrefixQuery prefixQuery) => Set(prefixQuery, "prefix");
	...
	public QueryContainerDescriptor QueryString(QueryStringQuery queryStringQuery) => Set(queryStringQuery, "query_string");
	...
	public QueryContainerDescriptor Range(RangeQuery rangeQuery) => Set(rangeQuery, "range");
	public QueryContainerDescriptor RankFeature(RankFeatureQuery rankFeatureQuery) => Set(rankFeatureQuery, "rank_feature");
	...
	public QueryContainerDescriptor Regexp(RegexpQuery regexpQuery) => Set(regexpQuery, "regexp");
	...
	public QueryContainerDescriptor Script(ScriptQuery scriptQuery) => Set(scriptQuery, "script");
	...
	public QueryContainerDescriptor SpanContaining(SpanContainingQuery spanContainingQuery) => Set(spanContainingQuery, "span_containing");
	...
	public QueryContainerDescriptor SpanFirst(SpanFirstQuery spanFirstQuery) => Set(spanFirstQuery, "span_first");
	...
	public QueryContainerDescriptor SpanMulti(SpanMultiTermQuery spanMultiTermQuery) => Set(spanMultiTermQuery, "span_multi");
	...
	public QueryContainerDescriptor SpanNear(SpanNearQuery spanNearQuery) => Set(spanNearQuery, "span_near");
	...
	public QueryContainerDescriptor SpanNot(SpanNotQuery spanNotQuery) => Set(spanNotQuery, "span_not");
	...
	public QueryContainerDescriptor SpanOr(SpanOrQuery spanOrQuery) => Set(spanOrQuery, "span_or");
	...
	public QueryContainerDescriptor SpanTerm(SpanTermQuery spanTermQuery) => Set(spanTermQuery, "span_term");
	...
	public QueryContainerDescriptor SpanWithin(SpanWithinQuery spanWithinQuery) => Set(spanWithinQuery, "span_within");
	...
	public QueryContainerDescriptor Term(TermQuery termQuery) => Set(termQuery, "term");
	...
	public QueryContainerDescriptor Terms(TermsQuery termsQuery) => Set(termsQuery, "terms");
	...
	public QueryContainerDescriptor TermsSet(TermsSetQuery termsSetQuery) => Set(termsSetQuery, "terms_set");
	...
	public QueryContainerDescriptor Wildcard(WildcardQuery wildcardQuery) => Set(wildcardQuery, "wildcard");
	...
	public QueryContainerDescriptor Wrapper(WrapperQuery wrapperQuery) => Set(wrapperQuery, "wrapper");
