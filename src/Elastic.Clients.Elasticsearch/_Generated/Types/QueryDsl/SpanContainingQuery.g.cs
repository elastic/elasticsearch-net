...
namespace Elastic.Clients.Elasticsearch.QueryDsl
{
	...
	public sealed partial class SpanContainingQueryDescriptor<T> : DescriptorBase<SpanContainingQueryDescriptor<T>>
	{
		...
		public SpanContainingQueryDescriptor<T> Big(QueryDsl.SpanQueryDescriptor<T> descriptor)
		{
			BigValue = null;
			BigDescriptorAction = null;
		...
		public SpanContainingQueryDescriptor<T> Big(Action<QueryDsl.SpanQueryDescriptor<T>> configure)
		{
			BigValue = null;
			BigDescriptorAction = null;
		...
		public SpanContainingQueryDescriptor<T> Little(QueryDsl.SpanQueryDescriptor<T> descriptor)
		{
			LittleValue = null;
			LittleDescriptorAction = null;
		...
		public SpanContainingQueryDescriptor<T> Little(Action<QueryDsl.SpanQueryDescriptor<T>> configure)
		{
			LittleValue = null;
			LittleDescriptorAction = null;
		...
		public SpanContainingQueryDescriptor<T> Boost(float? boost) => Assign(boost, (a, v) => a.BoostValue = v);
		public SpanContainingQueryDescriptor<T> QueryName(string? queryName) => Assign(queryName, (a, v) => a.QueryNameValue = v);
