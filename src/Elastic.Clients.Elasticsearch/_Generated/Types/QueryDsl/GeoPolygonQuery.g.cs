...
public sealed partial class GeoPolygonQuery
{
	...
	public static implicit operator Elastic.Clients.Elasticsearch.QueryDsl.Query(GeoPolygonQuery geoPolygonQuery) => Elastic.Clients.Elasticsearch.QueryDsl.Query.GeoPolygon(geoPolygonQuery);
}
...
public sealed partial class GeoPolygonQueryDescriptor<TDocument> : SerializableDescriptor<GeoPolygonQueryDescriptor<TDocument>>
{
	...
	private Elastic.Clients.Elasticsearch.QueryDsl.GeoPolygonPointsDescriptor PolygonDescriptor { get; set; }
	private Action<Elastic.Clients.Elasticsearch.QueryDsl.GeoPolygonPointsDescriptor> PolygonDescriptorAction { get; set; }
	...
	public GeoPolygonQueryDescriptor<TDocument> Polygon(Elastic.Clients.Elasticsearch.QueryDsl.GeoPolygonPointsDescriptor descriptor)
	{
		PolygonValue = null;
		PolygonDescriptorAction = null;
	...
	public GeoPolygonQueryDescriptor<TDocument> Polygon(Action<Elastic.Clients.Elasticsearch.QueryDsl.GeoPolygonPointsDescriptor> configure)
	{
		PolygonValue = null;
		PolygonDescriptor = null;
...
public sealed partial class GeoPolygonQueryDescriptor : SerializableDescriptor<GeoPolygonQueryDescriptor>
{
	...
	public GeoPolygonQueryDescriptor Polygon(Elastic.Clients.Elasticsearch.QueryDsl.GeoPolygonPointsDescriptor descriptor)
	{
		PolygonValue = null;
		PolygonDescriptorAction = null;
		PolygonDescriptor = descriptor;
	...
	public GeoPolygonQueryDescriptor Polygon(Action<Elastic.Clients.Elasticsearch.QueryDsl.GeoPolygonPointsDescriptor> configure)
	{
		PolygonValue = null;
		PolygonDescriptor = null;
		PolygonDescriptorAction = configure;
