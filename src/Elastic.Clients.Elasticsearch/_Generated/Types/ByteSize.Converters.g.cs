...
public sealed partial class ByteSizeConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.ByteSize>
{
	public override Elastic.Clients.Elasticsearch.ByteSize Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		{
			1 => new Elastic.Clients.Elasticsearch.ByteSize(reader.ReadValue<long>(options, null)),
			2 => new Elastic.Clients.Elasticsearch.ByteSize(reader.ReadValue<string>(options, null)),
