...
public sealed partial class ComponentTemplateNodeWithRolloverConverter : System.Text.Json.Serialization.JsonConverter<Elastic.Clients.Elasticsearch.Cluster.ComponentTemplateNodeWithRollover>
{
	...
	public override Elastic.Clients.Elasticsearch.Cluster.ComponentTemplateNodeWithRollover Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonValue<Elastic.Clients.Elasticsearch.Cluster.ComponentTemplateSummaryRes> propTemplate = default;
		...
		return new Elastic.Clients.Elasticsearch.Cluster.ComponentTemplateNodeWithRollover(Elastic.Clients.Elasticsearch.Serialization.JsonConstructorSentinel.Instance)
		{
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, Elastic.Clients.Elasticsearch.Cluster.ComponentTemplateNodeWithRollover value, System.Text.Json.JsonSerializerOptions options)
	{
