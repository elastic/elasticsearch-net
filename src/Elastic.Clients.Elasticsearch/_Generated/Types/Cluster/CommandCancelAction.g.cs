...
namespace Elastic.Clients.Elasticsearch.Cluster
{
	...
	public sealed partial class CommandCancelActionDescriptor : SerializableDescriptorBase<CommandCancelActionDescriptor>
	{
		...
		private bool? AllowPrimaryValue { get; set; }
		...
		public CommandCancelActionDescriptor AllowPrimary(bool? allowPrimary = true)
		{
			AllowPrimaryValue = allowPrimary;
			return Self;
		}

		public CommandCancelActionDescriptor Index(Elastic.Clients.Elasticsearch.IndexName index)
		{
			IndexValue = index;
			return Self;
		}

		public CommandCancelActionDescriptor Node(string node)
		{
			NodeValue = node;
			return Self;
		}

		public CommandCancelActionDescriptor Shard(int shard)
		{
			ShardValue = shard;
			return Self;
		}
