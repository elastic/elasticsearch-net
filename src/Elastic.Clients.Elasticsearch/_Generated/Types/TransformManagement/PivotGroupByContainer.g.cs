...
namespace Elastic.Clients.Elasticsearch.TransformManagement
{
	...
	public sealed partial class PivotGroupByContainerDescriptor<TDocument> : SerializableDescriptorBase<PivotGroupByContainerDescriptor<TDocument>>
	{
		...
		{
			if (ContainsVariant)
				throw new InvalidOperationException("A variant has already been assigned to the PivotGroupByContainerDescriptor. Only a single PivotGroupByContainer can be added to this container type.");
		...
		{
			if (ContainsVariant)
				throw new Exception("A variant has already been assigned to the PivotGroupByContainerDescriptor. Only a single PivotGroupByContainer can be added to this container type.");
