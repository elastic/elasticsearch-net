...
public sealed partial class Latest
{
	...
	public ICollection<Elastic.Clients.Elasticsearch.Field> UniqueKey { get; set; }
}
...
public sealed partial class LatestDescriptor<TDocument> : SerializableDescriptor<LatestDescriptor<TDocument>>
{
	...
	private ICollection<Elastic.Clients.Elasticsearch.Field> UniqueKeyValue { get; set; }
	...
	/// <para>Specifies an array of one or more fields that are used to group the data.</para>
	/// </summary>
	public LatestDescriptor<TDocument> UniqueKey(ICollection<Elastic.Clients.Elasticsearch.Field> uniqueKey)
	{
...
public sealed partial class LatestDescriptor : SerializableDescriptor<LatestDescriptor>
{
	...
	/// <para>Specifies an array of one or more fields that are used to group the data.</para>
	/// </summary>
	public LatestDescriptor UniqueKey(ICollection<Elastic.Clients.Elasticsearch.Field> uniqueKey)
	{
		UniqueKeyValue = uniqueKey;
		return Self;
	}
