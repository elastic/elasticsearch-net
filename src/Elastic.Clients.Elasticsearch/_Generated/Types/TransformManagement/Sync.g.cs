...
public sealed partial class SyncDescriptor : SerializableDescriptor<SyncDescriptor>
{
	...
	public SyncDescriptor Time(Action<Elastic.Clients.Elasticsearch.TransformManagement.TimeSyncDescriptor> configure) => Set(configure, "time");
	public SyncDescriptor Time<TDocument>(Action<Elastic.Clients.Elasticsearch.TransformManagement.TimeSyncDescriptor<TDocument>> configure) => Set(configure, "time");
