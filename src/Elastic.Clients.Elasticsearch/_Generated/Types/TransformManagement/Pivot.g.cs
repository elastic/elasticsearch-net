...
public sealed partial class PivotDescriptor<TDocument> : SerializableDescriptor<PivotDescriptor<TDocument>>
{
	...
	private IDictionary<string, Elastic.Clients.Elasticsearch.TransformManagement.PivotGroupBy>? GroupByValue { get; set; }

	/// <summary>
	/// <para>Defines how to aggregate the grouped data. The following aggregations are currently supported: average, bucket<br/>script, bucket selector, cardinality, filter, geo bounds, geo centroid, geo line, max, median absolute deviation,<br/>min, missing, percentiles, rare terms, scripted metric, stats, sum, terms, top metrics, value count, weighted<br/>average.</para>
	/// </summary>
	public PivotDescriptor<TDocument> Aggregations(Func<FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>, FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>> selector)
	{
	...
	/// <para>Defines how to group the data. More than one grouping can be defined per pivot. The following groupings are<br/>currently supported: date histogram, geotile grid, histogram, terms.</para>
	/// </summary>
	public PivotDescriptor<TDocument> GroupBy(Func<FluentDictionary<string, Elastic.Clients.Elasticsearch.TransformManagement.PivotGroupBy>, FluentDictionary<string, Elastic.Clients.Elasticsearch.TransformManagement.PivotGroupBy>> selector)
	{
		GroupByValue = selector?.Invoke(new FluentDictionary<string, Elastic.Clients.Elasticsearch.TransformManagement.PivotGroupBy>());
		return Self;
	}
...
public sealed partial class PivotDescriptor : SerializableDescriptor<PivotDescriptor>
{
	...
	/// <para>Defines how to aggregate the grouped data. The following aggregations are currently supported: average, bucket<br/>script, bucket selector, cardinality, filter, geo bounds, geo centroid, geo line, max, median absolute deviation,<br/>min, missing, percentiles, rare terms, scripted metric, stats, sum, terms, top metrics, value count, weighted<br/>average.</para>
	/// </summary>
	public PivotDescriptor Aggregations(Func<FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>, FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>> selector)
	{
		AggregationsValue = selector?.Invoke(new FluentDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>());
		return Self;
	}
	...
	/// <para>Defines how to group the data. More than one grouping can be defined per pivot. The following groupings are<br/>currently supported: date histogram, geotile grid, histogram, terms.</para>
	/// </summary>
	public PivotDescriptor GroupBy(Func<FluentDictionary<string, Elastic.Clients.Elasticsearch.TransformManagement.PivotGroupBy>, FluentDictionary<string, Elastic.Clients.Elasticsearch.TransformManagement.PivotGroupBy>> selector)
	{
		GroupByValue = selector?.Invoke(new FluentDictionary<string, Elastic.Clients.Elasticsearch.TransformManagement.PivotGroupBy>());
		return Self;
	}
