...
namespace Elastic.Clients.Elasticsearch.Autoscaling
{
	public class AutoscalingNamespace : NamespacedClientProxy
	{
		...
		public DeleteAutoscalingPolicyResponse DeletePolicy(Elastic.Clients.Elasticsearch.Name name, Func<DeleteAutoscalingPolicyDescriptor, IDeleteAutoscalingPolicyRequest> selector = null) => DeletePolicy(selector.InvokeOrDefault(new DeleteAutoscalingPolicyDescriptor(name)));
		public Task<DeleteAutoscalingPolicyResponse> DeletePolicyAsync(Elastic.Clients.Elasticsearch.Name name, Func<DeleteAutoscalingPolicyDescriptor, IDeleteAutoscalingPolicyRequest> selector = null, CancellationToken cancellationToken = default) => DeletePolicyAsync(selector.InvokeOrDefault(new DeleteAutoscalingPolicyDescriptor(name)), cancellationToken);
		...
		public GetAutoscalingPolicyResponse GetPolicy(Elastic.Clients.Elasticsearch.Name name, Func<GetAutoscalingPolicyDescriptor, IGetAutoscalingPolicyRequest> selector = null) => GetPolicy(selector.InvokeOrDefault(new GetAutoscalingPolicyDescriptor(name)));
		public Task<GetAutoscalingPolicyResponse> GetPolicyAsync(Elastic.Clients.Elasticsearch.Name name, Func<GetAutoscalingPolicyDescriptor, IGetAutoscalingPolicyRequest> selector = null, CancellationToken cancellationToken = default) => GetPolicyAsync(selector.InvokeOrDefault(new GetAutoscalingPolicyDescriptor(name)), cancellationToken);
		...
		public PutAutoscalingPolicyResponse PutPolicy(Elastic.Clients.Elasticsearch.Name name, Func<PutAutoscalingPolicyDescriptor, IPutAutoscalingPolicyRequest> selector = null) => PutPolicy(selector.InvokeOrDefault(new PutAutoscalingPolicyDescriptor(name)));
		public Task<PutAutoscalingPolicyResponse> PutPolicyAsync(Elastic.Clients.Elasticsearch.Name name, Func<PutAutoscalingPolicyDescriptor, IPutAutoscalingPolicyRequest> selector = null, CancellationToken cancellationToken = default) => PutPolicyAsync(selector.InvokeOrDefault(new PutAutoscalingPolicyDescriptor(name)), cancellationToken);
	}
}