...
namespace Elastic.Clients.Elasticsearch.DanglingIndices
{
	public class DanglingIndicesNamespace : NamespacedClientProxy
	{
		...
		public DeleteDanglingIndexResponse DeleteDanglingIndex(Elastic.Clients.Elasticsearch.Uuid index_uuid, Func<DeleteDanglingIndexDescriptor, IDeleteDanglingIndexRequest> selector = null) => DeleteDanglingIndex(selector.InvokeOrDefault(new DeleteDanglingIndexDescriptor(index_uuid)));
		public Task<DeleteDanglingIndexResponse> DeleteDanglingIndexAsync(Elastic.Clients.Elasticsearch.Uuid index_uuid, Func<DeleteDanglingIndexDescriptor, IDeleteDanglingIndexRequest> selector = null, CancellationToken cancellationToken = default) => DeleteDanglingIndexAsync(selector.InvokeOrDefault(new DeleteDanglingIndexDescriptor(index_uuid)), cancellationToken);
		...
		public ImportDanglingIndexResponse ImportDanglingIndex(Elastic.Clients.Elasticsearch.Uuid index_uuid, Func<ImportDanglingIndexDescriptor, IImportDanglingIndexRequest> selector = null) => ImportDanglingIndex(selector.InvokeOrDefault(new ImportDanglingIndexDescriptor(index_uuid)));
		public Task<ImportDanglingIndexResponse> ImportDanglingIndexAsync(Elastic.Clients.Elasticsearch.Uuid index_uuid, Func<ImportDanglingIndexDescriptor, IImportDanglingIndexRequest> selector = null, CancellationToken cancellationToken = default) => ImportDanglingIndexAsync(selector.InvokeOrDefault(new ImportDanglingIndexDescriptor(index_uuid)), cancellationToken);
