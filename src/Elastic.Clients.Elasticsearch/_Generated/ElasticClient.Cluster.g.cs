...
namespace Elastic.Clients.Elasticsearch.Cluster
{
	public class ClusterNamespace : NamespacedClientProxy
	{
		...
		public DeleteComponentTemplateResponse DeleteComponentTemplate(Elastic.Clients.Elasticsearch.Name name, Func<DeleteComponentTemplateDescriptor, IDeleteComponentTemplateRequest> selector = null) => DeleteComponentTemplate(selector.InvokeOrDefault(new DeleteComponentTemplateDescriptor(name)));
		public Task<DeleteComponentTemplateResponse> DeleteComponentTemplateAsync(Elastic.Clients.Elasticsearch.Name name, Func<DeleteComponentTemplateDescriptor, IDeleteComponentTemplateRequest> selector = null, CancellationToken cancellationToken = default) => DeleteComponentTemplateAsync(selector.InvokeOrDefault(new DeleteComponentTemplateDescriptor(name)), cancellationToken);
		...
		public ExistsComponentTemplateResponse ExistsComponentTemplate(Elastic.Clients.Elasticsearch.Names name, Func<ExistsComponentTemplateDescriptor, IExistsComponentTemplateRequest> selector = null) => ExistsComponentTemplate(selector.InvokeOrDefault(new ExistsComponentTemplateDescriptor(name)));
		public Task<ExistsComponentTemplateResponse> ExistsComponentTemplateAsync(Elastic.Clients.Elasticsearch.Names name, Func<ExistsComponentTemplateDescriptor, IExistsComponentTemplateRequest> selector = null, CancellationToken cancellationToken = default) => ExistsComponentTemplateAsync(selector.InvokeOrDefault(new ExistsComponentTemplateDescriptor(name)), cancellationToken);
		...
		public PutComponentTemplateResponse PutComponentTemplate(Elastic.Clients.Elasticsearch.Name name, Func<PutComponentTemplateDescriptor, IPutComponentTemplateRequest> selector = null) => PutComponentTemplate(selector.InvokeOrDefault(new PutComponentTemplateDescriptor(name)));
		public Task<PutComponentTemplateResponse> PutComponentTemplateAsync(Elastic.Clients.Elasticsearch.Name name, Func<PutComponentTemplateDescriptor, IPutComponentTemplateRequest> selector = null, CancellationToken cancellationToken = default) => PutComponentTemplateAsync(selector.InvokeOrDefault(new PutComponentTemplateDescriptor(name)), cancellationToken);
