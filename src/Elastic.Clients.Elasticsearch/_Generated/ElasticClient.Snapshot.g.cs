...
namespace Elastic.Clients.Elasticsearch.Snapshot
{
	public class SnapshotNamespace : NamespacedClientProxy
	{
		...
		public CleanupRepositoryResponse CleanupRepository(Elastic.Clients.Elasticsearch.Name repository, Func<CleanupRepositoryDescriptor, ICleanupRepositoryRequest> selector = null) => CleanupRepository(selector.InvokeOrDefault(new CleanupRepositoryDescriptor(repository)));
		public Task<CleanupRepositoryResponse> CleanupRepositoryAsync(Elastic.Clients.Elasticsearch.Name repository, Func<CleanupRepositoryDescriptor, ICleanupRepositoryRequest> selector = null, CancellationToken cancellationToken = default) => CleanupRepositoryAsync(selector.InvokeOrDefault(new CleanupRepositoryDescriptor(repository)), cancellationToken);
		...
		public CloneResponse Clone(Elastic.Clients.Elasticsearch.Name repository, Elastic.Clients.Elasticsearch.Name snapshot, Elastic.Clients.Elasticsearch.Name target_snapshot, Func<CloneDescriptor, ICloneRequest> selector = null) => Clone(selector.InvokeOrDefault(new CloneDescriptor(repository, snapshot, target_snapshot)));
		public Task<CloneResponse> CloneAsync(Elastic.Clients.Elasticsearch.Name repository, Elastic.Clients.Elasticsearch.Name snapshot, Elastic.Clients.Elasticsearch.Name target_snapshot, Func<CloneDescriptor, ICloneRequest> selector = null, CancellationToken cancellationToken = default) => CloneAsync(selector.InvokeOrDefault(new CloneDescriptor(repository, snapshot, target_snapshot)), cancellationToken);
		...
		public CreateResponse Create(Elastic.Clients.Elasticsearch.Name repository, Elastic.Clients.Elasticsearch.Name snapshot, Func<CreateDescriptor, ICreateRequest> selector = null) => Create(selector.InvokeOrDefault(new CreateDescriptor(repository, snapshot)));
		public Task<CreateResponse> CreateAsync(Elastic.Clients.Elasticsearch.Name repository, Elastic.Clients.Elasticsearch.Name snapshot, Func<CreateDescriptor, ICreateRequest> selector = null, CancellationToken cancellationToken = default) => CreateAsync(selector.InvokeOrDefault(new CreateDescriptor(repository, snapshot)), cancellationToken);
		...
		public CreateRepositoryResponse CreateRepository(Elastic.Clients.Elasticsearch.Name repository, Func<CreateRepositoryDescriptor, ICreateRepositoryRequest> selector = null) => CreateRepository(selector.InvokeOrDefault(new CreateRepositoryDescriptor(repository)));
		public Task<CreateRepositoryResponse> CreateRepositoryAsync(Elastic.Clients.Elasticsearch.Name repository, Func<CreateRepositoryDescriptor, ICreateRepositoryRequest> selector = null, CancellationToken cancellationToken = default) => CreateRepositoryAsync(selector.InvokeOrDefault(new CreateRepositoryDescriptor(repository)), cancellationToken);
		...
		public DeleteResponse Delete(Elastic.Clients.Elasticsearch.Name repository, Elastic.Clients.Elasticsearch.Name snapshot, Func<DeleteDescriptor, IDeleteRequest> selector = null) => Delete(selector.InvokeOrDefault(new DeleteDescriptor(repository, snapshot)));
		public Task<DeleteResponse> DeleteAsync(Elastic.Clients.Elasticsearch.Name repository, Elastic.Clients.Elasticsearch.Name snapshot, Func<DeleteDescriptor, IDeleteRequest> selector = null, CancellationToken cancellationToken = default) => DeleteAsync(selector.InvokeOrDefault(new DeleteDescriptor(repository, snapshot)), cancellationToken);
		...
		public DeleteRepositoryResponse DeleteRepository(Elastic.Clients.Elasticsearch.Names repository, Func<DeleteRepositoryDescriptor, IDeleteRepositoryRequest> selector = null) => DeleteRepository(selector.InvokeOrDefault(new DeleteRepositoryDescriptor(repository)));
		public Task<DeleteRepositoryResponse> DeleteRepositoryAsync(Elastic.Clients.Elasticsearch.Names repository, Func<DeleteRepositoryDescriptor, IDeleteRepositoryRequest> selector = null, CancellationToken cancellationToken = default) => DeleteRepositoryAsync(selector.InvokeOrDefault(new DeleteRepositoryDescriptor(repository)), cancellationToken);
		...
		public GetResponse Get(Elastic.Clients.Elasticsearch.Name repository, Elastic.Clients.Elasticsearch.Names snapshot, Func<GetDescriptor, IGetRequest> selector = null) => Get(selector.InvokeOrDefault(new GetDescriptor(repository, snapshot)));
		public Task<GetResponse> GetAsync(Elastic.Clients.Elasticsearch.Name repository, Elastic.Clients.Elasticsearch.Names snapshot, Func<GetDescriptor, IGetRequest> selector = null, CancellationToken cancellationToken = default) => GetAsync(selector.InvokeOrDefault(new GetDescriptor(repository, snapshot)), cancellationToken);
		...
		public RestoreResponse Restore(Elastic.Clients.Elasticsearch.Name repository, Elastic.Clients.Elasticsearch.Name snapshot, Func<RestoreDescriptor, IRestoreRequest> selector = null) => Restore(selector.InvokeOrDefault(new RestoreDescriptor(repository, snapshot)));
		public Task<RestoreResponse> RestoreAsync(Elastic.Clients.Elasticsearch.Name repository, Elastic.Clients.Elasticsearch.Name snapshot, Func<RestoreDescriptor, IRestoreRequest> selector = null, CancellationToken cancellationToken = default) => RestoreAsync(selector.InvokeOrDefault(new RestoreDescriptor(repository, snapshot)), cancellationToken);
		...
		public VerifyRepositoryResponse VerifyRepository(Elastic.Clients.Elasticsearch.Name repository, Func<VerifyRepositoryDescriptor, IVerifyRepositoryRequest> selector = null) => VerifyRepository(selector.InvokeOrDefault(new VerifyRepositoryDescriptor(repository)));
		public Task<VerifyRepositoryResponse> VerifyRepositoryAsync(Elastic.Clients.Elasticsearch.Name repository, Func<VerifyRepositoryDescriptor, IVerifyRepositoryRequest> selector = null, CancellationToken cancellationToken = default) => VerifyRepositoryAsync(selector.InvokeOrDefault(new VerifyRepositoryDescriptor(repository)), cancellationToken);
	}
}