...
namespace Elastic.Clients.Elasticsearch.CrossClusterReplication
{
	public class CrossClusterReplicationNamespace : NamespacedClientProxy
	{
		...
		public DeleteAutoFollowPatternResponse DeleteAutoFollowPattern(Elastic.Clients.Elasticsearch.Name name, Func<DeleteAutoFollowPatternDescriptor, IDeleteAutoFollowPatternRequest> selector = null) => DeleteAutoFollowPattern(selector.InvokeOrDefault(new DeleteAutoFollowPatternDescriptor(name)));
		public Task<DeleteAutoFollowPatternResponse> DeleteAutoFollowPatternAsync(Elastic.Clients.Elasticsearch.Name name, Func<DeleteAutoFollowPatternDescriptor, IDeleteAutoFollowPatternRequest> selector = null, CancellationToken cancellationToken = default) => DeleteAutoFollowPatternAsync(selector.InvokeOrDefault(new DeleteAutoFollowPatternDescriptor(name)), cancellationToken);
		...
		public FollowResponse Follow(Elastic.Clients.Elasticsearch.IndexName index, Func<FollowDescriptor, IFollowRequest> selector = null) => Follow(selector.InvokeOrDefault(new FollowDescriptor(index)));
		public Task<FollowResponse> FollowAsync(Elastic.Clients.Elasticsearch.IndexName index, Func<FollowDescriptor, IFollowRequest> selector = null, CancellationToken cancellationToken = default) => FollowAsync(selector.InvokeOrDefault(new FollowDescriptor(index)), cancellationToken);
		...
		public FollowInfoResponse FollowInfo(Elastic.Clients.Elasticsearch.Indices index, Func<FollowInfoDescriptor, IFollowInfoRequest> selector = null) => FollowInfo(selector.InvokeOrDefault(new FollowInfoDescriptor(index)));
		public Task<FollowInfoResponse> FollowInfoAsync(Elastic.Clients.Elasticsearch.Indices index, Func<FollowInfoDescriptor, IFollowInfoRequest> selector = null, CancellationToken cancellationToken = default) => FollowInfoAsync(selector.InvokeOrDefault(new FollowInfoDescriptor(index)), cancellationToken);
		...
		public FollowStatsResponse FollowStats(Elastic.Clients.Elasticsearch.Indices index, Func<FollowStatsDescriptor, IFollowStatsRequest> selector = null) => FollowStats(selector.InvokeOrDefault(new FollowStatsDescriptor(index)));
		public Task<FollowStatsResponse> FollowStatsAsync(Elastic.Clients.Elasticsearch.Indices index, Func<FollowStatsDescriptor, IFollowStatsRequest> selector = null, CancellationToken cancellationToken = default) => FollowStatsAsync(selector.InvokeOrDefault(new FollowStatsDescriptor(index)), cancellationToken);
		...
		public ForgetFollowerResponse ForgetFollower(Elastic.Clients.Elasticsearch.IndexName index, Func<ForgetFollowerDescriptor, IForgetFollowerRequest> selector = null) => ForgetFollower(selector.InvokeOrDefault(new ForgetFollowerDescriptor(index)));
		public Task<ForgetFollowerResponse> ForgetFollowerAsync(Elastic.Clients.Elasticsearch.IndexName index, Func<ForgetFollowerDescriptor, IForgetFollowerRequest> selector = null, CancellationToken cancellationToken = default) => ForgetFollowerAsync(selector.InvokeOrDefault(new ForgetFollowerDescriptor(index)), cancellationToken);
		...
		public PauseAutoFollowPatternResponse PauseAutoFollowPattern(Elastic.Clients.Elasticsearch.Name name, Func<PauseAutoFollowPatternDescriptor, IPauseAutoFollowPatternRequest> selector = null) => PauseAutoFollowPattern(selector.InvokeOrDefault(new PauseAutoFollowPatternDescriptor(name)));
		public Task<PauseAutoFollowPatternResponse> PauseAutoFollowPatternAsync(Elastic.Clients.Elasticsearch.Name name, Func<PauseAutoFollowPatternDescriptor, IPauseAutoFollowPatternRequest> selector = null, CancellationToken cancellationToken = default) => PauseAutoFollowPatternAsync(selector.InvokeOrDefault(new PauseAutoFollowPatternDescriptor(name)), cancellationToken);
		...
		public PauseFollowResponse PauseFollow(Elastic.Clients.Elasticsearch.IndexName index, Func<PauseFollowDescriptor, IPauseFollowRequest> selector = null) => PauseFollow(selector.InvokeOrDefault(new PauseFollowDescriptor(index)));
		public Task<PauseFollowResponse> PauseFollowAsync(Elastic.Clients.Elasticsearch.IndexName index, Func<PauseFollowDescriptor, IPauseFollowRequest> selector = null, CancellationToken cancellationToken = default) => PauseFollowAsync(selector.InvokeOrDefault(new PauseFollowDescriptor(index)), cancellationToken);
		...
		public PutAutoFollowPatternResponse PutAutoFollowPattern(Elastic.Clients.Elasticsearch.Name name, Func<PutAutoFollowPatternDescriptor, IPutAutoFollowPatternRequest> selector = null) => PutAutoFollowPattern(selector.InvokeOrDefault(new PutAutoFollowPatternDescriptor(name)));
		public Task<PutAutoFollowPatternResponse> PutAutoFollowPatternAsync(Elastic.Clients.Elasticsearch.Name name, Func<PutAutoFollowPatternDescriptor, IPutAutoFollowPatternRequest> selector = null, CancellationToken cancellationToken = default) => PutAutoFollowPatternAsync(selector.InvokeOrDefault(new PutAutoFollowPatternDescriptor(name)), cancellationToken);
		...
		public ResumeAutoFollowPatternResponse ResumeAutoFollowPattern(Elastic.Clients.Elasticsearch.Name name, Func<ResumeAutoFollowPatternDescriptor, IResumeAutoFollowPatternRequest> selector = null) => ResumeAutoFollowPattern(selector.InvokeOrDefault(new ResumeAutoFollowPatternDescriptor(name)));
		public Task<ResumeAutoFollowPatternResponse> ResumeAutoFollowPatternAsync(Elastic.Clients.Elasticsearch.Name name, Func<ResumeAutoFollowPatternDescriptor, IResumeAutoFollowPatternRequest> selector = null, CancellationToken cancellationToken = default) => ResumeAutoFollowPatternAsync(selector.InvokeOrDefault(new ResumeAutoFollowPatternDescriptor(name)), cancellationToken);
		...
		public ResumeFollowResponse ResumeFollow(Elastic.Clients.Elasticsearch.IndexName index, Func<ResumeFollowDescriptor, IResumeFollowRequest> selector = null) => ResumeFollow(selector.InvokeOrDefault(new ResumeFollowDescriptor(index)));
		public Task<ResumeFollowResponse> ResumeFollowAsync(Elastic.Clients.Elasticsearch.IndexName index, Func<ResumeFollowDescriptor, IResumeFollowRequest> selector = null, CancellationToken cancellationToken = default) => ResumeFollowAsync(selector.InvokeOrDefault(new ResumeFollowDescriptor(index)), cancellationToken);
		...
		public UnfollowResponse Unfollow(Elastic.Clients.Elasticsearch.IndexName index, Func<UnfollowDescriptor, IUnfollowRequest> selector = null) => Unfollow(selector.InvokeOrDefault(new UnfollowDescriptor(index)));
		public Task<UnfollowResponse> UnfollowAsync(Elastic.Clients.Elasticsearch.IndexName index, Func<UnfollowDescriptor, IUnfollowRequest> selector = null, CancellationToken cancellationToken = default) => UnfollowAsync(selector.InvokeOrDefault(new UnfollowDescriptor(index)), cancellationToken);
	}
}