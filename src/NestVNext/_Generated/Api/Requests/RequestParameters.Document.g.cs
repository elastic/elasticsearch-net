...
namespace Nest
{
    ...
    public class DeleteByQueryRequestParameters : RequestParameters<DeleteByQueryRequestParameters>
    {
        ...
        {
            get => Q<bool?>("source_enabled");
            set => Q("source_enabled", value);
        }

        public Fields? SourceExcludes
        {
            get => Q<Fields?>("source_excludes");
            set => Q("source_excludes", value);
        }

        public Fields? SourceIncludes
        {
            get => Q<Fields?>("source_includes");
            set => Q("source_includes", value);
        }
