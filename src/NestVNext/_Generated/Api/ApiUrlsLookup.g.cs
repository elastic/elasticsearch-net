...
namespace Nest
{
    internal static class ApiUrlsLookups
    {
        ...
        internal static ApiUrls AutoscalingGetAutoscalingDecision = new ApiUrls(new[]{"/_autoscaling/decision"});
        ...
        internal static ApiUrls NoNamespaceBulk = new ApiUrls(new[]{"/_bulk", "/_bulk", "/{index}/_bulk", "/{index}/_bulk", "/{index}/{type}/_bulk", "/{index}/{type}/_bulk"});
        ...
        internal static ApiUrls ClusterAllocationExplain = new ApiUrls(new[]{"/_cluster/allocation/explain", "/_cluster/allocation/explain"});
        ...
        internal static ApiUrls ClusterPutComponentTemplate = new ApiUrls(new[]{"/_component_template/{name}", "/_component_template/{name}"});
        ...
        internal static ApiUrls NoNamespaceCount = new ApiUrls(new[]{"/_count", "/_count", "/{index}/_count", "/{index}/_count", "/{index}/{type}/_count", "/{index}/{type}/_count"});
        internal static ApiUrls NoNamespaceCreate = new ApiUrls(new[]{"/{index}/_create/{id}", "/{index}/_create/{id}", "/{index}/{type}/{id}/_create", "/{index}/{type}/{id}/_create"});
        ...
        internal static ApiUrls DataFrameTransformDeprecatedDeleteTransform = new ApiUrls(new[]{"/_data_frame/transforms/{transform_id}"});
        internal static ApiUrls DataFrameTransformDeprecatedGetTransform = new ApiUrls(new[]{"/_data_frame/transforms/{transform_id}", "/_data_frame/transforms"});
        internal static ApiUrls DataFrameTransformDeprecatedGetTransformStats = new ApiUrls(new[]{"/_data_frame/transforms/{transform_id}/_stats"});
        internal static ApiUrls DataFrameTransformDeprecatedPreviewTransform = new ApiUrls(new[]{"/_data_frame/transforms/_preview"});
        internal static ApiUrls DataFrameTransformDeprecatedPutTransform = new ApiUrls(new[]{"/_data_frame/transforms/{transform_id}"});
        internal static ApiUrls DataFrameTransformDeprecatedStartTransform = new ApiUrls(new[]{"/_data_frame/transforms/{transform_id}/_start"});
        internal static ApiUrls DataFrameTransformDeprecatedStopTransform = new ApiUrls(new[]{"/_data_frame/transforms/{transform_id}/_stop"});
        internal static ApiUrls DataFrameTransformDeprecatedUpdateTransform = new ApiUrls(new[]{"/_data_frame/transforms/{transform_id}/_update"});
        internal static ApiUrls NoNamespaceDelete = new ApiUrls(new[]{"/{index}/_doc/{id}", "/{index}/{type}/{id}"});
        internal static ApiUrls NoNamespaceDeleteByQuery = new ApiUrls(new[]{"/{index}/_delete_by_query", "/{index}/{type}/_delete_by_query"});
        ...
        internal static ApiUrls EqlSearch = new ApiUrls(new[]{"/{index}/_eql/search", "/{index}/_eql/search"});
        internal static ApiUrls NoNamespaceExists = new ApiUrls(new[]{"/{index}/_doc/{id}", "/{index}/{type}/{id}"});
        internal static ApiUrls NoNamespaceExistsSource = new ApiUrls(new[]{"/{index}/_source/{id}", "/{index}/{type}/{id}/_source"});
        internal static ApiUrls NoNamespaceExplain = new ApiUrls(new[]{"/{index}/_explain/{id}", "/{index}/_explain/{id}", "/{index}/{type}/{id}/_explain", "/{index}/{type}/{id}/_explain"});
        internal static ApiUrls NoNamespaceFieldCaps = new ApiUrls(new[]{"/_field_caps", "/_field_caps", "/{index}/_field_caps", "/{index}/_field_caps"});
        internal static ApiUrls NoNamespaceGet = new ApiUrls(new[]{"/{index}/_doc/{id}", "/{index}/{type}/{id}"});
        ...
        internal static ApiUrls NoNamespaceGetSource = new ApiUrls(new[]{"/{index}/_source/{id}", "/{index}/{type}/{id}/_source"});
        internal static ApiUrls GraphExplore = new ApiUrls(new[]{"/{index}/_graph/explore", "/{index}/_graph/explore", "/{index}/{type}/_graph/explore", "/{index}/{type}/_graph/explore"});
        ...
        internal static ApiUrls NoNamespaceIndex = new ApiUrls(new[]{"/{index}/_doc/{id}", "/{index}/_doc/{id}", "/{index}/_doc", "/{index}/{type}", "/{index}/{type}/{id}", "/{index}/{type}/{id}"});
        internal static ApiUrls IndicesAddBlock = new ApiUrls(new[]{"/{index}/_block/{block}"});
        internal static ApiUrls IndicesAnalyze = new ApiUrls(new[]{"/_analyze", "/_analyze", "/{index}/_analyze", "/{index}/_analyze"});
        internal static ApiUrls IndicesClearCache = new ApiUrls(new[]{"/_cache/clear", "/{index}/_cache/clear"});
        internal static ApiUrls IndicesClone = new ApiUrls(new[]{"/{index}/_clone/{target}", "/{index}/_clone/{target}"});
        ...
        internal static ApiUrls IndicesDeleteAlias = new ApiUrls(new[]{"/{index}/_alias/{name}", "/{index}/_aliases/{name}"});
        ...
        internal static ApiUrls IndicesFlush = new ApiUrls(new[]{"/_flush", "/_flush", "/{index}/_flush", "/{index}/_flush"});
        internal static ApiUrls IndicesFlushSynced = new ApiUrls(new[]{"/_flush/synced", "/_flush/synced", "/{index}/_flush/synced", "/{index}/_flush/synced"});
        ...
        internal static ApiUrls IndicesGetFieldMapping = new ApiUrls(new[]{"/_mapping/field/{fields}", "/{index}/_mapping/field/{fields}", "/_mapping/{type}/field/{fields}", "/{index}/_mapping/{type}/field/{fields}"});
        internal static ApiUrls IndicesGetIndexTemplate = new ApiUrls(new[]{"/_index_template", "/_index_template/{name}"});
        internal static ApiUrls IndicesGetMapping = new ApiUrls(new[]{"/_mapping", "/{index}/_mapping", "/_mapping/{type}", "/{index}/_mapping/{type}"});
        ...
        internal static ApiUrls IndicesGetUpgrade = new ApiUrls(new[]{"/_upgrade", "/{index}/_upgrade"});
        internal static ApiUrls IndicesOpen = new ApiUrls(new[]{"/{index}/_open"});
        internal static ApiUrls IndicesPutAlias = new ApiUrls(new[]{"/{index}/_alias/{name}", "/{index}/_alias/{name}", "/{index}/_aliases/{name}", "/{index}/_aliases/{name}"});
        internal static ApiUrls IndicesPutIndexTemplate = new ApiUrls(new[]{"/_index_template/{name}", "/_index_template/{name}"});
        internal static ApiUrls IndicesPutMapping = new ApiUrls(new[]{"/{index}/_mapping", "/{index}/_mapping", "/{index}/{type}/_mapping", "/{index}/{type}/_mapping", "/{index}/_mapping/{type}", "/{index}/_mapping/{type}", "/{index}/{type}/_mappings", "/{index}/{type}/_mappings", "/{index}/_mappings/{type}", "/{index}/_mappings/{type}", "/_mappings/{type}", "/_mappings/{type}", "/{index}/_mappings", "/{index}/_mappings", "/_mapping/{type}", "/_mapping/{type}"});
        internal static ApiUrls IndicesPutSettings = new ApiUrls(new[]{"/_settings", "/{index}/_settings"});
        internal static ApiUrls IndicesPutTemplate = new ApiUrls(new[]{"/_template/{name}", "/_template/{name}"});
        internal static ApiUrls IndicesRecovery = new ApiUrls(new[]{"/_recovery", "/{index}/_recovery"});
        internal static ApiUrls IndicesRefresh = new ApiUrls(new[]{"/_refresh", "/_refresh", "/{index}/_refresh", "/{index}/_refresh"});
        internal static ApiUrls IndicesReloadSearchAnalyzers = new ApiUrls(new[]{"/{index}/_reload_search_analyzers", "/{index}/_reload_search_analyzers"});
        ...
        internal static ApiUrls IndicesShrink = new ApiUrls(new[]{"/{index}/_shrink/{target}", "/{index}/_shrink/{target}"});
        ...
        internal static ApiUrls IndicesSplit = new ApiUrls(new[]{"/{index}/_split/{target}", "/{index}/_split/{target}"});
        ...
        internal static ApiUrls IndicesValidateQuery = new ApiUrls(new[]{"/_validate/query", "/_validate/query", "/{index}/_validate/query", "/{index}/_validate/query", "/{index}/{type}/_validate/query", "/{index}/{type}/_validate/query"});
        ...
        internal static ApiUrls IngestSimulate = new ApiUrls(new[]{"/_ingest/pipeline/_simulate", "/_ingest/pipeline/_simulate", "/_ingest/pipeline/{id}/_simulate", "/_ingest/pipeline/{id}/_simulate"});
        ...
        internal static ApiUrls LicensePost = new ApiUrls(new[]{"/_license", "/_license"});
        ...
        internal static ApiUrls NoNamespaceMget = new ApiUrls(new[]{"/_mget", "/_mget", "/{index}/_mget", "/{index}/_mget", "/{index}/{type}/_mget", "/{index}/{type}/_mget"});
        ...
        internal static ApiUrls MachineLearningExplainDataFrameAnalytics = new ApiUrls(new[]{"/_ml/data_frame/analytics/_explain", "/_ml/data_frame/analytics/_explain", "/_ml/data_frame/analytics/{id}/_explain", "/_ml/data_frame/analytics/{id}/_explain"});
        ...
        internal static ApiUrls MachineLearningGetBuckets = new ApiUrls(new[]{"/_ml/anomaly_detectors/{job_id}/results/buckets/{timestamp}", "/_ml/anomaly_detectors/{job_id}/results/buckets/{timestamp}", "/_ml/anomaly_detectors/{job_id}/results/buckets", "/_ml/anomaly_detectors/{job_id}/results/buckets"});
        internal static ApiUrls MachineLearningGetCalendarEvents = new ApiUrls(new[]{"/_ml/calendars/{calendar_id}/events"});
        internal static ApiUrls MachineLearningGetCalendars = new ApiUrls(new[]{"/_ml/calendars", "/_ml/calendars", "/_ml/calendars/{calendar_id}", "/_ml/calendars/{calendar_id}"});
        internal static ApiUrls MachineLearningGetCategories = new ApiUrls(new[]{"/_ml/anomaly_detectors/{job_id}/results/categories/{category_id}", "/_ml/anomaly_detectors/{job_id}/results/categories/{category_id}", "/_ml/anomaly_detectors/{job_id}/results/categories/", "/_ml/anomaly_detectors/{job_id}/results/categories/"});
        ...
        internal static ApiUrls MachineLearningGetInfluencers = new ApiUrls(new[]{"/_ml/anomaly_detectors/{job_id}/results/influencers", "/_ml/anomaly_detectors/{job_id}/results/influencers"});
        ...
        internal static ApiUrls MachineLearningGetModelSnapshots = new ApiUrls(new[]{"/_ml/anomaly_detectors/{job_id}/model_snapshots/{snapshot_id}", "/_ml/anomaly_detectors/{job_id}/model_snapshots/{snapshot_id}", "/_ml/anomaly_detectors/{job_id}/model_snapshots", "/_ml/anomaly_detectors/{job_id}/model_snapshots"});
        internal static ApiUrls MachineLearningGetOverallBuckets = new ApiUrls(new[]{"/_ml/anomaly_detectors/{job_id}/results/overall_buckets", "/_ml/anomaly_detectors/{job_id}/results/overall_buckets"});
        internal static ApiUrls MachineLearningGetRecords = new ApiUrls(new[]{"/_ml/anomaly_detectors/{job_id}/results/records", "/_ml/anomaly_detectors/{job_id}/results/records"});
        ...
        internal static ApiUrls MonitoringBulk = new ApiUrls(new[]{"/_monitoring/bulk", "/_monitoring/bulk", "/_monitoring/{type}/bulk", "/_monitoring/{type}/bulk"});
        internal static ApiUrls NoNamespaceMsearch = new ApiUrls(new[]{"/_msearch", "/_msearch", "/{index}/_msearch", "/{index}/_msearch", "/{index}/{type}/_msearch", "/{index}/{type}/_msearch"});
        internal static ApiUrls NoNamespaceMsearchTemplate = new ApiUrls(new[]{"/_msearch/template", "/_msearch/template", "/{index}/_msearch/template", "/{index}/_msearch/template", "/{index}/{type}/_msearch/template", "/{index}/{type}/_msearch/template"});
        internal static ApiUrls NoNamespaceMtermvectors = new ApiUrls(new[]{"/_mtermvectors", "/_mtermvectors", "/{index}/_mtermvectors", "/{index}/_mtermvectors", "/{index}/{type}/_mtermvectors", "/{index}/{type}/_mtermvectors"});
        internal static ApiUrls NodesHotThreads = new ApiUrls(new[]{"/_nodes/hot_threads", "/_nodes/{node_id}/hot_threads", "/_cluster/nodes/hotthreads", "/_cluster/nodes/{node_id}/hotthreads", "/_nodes/hotthreads", "/_nodes/{node_id}/hotthreads", "/_cluster/nodes/hot_threads", "/_cluster/nodes/{node_id}/hot_threads"});
        ...
        internal static ApiUrls NoNamespacePutScript = new ApiUrls(new[]{"/_scripts/{id}", "/_scripts/{id}", "/_scripts/{id}/{context}", "/_scripts/{id}/{context}"});
        internal static ApiUrls NoNamespaceRankEval = new ApiUrls(new[]{"/_rank_eval", "/_rank_eval", "/{index}/_rank_eval", "/{index}/_rank_eval"});
        ...
        internal static ApiUrls NoNamespaceRenderSearchTemplate = new ApiUrls(new[]{"/_render/template", "/_render/template", "/_render/template/{id}", "/_render/template/{id}"});
        ...
        internal static ApiUrls RollupRollupSearch = new ApiUrls(new[]{"/{index}/_rollup_search", "/{index}/_rollup_search", "/{index}/{type}/_rollup_search", "/{index}/{type}/_rollup_search"});
        ...
        internal static ApiUrls NoNamespaceScriptsPainlessExecute = new ApiUrls(new[]{"/_scripts/painless/_execute", "/_scripts/painless/_execute"});
        internal static ApiUrls NoNamespaceScroll = new ApiUrls(new[]{"/_search/scroll", "/_search/scroll", "/_search/scroll/{scroll_id}", "/_search/scroll/{scroll_id}"});
        internal static ApiUrls NoNamespaceSearch = new ApiUrls(new[]{"/_search", "/_search", "/{index}/_search", "/{index}/_search", "/{index}/{type}/_search", "/{index}/{type}/_search"});
        internal static ApiUrls NoNamespaceSearchShards = new ApiUrls(new[]{"/_search_shards", "/_search_shards", "/{index}/_search_shards", "/{index}/_search_shards"});
        internal static ApiUrls NoNamespaceSearchTemplate = new ApiUrls(new[]{"/_search/template", "/_search/template", "/{index}/_search/template", "/{index}/_search/template", "/{index}/{type}/_search/template", "/{index}/{type}/_search/template"});
        ...
        internal static ApiUrls SecurityChangePassword = new ApiUrls(new[]{"/_security/user/{username}/_password", "/_security/user/{username}/_password", "/_security/user/_password", "/_security/user/_password"});
        ...
        internal static ApiUrls SecurityCreateApiKey = new ApiUrls(new[]{"/_security/api_key", "/_security/api_key"});
        ...
        internal static ApiUrls SecurityDisableUser = new ApiUrls(new[]{"/_security/user/{username}/_disable", "/_security/user/{username}/_disable"});
        internal static ApiUrls SecurityEnableUser = new ApiUrls(new[]{"/_security/user/{username}/_enable", "/_security/user/{username}/_enable"});
        ...
        internal static ApiUrls SecurityHasPrivileges = new ApiUrls(new[]{"/_security/user/_has_privileges", "/_security/user/_has_privileges", "/_security/user/{user}/_has_privileges", "/_security/user/{user}/_has_privileges"});
        ...
        internal static ApiUrls SecurityPutPrivileges = new ApiUrls(new[]{"/_security/privilege/", "/_security/privilege/"});
        internal static ApiUrls SecurityPutRole = new ApiUrls(new[]{"/_security/role/{name}", "/_security/role/{name}"});
        internal static ApiUrls SecurityPutRoleMapping = new ApiUrls(new[]{"/_security/role_mapping/{name}", "/_security/role_mapping/{name}"});
        internal static ApiUrls SecurityPutUser = new ApiUrls(new[]{"/_security/user/{username}", "/_security/user/{username}"});
        ...
        internal static ApiUrls SnapshotCreate = new ApiUrls(new[]{"/_snapshot/{repository}/{snapshot}", "/_snapshot/{repository}/{snapshot}"});
        internal static ApiUrls SnapshotCreateRepository = new ApiUrls(new[]{"/_snapshot/{repository}", "/_snapshot/{repository}"});
        ...
        internal static ApiUrls SqlQuery = new ApiUrls(new[]{"/_sql", "/_sql"});
        internal static ApiUrls SqlTranslate = new ApiUrls(new[]{"/_sql/translate", "/_sql/translate"});
        ...
        internal static ApiUrls NoNamespaceTermvectors = new ApiUrls(new[]{"/{index}/_termvectors/{id}", "/{index}/_termvectors/{id}", "/{index}/_termvectors", "/{index}/_termvectors", "/{index}/{type}/{id}/_termvectors", "/{index}/{type}/{id}/_termvectors", "/{index}/{type}/_termvectors", "/{index}/{type}/_termvectors"});
        internal static ApiUrls TransformDeleteTransform = new ApiUrls(new[]{"/_transform/{transform_id}"});
        internal static ApiUrls TransformGetTransform = new ApiUrls(new[]{"/_transform/{transform_id}", "/_transform"});
        internal static ApiUrls TransformGetTransformStats = new ApiUrls(new[]{"/_transform/{transform_id}/_stats"});
        internal static ApiUrls TransformPreviewTransform = new ApiUrls(new[]{"/_transform/_preview"});
        internal static ApiUrls TransformPutTransform = new ApiUrls(new[]{"/_transform/{transform_id}"});
        internal static ApiUrls TransformStartTransform = new ApiUrls(new[]{"/_transform/{transform_id}/_start"});
        internal static ApiUrls TransformStopTransform = new ApiUrls(new[]{"/_transform/{transform_id}/_stop"});
        internal static ApiUrls TransformUpdateTransform = new ApiUrls(new[]{"/_transform/{transform_id}/_update"});
        internal static ApiUrls NoNamespaceUpdate = new ApiUrls(new[]{"/{index}/_update/{id}", "/{index}/{type}/{id}/_update"});
        internal static ApiUrls NoNamespaceUpdateByQuery = new ApiUrls(new[]{"/{index}/_update_by_query", "/{index}/{type}/_update_by_query"});
        internal static ApiUrls NoNamespaceUpdateByQueryRethrottle = new ApiUrls(new[]{"/_update_by_query/{task_id}/_rethrottle"});
        internal static ApiUrls WatcherAckWatch = new ApiUrls(new[]{"/_watcher/watch/{watch_id}/_ack", "/_watcher/watch/{watch_id}/_ack", "/_watcher/watch/{watch_id}/_ack/{action_id}", "/_watcher/watch/{watch_id}/_ack/{action_id}"});
        internal static ApiUrls WatcherActivateWatch = new ApiUrls(new[]{"/_watcher/watch/{watch_id}/_activate", "/_watcher/watch/{watch_id}/_activate"});
        internal static ApiUrls WatcherDeactivateWatch = new ApiUrls(new[]{"/_watcher/watch/{watch_id}/_deactivate", "/_watcher/watch/{watch_id}/_deactivate"});
        internal static ApiUrls WatcherDeleteWatch = new ApiUrls(new[]{"/_watcher/watch/{id}"});
        internal static ApiUrls WatcherExecuteWatch = new ApiUrls(new[]{"/_watcher/watch/{id}/_execute", "/_watcher/watch/{id}/_execute", "/_watcher/watch/_execute", "/_watcher/watch/_execute"});
        internal static ApiUrls WatcherGetWatch = new ApiUrls(new[]{"/_watcher/watch/{id}"});
        internal static ApiUrls WatcherPutWatch = new ApiUrls(new[]{"/_watcher/watch/{id}", "/_watcher/watch/{id}"});
