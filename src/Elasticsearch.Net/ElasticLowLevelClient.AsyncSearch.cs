...
namespace Elasticsearch.Net.Specification.AsyncSearchApi
{
	...
	public partial class LowLevelAsyncSearchNamespace : NamespacedClientProxy
	{
		...
		///<param name = "requestParameters">Request specific configuration such as querystring parameters &amp; request specific connection settings.</param>
		public TResponse Submit<TResponse>(PostData body, SubmitRequestParameters requestParameters = null)
		...
		public Task<TResponse> SubmitAsync<TResponse>(PostData body, SubmitRequestParameters requestParameters = null, CancellationToken ctx = default)
		...
		///<param name = "body">The search definition using the Query DSL</param>
		///<param name = "requestParameters">Request specific configuration such as querystring parameters &amp; request specific connection settings.</param>
		public TResponse Submit<TResponse>(string index, PostData body, SubmitRequestParameters requestParameters = null)
		...
		public Task<TResponse> SubmitAsync<TResponse>(string index, PostData body, SubmitRequestParameters requestParameters = null, CancellationToken ctx = default)
