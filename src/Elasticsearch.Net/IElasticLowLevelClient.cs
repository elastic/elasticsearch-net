...
namespace Elasticsearch.Net
{
	public partial interface IElasticLowLevelClient
	{
		...
		ElasticsearchResponse<T> DoRequest<T>(HttpMethod method, string path, PostData<object> data = null,
		...
		Task<ElasticsearchResponse<T>> DoRequestAsync<T>(HttpMethod method, string path, CancellationToken cancellationToken,
