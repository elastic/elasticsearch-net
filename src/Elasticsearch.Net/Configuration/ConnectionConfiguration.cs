...
namespace Elasticsearch.Net
{
		...
		where T : ConnectionConfiguration<T>
	{
		...
		///     </para>
		///     <para>
		///         For Core CLR, this setting applies to the MaxConnectionsPerServer property on the HttpClientHandler instances used by the
		///         HttpClient inside the default <see cref="IConnection" /> implementation
		///     </para>
		/// </summary>
		...
		/// <summary>
		///     Configure the client to skip deserialization of certain status codes e.g: you run elasticsearch behind a proxy that returns a HTML for
		///     401, 500
		/// </summary>
