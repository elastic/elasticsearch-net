...
namespace Elasticsearch.Net.Specification.CrossClusterReplicationApi
{
	...
	public class LowLevelCrossClusterReplicationNamespace : NamespacedClientProxy
	{
		...
		///<summary>POST on /{index}/_ccr/forget_follower <para>https://www.elastic.co/guide/en/elasticsearch/reference/current</para></summary>
		...
		///<summary>POST on /{index}/_ccr/unfollow <para>https://www.elastic.co/guide/en/elasticsearch/reference/current</para></summary>
