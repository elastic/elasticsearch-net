...
namespace Elasticsearch.Net.Specification.CatApi
{
	...
	public class LowLevelCatNamespace : NamespacedClientProxy
	{
		...
		///<param name = "requestParameters">Request specific configuration such as querystring parameters &amp; request specific connection settings.</param>
		public TResponse Transform<TResponse>(CatTransformRequestParameters requestParameters = null)
		...
		public Task<TResponse> TransformAsync<TResponse>(CatTransformRequestParameters requestParameters = null, CancellationToken ctx = default)
		...
		///<param name = "requestParameters">Request specific configuration such as querystring parameters &amp; request specific connection settings.</param>
		public TResponse Transform<TResponse>(string transformId, CatTransformRequestParameters requestParameters = null)
		...
		public Task<TResponse> TransformAsync<TResponse>(string transformId, CatTransformRequestParameters requestParameters = null, CancellationToken ctx = default)
