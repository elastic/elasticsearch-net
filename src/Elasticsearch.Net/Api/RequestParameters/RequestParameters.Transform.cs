...
{
	///<summary>Request options for Cat <para>https://www.elastic.co/guide/en/elasticsearch/reference/current/cat-transforms.html</para></summary>
	public class CatTransformRequestParameters : RequestParameters<CatTransformRequestParameters>
	{
