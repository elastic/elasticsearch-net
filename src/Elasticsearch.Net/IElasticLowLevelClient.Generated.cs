...
namespace Elasticsearch.Net
{
	...
	public partial interface IElasticLowLevelClient
	{
		...
		///<param name="body">The search definition using the Query DSL and the prototype for the eval request.</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		TResponse RankEval<TResponse>(string index, string type, PostData body, RankEvalRequestParameters requestParameters = null) where TResponse : class, IElasticsearchResponse, new();
		...
		///<param name="body">The search definition using the Query DSL and the prototype for the eval request.</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		Task<TResponse> RankEvalAsync<TResponse>(string index, string type, PostData body, RankEvalRequestParameters requestParameters = null, CancellationToken ctx = default(CancellationToken)) where TResponse : class, IElasticsearchResponse, new();
