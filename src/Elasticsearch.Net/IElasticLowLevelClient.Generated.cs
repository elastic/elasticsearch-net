...
namespace Elasticsearch.Net
{
	...
	public partial interface IElasticLowLevelClient 
	{
		...
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		TResponse RankEval<TResponse>(PostData body, RankingEvaluationRequestParameters requestParameters = null) where TResponse : class, IElasticsearchResponse, new();
		
		///<summary>POST on /_rank_eval <para>https://www.elastic.co/guide/en/elasticsearch/reference/master/search-rank-eval.html</para></summary>
		///<param name="body">The search definition using the Query DSL and the prototype for the eval request.</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		Task<TResponse> RankEvalAsync<TResponse>(PostData body, RankingEvaluationRequestParameters requestParameters = null, CancellationToken ctx = default(CancellationToken)) where TResponse : class, IElasticsearchResponse, new();
		...
		///<param name="body">The search definition using the Query DSL and the prototype for the eval request.</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		TResponse RankEval<TResponse>(string index, PostData body, RankingEvaluationRequestParameters requestParameters = null) where TResponse : class, IElasticsearchResponse, new();
		
		///<summary>POST on /{index}/_rank_eval <para>https://www.elastic.co/guide/en/elasticsearch/reference/master/search-rank-eval.html</para></summary>
		///<param name="index">A comma-separated list of index names to search; use the special string `_all` or Indices.All to perform the operation on all indices</param>
		///<param name="body">The search definition using the Query DSL and the prototype for the eval request.</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		Task<TResponse> RankEvalAsync<TResponse>(string index, PostData body, RankingEvaluationRequestParameters requestParameters = null, CancellationToken ctx = default(CancellationToken)) where TResponse : class, IElasticsearchResponse, new();
		...
		///<param name="body">The search definition using the Query DSL and the prototype for the eval request.</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		TResponse RankEval<TResponse>(string index, string type, PostData body, RankingEvaluationRequestParameters requestParameters = null) where TResponse : class, IElasticsearchResponse, new();
		...
		///<param name="body">The search definition using the Query DSL and the prototype for the eval request.</param>
		///<param name="requestParameters">A func that allows you to describe the querystring parameters &amp; request specific connection settings.</param>
		Task<TResponse> RankEvalAsync<TResponse>(string index, string type, PostData body, RankingEvaluationRequestParameters requestParameters = null, CancellationToken ctx = default(CancellationToken)) where TResponse : class, IElasticsearchResponse, new();
