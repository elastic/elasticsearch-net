...
namespace Elasticsearch.Net
{
		...
		IDictionary<string, object>
	{
		...
		public override bool Equals(object obj)
		{
			...
			return obj.GetType() == typeof(DynamicBody) && this.Equals((DynamicBody)obj);
		}
		...
		/// </summary>
		/// <returns><see langword="true" /> if the <see cref="DynamicBody"/> contains an element with the key; otherwise, <see langword="false" />.
		/// </returns>
		...
		/// </summary>
		/// <returns><see langword="true" /> if the <see cref="DynamicBody"/> contains an element with the specified key; otherwise, <see langword="false" />.</returns>
		...
		/// </summary>
		/// <returns><see langword="true" /> if <paramref name="item"/> is found in the <see cref="DynamicBody"/>; otherwise, <see langword="false" />.
		/// </returns>
		...
		/// <summary>
		/// Copies the elements of the <see cref="DynamicBody"/> to an <see cref="T:System.Array"/>, starting at a particular <see cref="T:System.Array"/> index.
		/// </summary>
		/// <param name="array">The one-dimensional <see cref="T:System.Array"/> that is the destination of the elements copied from the <see cref="DynamicBody"/>. The <see cref="T:System.Array"/> must have zero-based indexing.</param>
		...
		/// </summary>
		/// <returns><see langword="true" /> if <paramref name="item"/> was successfully removed from the <see cref="DynamicBody"/>; otherwise, <see langword="false" />.</returns>
