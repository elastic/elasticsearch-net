...
namespace Elasticsearch.Net
{
			...
			IDictionary<string, object>
	{
		...
		/// </summary>
		/// <returns>
		/// <see langword="true" /> if <paramref name="item" /> is found in the <see cref="DynamicResponse" />; otherwise, <see langword="false" />.
		/// </returns>
		...
		/// <summary>
		/// Copies the elements of the <see cref="DynamicResponse" /> to an <see cref="T:System.Array" />, starting at a particular
		/// <see cref="T:System.Array" /> index.
		/// </summary>
		/// <param name="array">
		/// The one-dimensional <see cref="T:System.Array" /> that is the destination of the elements copied from the
		/// <see cref="DynamicResponse" />. The <see cref="T:System.Array" /> must have zero-based indexing.
		/// </param>
		...
		/// </summary>
		/// <returns>
		/// <see langword="true" /> if <paramref name="item" /> was successfully removed from the <see cref="DynamicResponse" />; otherwise,
		/// <see langword="false" />.
		/// </returns>
		...
		/// </summary>
		/// <returns>
		/// <see langword="true" /> if the <see cref="DynamicResponse" /> contains an element with the key; otherwise, <see langword="false" />.
		/// </returns>
		...
		/// </summary>
		/// <returns>
		/// <see langword="true" /> if the <see cref="DynamicResponse" /> contains an element with the specified key; otherwise,
		/// <see langword="false" />.
		/// </returns>
		...
		public override bool Equals(object obj)
		{
			...
			return obj.GetType() == typeof(DynamicResponse) && Equals((DynamicResponse)obj);
		}
		...
		/// </summary>
		/// <returns>
		/// A hash code for this <see cref="DynamicResponse" />, suitable for use in hashing algorithms and data structures like a hash
		/// table.
		/// </returns>
