...
namespace Examples
{
	public class Example
	{
		...
		public static Example CreateWithGlobalClientChanges(string example)
		{
			...
			var httpMethod = body != null && method == HttpMethod.GET ? HttpMethod.POST : method;
			...
			return new Example(httpMethod, uri, body);
		}
	}
}
