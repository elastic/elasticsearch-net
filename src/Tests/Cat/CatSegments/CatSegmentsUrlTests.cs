	...
	public class CatSegmentsUrlTests : IUrlTests
	{
		[U] public async Task Urls()
		{
			...
			await GET("/_cat/segments/project")
				...
				.Request(c => c.CatSegments(new CatSegmentsRequest(Nest_5_2_0.Indices.Index<Project>())))
				.FluentAsync(c => c.CatSegmentsAsync(r => r.Index<Project>()))
				.RequestAsync(c => c.CatSegmentsAsync(new CatSegmentsRequest(Nest_5_2_0.Indices.Index<Project>())));
		}
	}
}
