...
namespace Tests.CommonOptions.DateMath
{
	public class DateMathEpressions
	{
		...
		[U] public void SimpleExpressions()
		{
			...
			*/
			Expect("now").WhenSerializing(Nest_5_2_0.DateMath.Now);
			Expect("2015-05-05T00:00:00").WhenSerializing(Nest_5_2_0.DateMath.Anchored(new DateTime(2015,05, 05)));
			...
			Expect(nonsense).WhenSerializing<Nest_5_2_0.DateMath>(nonsense)
			...
			Expect("2015-05-05T00:00:00").WhenSerializing<Nest_5_2_0.DateMath>(date)
		...
		[U] public void ComplexExpressions()
		{
			...
			*/
			Expect("now+1d").WhenSerializing(
				Nest_5_2_0.DateMath.Now.Add("1d"));

			/** Including multiple operations */
			Expect("now+1d-1m").WhenSerializing(
				Nest_5_2_0.DateMath.Now.Add("1d").Subtract(TimeSpan.FromMinutes(1)));
			...
			Expect("now+1d-1m/d").WhenSerializing(
				Nest_5_2_0.DateMath.Now.Add("1d")
					...
					.RoundTo(Nest_5_2_0.TimeUnit.Day));
			...
			*/
			Expect("2015-05-05T00:00:00||+1d-1m").WhenSerializing(
				Nest_5_2_0.DateMath.Anchored(new DateTime(2015,05,05))
					.Add("1d")
					.Subtract(TimeSpan.FromMinutes(1)));
		}
		...
		[U] public void FractionalsUnitsAreDroppeToIntegerPart()
		{
			...
			*/
			Expect("now+25h").WhenSerializing(
				Nest_5_2_0.DateMath.Now.Add(TimeSpan.FromHours(25)));
			...
			Expect("now+90001s").WhenSerializing(
				Nest_5_2_0.DateMath.Now.Add(TimeSpan.FromHours(25).Add(TimeSpan.FromSeconds(1))));

			Expect("now+90000001ms").WhenSerializing(
				Nest_5_2_0.DateMath.Now.Add(TimeSpan.FromHours(25).Add(TimeSpan.FromMilliseconds(1))));

			Expect("now+1y").WhenSerializing(
				Nest_5_2_0.DateMath.Now.Add("1y"));

			Expect("now+52w").WhenSerializing(
				Nest_5_2_0.DateMath.Now.Add(TimeSpan.FromDays(7 * 52)));
