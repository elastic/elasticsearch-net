...
namespace Tests.QueryDsl
{
	...
	public abstract class QueryDslUsageTestsBase : ApiIntegrationTestBase<ISearchResponse<Project>, ISearchRequest, SearchDescriptor<Project>, SearchRequest<Project>>
	{
		...
		protected abstract QueryContainer QueryFluent(QueryContainerDescriptor<Project> arg);
