	...
	public class FunctionScoreQueryUsageTests : QueryDslUsageTestsBase
	{
		...
		protected override QueryContainer QueryInitializer => new FunctionScoreQuery()
		{
			...
			Functions = new List<IScoreFunction>
			{
				...
				new LinearGeoDecayFunction { Origin = new GeoLocation(70, -70), Field = Field<Project>(p=>p.Location), Scale = DistanceUnit.Miles(1), MultiValueMode = MultiValueMode.Average },
		...
		protected override QueryContainer QueryFluent(QueryContainerDescriptor<Project> q) => q
			.FunctionScore(c => c
				...
				.Functions(f => f
					...
					.LinearGeoLocation(b => b.Field(p => p.Location).Origin(new GeoLocation(70, -70)).Scale(DistanceUnit.Miles(1)).MultiValueMode(MultiValueMode.Average))
