...
namespace Tests.Document.Single.Create
{
		...
		ApiIntegrationTestBase<WritableCluster, ICreateResponse, ICreateRequest<Project>, CreateDescriptor<Project>, CreateRequest<Project>>
	{
		...
		protected override string UrlPath
			=> $"/project/project/{CallIsolatedValue}/_create?consistency=one&refresh=true&routing=route";
	...
	public class CreateInvalidApiTests : SimpleIntegration, IClusterFixture<WritableCluster>
	{
	...
	public class CreateJObjectIntegrationTests : SimpleIntegration, IClusterFixture<WritableCluster>
	{
	...
	public class CreateAnonymousTypesIntegrationTests : SimpleIntegration, IClusterFixture<WritableCluster>
	{
