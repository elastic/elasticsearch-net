...
{
	public class SignificantTermsAggregationUsageTest : AggregationUsageTestBase
	{
		public SignificantTermsAggregationUsageTest(ReadOnlyCluster i, EndpointUsage usage) : base(i, usage) { }
