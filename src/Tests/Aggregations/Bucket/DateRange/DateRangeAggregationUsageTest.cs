...
namespace Tests.Aggregations.Bucket
{
	...
	*/
	public class DateRangeAggregationUsageTest : AggregationUsageTestBase
	{
		public DateRangeAggregationUsageTest(ReadOnlyCluster i, EndpointUsage usage) : base(i, usage) { }
