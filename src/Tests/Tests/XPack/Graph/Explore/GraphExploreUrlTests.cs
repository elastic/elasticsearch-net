...
namespace Tests.XPack.Graph.Explore
{
	public class GraphExploreUrlTests : UrlTestsBase
	{
		...
		{
			await POST("/project/project/_xpack/_graph/_explore")
			...
			await POST("/project/_xpack/_graph/_explore")
			...
			await POST($"_all/_xpack/_graph/_explore")
			...
			await POST($"/{index}/_xpack/_graph/_explore")
			...
			await POST($"/{index}/project/_xpack/_graph/_explore")
