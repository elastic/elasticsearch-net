...
namespace Tests.MetaHeader
{
	public class MetaHeaderHelperTests
	{
		...
		[U] public void ScrollAllHelperRequestsIncludeExpectedHelperMetaData()
		{
			...
			var responses = new List<(int, string)>
			{
				(200, "{\"_scroll_id\":\"SCROLLID\",\"took\":0,\"timed_out\":false,\"_shards\":{\"total\":1,\"successful\":1,\"skipped\":0,\"failed\":0},\"hits\":{\"total\":0,\"max_score\":null,\"hits\":[]}}"),
				(200, "{\"_scroll_id\":\"SCROLLID\",\"took\":0,\"timed_out\":false,\"_shards\":{\"total\":1,\"successful\":1,\"skipped\":0,\"failed\":0},\"hits\":{\"total\":1,\"max_score\":null,\"hits\":[{\"_index\":\"index-a\",\"_type\":\"_doc\",\"_id\":\"ISXw0HYBAJbnbq7-Utq6\",\"_score\":null,\"_source\":{\"name\": \"name-a\"},\"sort\":[0]}]}}"),
				(200, "{\"_scroll_id\":\"SCROLLID\",\"took\":1,\"timed_out\":false,\"terminated_early\":false,\"_shards\":{\"total\":1,\"successful\":1,\"skipped\":0,\"failed\":0},\"hits\":{\"total\":1,\"max_score\":null,\"hits\":[]}}")
			};
		...
		[U] public void ReindexHelperRequestsIncludeExpectedHelperMetaData()
		{
			...
			var responses = new List<(int, string)>
			{
				...
				(200, "{\"_scroll_id\":\"SCROLLID\",\"took\":0,\"timed_out\":false,\"_shards\":{\"total\":1,\"successful\":1,\"skipped\":0,\"failed\":0},\"hits\":{\"total\":0,\"max_score\":null,\"hits\":[]}}"),
				(200, "{\"_scroll_id\":\"SCROLLID\",\"took\":0,\"timed_out\":false,\"_shards\":{\"total\":1,\"successful\":1,\"skipped\":0,\"failed\":0},\"hits\":{\"total\":0,\"max_score\":null,\"hits\":[{\"_index\":\"index-a\",\"_type\":\"_doc\",\"_id\":\"ISXw0HYBAJbnbq7-Utq6\",\"_score\":null,\"_source\":{\"name\": \"name-a\"},\"sort\":[0]}]}}"),
				(200, "{\"_scroll_id\":\"SCROLLID\",\"took\":1,\"timed_out\":false,\"terminated_early\":false,\"_shards\":{\"total\":1,\"successful\":1,\"skipped\":0,\"failed\":0},\"hits\":{\"total\":0,\"max_score\":null,\"hits\":[]}}"),
		...
		private class SnapshotObserver : IObserver<ISnapshotStatusResponse>
		{
			...
			public void OnNext(ISnapshotStatusResponse value) { }
		}
		...
		private class RestoreObserver : IObserver<IRecoveryStatusResponse>
		{
			private readonly TestableInMemoryConnection _connection;
			...
			public void OnCompleted() => _connection.AssertExpectedCallCount();
			public void OnError(Exception error) => throw new NotImplementedException();
			public void OnNext(IRecoveryStatusResponse value) { }
		}
