...
#pragma warning disable 618
		public void Visit(IStringProperty mapping) => Increment("string");
...
#pragma warning disable 618
		public void Visit(IAttachmentProperty mapping) => Increment("attachment");
#pragma warning restore 618
		...
		{
			Counts.ContainsKey(key).Should().BeTrue();
			Counts[key].Should().Be(count, $"because there should be {count} {key} properties");
		}
	}
}
