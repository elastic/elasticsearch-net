...
namespace Tests.ClientConcepts.HighLevel.Caching
{
	public class FieldResolverCacheBusterTests
	{
		...
		public class Fields
		{
			...
			[U] public void ExpressionWithVariableSuffix()
			{
				var suffix = "raw";
			...
			[U] public void ExpressionWithConstantSuffix()
			{
				var resolver = new TestableFieldResolver(new ConnectionSettings());
			...
			[U] public void ExpressionWithDictionaryItemVariableExpression()
			{
				var resolver = new TestableFieldResolver(new ConnectionSettings());
				var key = "key1";
			...
			[U] public void ExpressionWithDictionarySuffix()
			{
				var resolver = new TestableFieldResolver(new ConnectionSettings());
				var key = "key1";
