...
namespace Nest.Tests.Unit.Core.Snapshot
{
    ...
    public class SnapshotObservableTests : BaseJsonTests
    {
        ...
        public void OnNext_SnapshotObservableShouldNotify()
        {
            ...
            sut.Subscribe(new Observer<ISnapshotStatusResponse>(response =>
            {
                onNextCounter++;
        ...
        public void ShouldNotNotifyOnNextWhenDisposed()
        {
            ...
            using (sut.Subscribe(new Observer<ISnapshotStatusResponse>(onNext, exception => done = true, () => done = true)))
            {
                while (!done) Thread.Sleep(10);
            }
        ...
        public void OnCompleted_SnapshotObservableShouldNotify()
        {
            ...
            sut.Subscribe(new Observer<ISnapshotStatusResponse>(response => done = true, exception => done = true,
        ...
        public void OnError_SnapshotObservableShouldNotify()
        {
            ...
            sut.Subscribe(new Observer<ISnapshotStatusResponse>(response => done = true, exception => onErrorWasCalled = done = true, () => done = true));
