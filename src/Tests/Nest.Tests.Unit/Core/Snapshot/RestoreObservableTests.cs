...
namespace Nest.Tests.Unit.Core.Snapshot
{
    ...
    public class RestoreObservableTests : BaseJsonTests
    {
        ...
        public void ShouldCallRestoreMethodOnce()
        {
            ...
            sut.Subscribe(new Observer<IRecoveryStatusResponse>());
        ...
        public void OnNext_RestoreObservableShouldNotify()
        {
            ...
            sut.Subscribe(new Observer<IRecoveryStatusResponse>(response =>
            {
                onNextCounter++;
        ...
        public void ShouldNotNotifyOnNextWhenDisposed()
        {
            ...
            using (sut.Subscribe(new Observer<IRecoveryStatusResponse>(onNext, exception => done = true, () => done = true)))
            {
                while (!done) Thread.Sleep(10);
            }
        ...
        public void OnCompleted_RestoreObservableShouldNotify()
        {
            ...
            sut.Subscribe(new Observer<IRecoveryStatusResponse>(response => done = true, exception => done = true,
        ...
        public void OnError_RestoreObservableShouldNotify()
        {
            ...
            sut.Subscribe(new Observer<IRecoveryStatusResponse>(response => done = true, exception => onErrorWasCalled = done = true, () => done = true));
        ...
        private Dictionary<string, RecoveryStatus> RecoveryStatusFixture(string indexName, long recovered, long total)
        {
            return new Dictionary<string, RecoveryStatus>
            {
                {
                    indexName,
                    new RecoveryStatusWrapper(new List<ShardRecovery>
                    {
                        new ShardRecoveryWrapper(
                            new RecoveryIndexStatusWrapper(new RecoveryFilesWrapper(recovered, total)))
                    })
                }
            };
        }
