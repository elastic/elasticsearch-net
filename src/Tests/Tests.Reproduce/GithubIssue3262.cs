...
namespace Tests.Reproduce
{
	public class GithubIssue3262
	{
		...
		public void CanDeserializeSingleFilterAndCharacterFilter()
		{
			...
			Action getIndexRequest = () => client.Indices.GetIndex(new GetIndexRequest("products_purchasing"));

			getIndexRequest.Should().NotThrow();

			var response = client.Indices.GetIndex(new GetIndexRequest("products_purchasing"));
