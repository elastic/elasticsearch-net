...
using Elasticsearch.Net.Tests.Unit.Memory;
...
{
	public class MemorySetup<T> : IDisposable where T : class
	{
		...
		private TrackableMemoryStream CreateServerExceptionResponse(object responseValue)
		{
