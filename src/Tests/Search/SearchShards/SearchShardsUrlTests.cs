	...
	public class SearchShardsUrlTests
	{
		[U] public async Task Urls()
		{
			...
			await POST("/_search_shards")
				...
				.Request(c=>c.SearchShards(new SearchShardsRequest<Project>(Nest_5_2_0.Indices.All, Types.All)))
				.FluentAsync(c=>c.SearchShardsAsync<Project>(s=>s.AllIndices().Type(Types.All)))
				.RequestAsync(c=>c.SearchShardsAsync(new SearchShardsRequest<Project>(Nest_5_2_0.Indices.All, Types.All)))
