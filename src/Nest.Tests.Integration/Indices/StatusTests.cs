...
namespace Nest.Tests.Integration.Indices
{
    ...
    public class StatusTests : IntegrationTests
    {
        ...
        {
            var r = this._client.Status(new StatusParams { Recovery = true, Snapshot = true });
            Assert.True(r.OK);
            Assert.True(r.IsValid);
            Assert.NotNull(r.Shards);
            Assert.NotNull(r.Indices);
        ...
        {
            var r = this._client.Status(new StatusParams { Recovery = true, Snapshot = false });
            Assert.True(r.OK);
            Assert.True(r.IsValid);
            Assert.NotNull(r.Shards);
            Assert.NotNull(r.Indices);
        ...
        {
            var r = this._client.Status(ElasticsearchConfiguration.DefaultIndex);
            Assert.True(r.OK);
            Assert.True(r.IsValid);
            Assert.NotNull(r.Shards);
            Assert.NotNull(r.Indices);
        ...
        {
            var r = this._client.Status<ElasticSearchProject>();
            Assert.True(r.OK);
            Assert.True(r.IsValid);
            Assert.NotNull(r.Shards);
            Assert.NotNull(r.Indices);
