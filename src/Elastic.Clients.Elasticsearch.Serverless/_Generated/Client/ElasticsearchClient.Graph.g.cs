...
public partial class GraphNamespacedClient : NamespacedClientProxy
{
	...
	/// <para><see href="https://www.elastic.co/guide/en/elasticsearch/reference/8.10/graph-explore-api.html">Learn more about this API in the Elasticsearch documentation.</see></para>
	/// </summary>
	...
	/// <para><see href="https://www.elastic.co/guide/en/elasticsearch/reference/8.10/graph-explore-api.html">Learn more about this API in the Elasticsearch documentation.</see></para>
	/// </summary>
	public virtual ExploreResponse Explore(Elastic.Clients.Elasticsearch.Serverless.Indices indices)
	{
	...
	/// <para><see href="https://www.elastic.co/guide/en/elasticsearch/reference/8.10/graph-explore-api.html">Learn more about this API in the Elasticsearch documentation.</see></para>
	/// </summary>
	public virtual ExploreResponse Explore(Elastic.Clients.Elasticsearch.Serverless.Indices indices, Action<ExploreRequestDescriptor> configureRequest)
	{
		var descriptor = new ExploreRequestDescriptor(indices);
	...
	/// <para><see href="https://www.elastic.co/guide/en/elasticsearch/reference/8.10/graph-explore-api.html">Learn more about this API in the Elasticsearch documentation.</see></para>
	/// </summary>
	public virtual ExploreResponse Explore<TDocument>(Elastic.Clients.Elasticsearch.Serverless.Indices indices, Action<ExploreRequestDescriptor<TDocument>> configureRequest)
	{
