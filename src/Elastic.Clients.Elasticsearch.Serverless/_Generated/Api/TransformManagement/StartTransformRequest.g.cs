...
{
	/// <summary>
	/// <para>Restricts the set of transformed entities to those changed after this time. Relative times like now-30d are supported. Only applicable for continuous transforms.</para>
	/// </summary>
...
{
	public StartTransformRequest(Elastic.Clients.Elasticsearch.Serverless.Id transformId) : base(r => r.Required("transform_id", transformId))
	{
	}
...
public sealed partial class StartTransformRequestDescriptor : RequestDescriptor<StartTransformRequestDescriptor, StartTransformRequestParameters>
{
	...
	public StartTransformRequestDescriptor(Elastic.Clients.Elasticsearch.Serverless.Id transformId) : base(r => r.Required("transform_id", transformId))
	{
	}
	...
	public StartTransformRequestDescriptor Timeout(Elastic.Clients.Elasticsearch.Serverless.Duration? timeout) => Qs("timeout", timeout);

	public StartTransformRequestDescriptor TransformId(Elastic.Clients.Elasticsearch.Serverless.Id transformId)
	{
