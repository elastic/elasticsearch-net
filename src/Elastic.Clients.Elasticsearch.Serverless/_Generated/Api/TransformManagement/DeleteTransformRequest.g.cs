...
{
	public DeleteTransformRequest(Elastic.Clients.Elasticsearch.Serverless.Id transformId) : base(r => r.Required("transform_id", transformId))
	{
	}
...
public sealed partial class DeleteTransformRequestDescriptor : RequestDescriptor<DeleteTransformRequestDescriptor, DeleteTransformRequestParameters>
{
	...
	public DeleteTransformRequestDescriptor(Elastic.Clients.Elasticsearch.Serverless.Id transformId) : base(r => r.Required("transform_id", transformId))
	{
	}
	...
	public DeleteTransformRequestDescriptor Timeout(Elastic.Clients.Elasticsearch.Serverless.Duration? timeout) => Qs("timeout", timeout);

	public DeleteTransformRequestDescriptor TransformId(Elastic.Clients.Elasticsearch.Serverless.Id transformId)
	{
