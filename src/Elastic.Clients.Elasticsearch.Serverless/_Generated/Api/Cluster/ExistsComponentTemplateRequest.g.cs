...
{
	public ExistsComponentTemplateRequest(Elastic.Clients.Elasticsearch.Serverless.Names name) : base(r => r.Required("name", name))
	{
	}
...
public sealed partial class ExistsComponentTemplateRequestDescriptor : RequestDescriptor<ExistsComponentTemplateRequestDescriptor, ExistsComponentTemplateRequestParameters>
{
	...
	public ExistsComponentTemplateRequestDescriptor(Elastic.Clients.Elasticsearch.Serverless.Names name) : base(r => r.Required("name", name))
	{
	}
	...
	public ExistsComponentTemplateRequestDescriptor MasterTimeout(Elastic.Clients.Elasticsearch.Serverless.Duration? masterTimeout) => Qs("master_timeout", masterTimeout);

	public ExistsComponentTemplateRequestDescriptor Name(Elastic.Clients.Elasticsearch.Serverless.Names name)
	{
