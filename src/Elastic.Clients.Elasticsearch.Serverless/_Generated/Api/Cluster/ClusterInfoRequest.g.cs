...
{
	public ClusterInfoRequest(IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.ClusterInfoTarget> target) : base(r => r.Required("target", target))
	{
	}
...
public sealed partial class ClusterInfoRequestDescriptor : RequestDescriptor<ClusterInfoRequestDescriptor, ClusterInfoRequestParameters>
{
	...
	public ClusterInfoRequestDescriptor(IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.ClusterInfoTarget> target) : base(r => r.Required("target", target))
	{
	}
	...
	public ClusterInfoRequestDescriptor Target(IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.ClusterInfoTarget> target)
	{
