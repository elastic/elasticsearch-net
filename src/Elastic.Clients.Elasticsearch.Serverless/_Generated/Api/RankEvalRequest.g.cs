...
public sealed partial class RankEvalRequestDescriptor<TDocument> : RequestDescriptor<RankEvalRequestDescriptor<TDocument>, RankEvalRequestParameters>
{
	...
	public RankEvalRequestDescriptor(Elastic.Clients.Elasticsearch.Serverless.Indices? indices) : base(r => r.Optional("index", indices))
	{
	}
	...
	private Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalMetricDescriptor MetricDescriptor { get; set; }
	private Action<Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalMetricDescriptor> MetricDescriptorAction { get; set; }
	private ICollection<Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalRequestItem> RequestsValue { get; set; }
	private Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalRequestItemDescriptor<TDocument> RequestsDescriptor { get; set; }
	private Action<Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalRequestItemDescriptor<TDocument>> RequestsDescriptorAction { get; set; }
	...
	public RankEvalRequestDescriptor<TDocument> Metric(Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalMetricDescriptor descriptor)
	{
		MetricValue = null;
		MetricDescriptorAction = null;
	...
	public RankEvalRequestDescriptor<TDocument> Metric(Action<Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalMetricDescriptor> configure)
	{
		MetricValue = null;
		MetricDescriptor = null;
	...
	public RankEvalRequestDescriptor<TDocument> Requests(Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalRequestItemDescriptor<TDocument> descriptor)
	{
		RequestsValue = null;
		RequestsDescriptorAction = null;
		RequestsDescriptorActions = null;
	...
	public RankEvalRequestDescriptor<TDocument> Requests(Action<Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalRequestItemDescriptor<TDocument>> configure)
	{
		RequestsValue = null;
		RequestsDescriptor = null;
		RequestsDescriptorActions = null;
	...
	public RankEvalRequestDescriptor<TDocument> Requests(params Action<Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalRequestItemDescriptor<TDocument>>[] configure)
	{
		RequestsValue = null;
		RequestsDescriptor = null;
		RequestsDescriptorAction = null;
	...
	protected override void Serialize(Utf8JsonWriter writer, JsonSerializerOptions options, IElasticsearchClientSettings settings)
	{
		...
		{
			writer.WritePropertyName("metric");
			JsonSerializer.Serialize(writer, new Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalMetricDescriptor(MetricDescriptorAction), options);
		}
		...
		else if (RequestsDescriptorAction is not null)
		{
			writer.WritePropertyName("requests");
			writer.WriteStartArray();
			JsonSerializer.Serialize(writer, new Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalRequestItemDescriptor<TDocument>(RequestsDescriptorAction), options);
			writer.WriteEndArray();
		}
		else if (RequestsDescriptorActions is not null)
		{
			...
			{
				JsonSerializer.Serialize(writer, new Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalRequestItemDescriptor<TDocument>(action), options);
			}
...
public sealed partial class RankEvalRequestDescriptor : RequestDescriptor<RankEvalRequestDescriptor, RankEvalRequestParameters>
{
	...
	private Action<Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalMetricDescriptor> MetricDescriptorAction { get; set; }
	private ICollection<Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalRequestItem> RequestsValue { get; set; }
	private Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalRequestItemDescriptor RequestsDescriptor { get; set; }
	private Action<Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalRequestItemDescriptor> RequestsDescriptorAction { get; set; }
	...
	public RankEvalRequestDescriptor Metric(Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalMetricDescriptor descriptor)
	{
		MetricValue = null;
		MetricDescriptorAction = null;
		MetricDescriptor = descriptor;
	...
	public RankEvalRequestDescriptor Metric(Action<Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalMetricDescriptor> configure)
	{
		MetricValue = null;
		MetricDescriptor = null;
		MetricDescriptorAction = configure;
	...
	public RankEvalRequestDescriptor Requests(Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalRequestItemDescriptor descriptor)
	{
		RequestsValue = null;
		RequestsDescriptorAction = null;
		RequestsDescriptorActions = null;
	...
	public RankEvalRequestDescriptor Requests(Action<Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalRequestItemDescriptor> configure)
	{
		RequestsValue = null;
		RequestsDescriptor = null;
		RequestsDescriptorActions = null;
	...
	public RankEvalRequestDescriptor Requests(params Action<Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalRequestItemDescriptor>[] configure)
	{
		RequestsValue = null;
		RequestsDescriptor = null;
		RequestsDescriptorAction = null;
	...
	protected override void Serialize(Utf8JsonWriter writer, JsonSerializerOptions options, IElasticsearchClientSettings settings)
	{
		...
		else if (RequestsDescriptorAction is not null)
		{
			writer.WritePropertyName("requests");
			writer.WriteStartArray();
			JsonSerializer.Serialize(writer, new Elastic.Clients.Elasticsearch.Serverless.Core.RankEval.RankEvalRequestItemDescriptor(RequestsDescriptorAction), options);
			writer.WriteEndArray();
		}
		else if (RequestsDescriptorActions is not null)
		{
