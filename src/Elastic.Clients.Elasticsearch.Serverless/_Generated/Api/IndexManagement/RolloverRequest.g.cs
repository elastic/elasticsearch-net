...
public sealed partial class RolloverRequest : PlainRequest<RolloverRequestParameters>
{
	...
	public RolloverRequest(Elastic.Clients.Elasticsearch.Serverless.IndexAlias alias, Elastic.Clients.Elasticsearch.Serverless.IndexName? new_index) : base(r => r.Required("alias", alias).Optional("new_index", new_index))
	{
	}
...
public sealed partial class RolloverRequestDescriptor : RequestDescriptor<RolloverRequestDescriptor, RolloverRequestParameters>
{
	...
	public RolloverRequestDescriptor(Elastic.Clients.Elasticsearch.Serverless.IndexAlias alias, Elastic.Clients.Elasticsearch.Serverless.IndexName? new_index) : base(r => r.Required("alias", alias).Optional("new_index", new_index))
	{
	}
	...
	public RolloverRequestDescriptor NewIndex(Elastic.Clients.Elasticsearch.Serverless.IndexName? new_index)
	{
