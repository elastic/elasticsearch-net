...
public sealed partial class GetTemplateRequest : PlainRequest<GetTemplateRequestParameters>
{
	...
	public GetTemplateRequest(Elastic.Clients.Elasticsearch.Serverless.Names? name) : base(r => r.Optional("name", name))
	{
	}
...
public sealed partial class GetTemplateRequestDescriptor : RequestDescriptor<GetTemplateRequestDescriptor, GetTemplateRequestParameters>
{
	...
	public GetTemplateRequestDescriptor MasterTimeout(Elastic.Clients.Elasticsearch.Serverless.Duration? masterTimeout) => Qs("master_timeout", masterTimeout);

	public GetTemplateRequestDescriptor Name(Elastic.Clients.Elasticsearch.Serverless.Names? name)
	{
