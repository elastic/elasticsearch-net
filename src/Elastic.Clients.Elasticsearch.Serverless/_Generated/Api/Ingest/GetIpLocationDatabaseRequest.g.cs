...
public sealed partial class GetIpLocationDatabaseRequestDescriptor<TDocument> : RequestDescriptor<GetIpLocationDatabaseRequestDescriptor<TDocument>, GetIpLocationDatabaseRequestParameters>
{
	...
	public GetIpLocationDatabaseRequestDescriptor<TDocument> MasterTimeout(Elastic.Clients.Elasticsearch.Serverless.Duration? masterTimeout) => Qs("master_timeout", masterTimeout);

	public GetIpLocationDatabaseRequestDescriptor<TDocument> Id(Elastic.Clients.Elasticsearch.Serverless.Ids? id)
	{
