...
{
	public UpdateFilterRequest(Elastic.Clients.Elasticsearch.Serverless.Id filterId) : base(r => r.Required("filter_id", filterId))
	{
	}
...
public sealed partial class UpdateFilterRequestDescriptor : RequestDescriptor<UpdateFilterRequestDescriptor, UpdateFilterRequestParameters>
{
	...
	public UpdateFilterRequestDescriptor(Elastic.Clients.Elasticsearch.Serverless.Id filterId) : base(r => r.Required("filter_id", filterId))
	{
	}
	...
	public UpdateFilterRequestDescriptor FilterId(Elastic.Clients.Elasticsearch.Serverless.Id filterId)
	{
