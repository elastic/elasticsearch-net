...
{
	public GetInfluencersRequest(Elastic.Clients.Elasticsearch.Serverless.Id jobId) : base(r => r.Required("job_id", jobId))
	{
	}
...
public sealed partial class GetInfluencersRequestDescriptor<TDocument> : RequestDescriptor<GetInfluencersRequestDescriptor<TDocument>, GetInfluencersRequestParameters>
{
	...
	public GetInfluencersRequestDescriptor(Elastic.Clients.Elasticsearch.Serverless.Id jobId) : base(r => r.Required("job_id", jobId))
	{
	}
	...
	public GetInfluencersRequestDescriptor<TDocument> Sort(Elastic.Clients.Elasticsearch.Serverless.Field? sort) => Qs("sort", sort);
	public GetInfluencersRequestDescriptor<TDocument> Start(DateTimeOffset? start) => Qs("start", start);

	public GetInfluencersRequestDescriptor<TDocument> JobId(Elastic.Clients.Elasticsearch.Serverless.Id jobId)
	{
	...
	public GetInfluencersRequestDescriptor<TDocument> Page(Elastic.Clients.Elasticsearch.Serverless.MachineLearning.PageDescriptor descriptor)
	{
		PageValue = null;
		PageDescriptorAction = null;
	...
	public GetInfluencersRequestDescriptor<TDocument> Page(Action<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.PageDescriptor> configure)
	{
		PageValue = null;
		PageDescriptor = null;
...
public sealed partial class GetInfluencersRequestDescriptor : RequestDescriptor<GetInfluencersRequestDescriptor, GetInfluencersRequestParameters>
{
	...
	public GetInfluencersRequestDescriptor Sort(Elastic.Clients.Elasticsearch.Serverless.Field? sort) => Qs("sort", sort);
	public GetInfluencersRequestDescriptor Start(DateTimeOffset? start) => Qs("start", start);

	public GetInfluencersRequestDescriptor JobId(Elastic.Clients.Elasticsearch.Serverless.Id jobId)
	{
		RouteValues.Required("job_id", jobId);
		return Self;
	}
	...
	public GetInfluencersRequestDescriptor Page(Elastic.Clients.Elasticsearch.Serverless.MachineLearning.PageDescriptor descriptor)
	{
		PageValue = null;
		PageDescriptorAction = null;
		PageDescriptor = descriptor;
	...
	public GetInfluencersRequestDescriptor Page(Action<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.PageDescriptor> configure)
	{
		PageValue = null;
		PageDescriptor = null;
		PageDescriptorAction = configure;
