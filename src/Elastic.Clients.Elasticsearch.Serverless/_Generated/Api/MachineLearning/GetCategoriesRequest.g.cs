...
{
	public GetCategoriesRequest(Elastic.Clients.Elasticsearch.Serverless.Id jobId, string? categoryId) : base(r => r.Required("job_id", jobId).Optional("category_id", categoryId))
	{
	}

	public GetCategoriesRequest(Elastic.Clients.Elasticsearch.Serverless.Id jobId) : base(r => r.Required("job_id", jobId))
	{
	}
...
public sealed partial class GetCategoriesRequestDescriptor : RequestDescriptor<GetCategoriesRequestDescriptor, GetCategoriesRequestParameters>
{
	...
	public GetCategoriesRequestDescriptor(Elastic.Clients.Elasticsearch.Serverless.Id jobId, string? categoryId) : base(r => r.Required("job_id", jobId).Optional("category_id", categoryId))
	{
	}

	public GetCategoriesRequestDescriptor(Elastic.Clients.Elasticsearch.Serverless.Id jobId) : base(r => r.Required("job_id", jobId))
	{
	}
	...
	public GetCategoriesRequestDescriptor JobId(Elastic.Clients.Elasticsearch.Serverless.Id jobId)
	{
	...
	/// <para>Configures pagination.<br/>This parameter has the `from` and `size` properties.</para>
	/// </summary>
	public GetCategoriesRequestDescriptor Page(Elastic.Clients.Elasticsearch.Serverless.MachineLearning.Page? page)
	{
		PageDescriptor = null;
	...
	public GetCategoriesRequestDescriptor Page(Elastic.Clients.Elasticsearch.Serverless.MachineLearning.PageDescriptor descriptor)
	{
		PageValue = null;
		PageDescriptorAction = null;
	...
	public GetCategoriesRequestDescriptor Page(Action<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.PageDescriptor> configure)
	{
		PageValue = null;
		PageDescriptor = null;
