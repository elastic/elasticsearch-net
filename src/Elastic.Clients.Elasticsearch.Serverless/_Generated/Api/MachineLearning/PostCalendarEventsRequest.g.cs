...
{
	public PostCalendarEventsRequest(Elastic.Clients.Elasticsearch.Serverless.Id calendarId) : base(r => r.Required("calendar_id", calendarId))
	{
	}
...
public sealed partial class PostCalendarEventsRequestDescriptor : RequestDescriptor<PostCalendarEventsRequestDescriptor, PostCalendarEventsRequestParameters>
{
	...
	public PostCalendarEventsRequestDescriptor(Elastic.Clients.Elasticsearch.Serverless.Id calendarId) : base(r => r.Required("calendar_id", calendarId))
	{
	}
	...
	public PostCalendarEventsRequestDescriptor CalendarId(Elastic.Clients.Elasticsearch.Serverless.Id calendarId)
	{
		RouteValues.Required("calendar_id", calendarId);
		return Self;
	}

	private ICollection<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.CalendarEvent> EventsValue { get; set; }
	private Elastic.Clients.Elasticsearch.Serverless.MachineLearning.CalendarEventDescriptor EventsDescriptor { get; set; }
	private Action<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.CalendarEventDescriptor> EventsDescriptorAction { get; set; }
	...
	public PostCalendarEventsRequestDescriptor Events(Elastic.Clients.Elasticsearch.Serverless.MachineLearning.CalendarEventDescriptor descriptor)
	{
		EventsValue = null;
		EventsDescriptorAction = null;
		EventsDescriptorActions = null;
	...
	public PostCalendarEventsRequestDescriptor Events(Action<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.CalendarEventDescriptor> configure)
	{
		EventsValue = null;
		EventsDescriptor = null;
		EventsDescriptorActions = null;
	...
	public PostCalendarEventsRequestDescriptor Events(params Action<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.CalendarEventDescriptor>[] configure)
	{
		EventsValue = null;
		EventsDescriptor = null;
		EventsDescriptorAction = null;
	...
	protected override void Serialize(Utf8JsonWriter writer, JsonSerializerOptions options, IElasticsearchClientSettings settings)
	{
		...
		else if (EventsDescriptorAction is not null)
		{
			writer.WritePropertyName("events");
			writer.WriteStartArray();
			JsonSerializer.Serialize(writer, new Elastic.Clients.Elasticsearch.Serverless.MachineLearning.CalendarEventDescriptor(EventsDescriptorAction), options);
			writer.WriteEndArray();
		}
		else if (EventsDescriptorActions is not null)
		{
			...
			{
				JsonSerializer.Serialize(writer, new Elastic.Clients.Elasticsearch.Serverless.MachineLearning.CalendarEventDescriptor(action), options);
			}
