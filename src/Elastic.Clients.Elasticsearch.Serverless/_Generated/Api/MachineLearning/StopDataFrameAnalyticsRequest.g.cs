...
{
	public StopDataFrameAnalyticsRequest(Elastic.Clients.Elasticsearch.Serverless.Id id) : base(r => r.Required("id", id))
	{
	}
...
public sealed partial class StopDataFrameAnalyticsRequestDescriptor<TDocument> : RequestDescriptor<StopDataFrameAnalyticsRequestDescriptor<TDocument>, StopDataFrameAnalyticsRequestParameters>
{
	...
	public StopDataFrameAnalyticsRequestDescriptor(Elastic.Clients.Elasticsearch.Serverless.Id id) : base(r => r.Required("id", id))
	{
	}
	...
	public StopDataFrameAnalyticsRequestDescriptor<TDocument> Timeout(Elastic.Clients.Elasticsearch.Serverless.Duration? timeout) => Qs("timeout", timeout);

	public StopDataFrameAnalyticsRequestDescriptor<TDocument> Id(Elastic.Clients.Elasticsearch.Serverless.Id id)
	{
...
public sealed partial class StopDataFrameAnalyticsRequestDescriptor : RequestDescriptor<StopDataFrameAnalyticsRequestDescriptor, StopDataFrameAnalyticsRequestParameters>
{
	...
	public StopDataFrameAnalyticsRequestDescriptor Timeout(Elastic.Clients.Elasticsearch.Serverless.Duration? timeout) => Qs("timeout", timeout);

	public StopDataFrameAnalyticsRequestDescriptor Id(Elastic.Clients.Elasticsearch.Serverless.Id id)
	{
		RouteValues.Required("id", id);
		return Self;
	}
