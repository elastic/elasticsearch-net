...
public sealed partial class PreviewDataFrameAnalyticsRequest : PlainRequest<PreviewDataFrameAnalyticsRequestParameters>
{
	...
	public PreviewDataFrameAnalyticsRequest(Elastic.Clients.Elasticsearch.Serverless.Id? id) : base(r => r.Optional("id", id))
	{
	}
...
public sealed partial class PreviewDataFrameAnalyticsRequestDescriptor<TDocument> : RequestDescriptor<PreviewDataFrameAnalyticsRequestDescriptor<TDocument>, PreviewDataFrameAnalyticsRequestParameters>
{
	...
	public PreviewDataFrameAnalyticsRequestDescriptor(Elastic.Clients.Elasticsearch.Serverless.Id? id) : base(r => r.Optional("id", id))
	{
	}
	...
	public PreviewDataFrameAnalyticsRequestDescriptor<TDocument> Id(Elastic.Clients.Elasticsearch.Serverless.Id? id)
	{
		RouteValues.Optional("id", id);
		return Self;
	}

	private Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframePreviewConfig? ConfigValue { get; set; }
	private Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframePreviewConfigDescriptor<TDocument> ConfigDescriptor { get; set; }
	...
	public PreviewDataFrameAnalyticsRequestDescriptor<TDocument> Config(Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframePreviewConfigDescriptor<TDocument> descriptor)
	{
		ConfigValue = null;
		ConfigDescriptorAction = null;
	...
	public PreviewDataFrameAnalyticsRequestDescriptor<TDocument> Config(Action<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframePreviewConfigDescriptor<TDocument>> configure)
	{
		ConfigValue = null;
		ConfigDescriptor = null;
	...
	protected override void Serialize(Utf8JsonWriter writer, JsonSerializerOptions options, IElasticsearchClientSettings settings)
	{
		...
		{
			writer.WritePropertyName("config");
			JsonSerializer.Serialize(writer, new Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframePreviewConfigDescriptor<TDocument>(ConfigDescriptorAction), options);
		}
...
public sealed partial class PreviewDataFrameAnalyticsRequestDescriptor : RequestDescriptor<PreviewDataFrameAnalyticsRequestDescriptor, PreviewDataFrameAnalyticsRequestParameters>
{
	...
	public PreviewDataFrameAnalyticsRequestDescriptor Id(Elastic.Clients.Elasticsearch.Serverless.Id? id)
	{
		RouteValues.Optional("id", id);
		return Self;
	}
	...
	private Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframePreviewConfig? ConfigValue { get; set; }
	private Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframePreviewConfigDescriptor ConfigDescriptor { get; set; }
	...
	public PreviewDataFrameAnalyticsRequestDescriptor Config(Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframePreviewConfigDescriptor descriptor)
	{
		ConfigValue = null;
		ConfigDescriptorAction = null;
		ConfigDescriptor = descriptor;
	...
	public PreviewDataFrameAnalyticsRequestDescriptor Config(Action<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframePreviewConfigDescriptor> configure)
	{
		ConfigValue = null;
		ConfigDescriptor = null;
		ConfigDescriptorAction = configure;
	...
	protected override void Serialize(Utf8JsonWriter writer, JsonSerializerOptions options, IElasticsearchClientSettings settings)
	{
		...
		{
			writer.WritePropertyName("config");
			JsonSerializer.Serialize(writer, new Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframePreviewConfigDescriptor(ConfigDescriptorAction), options);
		}
		else if (ConfigValue is not null)
		{
			writer.WritePropertyName("config");
