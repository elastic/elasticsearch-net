...
{
	public PutFilterRequest(Elastic.Clients.Elasticsearch.Serverless.Id filterId) : base(r => r.Required("filter_id", filterId))
	{
	}
...
public sealed partial class PutFilterRequestDescriptor : RequestDescriptor<PutFilterRequestDescriptor, PutFilterRequestParameters>
{
	...
	public PutFilterRequestDescriptor(Elastic.Clients.Elasticsearch.Serverless.Id filterId) : base(r => r.Required("filter_id", filterId))
	{
	}
	...
	public PutFilterRequestDescriptor FilterId(Elastic.Clients.Elasticsearch.Serverless.Id filterId)
	{
