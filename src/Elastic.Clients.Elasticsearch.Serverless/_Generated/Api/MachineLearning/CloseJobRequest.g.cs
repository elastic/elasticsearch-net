...
{
	public CloseJobRequest(Elastic.Clients.Elasticsearch.Serverless.Id jobId) : base(r => r.Required("job_id", jobId))
	{
	}
...
public sealed partial class CloseJobRequestDescriptor : RequestDescriptor<CloseJobRequestDescriptor, CloseJobRequestParameters>
{
	...
	public CloseJobRequestDescriptor(Elastic.Clients.Elasticsearch.Serverless.Id jobId) : base(r => r.Required("job_id", jobId))
	{
	}
	...
	public CloseJobRequestDescriptor JobId(Elastic.Clients.Elasticsearch.Serverless.Id jobId)
	{
