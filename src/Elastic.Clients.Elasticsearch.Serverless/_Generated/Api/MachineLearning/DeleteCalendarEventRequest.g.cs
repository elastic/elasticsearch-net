...
{
	public DeleteCalendarEventRequest(Elastic.Clients.Elasticsearch.Serverless.Id calendarId, Elastic.Clients.Elasticsearch.Serverless.Id eventId) : base(r => r.Required("calendar_id", calendarId).Required("event_id", eventId))
	{
	}
...
public sealed partial class DeleteCalendarEventRequestDescriptor : RequestDescriptor<DeleteCalendarEventRequestDescriptor, DeleteCalendarEventRequestParameters>
{
	...
	public DeleteCalendarEventRequestDescriptor(Elastic.Clients.Elasticsearch.Serverless.Id calendarId, Elastic.Clients.Elasticsearch.Serverless.Id eventId) : base(r => r.Required("calendar_id", calendarId).Required("event_id", eventId))
	{
	}
	...
	public DeleteCalendarEventRequestDescriptor CalendarId(Elastic.Clients.Elasticsearch.Serverless.Id calendarId)
	{
		RouteValues.Required("calendar_id", calendarId);
		return Self;
	}

	public DeleteCalendarEventRequestDescriptor EventId(Elastic.Clients.Elasticsearch.Serverless.Id eventId)
	{
