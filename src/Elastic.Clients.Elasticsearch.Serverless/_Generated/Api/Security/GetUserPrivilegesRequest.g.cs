...
public sealed partial class GetUserPrivilegesRequestParameters : RequestParameters
{
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Serverless.Name? Application { get => Q<Elastic.Clients.Elasticsearch.Serverless.Name?>("application"); set => Q("application", value); }
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Serverless.Name? Priviledge { get => Q<Elastic.Clients.Elasticsearch.Serverless.Name?>("priviledge"); set => Q("priviledge", value); }
	public Elastic.Clients.Elasticsearch.Serverless.Name? Username { get => Q<Elastic.Clients.Elasticsearch.Serverless.Name?>("username"); set => Q("username", value); }
}
