...
public sealed partial class BulkPutRoleRequest : PlainRequest<BulkPutRoleRequestParameters>
{
	...
	public IDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Security.RoleDescriptor> Roles { get; set; }
}
...
public sealed partial class BulkPutRoleRequestDescriptor<TDocument> : RequestDescriptor<BulkPutRoleRequestDescriptor<TDocument>, BulkPutRoleRequestParameters>
{
	...
	public BulkPutRoleRequestDescriptor<TDocument> Refresh(Elastic.Clients.Elasticsearch.Serverless.Refresh? refresh) => Qs("refresh", refresh);

	private IDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Security.RoleDescriptorDescriptor<TDocument>> RolesValue { get; set; }
	...
	/// </para>
	/// </summary>
	public BulkPutRoleRequestDescriptor<TDocument> Roles(Func<FluentDescriptorDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Security.RoleDescriptorDescriptor<TDocument>>, FluentDescriptorDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Security.RoleDescriptorDescriptor<TDocument>>> selector)
	{
		RolesValue = selector?.Invoke(new FluentDescriptorDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Security.RoleDescriptorDescriptor<TDocument>>());
		return Self;
	}
...
public sealed partial class BulkPutRoleRequestDescriptor : RequestDescriptor<BulkPutRoleRequestDescriptor, BulkPutRoleRequestParameters>
{
	...
	private IDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Security.RoleDescriptorDescriptor> RolesValue { get; set; }
	...
	/// </para>
	/// </summary>
	public BulkPutRoleRequestDescriptor Roles(Func<FluentDescriptorDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Security.RoleDescriptorDescriptor>, FluentDescriptorDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Security.RoleDescriptorDescriptor>> selector)
	{
		RolesValue = selector?.Invoke(new FluentDescriptorDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Security.RoleDescriptorDescriptor>());
		return Self;
	}
