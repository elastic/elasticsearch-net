...
{
	public GetTasksRequest(Elastic.Clients.Elasticsearch.Serverless.Id task_id) : base(r => r.Required("task_id", task_id))
	{
	}
...
public sealed partial class GetTasksRequestDescriptor : RequestDescriptor<GetTasksRequestDescriptor, GetTasksRequestParameters>
{
	...
	public GetTasksRequestDescriptor(Elastic.Clients.Elasticsearch.Serverless.Id task_id) : base(r => r.Required("task_id", task_id))
	{
	}
	...
	public GetTasksRequestDescriptor Timeout(Elastic.Clients.Elasticsearch.Serverless.Duration? timeout) => Qs("timeout", timeout);
	public GetTasksRequestDescriptor WaitForCompletion(bool? waitForCompletion = true) => Qs("wait_for_completion", waitForCompletion);

	public GetTasksRequestDescriptor TaskId(Elastic.Clients.Elasticsearch.Serverless.Id task_id)
	{
