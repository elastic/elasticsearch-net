...
public sealed partial class DocumentRatingDescriptor : SerializableDescriptor<DocumentRatingDescriptor>
{
	...
	/// <para>The document ID.</para>
	/// </summary>
	public DocumentRatingDescriptor Id(Elastic.Clients.Elasticsearch.Serverless.Id id)
	{
		IdValue = id;
		return Self;
	}
	...
	/// <para>The document’s index. For data streams, this should be the document’s backing index.</para>
	/// </summary>
	public DocumentRatingDescriptor Index(Elastic.Clients.Elasticsearch.Serverless.IndexName index)
	{
		IndexValue = index;
		return Self;
	}
