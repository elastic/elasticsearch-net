...
public sealed partial class PhraseSuggestCollateDescriptor : SerializableDescriptor<PhraseSuggestCollateDescriptor>
{
	...
	private Elastic.Clients.Elasticsearch.Serverless.Core.Search.PhraseSuggestCollateQueryDescriptor QueryDescriptor { get; set; }
	...
	public PhraseSuggestCollateDescriptor Query(Elastic.Clients.Elasticsearch.Serverless.Core.Search.PhraseSuggestCollateQueryDescriptor descriptor)
	{
		QueryValue = null;
		QueryDescriptorAction = null;
	...
	public PhraseSuggestCollateDescriptor Query(Action<Elastic.Clients.Elasticsearch.Serverless.Core.Search.PhraseSuggestCollateQueryDescriptor> configure)
	{
		QueryValue = null;
		QueryDescriptor = null;
	...
	protected override void Serialize(Utf8JsonWriter writer, JsonSerializerOptions options, IElasticsearchClientSettings settings)
	{
		...
		{
			writer.WritePropertyName("query");
			JsonSerializer.Serialize(writer, new Elastic.Clients.Elasticsearch.Serverless.Core.Search.PhraseSuggestCollateQueryDescriptor(QueryDescriptorAction), options);
		}
		else
		{
			writer.WritePropertyName("query");
