...
public sealed partial class CompletionSuggester
{
	...
	public IDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, ICollection<Elastic.Clients.Elasticsearch.Serverless.Core.Search.CompletionContext>>? Contexts { get; set; }
...
public sealed partial class CompletionSuggesterDescriptor<TDocument> : SerializableDescriptor<CompletionSuggesterDescriptor<TDocument>>
{
	...
	private IDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, ICollection<Elastic.Clients.Elasticsearch.Serverless.Core.Search.CompletionContext>>? ContextsValue { get; set; }
	...
	/// <para>A value, geo point object, or a geo hash string to filter or boost the suggestion on.</para>
	/// </summary>
	public CompletionSuggesterDescriptor<TDocument> Contexts(Func<FluentDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, ICollection<Elastic.Clients.Elasticsearch.Serverless.Core.Search.CompletionContext>>, FluentDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, ICollection<Elastic.Clients.Elasticsearch.Serverless.Core.Search.CompletionContext>>> selector)
	{
		ContextsValue = selector?.Invoke(new FluentDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, ICollection<Elastic.Clients.Elasticsearch.Serverless.Core.Search.CompletionContext>>());
		return Self;
	}
