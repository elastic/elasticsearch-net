...
public sealed partial class Highlight
{
	...
	public Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlighterEncoder? Encoder { get; set; }
	[JsonInclude, JsonPropertyName("fields")]
	public IDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlightField> Fields { get; set; }
...
public sealed partial class HighlightDescriptor<TDocument> : SerializableDescriptor<HighlightDescriptor<TDocument>>
{
	...
	private Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlighterEncoder? EncoderValue { get; set; }
	private IDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlightFieldDescriptor<TDocument>> FieldsValue { get; set; }
	...
	/// <para>Specifies how to break the highlighted fragments: chars, sentence, or word.<br/>Only valid for the unified and fvh highlighters.<br/>Defaults to `sentence` for the `unified` highlighter. Defaults to `chars` for the `fvh` highlighter.</para>
	/// </summary>
	public HighlightDescriptor<TDocument> BoundaryScanner(Elastic.Clients.Elasticsearch.Serverless.Core.Search.BoundaryScanner? boundaryScanner)
	{
	...
	public HighlightDescriptor<TDocument> Encoder(Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlighterEncoder? encoder)
	{
		EncoderValue = encoder;
		return Self;
	}

	public HighlightDescriptor<TDocument> Fields(Func<FluentDescriptorDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlightFieldDescriptor<TDocument>>, FluentDescriptorDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlightFieldDescriptor<TDocument>>> selector)
	{
		FieldsValue = selector?.Invoke(new FluentDescriptorDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlightFieldDescriptor<TDocument>>());
		return Self;
	}
	...
	/// <para>Specifies how text should be broken up in highlight snippets: `simple` or `span`.<br/>Only valid for the `plain` highlighter.</para>
	/// </summary>
	public HighlightDescriptor<TDocument> Fragmenter(Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlighterFragmenter? fragmenter)
	{
	...
	/// <para>Highlight matches for a query other than the search query.<br/>This is especially useful if you use a rescore query because those are not taken into account by highlighting by default.</para>
	/// </summary>
	public HighlightDescriptor<TDocument> HighlightQuery(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query? highlightQuery)
	{
	...
	public HighlightDescriptor<TDocument> HighlightQuery(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.QueryDescriptor<TDocument> descriptor)
	{
	...
	public HighlightDescriptor<TDocument> HighlightQuery(Action<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.QueryDescriptor<TDocument>> configure)
	{
		HighlightQueryValue = null;
		HighlightQueryDescriptor = null;
	...
	/// <para>Sorts highlighted fragments by score when set to `score`.<br/>By default, fragments will be output in the order they appear in the field (order: `none`).<br/>Setting this option to `score` will output the most relevant fragments first.<br/>Each highlighter applies its own logic to compute relevancy scores.</para>
	/// </summary>
	public HighlightDescriptor<TDocument> Order(Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlighterOrder? order)
	{
		OrderValue = order;
		return Self;
	}
	...
	/// <para>Set to `styled` to use the built-in tag schema.</para>
	/// </summary>
	public HighlightDescriptor<TDocument> TagsSchema(Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlighterTagsSchema? tagsSchema)
	{
		TagsSchemaValue = tagsSchema;
		return Self;
	}

	public HighlightDescriptor<TDocument> Type(Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlighterType? type)
	{
		TypeValue = type;
		return Self;
	}
...
public sealed partial class HighlightDescriptor : SerializableDescriptor<HighlightDescriptor>
{
	...
	private string? BoundaryScannerLocaleValue { get; set; }
	private Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlighterEncoder? EncoderValue { get; set; }
	private IDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlightFieldDescriptor> FieldsValue { get; set; }
	private Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlighterFragmenter? FragmenterValue { get; set; }
	private int? FragmentSizeValue { get; set; }
	private bool? HighlightFilterValue { get; set; }
	private Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query? HighlightQueryValue { get; set; }
	...
	/// <para>Specifies how to break the highlighted fragments: chars, sentence, or word.<br/>Only valid for the unified and fvh highlighters.<br/>Defaults to `sentence` for the `unified` highlighter. Defaults to `chars` for the `fvh` highlighter.</para>
	/// </summary>
	public HighlightDescriptor BoundaryScanner(Elastic.Clients.Elasticsearch.Serverless.Core.Search.BoundaryScanner? boundaryScanner)
	{
		BoundaryScannerValue = boundaryScanner;
		return Self;
	}
	...
	public HighlightDescriptor Encoder(Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlighterEncoder? encoder)
	{
		EncoderValue = encoder;
		return Self;
	}

	public HighlightDescriptor Fields(Func<FluentDescriptorDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlightFieldDescriptor>, FluentDescriptorDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlightFieldDescriptor>> selector)
	{
		FieldsValue = selector?.Invoke(new FluentDescriptorDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlightFieldDescriptor>());
		return Self;
	}
	...
	/// <para>Specifies how text should be broken up in highlight snippets: `simple` or `span`.<br/>Only valid for the `plain` highlighter.</para>
	/// </summary>
	public HighlightDescriptor Fragmenter(Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlighterFragmenter? fragmenter)
	{
		FragmenterValue = fragmenter;
		return Self;
	}
	...
	/// <para>Highlight matches for a query other than the search query.<br/>This is especially useful if you use a rescore query because those are not taken into account by highlighting by default.</para>
	/// </summary>
	public HighlightDescriptor HighlightQuery(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query? highlightQuery)
	{
		HighlightQueryDescriptor = null;
		HighlightQueryDescriptorAction = null;
		HighlightQueryValue = highlightQuery;
	...
	public HighlightDescriptor HighlightQuery(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.QueryDescriptor descriptor)
	{
		HighlightQueryValue = null;
		HighlightQueryDescriptorAction = null;
		HighlightQueryDescriptor = descriptor;
	...
	public HighlightDescriptor HighlightQuery(Action<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.QueryDescriptor> configure)
	{
		HighlightQueryValue = null;
		HighlightQueryDescriptor = null;
		HighlightQueryDescriptorAction = configure;
	...
	/// <para>Sorts highlighted fragments by score when set to `score`.<br/>By default, fragments will be output in the order they appear in the field (order: `none`).<br/>Setting this option to `score` will output the most relevant fragments first.<br/>Each highlighter applies its own logic to compute relevancy scores.</para>
	/// </summary>
	public HighlightDescriptor Order(Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlighterOrder? order)
	{
		OrderValue = order;
		return Self;
	}
	...
	/// <para>Set to `styled` to use the built-in tag schema.</para>
	/// </summary>
	public HighlightDescriptor TagsSchema(Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlighterTagsSchema? tagsSchema)
	{
		TagsSchemaValue = tagsSchema;
		return Self;
	}

	public HighlightDescriptor Type(Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlighterType? type)
	{
		TypeValue = type;
		return Self;
	}
