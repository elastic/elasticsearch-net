...
public sealed partial class HighlightDescriptor<TDocument> : SerializableDescriptor<HighlightDescriptor<TDocument>>
{
	...
	private IDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlightField> FieldsValue { get; set; }
	...
	public HighlightDescriptor<TDocument> Fields(Func<FluentDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlightField>, FluentDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlightField>> selector)
	{
		FieldsValue = selector?.Invoke(new FluentDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlightField>());
		return Self;
	}
