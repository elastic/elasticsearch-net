...
public sealed partial class QueryProfile
{
	...
	public Elastic.Clients.Elasticsearch.Serverless.Core.Search.QueryBreakdown Breakdown { get; init; }
	[JsonInclude, JsonPropertyName("children")]
	public IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Core.Search.QueryProfile>? Children { get; init; }
