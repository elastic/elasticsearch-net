...
internal sealed partial class ChildrenAggregateConverter : JsonConverter<ChildrenAggregate>
{
	public override ChildrenAggregate Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
	{
		...
		return new ChildrenAggregate { Aggregations = new Elastic.Clients.Elasticsearch.Serverless.Aggregations.AggregateDictionary(additionalProperties), DocCount = docCount, Meta = meta };
	}
