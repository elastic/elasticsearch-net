...
internal sealed partial class GlobalAggregateConverter : JsonConverter<GlobalAggregate>
{
	public override GlobalAggregate Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
	{
		...
		return new GlobalAggregate { Aggregations = new Elastic.Clients.Elasticsearch.Serverless.Aggregations.AggregateDictionary(additionalProperties), DocCount = docCount, Meta = meta };
	}

	public override void Write(Utf8JsonWriter writer, GlobalAggregate value, JsonSerializerOptions options)
	{
		throw new NotImplementedException("'GlobalAggregate' is a readonly type, used only on responses and does not support being written to JSON.");
	}
}
