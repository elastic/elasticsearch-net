...
public sealed partial class SamplerAggregate : AggregateDictionary, IAggregate
{
	public SamplerAggregate(IReadOnlyDictionary<string, IAggregate> backingDictionary) : base(backingDictionary)
	{
	}
...
internal sealed class SamplerAggregateConverter : JsonConverter<SamplerAggregate>
{
	public override SamplerAggregate? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
	{
		...
		return new SamplerAggregate(subAggs) { DocCount = docCount, Meta = meta };
	}
