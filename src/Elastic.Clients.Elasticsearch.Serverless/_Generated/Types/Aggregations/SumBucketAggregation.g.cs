...
public sealed partial class SumBucketAggregation
{
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.Aggregations.Aggregation(SumBucketAggregation sumBucketAggregation) => Elastic.Clients.Elasticsearch.Serverless.Aggregations.Aggregation.SumBucket(sumBucketAggregation);
}

public sealed partial class SumBucketAggregationDescriptor : SerializableDescriptor<SumBucketAggregationDescriptor>
{
	internal SumBucketAggregationDescriptor(Action<SumBucketAggregationDescriptor> configure) => configure.Invoke(this);

	public SumBucketAggregationDescriptor() : base()
	{
	}
	...
	/// <para>Path to the buckets that contain one set of values to correlate.</para>
	/// </summary>
	public SumBucketAggregationDescriptor BucketsPath(Elastic.Clients.Elasticsearch.Serverless.Aggregations.BucketsPath? bucketsPath)
	{
	...
	/// <para>`DecimalFormat` pattern for the output value.<br/>If specified, the formatted value is returned in the aggregation’s `value_as_string` property.</para>
	/// </summary>
	public SumBucketAggregationDescriptor Format(string? format)
	{
		FormatValue = format;
		return Self;
	}
	...
	/// <para>Policy to apply when gaps are found in the data.</para>
	/// </summary>
	public SumBucketAggregationDescriptor GapPolicy(Elastic.Clients.Elasticsearch.Serverless.Aggregations.GapPolicy? gapPolicy)
	{
		GapPolicyValue = gapPolicy;
		return Self;
	}

	public SumBucketAggregationDescriptor Meta(Func<FluentDictionary<string, object>, FluentDictionary<string, object>> selector)
	{
		MetaValue = selector?.Invoke(new FluentDictionary<string, object>());
		return Self;
	}

	public SumBucketAggregationDescriptor Name(string? name)
	{
		NameValue = name;
		return Self;
	}
