...
public sealed partial class CompositeTermsAggregationDescriptor<TDocument> : SerializableDescriptor<CompositeTermsAggregationDescriptor<TDocument>>
{
	...
	public CompositeTermsAggregationDescriptor<TDocument> MissingOrder(Elastic.Clients.Elasticsearch.Serverless.Aggregations.MissingOrder? missingOrder)
	{
		MissingOrderValue = missingOrder;
		return Self;
	}

	public CompositeTermsAggregationDescriptor<TDocument> Order(Elastic.Clients.Elasticsearch.Serverless.SortOrder? order)
	{
		OrderValue = order;
		return Self;
	}
	...
	public CompositeTermsAggregationDescriptor<TDocument> ValueType(Elastic.Clients.Elasticsearch.Serverless.Aggregations.ValueType? valueType)
	{
...
public sealed partial class CompositeTermsAggregationDescriptor : SerializableDescriptor<CompositeTermsAggregationDescriptor>
{
	...
	public CompositeTermsAggregationDescriptor MissingOrder(Elastic.Clients.Elasticsearch.Serverless.Aggregations.MissingOrder? missingOrder)
	{
		MissingOrderValue = missingOrder;
		return Self;
	}

	public CompositeTermsAggregationDescriptor Order(Elastic.Clients.Elasticsearch.Serverless.SortOrder? order)
	{
		OrderValue = order;
		return Self;
	}
	...
	public CompositeTermsAggregationDescriptor ValueType(Elastic.Clients.Elasticsearch.Serverless.Aggregations.ValueType? valueType)
	{
		ValueTypeValue = valueType;
		return Self;
	}
