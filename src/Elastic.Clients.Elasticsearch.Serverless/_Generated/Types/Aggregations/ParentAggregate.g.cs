...
internal sealed partial class ParentAggregateConverter : JsonConverter<ParentAggregate>
{
	public override ParentAggregate Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
	{
		...
		return new ParentAggregate { Aggregations = new Elastic.Clients.Elasticsearch.Serverless.Aggregations.AggregateDictionary(additionalProperties), DocCount = docCount, Meta = meta };
	}

	public override void Write(Utf8JsonWriter writer, ParentAggregate value, JsonSerializerOptions options)
	{
		throw new NotImplementedException("'ParentAggregate' is a readonly type, used only on responses and does not support being written to JSON.");
	}
}
