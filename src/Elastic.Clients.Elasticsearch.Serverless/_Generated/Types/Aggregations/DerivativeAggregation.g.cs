...
public sealed partial class DerivativeAggregation
{
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.Aggregations.Aggregation(DerivativeAggregation derivativeAggregation) => Elastic.Clients.Elasticsearch.Serverless.Aggregations.Aggregation.Derivative(derivativeAggregation);
}
...
public sealed partial class DerivativeAggregationDescriptor : SerializableDescriptor<DerivativeAggregationDescriptor>
{
	...
	/// <para>Path to the buckets that contain one set of values to correlate.</para>
	/// </summary>
	public DerivativeAggregationDescriptor BucketsPath(Elastic.Clients.Elasticsearch.Serverless.Aggregations.BucketsPath? bucketsPath)
	{
	...
	/// <para>Policy to apply when gaps are found in the data.</para>
	/// </summary>
	public DerivativeAggregationDescriptor GapPolicy(Elastic.Clients.Elasticsearch.Serverless.Aggregations.GapPolicy? gapPolicy)
	{
	...
	public DerivativeAggregationDescriptor Name(string? name)
	{
		NameValue = name;
		return Self;
	}
