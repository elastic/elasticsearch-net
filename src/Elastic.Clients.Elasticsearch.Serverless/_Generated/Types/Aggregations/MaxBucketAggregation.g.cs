...
public sealed partial class MaxBucketAggregation
{
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.Aggregations.Aggregation(MaxBucketAggregation maxBucketAggregation) => Elastic.Clients.Elasticsearch.Serverless.Aggregations.Aggregation.MaxBucket(maxBucketAggregation);
}
...
public sealed partial class MaxBucketAggregationDescriptor : SerializableDescriptor<MaxBucketAggregationDescriptor>
{
	...
	/// <para>Path to the buckets that contain one set of values to correlate.</para>
	/// </summary>
	public MaxBucketAggregationDescriptor BucketsPath(Elastic.Clients.Elasticsearch.Serverless.Aggregations.BucketsPath? bucketsPath)
	{
	...
	/// <para>Policy to apply when gaps are found in the data.</para>
	/// </summary>
	public MaxBucketAggregationDescriptor GapPolicy(Elastic.Clients.Elasticsearch.Serverless.Aggregations.GapPolicy? gapPolicy)
	{
		GapPolicyValue = gapPolicy;
		return Self;
	}

	public MaxBucketAggregationDescriptor Meta(Func<FluentDictionary<string, object>, FluentDictionary<string, object>> selector)
	{
		MetaValue = selector?.Invoke(new FluentDictionary<string, object>());
		return Self;
	}

	public MaxBucketAggregationDescriptor Name(string? name)
	{
		NameValue = name;
		return Self;
	}
