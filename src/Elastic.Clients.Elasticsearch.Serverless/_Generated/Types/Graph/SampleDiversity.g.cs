...
public sealed partial class SampleDiversityDescriptor<TDocument> : SerializableDescriptor<SampleDiversityDescriptor<TDocument>>
{
	...
	public SampleDiversityDescriptor<TDocument> Field(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		FieldValue = field;
		return Self;
	}
...
public sealed partial class SampleDiversityDescriptor : SerializableDescriptor<SampleDiversityDescriptor>
{
	...
	public SampleDiversityDescriptor Field(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		FieldValue = field;
		return Self;
	}
