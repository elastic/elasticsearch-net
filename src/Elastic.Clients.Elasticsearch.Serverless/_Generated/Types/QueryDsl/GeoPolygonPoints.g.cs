...
public sealed partial class GeoPolygonPoints
{
	...
	public ICollection<Elastic.Clients.Elasticsearch.Serverless.GeoLocation> Points { get; set; }
}
...
public sealed partial class GeoPolygonPointsDescriptor : SerializableDescriptor<GeoPolygonPointsDescriptor>
{
	...
	private ICollection<Elastic.Clients.Elasticsearch.Serverless.GeoLocation> PointsValue { get; set; }

	public GeoPolygonPointsDescriptor Points(ICollection<Elastic.Clients.Elasticsearch.Serverless.GeoLocation> points)
	{
		PointsValue = points;
		return Self;
	}
