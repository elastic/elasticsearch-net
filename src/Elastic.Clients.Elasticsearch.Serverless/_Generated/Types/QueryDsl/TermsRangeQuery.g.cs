...
{
	public TermsRangeQuery(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		if (field is null)
...
public sealed partial class TermsRangeQueryDescriptor<TDocument> : SerializableDescriptor<TermsRangeQueryDescriptor<TDocument>>
{
	...
	public TermsRangeQueryDescriptor<TDocument> Field(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		FieldValue = field;
		return Self;
	}
	...
	/// <para>Indicates how the range query matches values for `range` fields.</para>
	/// </summary>
	public TermsRangeQueryDescriptor<TDocument> Relation(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.RangeRelation? relation)
	{
...
public sealed partial class TermsRangeQueryDescriptor : SerializableDescriptor<TermsRangeQueryDescriptor>
{
	...
	public TermsRangeQueryDescriptor Field(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		FieldValue = field;
		return Self;
	}
	...
	/// <para>Indicates how the range query matches values for `range` fields.</para>
	/// </summary>
	public TermsRangeQueryDescriptor Relation(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.RangeRelation? relation)
	{
		RelationValue = relation;
		return Self;
	}
