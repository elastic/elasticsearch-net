...
public sealed partial class MatchQueryDescriptor<TDocument> : SerializableDescriptor<MatchQueryDescriptor<TDocument>>
{
	...
	/// <para>Boolean logic used to interpret text in the query value.</para>
	/// </summary>
	public MatchQueryDescriptor<TDocument> Operator(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Operator? op)
	{
		OperatorValue = op;
		return Self;
	}
...
public sealed partial class MatchQueryDescriptor : SerializableDescriptor<MatchQueryDescriptor>
{
	...
	/// <para>Boolean logic used to interpret text in the query value.</para>
	/// </summary>
	public MatchQueryDescriptor Operator(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Operator? op)
	{
		OperatorValue = op;
		return Self;
	}
