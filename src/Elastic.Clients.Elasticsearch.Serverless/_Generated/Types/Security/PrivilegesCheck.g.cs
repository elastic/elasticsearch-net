...
public sealed partial class PrivilegesCheckDescriptor : SerializableDescriptor<PrivilegesCheckDescriptor>
{
	...
	public PrivilegesCheckDescriptor Application(ICollection<Elastic.Clients.Elasticsearch.Serverless.Security.ApplicationPrivilegesCheck>? application)
	{
	...
	public PrivilegesCheckDescriptor Application(Elastic.Clients.Elasticsearch.Serverless.Security.ApplicationPrivilegesCheckDescriptor descriptor)
	{
	...
	public PrivilegesCheckDescriptor Application(Action<Elastic.Clients.Elasticsearch.Serverless.Security.ApplicationPrivilegesCheckDescriptor> configure)
	{
		ApplicationValue = null;
		ApplicationDescriptor = null;
		ApplicationDescriptorActions = null;
	...
	public PrivilegesCheckDescriptor Application(params Action<Elastic.Clients.Elasticsearch.Serverless.Security.ApplicationPrivilegesCheckDescriptor>[] configure)
	{
		ApplicationValue = null;
		ApplicationDescriptor = null;
		ApplicationDescriptorAction = null;
	...
	/// </para>
	/// </summary>
	public PrivilegesCheckDescriptor Cluster(ICollection<Elastic.Clients.Elasticsearch.Serverless.Security.ClusterPrivilege>? cluster)
	{
		ClusterValue = cluster;
		return Self;
	}

	public PrivilegesCheckDescriptor Index(ICollection<Elastic.Clients.Elasticsearch.Serverless.Security.IndexPrivilegesCheck>? index)
	{
	...
	public PrivilegesCheckDescriptor Index(Elastic.Clients.Elasticsearch.Serverless.Security.IndexPrivilegesCheckDescriptor descriptor)
	{
		IndexValue = null;
		IndexDescriptorAction = null;
		IndexDescriptorActions = null;
	...
	public PrivilegesCheckDescriptor Index(Action<Elastic.Clients.Elasticsearch.Serverless.Security.IndexPrivilegesCheckDescriptor> configure)
	{
		IndexValue = null;
		IndexDescriptor = null;
		IndexDescriptorActions = null;
	...
	public PrivilegesCheckDescriptor Index(params Action<Elastic.Clients.Elasticsearch.Serverless.Security.IndexPrivilegesCheckDescriptor>[] configure)
	{
		IndexValue = null;
		IndexDescriptor = null;
		IndexDescriptorAction = null;
