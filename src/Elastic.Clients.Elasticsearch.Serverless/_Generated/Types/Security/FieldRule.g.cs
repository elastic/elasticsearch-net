...
internal sealed partial class FieldRuleConverter : JsonConverter<FieldRule>
{
	public override FieldRule Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
	{
		...
		while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
		{
			...
			if (propertyName == "dn")
			{
				variantValue = JsonSerializer.Deserialize<Elastic.Clients.Elasticsearch.Serverless.Names?>(ref reader, options);
	...
	public override void Write(Utf8JsonWriter writer, FieldRule value, JsonSerializerOptions options)
	{
		...
		if (value.VariantName is not null && value.Variant is not null)
		{
			...
			{
				case "dn":
					JsonSerializer.Serialize<Elastic.Clients.Elasticsearch.Serverless.Names>(writer, (Elastic.Clients.Elasticsearch.Serverless.Names)value.Variant, options);
					break;
				case "groups":
					JsonSerializer.Serialize<Elastic.Clients.Elasticsearch.Serverless.Names>(writer, (Elastic.Clients.Elasticsearch.Serverless.Names)value.Variant, options);
					break;
