...
public sealed partial class IndicesPrivilegesDescriptor<TDocument> : SerializableDescriptor<IndicesPrivilegesDescriptor<TDocument>>
{
	...
	/// </para>
	/// </summary>
	public IndicesPrivilegesDescriptor<TDocument> Names(Elastic.Clients.Elasticsearch.Serverless.Indices names)
	{
		NamesValue = names;
		return Self;
	}
...
public sealed partial class IndicesPrivilegesDescriptor : SerializableDescriptor<IndicesPrivilegesDescriptor>
{
	...
	/// </para>
	/// </summary>
	public IndicesPrivilegesDescriptor Names(Elastic.Clients.Elasticsearch.Serverless.Indices names)
	{
		NamesValue = names;
		return Self;
	}
