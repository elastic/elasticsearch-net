...
internal sealed partial class RankConverter : JsonConverter<Rank>
{
	...
	public override void Write(Utf8JsonWriter writer, Rank value, JsonSerializerOptions options)
	{
		...
		if (value.VariantName is not null & value.Variant is not null)
		{
			...
			{
				case "rrf":
					JsonSerializer.Serialize<Elastic.Clients.Elasticsearch.Serverless.RrfRank>(writer, (Elastic.Clients.Elasticsearch.Serverless.RrfRank)value.Variant, options);
					break;
			}
		}
