...
internal sealed partial class NodeJvmInfoConverter : JsonConverter<NodeJvmInfo>
{
	public override NodeJvmInfo Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
	{
		...
		Elastic.Clients.Elasticsearch.Serverless.Nodes.NodeInfoJvmMemory mem = default;
		...
		while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
		{
			if (reader.TokenType == JsonTokenType.PropertyName)
			{
				...
				if (property == "mem")
				{
					mem = JsonSerializer.Deserialize<Elastic.Clients.Elasticsearch.Serverless.Nodes.NodeInfoJvmMemory>(ref reader, options);
					continue;
				}
