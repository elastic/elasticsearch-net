...
public sealed partial class IoStats
{
	...
	public IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Nodes.IoStatDevice>? Devices { get; init; }

	/// <summary>
	/// <para>The sum of the disk metrics for all devices that back an Elasticsearch data path.</para>
	/// </summary>
	[JsonInclude, JsonPropertyName("total")]
	public Elastic.Clients.Elasticsearch.Serverless.Nodes.IoStatDevice? Total { get; init; }
}