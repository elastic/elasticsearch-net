...
public sealed partial class Ingest
{
	...
	public IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Nodes.IngestTotal>? Pipelines { get; init; }

	/// <summary>
	/// <para>Contains statistics about ingest operations for the node.</para>
	/// </summary>
	[JsonInclude, JsonPropertyName("total")]
	public Elastic.Clients.Elasticsearch.Serverless.Nodes.IngestTotal? Total { get; init; }
}