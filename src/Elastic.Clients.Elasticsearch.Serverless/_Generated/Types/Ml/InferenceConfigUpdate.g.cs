...
public sealed partial class InferenceConfigUpdate
{
	...
	public static InferenceConfigUpdate Classification(Elastic.Clients.Elasticsearch.Serverless.Ml.ClassificationInferenceOptions classificationInferenceOptions) => new InferenceConfigUpdate("classification", classificationInferenceOptions);
	public static InferenceConfigUpdate FillMask(Elastic.Clients.Elasticsearch.Serverless.Ml.FillMaskInferenceUpdateOptions fillMaskInferenceUpdateOptions) => new InferenceConfigUpdate("fill_mask", fillMaskInferenceUpdateOptions);
	public static InferenceConfigUpdate Ner(Elastic.Clients.Elasticsearch.Serverless.Ml.NerInferenceUpdateOptions nerInferenceUpdateOptions) => new InferenceConfigUpdate("ner", nerInferenceUpdateOptions);
	public static InferenceConfigUpdate PassThrough(Elastic.Clients.Elasticsearch.Serverless.Ml.PassThroughInferenceUpdateOptions passThroughInferenceUpdateOptions) => new InferenceConfigUpdate("pass_through", passThroughInferenceUpdateOptions);
	public static InferenceConfigUpdate QuestionAnswering(Elastic.Clients.Elasticsearch.Serverless.Ml.QuestionAnsweringInferenceUpdateOptions questionAnsweringInferenceUpdateOptions) => new InferenceConfigUpdate("question_answering", questionAnsweringInferenceUpdateOptions);
	public static InferenceConfigUpdate Regression(Elastic.Clients.Elasticsearch.Serverless.Ml.RegressionInferenceOptions regressionInferenceOptions) => new InferenceConfigUpdate("regression", regressionInferenceOptions);
	public static InferenceConfigUpdate TextClassification(Elastic.Clients.Elasticsearch.Serverless.Ml.TextClassificationInferenceUpdateOptions textClassificationInferenceUpdateOptions) => new InferenceConfigUpdate("text_classification", textClassificationInferenceUpdateOptions);
	public static InferenceConfigUpdate TextEmbedding(Elastic.Clients.Elasticsearch.Serverless.Ml.TextEmbeddingInferenceUpdateOptions textEmbeddingInferenceUpdateOptions) => new InferenceConfigUpdate("text_embedding", textEmbeddingInferenceUpdateOptions);
	public static InferenceConfigUpdate TextExpansion(Elastic.Clients.Elasticsearch.Serverless.Ml.TextExpansionInferenceUpdateOptions textExpansionInferenceUpdateOptions) => new InferenceConfigUpdate("text_expansion", textExpansionInferenceUpdateOptions);
	public static InferenceConfigUpdate ZeroShotClassification(Elastic.Clients.Elasticsearch.Serverless.Ml.ZeroShotClassificationInferenceUpdateOptions zeroShotClassificationInferenceUpdateOptions) => new InferenceConfigUpdate("zero_shot_classification", zeroShotClassificationInferenceUpdateOptions);
}
...
internal sealed partial class InferenceConfigUpdateConverter : JsonConverter<InferenceConfigUpdate>
{
	public override InferenceConfigUpdate Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
	{
		...
		{
			var variant = JsonSerializer.Deserialize<Elastic.Clients.Elasticsearch.Serverless.Ml.FillMaskInferenceUpdateOptions?>(ref reader, options);
			reader.Read();
			return new InferenceConfigUpdate(propertyName, variant);
		}
		...
		if (propertyName == "ner")
		{
			var variant = JsonSerializer.Deserialize<Elastic.Clients.Elasticsearch.Serverless.Ml.NerInferenceUpdateOptions?>(ref reader, options);
			reader.Read();
			return new InferenceConfigUpdate(propertyName, variant);
		}
		...
		{
			var variant = JsonSerializer.Deserialize<Elastic.Clients.Elasticsearch.Serverless.Ml.PassThroughInferenceUpdateOptions?>(ref reader, options);
			reader.Read();
			return new InferenceConfigUpdate(propertyName, variant);
		}
		...
		{
			var variant = JsonSerializer.Deserialize<Elastic.Clients.Elasticsearch.Serverless.Ml.QuestionAnsweringInferenceUpdateOptions?>(ref reader, options);
			reader.Read();
			return new InferenceConfigUpdate(propertyName, variant);
		}
		...
		{
			var variant = JsonSerializer.Deserialize<Elastic.Clients.Elasticsearch.Serverless.Ml.TextClassificationInferenceUpdateOptions?>(ref reader, options);
			reader.Read();
			return new InferenceConfigUpdate(propertyName, variant);
		}
		...
		{
			var variant = JsonSerializer.Deserialize<Elastic.Clients.Elasticsearch.Serverless.Ml.TextEmbeddingInferenceUpdateOptions?>(ref reader, options);
			reader.Read();
			return new InferenceConfigUpdate(propertyName, variant);
		}
		...
		{
			var variant = JsonSerializer.Deserialize<Elastic.Clients.Elasticsearch.Serverless.Ml.TextExpansionInferenceUpdateOptions?>(ref reader, options);
			reader.Read();
			return new InferenceConfigUpdate(propertyName, variant);
		}
		...
		{
			var variant = JsonSerializer.Deserialize<Elastic.Clients.Elasticsearch.Serverless.Ml.ZeroShotClassificationInferenceUpdateOptions?>(ref reader, options);
			reader.Read();
			return new InferenceConfigUpdate(propertyName, variant);
		}
		...
		if (value.VariantName is not null & value.Variant is not null)
		{
			...
			switch (value.VariantName)
			{
				case "classification":
					...
					break;
				case "fill_mask":
					JsonSerializer.Serialize<Elastic.Clients.Elasticsearch.Serverless.Ml.FillMaskInferenceUpdateOptions>(writer, (Elastic.Clients.Elasticsearch.Serverless.Ml.FillMaskInferenceUpdateOptions)value.Variant, options);
					break;
				case "ner":
					JsonSerializer.Serialize<Elastic.Clients.Elasticsearch.Serverless.Ml.NerInferenceUpdateOptions>(writer, (Elastic.Clients.Elasticsearch.Serverless.Ml.NerInferenceUpdateOptions)value.Variant, options);
					break;
				case "pass_through":
					JsonSerializer.Serialize<Elastic.Clients.Elasticsearch.Serverless.Ml.PassThroughInferenceUpdateOptions>(writer, (Elastic.Clients.Elasticsearch.Serverless.Ml.PassThroughInferenceUpdateOptions)value.Variant, options);
					break;
				case "question_answering":
					JsonSerializer.Serialize<Elastic.Clients.Elasticsearch.Serverless.Ml.QuestionAnsweringInferenceUpdateOptions>(writer, (Elastic.Clients.Elasticsearch.Serverless.Ml.QuestionAnsweringInferenceUpdateOptions)value.Variant, options);
					break;
				case "regression":
				...
				case "text_classification":
					JsonSerializer.Serialize<Elastic.Clients.Elasticsearch.Serverless.Ml.TextClassificationInferenceUpdateOptions>(writer, (Elastic.Clients.Elasticsearch.Serverless.Ml.TextClassificationInferenceUpdateOptions)value.Variant, options);
					break;
				case "text_embedding":
					JsonSerializer.Serialize<Elastic.Clients.Elasticsearch.Serverless.Ml.TextEmbeddingInferenceUpdateOptions>(writer, (Elastic.Clients.Elasticsearch.Serverless.Ml.TextEmbeddingInferenceUpdateOptions)value.Variant, options);
					break;
				case "text_expansion":
					JsonSerializer.Serialize<Elastic.Clients.Elasticsearch.Serverless.Ml.TextExpansionInferenceUpdateOptions>(writer, (Elastic.Clients.Elasticsearch.Serverless.Ml.TextExpansionInferenceUpdateOptions)value.Variant, options);
					break;
				case "zero_shot_classification":
					JsonSerializer.Serialize<Elastic.Clients.Elasticsearch.Serverless.Ml.ZeroShotClassificationInferenceUpdateOptions>(writer, (Elastic.Clients.Elasticsearch.Serverless.Ml.ZeroShotClassificationInferenceUpdateOptions)value.Variant, options);
					break;
			}
		}
