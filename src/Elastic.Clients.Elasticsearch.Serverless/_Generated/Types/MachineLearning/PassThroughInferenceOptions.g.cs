...
public sealed partial class PassThroughInferenceOptions
{
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.MachineLearning.InferenceConfigCreate(PassThroughInferenceOptions passThroughInferenceOptions) => Elastic.Clients.Elasticsearch.Serverless.MachineLearning.InferenceConfigCreate.PassThrough(passThroughInferenceOptions);
}
...
public sealed partial class PassThroughInferenceOptionsDescriptor : SerializableDescriptor<PassThroughInferenceOptionsDescriptor>
{
	...
	/// </para>
	/// </summary>
	public PassThroughInferenceOptionsDescriptor Tokenization(Elastic.Clients.Elasticsearch.Serverless.MachineLearning.TokenizationConfig? tokenization)
	{
	...
	public PassThroughInferenceOptionsDescriptor Tokenization(Elastic.Clients.Elasticsearch.Serverless.MachineLearning.TokenizationConfigDescriptor descriptor)
	{
	...
	public PassThroughInferenceOptionsDescriptor Tokenization(Action<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.TokenizationConfigDescriptor> configure)
	{
		TokenizationValue = null;
		TokenizationDescriptor = null;
	...
	public PassThroughInferenceOptionsDescriptor Vocabulary(Elastic.Clients.Elasticsearch.Serverless.MachineLearning.Vocabulary? vocabulary)
	{
	...
	public PassThroughInferenceOptionsDescriptor Vocabulary(Elastic.Clients.Elasticsearch.Serverless.MachineLearning.VocabularyDescriptor descriptor)
	{
	...
	public PassThroughInferenceOptionsDescriptor Vocabulary(Action<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.VocabularyDescriptor> configure)
	{
		VocabularyValue = null;
		VocabularyDescriptor = null;
