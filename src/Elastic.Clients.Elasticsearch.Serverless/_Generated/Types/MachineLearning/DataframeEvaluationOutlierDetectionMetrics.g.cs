...
public sealed partial class DataframeEvaluationOutlierDetectionMetrics
{
	...
	public Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframeEvaluationClassificationMetricsAucRoc? AucRoc { get; set; }
...
public sealed partial class DataframeEvaluationOutlierDetectionMetricsDescriptor : SerializableDescriptor<DataframeEvaluationOutlierDetectionMetricsDescriptor>
{
	...
	private Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframeEvaluationClassificationMetricsAucRoc? AucRocValue { get; set; }
	private Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframeEvaluationClassificationMetricsAucRocDescriptor AucRocDescriptor { get; set; }
	private Action<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframeEvaluationClassificationMetricsAucRocDescriptor> AucRocDescriptorAction { get; set; }
	...
	/// </para>
	/// </summary>
	public DataframeEvaluationOutlierDetectionMetricsDescriptor AucRoc(Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframeEvaluationClassificationMetricsAucRoc? aucRoc)
	{
	...
	public DataframeEvaluationOutlierDetectionMetricsDescriptor AucRoc(Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframeEvaluationClassificationMetricsAucRocDescriptor descriptor)
	{
		AucRocValue = null;
		AucRocDescriptorAction = null;
	...
	public DataframeEvaluationOutlierDetectionMetricsDescriptor AucRoc(Action<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframeEvaluationClassificationMetricsAucRocDescriptor> configure)
	{
		AucRocValue = null;
		AucRocDescriptor = null;
	...
	protected override void Serialize(Utf8JsonWriter writer, JsonSerializerOptions options, IElasticsearchClientSettings settings)
	{
		...
		{
			writer.WritePropertyName("auc_roc");
			JsonSerializer.Serialize(writer, new Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframeEvaluationClassificationMetricsAucRocDescriptor(AucRocDescriptorAction), options);
		}
