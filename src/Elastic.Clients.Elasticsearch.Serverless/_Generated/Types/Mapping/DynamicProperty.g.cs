...
public sealed partial class DynamicPropertyDescriptor<TDocument> : SerializableDescriptor<DynamicPropertyDescriptor<TDocument>>, IBuildableDescriptor<DynamicProperty>
{
	...
	private Elastic.Clients.Elasticsearch.Serverless.Mapping.TextIndexPrefixes? BuildIndexPrefixes()
	{
		...
		if (IndexPrefixesDescriptor is IBuildableDescriptor<Elastic.Clients.Elasticsearch.Serverless.Mapping.TextIndexPrefixes?> buildable)
		{
		...
		if (IndexPrefixesDescriptorAction is not null)
		{
			...
			if (descriptor is IBuildableDescriptor<Elastic.Clients.Elasticsearch.Serverless.Mapping.TextIndexPrefixes?> buildableFromAction)
			{
