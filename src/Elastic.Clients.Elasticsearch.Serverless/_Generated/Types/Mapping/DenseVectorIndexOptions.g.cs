...
public sealed partial class DenseVectorIndexOptions
{
	...
	public Elastic.Clients.Elasticsearch.Serverless.Mapping.DenseVectorIndexOptionsType Type { get; set; }
}
...
public sealed partial class DenseVectorIndexOptionsDescriptor : SerializableDescriptor<DenseVectorIndexOptionsDescriptor>
{
	...
	private Elastic.Clients.Elasticsearch.Serverless.Mapping.DenseVectorIndexOptionsType TypeValue { get; set; }
	...
	/// </para>
	/// </summary>
	public DenseVectorIndexOptionsDescriptor Type(Elastic.Clients.Elasticsearch.Serverless.Mapping.DenseVectorIndexOptionsType type)
	{
		TypeValue = type;
		return Self;
	}
