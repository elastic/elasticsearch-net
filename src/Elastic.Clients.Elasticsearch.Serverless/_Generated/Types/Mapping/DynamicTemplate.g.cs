...
internal sealed partial class DynamicTemplateConverter : JsonConverter<DynamicTemplate>
{
	public override DynamicTemplate Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
	{
		...
		Elastic.Clients.Elasticsearch.Serverless.Mapping.MatchType? matchPatternValue = default;
		...
		while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
		{
			...
			{
				matchPatternValue = JsonSerializer.Deserialize<Elastic.Clients.Elasticsearch.Serverless.Mapping.MatchType?>(ref reader, options);
				continue;
			}
			...
			{
				variantValue = JsonSerializer.Deserialize<Elastic.Clients.Elasticsearch.Serverless.Mapping.IProperty?>(ref reader, options);
	...
	public override void Write(Utf8JsonWriter writer, DynamicTemplate value, JsonSerializerOptions options)
	{
		...
		if (value.VariantName is not null && value.Variant is not null)
		{
			...
			{
				case "mapping":
					JsonSerializer.Serialize<Elastic.Clients.Elasticsearch.Serverless.Mapping.IProperty>(writer, (Elastic.Clients.Elasticsearch.Serverless.Mapping.IProperty)value.Variant, options);
					break;
				case "runtime":
					JsonSerializer.Serialize<Elastic.Clients.Elasticsearch.Serverless.Mapping.IProperty>(writer, (Elastic.Clients.Elasticsearch.Serverless.Mapping.IProperty)value.Variant, options);
					break;
