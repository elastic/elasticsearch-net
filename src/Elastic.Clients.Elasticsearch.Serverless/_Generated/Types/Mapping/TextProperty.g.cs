...
public sealed partial class TextPropertyDescriptor<TDocument> : SerializableDescriptor<TextPropertyDescriptor<TDocument>>, IBuildableDescriptor<TextProperty>
{
	...
	private Elastic.Clients.Elasticsearch.Serverless.IndexManagement.FielddataFrequencyFilter? BuildFielddataFrequencyFilter()
	{
		...
		if (FielddataFrequencyFilterDescriptor is IBuildableDescriptor<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.FielddataFrequencyFilter?> buildable)
		{
		...
		if (FielddataFrequencyFilterDescriptorAction is not null)
		{
			...
			if (descriptor is IBuildableDescriptor<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.FielddataFrequencyFilter?> buildableFromAction)
			{
