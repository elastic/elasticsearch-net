...
public sealed partial class SoftDeletesDescriptor : SerializableDescriptor<SoftDeletesDescriptor>
{
	...
	private Elastic.Clients.Elasticsearch.Serverless.IndexManagement.RetentionLeaseDescriptor RetentionLeaseDescriptor { get; set; }
	...
	public SoftDeletesDescriptor RetentionLease(Elastic.Clients.Elasticsearch.Serverless.IndexManagement.RetentionLeaseDescriptor descriptor)
	{
	...
	public SoftDeletesDescriptor RetentionLease(Action<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.RetentionLeaseDescriptor> configure)
	{
		RetentionLeaseValue = null;
		RetentionLeaseDescriptor = null;
	...
	protected override void Serialize(Utf8JsonWriter writer, JsonSerializerOptions options, IElasticsearchClientSettings settings)
	{
		...
		{
			writer.WritePropertyName("retention_lease");
			JsonSerializer.Serialize(writer, new Elastic.Clients.Elasticsearch.Serverless.IndexManagement.RetentionLeaseDescriptor(RetentionLeaseDescriptorAction), options);
		}
