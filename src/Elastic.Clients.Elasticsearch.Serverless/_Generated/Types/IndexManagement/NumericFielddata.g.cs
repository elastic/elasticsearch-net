...
public sealed partial class NumericFielddataDescriptor : SerializableDescriptor<NumericFielddataDescriptor>
{
	...
	private Elastic.Clients.Elasticsearch.Serverless.IndexManagement.NumericFielddataFormat FormatValue { get; set; }

	public NumericFielddataDescriptor Format(Elastic.Clients.Elasticsearch.Serverless.IndexManagement.NumericFielddataFormat format)
	{
		FormatValue = format;
		return Self;
	}
