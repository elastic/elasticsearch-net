...
public sealed partial class ScriptProcessor
{
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor(ScriptProcessor scriptProcessor) => Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor.Script(scriptProcessor);
}
...
public sealed partial class ScriptProcessorDescriptor<TDocument> : SerializableDescriptor<ScriptProcessorDescriptor<TDocument>>
{
	...
	/// <para>ID of a stored script.<br/>If no `source` is specified, this parameter is required.</para>
	/// </summary>
	public ScriptProcessorDescriptor<TDocument> Id(Elastic.Clients.Elasticsearch.Serverless.Id? id)
	{
		IdValue = id;
		return Self;
	}
	...
	/// <para>Handle failures for the processor.</para>
	/// </summary>
	public ScriptProcessorDescriptor<TDocument> OnFailure(ICollection<Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor>? onFailure)
	{
	...
	public ScriptProcessorDescriptor<TDocument> OnFailure(Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument> descriptor)
	{
		OnFailureValue = null;
		OnFailureDescriptorAction = null;
		OnFailureDescriptorActions = null;
	...
	public ScriptProcessorDescriptor<TDocument> OnFailure(Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument>> configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorActions = null;
	...
	public ScriptProcessorDescriptor<TDocument> OnFailure(params Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument>>[] configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorAction = null;
...
public sealed partial class ScriptProcessorDescriptor : SerializableDescriptor<ScriptProcessorDescriptor>
{
	...
	/// <para>ID of a stored script.<br/>If no `source` is specified, this parameter is required.</para>
	/// </summary>
	public ScriptProcessorDescriptor Id(Elastic.Clients.Elasticsearch.Serverless.Id? id)
	{
		IdValue = id;
		return Self;
	}
	...
	/// <para>Handle failures for the processor.</para>
	/// </summary>
	public ScriptProcessorDescriptor OnFailure(ICollection<Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor>? onFailure)
	{
		OnFailureDescriptor = null;
		OnFailureDescriptorAction = null;
		OnFailureDescriptorActions = null;
	...
	public ScriptProcessorDescriptor OnFailure(Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor descriptor)
	{
		OnFailureValue = null;
		OnFailureDescriptorAction = null;
		OnFailureDescriptorActions = null;
	...
	public ScriptProcessorDescriptor OnFailure(Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor> configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorActions = null;
	...
	public ScriptProcessorDescriptor OnFailure(params Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor>[] configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorAction = null;
