...
public sealed partial class UppercaseProcessor
{
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor(UppercaseProcessor uppercaseProcessor) => Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor.Uppercase(uppercaseProcessor);
}
...
public sealed partial class UppercaseProcessorDescriptor<TDocument> : SerializableDescriptor<UppercaseProcessorDescriptor<TDocument>>
{
	...
	/// <para>The field to make uppercase.</para>
	/// </summary>
	public UppercaseProcessorDescriptor<TDocument> Field(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		FieldValue = field;
		return Self;
	}
	...
	/// <para>Handle failures for the processor.</para>
	/// </summary>
	public UppercaseProcessorDescriptor<TDocument> OnFailure(ICollection<Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor>? onFailure)
	{
	...
	public UppercaseProcessorDescriptor<TDocument> OnFailure(Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument> descriptor)
	{
		OnFailureValue = null;
		OnFailureDescriptorAction = null;
		OnFailureDescriptorActions = null;
	...
	public UppercaseProcessorDescriptor<TDocument> OnFailure(Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument>> configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorActions = null;
	...
	public UppercaseProcessorDescriptor<TDocument> OnFailure(params Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument>>[] configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorAction = null;
	...
	/// <para>The field to assign the converted value to.<br/>By default, the field is updated in-place.</para>
	/// </summary>
	public UppercaseProcessorDescriptor<TDocument> TargetField(Elastic.Clients.Elasticsearch.Serverless.Field? targetField)
	{
...
public sealed partial class UppercaseProcessorDescriptor : SerializableDescriptor<UppercaseProcessorDescriptor>
{
	...
	/// <para>The field to make uppercase.</para>
	/// </summary>
	public UppercaseProcessorDescriptor Field(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		FieldValue = field;
		return Self;
	}
	...
	/// <para>Handle failures for the processor.</para>
	/// </summary>
	public UppercaseProcessorDescriptor OnFailure(ICollection<Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor>? onFailure)
	{
		OnFailureDescriptor = null;
		OnFailureDescriptorAction = null;
		OnFailureDescriptorActions = null;
	...
	public UppercaseProcessorDescriptor OnFailure(Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor descriptor)
	{
		OnFailureValue = null;
		OnFailureDescriptorAction = null;
		OnFailureDescriptorActions = null;
	...
	public UppercaseProcessorDescriptor OnFailure(Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor> configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorActions = null;
	...
	public UppercaseProcessorDescriptor OnFailure(params Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor>[] configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorAction = null;
	...
	/// <para>The field to assign the converted value to.<br/>By default, the field is updated in-place.</para>
	/// </summary>
	public UppercaseProcessorDescriptor TargetField(Elastic.Clients.Elasticsearch.Serverless.Field? targetField)
	{
		TargetFieldValue = targetField;
		return Self;
	}
