...
public sealed partial class DocumentDescriptor : SerializableDescriptor<DocumentDescriptor>
{
	...
	/// </para>
	/// </summary>
	public DocumentDescriptor Id(Elastic.Clients.Elasticsearch.Serverless.Id? id)
	{
		IdValue = id;
		return Self;
	}
	...
	/// </para>
	/// </summary>
	public DocumentDescriptor Index(Elastic.Clients.Elasticsearch.Serverless.IndexName? index)
	{
		IndexValue = index;
		return Self;
	}
