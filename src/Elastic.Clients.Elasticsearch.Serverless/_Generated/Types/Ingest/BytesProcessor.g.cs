...
public sealed partial class BytesProcessor
{
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor(BytesProcessor bytesProcessor) => Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor.Bytes(bytesProcessor);
}
...
public sealed partial class BytesProcessorDescriptor<TDocument> : SerializableDescriptor<BytesProcessorDescriptor<TDocument>>
{
	...
	/// <para>The field to convert.</para>
	/// </summary>
	public BytesProcessorDescriptor<TDocument> Field(Expression<Func<TDocument, object>> field)
	{
		FieldValue = field;
		return Self;
	}
	...
	/// <para>Conditionally execute the processor.</para>
	/// </summary>
	public BytesProcessorDescriptor<TDocument> If(string? value)
	{
		IfValue = value;
		return Self;
	}
	...
	public BytesProcessorDescriptor<TDocument> OnFailure(Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument> descriptor)
	{
		OnFailureValue = null;
		OnFailureDescriptorAction = null;
		OnFailureDescriptorActions = null;
	...
	public BytesProcessorDescriptor<TDocument> OnFailure(Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument>> configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorActions = null;
	...
	public BytesProcessorDescriptor<TDocument> OnFailure(params Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument>>[] configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorAction = null;
	...
	/// <para>The field to assign the converted value to.<br/>By default, the field is updated in-place.</para>
	/// </summary>
	public BytesProcessorDescriptor<TDocument> TargetField(Expression<Func<TDocument, object>> targetField)
	{
		TargetFieldValue = targetField;
		return Self;
	}
...
public sealed partial class BytesProcessorDescriptor : SerializableDescriptor<BytesProcessorDescriptor>
{
	...
	/// <para>Conditionally execute the processor.</para>
	/// </summary>
	public BytesProcessorDescriptor If(string? value)
	{
		IfValue = value;
		return Self;
	}
	...
	public BytesProcessorDescriptor OnFailure(Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor descriptor)
	{
		OnFailureValue = null;
		OnFailureDescriptorAction = null;
		OnFailureDescriptorActions = null;
	...
	public BytesProcessorDescriptor OnFailure(Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor> configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorActions = null;
	...
	public BytesProcessorDescriptor OnFailure(params Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor>[] configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorAction = null;
