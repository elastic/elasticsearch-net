...
public sealed partial class ForeachProcessor
{
	...
	public Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor Processor { get; set; }
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor(ForeachProcessor foreachProcessor) => Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor.Foreach(foreachProcessor);
}
...
public sealed partial class ForeachProcessorDescriptor<TDocument> : SerializableDescriptor<ForeachProcessorDescriptor<TDocument>>
{
	...
	private Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument> ProcessorDescriptor { get; set; }
	private Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument>> ProcessorDescriptorAction { get; set; }
	...
	public ForeachProcessorDescriptor<TDocument> OnFailure(Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument> descriptor)
	{
		OnFailureValue = null;
		OnFailureDescriptorAction = null;
		OnFailureDescriptorActions = null;
	...
	public ForeachProcessorDescriptor<TDocument> OnFailure(Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument>> configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorActions = null;
	...
	public ForeachProcessorDescriptor<TDocument> OnFailure(params Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument>>[] configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorAction = null;
	...
	/// </para>
	/// </summary>
	public ForeachProcessorDescriptor<TDocument> Processor(Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor processor)
	{
	...
	public ForeachProcessorDescriptor<TDocument> Processor(Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument> descriptor)
	{
		ProcessorValue = null;
		ProcessorDescriptorAction = null;
	...
	public ForeachProcessorDescriptor<TDocument> Processor(Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument>> configure)
	{
		ProcessorValue = null;
		ProcessorDescriptor = null;
	...
	protected override void Serialize(Utf8JsonWriter writer, JsonSerializerOptions options, IElasticsearchClientSettings settings)
	{
		...
		{
			writer.WritePropertyName("processor");
			JsonSerializer.Serialize(writer, new Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument>(ProcessorDescriptorAction), options);
		}
		else
		{
			writer.WritePropertyName("processor");
...
public sealed partial class ForeachProcessorDescriptor : SerializableDescriptor<ForeachProcessorDescriptor>
{
	...
	private Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor ProcessorValue { get; set; }
	private Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor ProcessorDescriptor { get; set; }
	private Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor> ProcessorDescriptorAction { get; set; }
	private string? TagValue { get; set; }
	...
	public ForeachProcessorDescriptor OnFailure(Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor descriptor)
	{
		OnFailureValue = null;
		OnFailureDescriptorAction = null;
		OnFailureDescriptorActions = null;
	...
	public ForeachProcessorDescriptor OnFailure(Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor> configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorActions = null;
	...
	public ForeachProcessorDescriptor OnFailure(params Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor>[] configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorAction = null;
	...
	/// </para>
	/// </summary>
	public ForeachProcessorDescriptor Processor(Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor processor)
	{
		ProcessorDescriptor = null;
		ProcessorDescriptorAction = null;
		ProcessorValue = processor;
	...
	public ForeachProcessorDescriptor Processor(Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor descriptor)
	{
		ProcessorValue = null;
		ProcessorDescriptorAction = null;
		ProcessorDescriptor = descriptor;
	...
	public ForeachProcessorDescriptor Processor(Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor> configure)
	{
		ProcessorValue = null;
		ProcessorDescriptor = null;
		ProcessorDescriptorAction = configure;
	...
	protected override void Serialize(Utf8JsonWriter writer, JsonSerializerOptions options, IElasticsearchClientSettings settings)
	{
		...
		{
			writer.WritePropertyName("processor");
			JsonSerializer.Serialize(writer, new Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor(ProcessorDescriptorAction), options);
		}
		else
		{
			writer.WritePropertyName("processor");
