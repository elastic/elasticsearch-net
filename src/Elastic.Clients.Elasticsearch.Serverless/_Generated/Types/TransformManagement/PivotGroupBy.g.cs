...
internal sealed partial class PivotGroupByConverter : JsonConverter<PivotGroupBy>
{
	public override PivotGroupBy Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
	{
		...
		{
			var variant = JsonSerializer.Deserialize<Elastic.Clients.Elasticsearch.Serverless.Aggregations.DateHistogramAggregation?>(ref reader, options);
			reader.Read();
		...
		{
			var variant = JsonSerializer.Deserialize<Elastic.Clients.Elasticsearch.Serverless.Aggregations.GeotileGridAggregation?>(ref reader, options);
			reader.Read();
			return new PivotGroupBy(propertyName, variant);
		}
		...
		{
			var variant = JsonSerializer.Deserialize<Elastic.Clients.Elasticsearch.Serverless.Aggregations.HistogramAggregation?>(ref reader, options);
			reader.Read();
			return new PivotGroupBy(propertyName, variant);
		}
		...
		{
			var variant = JsonSerializer.Deserialize<Elastic.Clients.Elasticsearch.Serverless.Aggregations.TermsAggregation?>(ref reader, options);
			reader.Read();
			return new PivotGroupBy(propertyName, variant);
		}
