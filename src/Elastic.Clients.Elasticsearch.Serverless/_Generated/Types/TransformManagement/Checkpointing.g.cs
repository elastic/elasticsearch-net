...
public sealed partial class Checkpointing
{
	...
	public Elastic.Clients.Elasticsearch.Serverless.TransformManagement.CheckpointStats Last { get; init; }
	[JsonInclude, JsonPropertyName("last_search_time")]
	public long? LastSearchTime { get; init; }
	[JsonInclude, JsonPropertyName("next")]
	public Elastic.Clients.Elasticsearch.Serverless.TransformManagement.CheckpointStats? Next { get; init; }
